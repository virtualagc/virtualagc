...
LLRET                           ERASE                           # Return address for LL2.
                                ...
                                TC        STARTUP     # Go to your "real" code.
                                NOOP
                                NOOP
...
STARTUP                         INCR    A
                                TC      NEXT
BAD                             INCR    L    #if L is above zero something bad happened
                                NOOP
FINAL                           INCR    A    #A should end as 3 everything else Q should be an address
                                EXTEND 
                                DCA     50
NEXT                            INCR    A
                                TC      FINAL
