...
class nameMacrodefBuffer(Buffer):
...
class nameMacrodefParser(Parser):
...
if __name__ == '__main__':
    ...
    ast = generic_main(main, nameMacrodefParser, name='nameMacrodef')
    data = asjson(ast)
