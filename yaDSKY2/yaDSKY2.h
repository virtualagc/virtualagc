...
/*
  Copyright 2009,2017 Ronald S. Burkey <info@sandroid.org>
...
public:
    ...
    int scriptFileCount;
    int scriptFileCurrentLine;
    double scriptFileDifferentialTime;
    int scriptFileChannelNumber;
    int scriptFileChannelValue;
    double scriptFileWaitUntil;
    void scriptFileProcessLine(void);
