...
# Reference:	pp. 1418-1438 of 1729.pdf.
# Contact:	Ron Burkey <info@sandroid.org>.
# Website:	www.ibiblio.org/apollo/index.html
# Mod history:	06/07/03 RSB.	Began transcribing.
#		05/14/05 RSB	Corrected website reference above.
#		2010-10-25 JL	Added missing # in comment. Indentation fixes.
...
# CHECK IF DAP PASS IS PERMISSIBLE
		...
		TC	CHEKBITS	# RETUR IS TC I+1 IF DAP SHOULD STAY ON.
...
#	TRAPSIZE	NEGATIVE LIMIT OF MAGNITUDE OF TRAEDP, ETC.
...
CALCPERR	CA	CDUY		# P-ERROR CALCULATION.
		...
		EXTEND
		MP	M11		# (CDUY-CDUYD)M1 SCALED AT PI RADIANS
