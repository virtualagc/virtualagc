...
# Reference:	pp. 268-307 of 1729.pdf.
...
# Page 269
		...
		TC	V90PERF		# VB 90 OUT OF PLANE RENDEZVOUS DISPLAY
...
LRPOS2K		TC	INTPRET
		BOFF			# IF AVG G ON?
			AVEGFLAG
			LRPOS2K1	# NO
		EXIT			# YES: IS P63 GOING?
		TC	CHECKMM
		DEC	63
		TCF	LRPOS2K1 +1	# NO: COMMAND LR TO POS2
		TC	BANKCALL
		CADR	V59GP63		# YES: GO SET UP HIGATE JOB
LRPOS2K1	EXIT
# Page 272
		TC	RDRUSECK	# CHECK USE OF LR
		TC	BANKCALL	
...
#	5.	DISPLAY FLASHING V24, N73 (LOAD NEW RR TRUNNION ANGLE AND NEW SHAFT ANGLE).
#		RESPONSES
#		A.	TERMINATE
...
# Page 284
		...
		CA	OPTIONX	+1	# SAVE DESIRED OPTION
		TS	RTSTDEX
...
R04Y		CAF	ZERO		# TO TERMINATE SAMPLING.
		TS	RSAMPDT
		TC	BANKCALL
		CADR	2SECDELY	# WAIT FOR LAST RADARUP
		CAF	1SEC+1		# SAMPLE ONCE PER SECOND
		TS	RSAMPDT
...
# VERB 93	CLEAR RENDWFLG, CAUSES W-MATRIX TO BE RE-INITIALIZE
...
DAPDATA1	CAF	BOOLSMSK	# SET DISPLAY ACCORDING TO DAPBOOL'S BITS.
		MASK	DAPBOOLS	# LM
# Page 300
		TS	DAPDATR1	# LM
...
STIKLOAD	CAF	EBANK6
		...
		CCS	A		# 20 D/S (NORMAL) OR 4 D/S (FINE), ACALED
		CA	NORMAL		# AT 45 D/S.
		AD	FINE
		TS	STIKSENS
		CA	-0.6D/S
...
# Page 306
# 
# ELEVATION IS THE ANGLE BETWEEN +ZNB AND THE PROJECTIKON OF THE LOS INTO THE X-Z PLANE, 0-360 ABOUT +Y.
...
RRLOSDSP	EXTEND
		...
		STOVL	8D
			6D
		UNIT
		STORE	6D		# UNIT OF LOS PROJ IN X-Z PLAND
		DOT
			UNITZ
		STOVL	COSTH		# 16D
			UNITX
