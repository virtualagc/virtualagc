...
##				Added in ##-comments with hyperlinks for some of the
##				documents reference in the code comments.  (Just as
##				an experiment; I didn't do it systematically.)
