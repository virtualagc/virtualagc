...
# Reference:	pp. 218-243 of 1729.pdf.
# Contact:	Ron Burkey <info@sandroid.org>.
# Website:	www.ibiblio.org/apollo/index.html
# Mod history:	05/06/03 RSB.	Began transcribing.
#		05/14/05 RSB	Corrected website reference above.
#		2010-10-25 JL	Added missing # to comment. Indentation fixes.
...
V37RET		CS	FLAGWRD0		# IS P20 PR 022 RUNNING?
		MASK	RNDVZBIT
		CCS	A
...
P00H		TC	RELDSP			# RELEASE DISPLAY SYSTEM
		...
		TC	CLRADMOD		# CLRADMOD DOES NA INHINT.
		
		CS	NODOBIT			# TURN OFF NODOFLAG.
		MASK	FLAGWRD2
		TS	FLAGWRD2
		
		CA	FIVE			# SET RESTART FOR STATINT
		TS	L
		COM
		DXCH	-PHASE2
