...
## Reference:	pp. 157-191
## Contact:	Ron Burkey <info@sandroid.org>. 
## Website:	www.ibiblio.org/apollo/index.html
## Mod history:	04/11/03 RSB.	Began transcribing.
## 		05/05/03 RSB.	Draft finished.
##		05/14/05 RSB	Corrected website reference above
##		2010-10-25 JL	Indentation fixes. Added missing p190 comment.
...
T4RUPT		TS	BANKRUPT
		...
		CCS	DSRUPTSW	# GOES 7(-1)0 AROUND AND AR
		TCF	NORMT4 +1
		TCF	NORMT4
...
# IMODESD0 BIT 7 IS SET = 1 BY THE FIRST BIT (CHANNEL 30 BIT 14 OR 9) WHICH ARRIVES.  FOLLOWING THIS, TNONTEST IS
...
# WENT PROPERLY, THE ISS DELAY CLTBIT IS SENT AND THE ICDU'S ZEROED.  A TASK IS INITIATED TO REMOVE THE PIPA FIAL
...
# ALIGN (= GIMBAL LOCK HERE) OR A MISSIN PROGRAM IS USING THE IMU (IMUSEFLG = 1).

# CALLING SEQUENCE:  T4RUPT EVERY 480 MILLISECONDS AFTER IMUMON.

# JOBS OR TASKS INITIATED:  1) ENDTMON, 90 SECONDS AFER CAGING STARTED.  2) ISSUP, 4 SECONDS AFTER CAGING DONE.
...
# WAITING AND INITIALIZATION COMPLET, EXIT TO ENDIMU, MISSION PROGRAM WAITING AND INITIALIZATION FAILED, EXIT TO
...
# PROGRAM NAME:  IMUOP.
#
# FUNCTIONAL DESCRIPTION:  THIS PROGRAM PROCESSES CHANGES IN TEH ISS OPERATE DISCRETE, BIT 9 OF CHANNEL 30.
...
# IMODES30 TO AGREE.  IT CALLS SETISSW IN CASE A PIPA FAIL NECESSITATES AN ISS WARNING.  IF NOT, I.E., MODES30
...
PIPFAIL		CCS	A			# SET BIT10 IN IMODES30 SO ALL ISS WARNING
		...
		CS	IMODES30		# IF PIP FAIL DOESN'T LIGHT TEST WARNING, DO
...
# PROGRESS.
#
# CALLING SEQUENCE:  CALLED BY IMUMON ON CHANGES TO IMU FAIL AND ICDU FAIL.  CALLED BY IFAILCK AND PFAILOK UPON
...
#
# THIS PROGRAM CALCULATES ALL FHTE SINGLE-PRECISION MATRIX ELEMENTS WHICH ARE USED BY LEM DAP TO TRANSFORM VECTORS
