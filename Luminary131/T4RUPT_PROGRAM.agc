...
# WENT PROPERLY, THE ISS DELAY CLTBIT IS SENT AND THE ICDU'S ZEROED.  A TASK IS INITIATED TO REMOVE THE PIPA FAIL
...
# CHANNEL 33 WITH A WAND INSTRUCTION BECAUSE A 1WRITE' PULSE IS REQUIRED TO RESET THE FLIP-FLOPS.  THE BITS
