...
FMAXODD		DEC	+3841			# FSAT +4.31454413 E+4 (comment garbled)
...
KPIP1(5)	DEC	.0512			# SCALES DELV TO M/CS*S(-5).
...
MINCSM		=	BIT11			# MIN CSM MASS (OK FOR 1/AGCS) = 9050 LB (comment garbled)
