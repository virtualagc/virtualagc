...
NEWMODEA        XCH     MODREG          # ENTRY FOR MODE IN A
...
#          IN ANY CASE, THE NEGATIVE OF THE PHASE, FOLLOWED (IN THE NEXT REGISTER)  BY THE PHASE, IF STORED IN THE
