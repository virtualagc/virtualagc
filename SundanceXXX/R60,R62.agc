...
TOBALL          TC      BALLANGS        # TO CONVERT ANGLES TO FDAI
TOBALLA         CAF     V06N18
                TC      BANKCALL
                CADR    GOPERF2R        # DISPLAY PLEASE PERFORM AUTO MANEUVER
                TC      R61TEST
                TC      REDOMANC        # PROCEED
                TC      GOMANMNV        # ENTER I.E. FINISHED WITH R60
...
TOBALLC         TC      BALLANGS        # TO CONVERT ANGLES TO FDAI
                TC      G+N,AUTO        # CHECK AUTO MODE
                CCS     A
                TC      MANMANUV        # NOT AUTO, GO PERFORM MANUAL MANEUVER.
...
ENDMANUV        TC      DOWNFLAG        # FINISHED MANEUVER.
                ADRES   AUTMANSW
                TCF     REDOMANC
