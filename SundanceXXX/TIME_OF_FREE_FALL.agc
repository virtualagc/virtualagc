...
TFFCONMU        VLOAD   ABVAL           # COME HERE WITH TFFRTMU LOADED.
                ...
                V/SC    VSQ
                        TFF/RTMU        # KEEP MPAC+2 HONEST FOR SQRT.
                STORE   TFFVSQ          # -(V SQ/MU)  E:(20) M:(18)
                                        # SAVE FOR VGAMCALC
                SR*     DCOMP
                        0 -4,1          # GET -VSQ/MU  E:(26-NR) M:(24-NR)
                DAD     STADR
                                        # 2/RMAG  FROM PDL+2
...
TFFRP/RA        DLOAD   DMP
                ...
                STORE   RAPO            # APOGEE RADIUS  M  E:(-29) M:(-27)
DUMPRPRA        RVQ
