...
downlists = {
    "CmPoweredListSpec": (0o77774, "CM Powered downlink list"),
    "LmOrbitalManeuversSpec": (0o77774, "LM Orbital Maneuvers downlink list"),
    "CmCoastAlignSpec": (0o77777, "CM Coast Align downlink list"),
    "LmCoastAlignSpec": (0o77777, "LM Coast Align downlink list"),
    "CmRendezvousPrethrustSpec": (0o77775, "CM Rendezvous/Prethrust downlink list"),
    "LmRendezvousPrethrustSpec": (0o77775, "LM Rendezvous/Prethrust downlink list"),
    "CmProgram22Spec": (0o77773, "CM Program 22 downlink list"),
    "LmDescentAscentSpec": (0o77773, "LM Descent/Ascent downlink list"),
    "LmLunarSurfaceAlignSpec": (0o77772, "LM Lunar Surface Align downlink list"),
    "CmEntryUpdateSpec": (0o77776, "CM Entry/Update downlink list"),
    "LmAgsInitializationUpdateSpec": (0o77776, "LM AGS initialization/update downlink list")
    }
...
for structureName in downlists:
    ...
    id = downlist[0]
    title = downlist[1]
    filename = "ddd-%05o-%s.tsv" % (id, title[:2])
    ...
    for line in f:
        ...
        if fields[0] == "-1":
            print('    { -1 },')
            continue
        print('    { %s, "%s=", %s, %s' % (fields[0], fields[1], fields[2], fields[3]), end="")
        if len(fields[4]) == 0:
            print(' },')
        else:
            print(', &%s },' % fields[4])
