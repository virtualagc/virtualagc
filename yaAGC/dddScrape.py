#!/usr/bin/env python
'''
This is a one-time-use program for initial creation of some external files
needed in refactoring DecodeDigitalDownlink.c.
'''
...
cmDownlists = {
    ...
    [ -1 ],
    [ -1 ],
    [ 180, "CHN1112=", "B0", "FMT_2OCT" ],
    [ 182, "CHN1314=", "B0", "FMT_2OCT" ],
    [ 184, "CHN3031=", "B0", "FMT_2OCT" ],
    [ 186, "CHN3233=", "B0", "FMT_2OCT" ],
    [ 188, "VGTIG=", "B7", "FMT_DP" ],
