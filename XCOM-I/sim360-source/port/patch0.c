{
  ...
  // History:   2024-06-28 RSB  Auto-generated by XCOM-I --guess-inlines
  //                            but heavily-modified by me, due to
  //                            self-modifying code *and* messing with
...
p0_4: ;
  ...
  // This is apparently for turning GR2 into the string descriptor for a
  // a null string.
...
p0_10: ;
  ...
  // This instruction should put the top 8 bits of GR3 (i.e., the L-1 field
  // of the string descriptor `TEXT`) into the least 8 bits of GR2.
  detailedInlineBefore(4, "SLDL 2,0,8(0)");
  scratch = (((int64_t) GR[2]) << 32) | GR[3];
  scratch = scratch << ((8) & 0x3F);
  GR[2] = scratch >> 32;
...
p0_14: ;
  ...
  // Shifts the 24-bit address field of `TEXT`, stored in GR3, back into the
  // position it had prior to the preceding instruction.  The L-1 field in GR3,
  // on the other hand, is now 0.
...
p0_22: ;
  ...
  address360B = 43184;
  // Type RX, p. 7-78:		LA	12,43184(0,0)
  detailedInlineBefore(7, "LA   12,43184(0,0)");
...
p0_26: ;
  ...
  // EX not supported by XCOM-I --guess, so loading its address into GR2
  // above (even if it had worked as expected, which it didn't!) was
  // wasted.  By my reckoning, the TRT instruction itself, prior to modification
  // of the length field by EX, is:
  //            TRT     0,0(3),0(1)
  // Here's the translation for running the TRT instruction directly:
...
p0_42: ;
  // (13)       CALL INLINE("1A", 1, 0);           /* ADD TO OBTAIN IDENTIFIER LENGTH */  
...
p0_56: ;
  ...
  address360B = 5100;
  // Type RX, p. 7-122:		ST	1,6900(0,0)
  detailedInlineBefore(18, "ST  1,5100(0,0)");
