{
   ...
   *                            For some reason, the jump-table for the BCR
   *                            in p0_8 wasn't generated, even though the
   *                            identical ones at p0_32 and p0_45 were.
   *                            I've copied p0_8 from the preceding generation
   *                            of now-obsoleted patches.  p0_8 was also
   *                            generated incorrectly (still containing an
   *                            unexpanded %s).  There was an unclosed
   *                            parenthesis in p0_14.  Yikes!  What gives?
   */
