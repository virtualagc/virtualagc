 /*@
    ...
    History:    2022-12-08 RSB  Suffixed the filename with ".xpl".
                2024-05-14 RSB  Added declarations for DX_SIZE and 
                                DESCRIPTOR_DESCRIPTOR.  These are used by
                                the XCOM-I and the runtime library, and so 
                                must not be removed.
 ...
 */
 ...
 /*@ Added 2024-05-14.  *Not* in HALINCL/SPACELIB.  I think that `DX_SIZE` and
     `DESCRIPTOR_DESCRIPTOR` must be built-ins in Intermetrics XCOM, but 
     I couldn't do that in XCOM-I, so I have to DECLARE them.  However,
