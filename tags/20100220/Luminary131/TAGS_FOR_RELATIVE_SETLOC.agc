...
HIDP1/4		EQUALS	DP1/4TH			# (line is garbled)
...
# ROPE-SPECIFIC ASSIGNS OBVIATING NEED TO CHECK COMPUTER FLAG IN (garbled) DETERMINING INTEGRATION AREA ENTRIES.
...
ERASID		EQUALS	BITS2-10		# DOWNLINK ERASABLE DUMP IO
DELAYNUM	EQUALS	TWO
