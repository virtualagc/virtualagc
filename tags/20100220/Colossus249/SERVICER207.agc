...
# 	ONMNITOR
#
#		A SEQUENCE OF THESE PASSES THROUGH QUICREAD FOLLOWING A CALL TO READACCS WITH ONMONFLG SET AT 1/2 
...
#			THE 2CADR OF SERVEXIT IS SET INTO AVGEXIT BY THE USER F NO OTHER ROUTINE (SEE ABOVE).
#
