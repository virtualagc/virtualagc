...
##              2016-12-11 HG   fix operand MOREIDLE -> NONEEDLE
...
# THE NECESSARY INITIALIZATION OF THE DAP IS DONE BY THE DAPIDLER PROGRAM.
		...
		COUNT*	$$/DAPID
#	CHECKBITS IS CALLED EVERY 0.1 SEC AT THE BEGINNING OF THE DAP PASS, WHETHER THE AUTOPILOT IS ACTIVE OR IDLING.
# IT CHECKS FOR THE FOLLOWING
#		A. IS THE PGNCS MODE SELECT SWITCH TURNED TO "OFF"?
#		B. IS THE IMU UNAVAILABLE AS AN ATTITUDE REFERENCE?
#		C. HAS THE INDICATION GONE FROM AGS TO PGNCS SINCE LAST CHECKED
#	IF EITHER A OR B HOLD, THE FDAI ERROR NEEDLES MUST NOT BE UPDATED (TOAVOID CONFLICT OVER USE OF THE DACS WITH
# V43 OR COARSE ALIGN) AND THE DAP MUST IDLE.  A BIT IS SET TO CAUSE  NEEDLER TO INITIALIZE ITSELF WHEN IT IS NEXT
# CALLED AND CONTROL IS TRANSFERRED TO A SHORT IDLING ROUTINE.  OTHERWISE, THE NEEDLES ARE UPDATED AND CONDITION
# "C" IS TESTED.

#	IF C HOLDS, THE DAP IS REINITIALIZED.  OTHERWISE, THE DAP SHOULD BE ACTIVE AND CONTROL IS TRANSFERRED BACK TO
# THE CALLER OF CHECKBITS.
...
CHEKMORE	CAF	BIT10		# BIT 10 OF 30 IS PGNCS CONTROL OF S/C
		...
		MASK	NPGNCSBT
		CCS	A
		RETURN			# PGNCS BOTH LAST TIME & THIS: GO CONTROL.

## Page 1408
		CS	NPGNCSBT	# PGNCS THIS TIME BUT AGS LAST: CLEAR
		MASK	FLGWRD10	#   NPGNCSFL AND GO INITIALIZE DAP.
		TS	FLGWRD10
		TCF	STARTDP1

AGSINDIC	CS	FLGWRD10
		MASK	NPGNCSBT
		ADS	FLGWRD10
		RETURN
...
STARTDP1	CAE	DAPBOOLS	# IF 1/ACCS HAS NOT BEEN COMPLETED, IDLE.
...
## Page 1413
		...
		CAE	FLAGWRD0	# NEEDFLG WILL INDICATE TOTAL OR DAP AT-
...
NEEDLES		CAF	TWO
DACLOOP		TS	DINDX
		CS	ONETENTH	# RESCALE OUTPUTS TO + OR - 1800 DEGREES.
		EXTEND
		INDEX	DINDX
		MP	AK
		TS	L
