...
GENRET          ERASE                                   # B(1) R61 RETURN CODE.
...
# PADLOADS FOR R12 DOPPLER COMPENSATION         (3D)
...
# ERASABLE FOR REGISTER 3 OF NOUN 49            (1D)
...
LONGEXIT        ERASE   +1              # B(2)TMP MAY BE SELDOM OVERLAYED(?) (garbled)
...
LMPOS           ERASE   +5              # I(6)TMP  STORAGE FOR LM POS. VECTOR.
LMVEL           ERASE   +5              # I(6)TMP  STORAGE FOR LM VEL. VECTOR.
...
RTSTLOC         ERASE                   # B(1)
RSAMPDT         ERASE                   # B(1)
RFAILCNT        EQUALS  PBODY +101D     # B(1)

END-E4          EQUALS                  # FIRST UNUSED LOCATION IN E4

# SECOND DPS GUIDANCE (LUNAR LANDING)  (OVERLAY P32-35, INITVEL)        (12D)

ANGTERM         EQUALS  PIPTEM +5       # I(6) GUIDANCE
...
TAUROD          EQUALS  RODSCALE +1     # I(2) TIME CONSTANT FOR R.O.D. (garbled)
...
DLAND           EQUALS  RGU     +6              # I(6) LANDING SITE CORRECTION SM FRAME
DLANDX          EQUALS  DLAND
...
## Page 138
# GIMBAL CONTROL LAW ERASABLES                  (11D)
...
ACCDOTQ         ERASE   +3              # Q-JERK SCALED AT P8/2(7) UNSIGNED
...
VELBIAS         ERASE   +1              # B(2) PL BIAS VALUE FOR VELOCITY
...
# INITVEL STORAGE.  ALSO USED BY P34,35,74,75,10,11 OTHER       (8D)
...
# L SR22.3 (RENDEZVOUS NAVIGATION) STORAGE.             (6D)
...
# ERASABLES FRO P64: OVERLAY OF RTARG           (4D)
...
ERADM           EQUALS  UT              # I(2)TMP LM POSITION VECTOR
INCORPEX        EQUALS  ERADM +2        # I(1)    CM V X R VECTOR
...
AZIDUMMY        =       ELIDUMMY +1     # (1)   DUMMY FOR AZONCR1
