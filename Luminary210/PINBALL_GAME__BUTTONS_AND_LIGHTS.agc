...
MINCON2		OCT	00011		# .0006 FOR MINUTES DISLPAY
		OCT	32445
MINCON1		OCT	02104		# .066..66 UPPED BY 2EXP-2B
		OCT	10422
HRCON1		2DEC	.16384 
...
REQUESTC	TC	RELDSP
		CA	N26/PRI
		EXTEND
		BZF	GODSPALM	# OP ERROR AND EOJ IF ZERO PRIO/DELAY
		CA	ENDINST
## Page 463
...
TSTCON2		OCT	40677		# DSPTAB +11D BITS 1,2,3,4,5,6,8,9.
					#       DAP, LR, SUPER KEYREL,
...
ERROR		XCH	21/22REG	# RESTORE ORIGINAL C(DSPLOCK). THUS ERROR
		...
		CAF	GL,ETC.		# LEAVE GIMBAL LOCK, NO ATT, DAPLITE,
					#   & SUPER KEYRELEASE LITES INTACT
...
GL,ETC.		OCT	00053		# NO ATT, GIMB LOCK, DAPLITE, SUPER KR.
NOTBIT12	OCT	73777
