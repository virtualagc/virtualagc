...
#          TO CHANGE A "FINDVAC" JOB TO A "NOVAC" -- RELEASE ITS VAC AREA:
VACRLEAS	CA	PRIORITY	# CHANGE TO NOVAC VALUE
		MASK	PRIO37
		AD	FAKEPRET
		XCH	PRIORITY
		MASK	LOW9
...
ADVAN		CCS	NEWJOB		# IS A NEWJOB ACTIVE ?
		...
		INCR	DUMLOOPS	# COUNT DUMMYJOB LOOPS FOR DOWNLINK
