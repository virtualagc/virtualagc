...
#	ERASABLES(SHARED AND USED WITH OTHER PROGRAMS) CADRSTORE, DSPLIST, LOC, DSPTEM1, OPTION1
...
PRIOMONR	TS	PLAYTEM1
		CAF	PRIMNMSK	# PRIORITY,MONITOR,FLASHING DISPLAY
		TCF	GOFLASH2
...
HIPRIO		INHINT
		CS	DSPTAB +11D	# SET BITS 15 AND 1

## Page 1356
		MASK	OCT40001	# (WHATEVER THEIR PREVIOUS STATE)
		ADS	DSPTAB +11D	#   TO TURN ON SUPER-KEYRELEASE LIGHT

		RELINT
		CA	FLAGWRD4	# MARK ACTIVE
		MASK	OCT40400
		EXTEND
		BZF	ASKIFNRM	# NO
...
#
#	IF THE MOST RECENT NORMAL DISPLAY REQUEST WAS NOT FINISHED, CONTROLIS SENT BACK TO TEH LAST NORMAL USER.
...
## Page 1363
		...
		INDEX	COPINDEX
		TCF	+1
		CA	OCT2600		# CAUSES V16 TO BE IN A AT NVMONOPT
		TS	TEM1		# SET, BIT 8 IN TEM1 IF DEC MARK
		CA	MPAC +2
		TS	MPAC2SAV
...
TIMECHEK	CS	TIME1
		...
		INHINT
		CS	OCT40001	# TURN OFF SUPER-KEYRELEASE LIGHT
		MASK	DSPTAB +11D
		AD	BIT15
		TS	DSPTAB +11D
...
# MORE LOGIC COULD BE INCORPORATED HERE TO MAKE SURE A RECYCLE IS A RECYCLEAND CONVERSELY THAT A LOAD IS A LOAD
...
OCT2600		OCT	02600
PRIMNMSK	OCT	00310		# MONITOR PASTE, PRIO, FLASH
