...
# PROGRAM (POO) BY KEYING V37E00E OR BY KEYING IN V56E
...
R21LEM4		TC	CLRADMD1	# CLEAR BITS 10 & 15 IN RADMODES
		...
		TC	UPFLAG
		ADRES	FRSTIME		# SET FIRST PASS FLAG
...
R21LEM00	DAD
		...
		TC	INTPRET
		BOF	CLRGO
			FRSTIME		# FIRST PASS THRU PREPOSITION
			R21LEM8		# NO-GO TO CONTINUOUS DESIGNATE
			FRSTIME		# YES - RESET FIRST PASS FLAG
			R21LEM50
...
## Page 529
		...
		TC	R23LEM3		# RECYCLE- TO ANOTHER MANUVER
		TC	ENDOFJOB
...
RADLITES	CS	BIT5
		...
		CCS	A
		CS	ONE
## A + is drawn in the margine next to ONE above.
		TCF	VLIGHT
## A 0 is drawn in the margine next to VLIGHT above.
