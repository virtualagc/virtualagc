...
displayGraphic(0, 190, imageVerbOn)
displayGraphic(colPN, 190, imageNounOn)
displayGraphic(0, 368, imageSeparatorOn)
displayGraphic(0, 516, imageSeparatorOff)
displayGraphic(0, 664, imageSeparatorOff)
...
guiKeyTranslations.append(("KP_PGUP", "9"))
guiKeyTranslations.append(("KP_Prio", "9"))
guiKeyTranslations.append(("Numpad0", "K"))
guiKeyTranslations.append(("(", "K"))
guiKeyTranslations.append(("Numpad1", "R"))
guiKeyTranslations.append((")", "R"))
debugKey = ""
...
lampStatuses = {
	"UPLINK ACTY" : { "isLit" : True, "cliParameter" : "3", "spiParameters" : [ { "register":1, "mask":0x70 } ] },
...
#agcdsky				pass
#		if ledPanelRunning:
#agcdsky			print("Delaying lamp flush to avoid overlap ...")
#			lampExecCheckCount = 0
