...
DODOWNTM	TS	BANKRUPT
		EXTEND
		QXCH	QRUPT		# SAVE Q
## In Luminary 98, the following instruction was changed to jump to a piece
...
## In Luminary 98, code to check if it is time to set the word order bit
## was inserted here.
