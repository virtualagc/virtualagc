...
## Reference:   pp. 1227-1248
## Assembler:   yaYUL
## Contact:     Ron Burkey <info@sandroid.org>.
## Website:     www.ibiblio.org/apollo/index.html
## Mod history: 2019-07-28 MAS  Created from Luminary 99. Removed the code
##                              for SETITCTR, which was introduced in Luminary
##                              98.
...
## In Luminary 98, code for ITERCTR was positioned here, at the end of bank 11,
## to fix Luminary anomaly 65. It was located here to minimize the number of
## modules that would have to be remanufactured before flight.
