...
## Mod history: 2019-07-28 MAS  Created from Luminary 99. Replaced the call
##                              to SETITCTR with LAMBERT to undo the fix
##                              for anomaly 65 made in Luminary 98.
...
## In Luminary 98, the following LAMBERT call was replaced with a call to
## the new routine SETITCTR to correct Luminary anomaly 65. 
			LAMBERT
