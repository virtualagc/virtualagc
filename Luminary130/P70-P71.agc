...
##		2018-09-04 MAS	Updated to reflect the state of Luminary 130.
...
YOK		DLOAD	DSU
		...
		VLOAD	GOTO
			J1PARM
## The following line contains a bug fixed in Luminary 131. It is described in
## Luminary memo #129. The fix was to change the +3 below to STORPARM, and add
## a STORPARM label to the "STODL JPARM" at the end of this page.
			+3
