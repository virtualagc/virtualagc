...
# NOTE OF SPECIAL IMPORT CONCERNING RADER:
...
LST2FAN		TC	VBZERO		# VB40 ZERO (USED WITH NOUN 20 OR 40 ONLY)
		...
		TC	BEGINCDU	# VB63 SEND SPECIAL CDU DOWNLIST
		TC	64UPDAT		# VB64 SET TIMER TO GROUND ELAPSED TIME
		TC	65UPDAT		# VB65 SET GUIDANCE REFERENCE RELEASE DISC
		TC	66UPDAT		# VB66 INITIATE LGC DFI TLM CALIBRATE RTN
		TC	67UPDAT		# VB67 SEND COMMAND TO LMP
		TC	70UPDAT		# VB70 SET MISSION TIMER
		TC	71UPDAT		# VB71 SET MISSION PHASE REGISTER
		TC	72UPDAT		# VB72 SET MISSION PHASE REGISTER + TIMER
		TC	73UPDAT		# VB73 RESET DPS OR RPS COLD SOAK DISC
		TC	74UPDAT		# VB74 STOP MISSION TIMERS
		TC	75UPDAT		# VB75 PARAMETER UPDATE
		TC	76UPDAT		# VB76 STATE VECTOR UPDATE
		TC	ALM/END
...
# DON'T USE 13 OR 14 (SEE NOT ON USER'S PAGE 1).
