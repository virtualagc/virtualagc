...
## Page 508
		...
		EXTEND
		DV		RUPTREG4			# (FCT1/DENOM)(LOWER PART OF (1/2JTSP)(2))
...
MINTJCHK	CS		PTJMINT6			# 11.5 MS SCALED AT 16. (4MS ADDED TO TMIN
		...
		EXTEND
		BZMF		LASTTEST			# LASTTEST TESTS FOR TP LESS THAN MN IMP.
ROOTNEXT	EXTEND
...
# AN EXAMPLE OF HOW THE PROGRAM WORKDS, CONSIDER THE FOLLOWING PROBLEM...
...
#	   5) T6NEXTJT IS CHANGED DO OCTAL 40020 , AND THE FORMER CONTENTS
...
RATEMAX		DEC		0.88889
-35AT16		DEC		0.79012
-5DEG+1		DEC		-.02772				# -5 DEGREES + CCSBIT SCALED AT P RADIANS
...
T5IDLER		LXCH		BANKRUP				# LOOKS FOR GODAPGO TO START THE DAP.
# START CODING FOR MODULE 3 REMAKE, AUGUST 1967***START CODING FOR MODULE 3 REMAKE, AUGUST 1967********************
## Page 516
T5IDLER1	EXTEND
		QXCH		QRUPT
...
DLOOPCHK	CCS		ITEMP1
		TCF		DLOOP				# R-AXIS DONE.  NOW TO THE Q-AXIS.
		TCF		NOQRSM				# RESUME.
...
CSPQ		OCT		00243				# .01 SCALED AT 1, FOR CSP(2).
