...
# THE PROLAUNCH ALIGNMENT TECHNIQUE IS BASICALLY THE SAME AS IN BLOCK 1
...
#    01    INITALIZING THE PLATFORM POSITION AND ERASABLE
#    02    GYROCOMPASSING
...
ALFLT1          TC              LOADSTDT                        # COMES HERE ON RESTART
		...
		DAD		BMN				# (DV OVFLOW GIVES DP POSMAX)
				GLIFTOFF			# WHEN GLIFTOFF = DP POSMAX, THIS KIND OF
				GRRNOW				# LIFTOFF DIRECTION IS INHIBITED.
		EXIT						# CONTINUE GYROCOMPASS IF NOT LIFTOFF.
