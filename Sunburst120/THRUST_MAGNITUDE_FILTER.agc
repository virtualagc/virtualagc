...
#     THE THRUST MAGNITUDE FILTER CONVERTS ABDELV TO M/CS, INVERTS AND COMBINES IT WITH TWO PROCEDING
...
# CALLING SEQUENC - ATMAG IS ENTERED BY EXTEND                 AND        EXTEND
...
## Page 924
		...
		DMP	DMP		# VE SUM(1/DV)*2(-14)
			...
			2SEC(9)
		SL3	PDDL		# 1/8 DT VE SUM(1/DV)*2(-7)
			TBUP		# LOAD TBUP*2(-17)
