...
##		2016-12-04 RSB	Made a number of corrections to program comments
##				using octopus/ProoferComments, but the proofing
##				process shouldn't be considered complete.
##		2016-12-05 RSB	Comment-proofing pass with octopus/ProoferComments completed;
##				changes made.
##		2017-05-31 RSB	A few comment corrections based on changes made while
##				proofing the corresponding file for Sunburst 37.
