...
NEWLOC+1	EQUALS	ITEMP6		# DP ADDRESS.
		...
		SETLOC	67		# NEWJOB MUST BE AT LOC 67.
NEWJOB		ERASE			#        ----
...
#                3                  12               AVAILABLE
#                4                  11               AVAILABLE
#                5      LOKONSW     10     LOKONSW   RADAR LOCK-ON REQUEST         NO RADAR LOCK-ON REQUEST
#                                                                                     (LOCKED ON 0)
...
#               11                   4     NBSMBIT   STAR POSITION IN NAVIGTION    STAR POSITION IN STABLE
...
#							TO THROTTLING
#		 5		    40		     MISSION PHASE TIMERS ENABLED  MISSION PHASE TIMERS NOT ENABLED
...
#						    	DESIRED CDU ANGLES IN	      ANGLES CONTINUE DURING 
#							KALCMANU		      KALCMANU
...
#		 8		    67     DIRECT    ASCENT EQ SET FOR MP 13	   ASCENT EQ SET UP FOR MP 4
...
# Page 18
#		10                  65	   SMANGLESW NORMALIZED TIME		   TIME SCALED +7 (LOCKED ON 0)
...
# SUBROUTINE ROOPSRS.  THEY MUST REMAIN WITHOUT INTERFERENCE WITH ITS SUBROUTINES WHICH ARE POWRSERS (POLY),
...
DELAYCTR	ERASE			# COUNTER FOR MINIMUM IMPUSE USE OF RHC
...
RSTRTWRD	ERASE			# EACH BIT INDICATES RESTARTABILITY OF A 
					...
					# BUT NO. = MISSION PHASE NO.

# ERASABLE FOR SINGLE PRECISION ROUTINES.
...
# ERASABLE ASSIGNMENTS FOR LMP ROUTINES
...
# STORAGE FOR MISSION TIMER/PHASE REGISTER PAIRS.
...
STOPDVC		ERASE			# VALUD FOR DVCNTR FOR ENGINE OFF
...
# Page 30
# ASSIGNMENTS RESERVED EXLUSIVELY FOR SELF-CHECK
...
AZLANG		EQUALS			# DELETE WHEN OPTICAL TRACKER NOUNS GONE.
ELANG		EQUALS
DESLOTSY	EQUALS
DESLOTSX	EQUALS
...
# THE FOLLOWING MAY BE PLACED IN SWITCHED ERASABLE
...
DELDCDJ		EQUALS	DELCDUX
DELDCDJ1	EQUALS	DELCDUY
DELDCDJ2	EQUALS	DELCDUZ
TTEMP		EQUALS	TMIS	+4
POINTVSM	ERASE	+5
SCAXIS		ERASE	+5
TF		ERASE	+1
...
AZO		ERASE	+1		# ANGLE BETWEEN GREENWICH AND X-Z PLANE
...
# CAUTION: ORBITAL INTEGRATION REGISTERS RAVEGON, VAVEGON, AND SECOND DPS GUIDANCE REGISTERS TPIP, TIF/4,
# TIF/4TMP, TULLG ARE ALL IN USE SIMULTANEOUSLY AND MUST NOT CONFLICT.

RRECT		EQUALS	AMEMORY	+000D
RIGNTION	EQUALS	AMEMORY	+000D
VRECT		EQUALS	AMEMORY	+006D
VIGNTION	EQUALS	AMEMORY	+006D
TDELAV		EQUALS	AMEMORY	+012D
...
TPIPOLD		=	TPIP		+2
TIF/4		=	TPIPOLD		+2		# SEE CAUTION ABOVE
TIF/4TMP	=	TIF/4		+2		# SEE CAUTION ABOVE
...
UDUM		=	24		# TAKING THE UNIT OF RDUM IN SUBR GDUMCL.
GDUM		=	32		# PLACE GDUM TO PRESERVE /RDUM/ FOR OTHERS

# COMPUTES SECOND DPS ERASABLES (EXCEPT FOR CPT6/2 WHICH IS ASSIGNED ELSEWHERE)
...
# ***  THE REGISTERS AMEMORY +76D THROUGH AMEMORY +87D CONTAIN RAVEGON AND VAVEGON, AND MUST NOT BE USED BY THE
# ASCENT EQUATIONS.  *********
...
W		EQUALS	PBODY	+1	# USED IN 206, BUT REFERRED TO BY
					# ORBITAL INTEGRATION
...
# Page 43
# THE FOLLOWING REGISTERS ARE USED BY THE  ENTRY AND INITIALIZATION JOB OF THE FCS TEST FOR LEM.
...
# THE FOLLOWING ERASABLE REGISTERS ARE USED BY THE INTERFACE 700K TASK.	
...
VINJECT		ERASE	+1		# INJECTION VELOCITY DESIRED.  THIS QUANTITY
					# DETERMINES APOGEE.  MUST BE IN METERS/CENTISECONDS * 2(-7)
...
# Page 50
# RHC INPUTS SCALED AT P/4 RAD/SEC.
...
OMEGA.K		EQUALS	ITEMP1		# D.P. OMETA*K SUPERCEDES K AND K(2)
...
DBMINIMP	ERASE	+1		# MINIMUM IMPULSE DEADBANS (EQUAL IN DESC
...
.5ACCMNV	EQUALS	.5ACCMNE +4	# IN UNITES OF SECONDS(2)/RADIAN
...
AOSU		EQUALS	AOSQ +2		# UV-AXES OFFSET ACCS FORMED BY VECTOR ADDITION.
...
RACDOTMP	EQUALS	QACDOTMP	# GTS,DGTS BEFORE THE FILTER CAN USE THEM
...
DRIVFACR	=	DRIVEACQ +2	#   DRIVE TIMES.
...
MPAC DESIGNATIOSN FOR AOSJOB:

JOBAXES		EQUALS	MPAC		# ADJACENT ENTRY INDEXER.
NUPLACE		EQUALS	MPAC	+1	# ONE APART ENTRY INDEXER.
