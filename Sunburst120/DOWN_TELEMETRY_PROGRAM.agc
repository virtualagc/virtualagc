...
## Page 331
		...
		DXCH	DNTMGOTO	# DODOWNTM WILL TRANSFER CONTROL TO
...
SNAPLOOP	TS	ITEMP2		# TOTAL NO. OF SNAPSHOT DP WORDS LESS 2.
		...
		INDEX	ITEMP		# AND SAVE IT IN THE NEXT AVAILABLE LOC
...
## Page 332
		TC	TMINDEX		# SAVE COUNT OF SNAPSHOT WORDS REMAINING
...
LSENDDSA	ADRESS	SENDDSA		# LOC OF ROUTINE WHICH SENDS DISPLAY TABLE
...
# ---------SNAPSHOT DP WORDS FROM EBANK E7 OR UNSWITCHABLE ERASABLE(GROUP 1)------
		...
		ADRES	CDUYD	-1	# (GARBAGE,CDUXD)  DESIRED CDU:S
		ADRES	STATTIME	# TIME FOR RN AND VN IN CENTISECONDS
