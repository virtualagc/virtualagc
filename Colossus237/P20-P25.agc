...
# Mod history:  2011-02-16 JL	Adapted from corresponding Colossus 249 file.
...
PROG22B		CLEAR	SET		# EARTH ORBIT
		...
		CALL			# GET LAT/LONG/ALT FROM ASTRO
			P22SUBRB
CALLR52		EXIT
		TC	UPFLAG		# TARG2FLG = 1 = SIGHTING LANDMARK
		ADRES	TARG2FLG	# BIT 9  FLAG 1
		TC	DOWNFLAG	# TARG1FLG = 0 = NON-LEM
		ADRES	TARG1FLG	# BIT 10  FLAG 1
		TC	2PHSCHNG
		OCT	00004
		OCT	05022
...
# INPUT- NONE REQURIED, NORMALLY CALLED BY P23
...
REND1		CALL
		...
		CALL	
			WAITONE
REND1A		EXIT
		CAF	MKBUFAD		# SET MARKSTAT FOR RESTART (CLEARED IN)
		TS	MARKSTAT	#   FRESH START)
		CA	MRKBUF2
		EXTEND
		BZF	REND2
		EXTEND
...
P23.17		SLOAD	PUSH
		...
		CA	LANDMARK
		MASK	OCT00077
		TS	IDOFLMK		# FOR R3(DE) LUNAFLAG ALREADY SET
		CA	HORIZON
		EXTEND
		BZF	P23.12
...
HORIZ		STQ	SETPD
		...
		STCALL	ALPHAV +4
			GETERAD
		DAD	PDDL		# MPAC HAS RADIUS OF FISCHER SLLIPSOID
