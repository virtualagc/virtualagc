...
#      WAS LAST ALIGNED ONLY DUE TO GYRO DRIFT(I.E. NEITHER GIMBAL LOCK NOR IMU POWER INTERRUPT HAS OCCURED
...
# HAVE GOOD SEPARATION IF THE ANGLE BETWEEN THEM IS LESS THAN 66DEGREES
# AND MORE THAN 40DEGREES. THOSE PAIRS OF STARS WITH GOOD SEPARATION
# ARE THEN TESTED TO SEE IF THEY LIE IN CURRENT FIELD OF VIEW.(WITHIN
# 33DEGREES OF SAX). THE PAIR WITH MAXIMUM SEPARATION IS CHOSEN FROM
...
R51A		CALL			# COMPUTE LOS IN SM FROM MARK DATA
		...
		EXIT
		TC	PHASCHNG
		OCT	05024		# RESTART THIS GROUP 4  JOB
		OCT	13000		#  WITH PRIORITY  13
		TC	INTPRET
		VLOAD
			STARSAV2
		STOVL	6D
...
P51B		TC	PHASCHNG
		...
		SSP	SETPD
			...
			0
		CLEAR	EXIT
			TARG2FLG	# SHOW START MARK-NOT LAND MARK
		CAF	BIT1
...
# CALLING SEQUENCE
# L+4      RETURN WHEN SHAFT OR TRUNION NOT WITHIN 5DEG OF DESIRED
# L        TC     BANKCALL
# L+1      CADR   SR52.1
...
DP1/6		2DEC	.16666666
MPERIOD		2DEC	.2992		# APPROX LUNAR ROT ANG IN 2HRS X 16
