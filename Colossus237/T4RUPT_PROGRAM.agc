...
#
# ERASABLE INITIALZIZATION:  SEE IMUMON FOR INITIALIZATION OF IMODES30.  THE RELAVANT BITS ARE 5, 7, 8, 9, AND 10.
#
...
PIPFAIL		CCS	A			# SET BIT10 IN IMODES30 SO ALL ISS WARNING
		...
		CS	IMODES30		# IF PIP FAIL DOESNT LIGHT ISSWARNING, DO
