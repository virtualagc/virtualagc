...
## Mod history: 2011-04-11 JL	Adapted from corresponding Colossus 249 file.
##		2017-01-01 RSB	Proofed comment text using octopus/ProoferComments,
##				and fixed errors found.
##		2017-01-14 RSB	Wherever '#' was followed by non-whitespace
##				(except in "##"), I inserted a space.  It wasn't
##				wrong to do it the other way, and indeed makes more
##				sense in some ways, but '#' is consistently
##				followed by a space everywhere else, and without a 
##				space it may be flagged in cross-diffs vs other
##				AGC version.
