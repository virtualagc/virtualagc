...
// Gate A16-U253A A16-U252A
pullup(OPEROR);
assign #GATE_DELAY OPEROR = rst ? 0 : ((0|g43444|FLASH) ? 1'b0 : 1'bz);
// Gate A16-U253B A16-U254A A16-U255A
pullup(WCH12_);
...
// Gate A16-U257A A16-U257B A16-U256A
pullup(CCH12);
...
// Gate A16-U246B A16-U245A
pullup(KYRLS);
assign #GATE_DELAY KYRLS = rst ? 0 : ((0|g43430|FLASH) ? 1'b0 : 1'bz);
// Gate A16-U247A
pullup(g43434);
...
// Gate A16-U248B A16-U249B
pullup(VNFLSH);
assign #GATE_DELAY VNFLSH = rst ? 0 : ((0|g43434|FLASH_) ? 1'b0 : 1'bz);
// Gate A16-U243A
pullup(g43428);
