...
// Gate A16-U247A
pullup(g43434);
assign #GATE_DELAY g43434 = rst ? 1'bz : ((0|g43433|g43432) ? 1'b0 : 1'bz);
// Gate A16-U247B
pullup(g43433);
assign #GATE_DELAY g43433 = rst ? 0 : ((0|g43434|CCH11) ? 1'b0 : 1'bz);
// Gate A16-U138A
pullup(g43116);
assign #GATE_DELAY g43116 = rst ? 0 : ((0|RCH05_|g43114) ? 1'b0 : 1'bz);
// Gate A16-U159B
pullup(g43158);
assign #GATE_DELAY g43158 = rst ? 0 : ((0|g43157|CCH12) ? 1'b0 : 1'bz);
// Gate A16-U147A
pullup(g43134);
assign #GATE_DELAY g43134 = rst ? 0 : ((0|g43132|RCH05_) ? 1'b0 : 1'bz);
// Gate A16-U159A
pullup(g43157);
assign #GATE_DELAY g43157 = rst ? 1'bz : ((0|g43158|g43156) ? 1'b0 : 1'bz);
// Gate A16-U106B
pullup(RCmZmR);
assign #GATE_DELAY RCmZmR = rst ? 0 : ((0|g43251) ? 1'b0 : 1'bz);
// Gate A16-U135A
pullup(g43110);
assign #GATE_DELAY g43110 = rst ? 0 : ((0|RCH05_|g43108) ? 1'b0 : 1'bz);
// Gate A16-U110A
pullup(g43242);
assign #GATE_DELAY g43242 = rst ? 0 : ((0|CCH06|g43241) ? 1'b0 : 1'bz);
// Gate A16-U154B
pullup(g43145);
...
// Gate A16-U201A
pullup(g43305);
assign #GATE_DELAY g43305 = rst ? 0 : ((0|WCH12_|CHWL01_) ? 1'b0 : 1'bz);
// Gate A16-U208B
pullup(g43314);
...
// Gate A16-U217A
pullup(CH1209);
assign #GATE_DELAY CH1209 = rst ? 0 : ((0|g43333|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U207A
pullup(g43311);
assign #GATE_DELAY g43311 = rst ? 0 : ((0|g43313|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U121B
pullup(g43222);
assign #GATE_DELAY g43222 = rst ? 0 : ((0|RCH06_|g43220) ? 1'b0 : 1'bz);
// Gate A16-U145A
pullup(g43131);
assign #GATE_DELAY g43131 = rst ? 0 : ((0|WCH05_|CHWL06_) ? 1'b0 : 1'bz);
// Gate A16-U124A
pullup(g43213);
assign #GATE_DELAY g43213 = rst ? 0 : ((0|XB6_|XT0_) ? 1'b0 : 1'bz);
// Gate A16-U258B
pullup(g43360);
assign #GATE_DELAY g43360 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A16-U141A
pullup(g43122);
assign #GATE_DELAY g43122 = rst ? 0 : ((0|RCH05_|g43120) ? 1'b0 : 1'bz);
// Gate A16-U254B
pullup(g43349);
assign #GATE_DELAY g43349 = rst ? 0 : ((0|WCHG_|XT1_|XB2_) ? 1'b0 : 1'bz);
// Gate A16-U235A
pullup(g43411);
assign #GATE_DELAY g43411 = rst ? 0 : ((0|RCH11_|g43409) ? 1'b0 : 1'bz);
// Gate A16-U147B
pullup(RCmXmY);
assign #GATE_DELAY RCmXmY = rst ? 0 : ((0|g43132) ? 1'b0 : 1'bz);
// Gate A16-U221A
pullup(CH1211);
assign #GATE_DELAY CH1211 = rst ? 0 : ((0|g43343|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U207B
pullup(g43313);
...
// Gate A16-U130A
pullup(g43203);
assign #GATE_DELAY g43203 = rst ? 0 : ((0|CCH06|g43202) ? 1'b0 : 1'bz);
// Gate A16-U129B
pullup(g43201);
...
// Gate A16-U120A
pullup(g43220);
assign #GATE_DELAY g43220 = rst ? 1'bz : ((0|g43221|g43219) ? 1'b0 : 1'bz);
// Gate A16-U224A
pullup(CH1212);
assign #GATE_DELAY CH1212 = rst ? 0 : ((0|g43447|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U113B
pullup(g43238);
assign #GATE_DELAY g43238 = rst ? 0 : ((0|RCH06_|g43236) ? 1'b0 : 1'bz);
// Gate A16-U143A
pullup(g43125);
assign #GATE_DELAY g43125 = rst ? 0 : ((0|WCH05_|CHWL05_) ? 1'b0 : 1'bz);
// Gate A16-U146B A16-U249A
pullup(CHOR06_);
assign #GATE_DELAY CHOR06_ = rst ? 1'bz : ((0|CH3206|g43233|g43134|g43436|CH0706|g43329) ? 1'b0 : 1'bz);
// Gate A16-U203A
pullup(g43306);
assign #GATE_DELAY g43306 = rst ? 0 : ((0|WCH12_|CHWL02_) ? 1'b0 : 1'bz);
// Gate A16-U242B
pullup(g43422);
...
// Gate A16-U220A
pullup(CH1210);
assign #GATE_DELAY CH1210 = rst ? 0 : ((0|g43337|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U154A
pullup(g43144);
assign #GATE_DELAY g43144 = rst ? 1'bz : ((0|g43145|g43143) ? 1'b0 : 1'bz);
// Gate A16-U223A
pullup(g43446);
assign #GATE_DELAY g43446 = rst ? 0 : ((0|WCH12_|CHWL12_) ? 1'b0 : 1'bz);
// Gate A16-U156B
pullup(g43153);
...
// Gate A16-U133A
pullup(g43107);
assign #GATE_DELAY g43107 = rst ? 0 : ((0|WCH05_|CHWL02_) ? 1'b0 : 1'bz);
// Gate A16-U153B
pullup(RCpXmY);
assign #GATE_DELAY RCpXmY = rst ? 0 : ((0|g43144) ? 1'b0 : 1'bz);
// Gate A16-U238A
pullup(g43414);
assign #GATE_DELAY g43414 = rst ? 0 : ((0|RCH11_|g43416) ? 1'b0 : 1'bz);
// Gate A16-U229B
pullup(g43457);
assign #GATE_DELAY g43457 = rst ? 1'bz : ((0|g43456|g43458) ? 1'b0 : 1'bz);
// Gate A16-U236A
pullup(g43409);
assign #GATE_DELAY g43409 = rst ? 1'bz : ((0|g43410|g43406) ? 1'b0 : 1'bz);
// Gate A16-U251A
pullup(g43442);
assign #GATE_DELAY g43442 = rst ? 0 : ((0|g43444|RCH11_) ? 1'b0 : 1'bz);
// Gate A16-U205A
pullup(ENEROP);
assign #GATE_DELAY ENEROP = rst ? 0 : ((0|g43307) ? 1'b0 : 1'bz);
// Gate A16-U219A
pullup(g43336);
assign #GATE_DELAY g43336 = rst ? 0 : ((0|WCH12_|CHWL10_) ? 1'b0 : 1'bz);
// Gate A16-U226A
pullup(CH1213);
assign #GATE_DELAY CH1213 = rst ? 0 : ((0|g43454|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U158B
pullup(g43156);
assign #GATE_DELAY g43156 = rst ? 0 : ((0|CHWL08_|WCH12_) ? 1'b0 : 1'bz);
// Gate A16-U211A
pullup(g43325);
assign #GATE_DELAY g43325 = rst ? 0 : ((0|WCH12_|CHWL05_) ? 1'b0 : 1'bz);
// Gate A16-U225B
pullup(g43448);
assign #GATE_DELAY g43448 = rst ? 0 : ((0|g43447|CCH12) ? 1'b0 : 1'bz);
// Gate A16-U123A
pullup(g43216);
assign #GATE_DELAY g43216 = rst ? 0 : ((0|XT0_|XB5_) ? 1'b0 : 1'bz);
// Gate A16-U244B
pullup(g43430);
...
// Gate A16-U228A
pullup(g43456);
assign #GATE_DELAY g43456 = rst ? 0 : ((0|WCH12_|CHWL14_) ? 1'b0 : 1'bz);
// Gate A16-U146A A16-U245B
pullup(CHOR05_);
assign #GATE_DELAY CHOR05_ = rst ? 1'bz : ((0|CH3205|g43238|g43128|CH0705|g43321|g43428) ? 1'b0 : 1'bz);
// Gate A16-U219B
pullup(g43337);
...
// Gate A16-U144A
pullup(g43128);
assign #GATE_DELAY g43128 = rst ? 0 : ((0|RCH05_|g43126) ? 1'b0 : 1'bz);
// Gate A16-U244A
pullup(g43431);
assign #GATE_DELAY g43431 = rst ? 0 : ((0|WCH11_|CHWL05_) ? 1'b0 : 1'bz);
// Gate A16-U107B
pullup(g43245);
...
// Gate A16-U233A
pullup(g43406);
assign #GATE_DELAY g43406 = rst ? 0 : ((0|WCH11_|CHWL02_) ? 1'b0 : 1'bz);
// Gate A16-U142A
pullup(g43120);
assign #GATE_DELAY g43120 = rst ? 1'bz : ((0|g43121|g43119) ? 1'b0 : 1'bz);
// Gate A16-U218A
pullup(g43335);
assign #GATE_DELAY g43335 = rst ? 0 : ((0|WCH12_|CHWL09_) ? 1'b0 : 1'bz);
// Gate A16-U105B
pullup(g43253);
...
// Gate A16-U113A
pullup(g43237);
assign #GATE_DELAY g43237 = rst ? 0 : ((0|CCH06|g43236) ? 1'b0 : 1'bz);
// Gate A16-U128A
pullup(g43206);
assign #GATE_DELAY g43206 = rst ? 0 : ((0|XB6_|WCHG_|XT0_) ? 1'b0 : 1'bz);
// Gate A16-U160A
pullup(TVCNAB);
...
// Gate A16-U215A
pullup(g43329);
assign #GATE_DELAY g43329 = rst ? 0 : ((0|g43327|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U148A
pullup(g43132);
assign #GATE_DELAY g43132 = rst ? 1'bz : ((0|g43133|g43131) ? 1'b0 : 1'bz);
// Gate A16-U241B
pullup(TMPOUT);
...
// Gate A16-U125A
pullup(g43210);
assign #GATE_DELAY g43210 = rst ? 0 : ((0|GOJAM|g43209) ? 1'b0 : 1'bz);
// Gate A16-U223B
pullup(g43344);
assign #GATE_DELAY g43344 = rst ? 0 : ((0|g43343|CCH12) ? 1'b0 : 1'bz);
// Gate A16-U140A A16-U240A
pullup(CHOR04_);
assign #GATE_DELAY CHOR04_ = rst ? 1'bz : ((0|g43243|g43122|CH3204|CH1504|g43423|g43319) ? 1'b0 : 1'bz);
// Gate A16-U203B
pullup(g43304);
...
// Gate A16-U132A
pullup(g43104);
assign #GATE_DELAY g43104 = rst ? 0 : ((0|RCH05_|g43102) ? 1'b0 : 1'bz);
// Gate A16-U128B
pullup(RCpYmR);
assign #GATE_DELAY RCpYmR = rst ? 0 : ((0|g43202) ? 1'b0 : 1'bz);
// Gate A16-U246A
pullup(g43432);
assign #GATE_DELAY g43432 = rst ? 0 : ((0|WCH11_|CHWL06_) ? 1'b0 : 1'bz);
// Gate A16-U239A
pullup(g43418);
assign #GATE_DELAY g43418 = rst ? 0 : ((0|WCH11_|CHWL04_) ? 1'b0 : 1'bz);
// Gate A16-U139A
pullup(g43119);
assign #GATE_DELAY g43119 = rst ? 0 : ((0|WCH05_|CHWL04_) ? 1'b0 : 1'bz);
...
// Gate A16-U149A
pullup(g43137);
assign #GATE_DELAY g43137 = rst ? 0 : ((0|WCH05_|CHWL07_) ? 1'b0 : 1'bz);
// Gate A16-U242A
pullup(g43421);
assign #GATE_DELAY g43421 = rst ? 1'bz : ((0|g43422|g43418) ? 1'b0 : 1'bz);
// Gate A16-U118B
pullup(g43226);
...
// Gate A16-U109A
pullup(g43241);
assign #GATE_DELAY g43241 = rst ? 1'bz : ((0|g43242|g43240) ? 1'b0 : 1'bz);
// Gate A16-U109B
pullup(g43240);
...
// Gate A16-U104A
pullup(g43251);
assign #GATE_DELAY g43251 = rst ? 1'bz : ((0|g43252|g43250) ? 1'b0 : 1'bz);
// Gate A16-U105A
pullup(g43252);
assign #GATE_DELAY g43252 = rst ? 0 : ((0|CCH06|g43251) ? 1'b0 : 1'bz);
// Gate A16-U104B
pullup(g43250);
...
// Gate A16-U129A
pullup(g43202);
assign #GATE_DELAY g43202 = rst ? 1'bz : ((0|g43201|g43203) ? 1'b0 : 1'bz);
// Gate A16-U118A
pullup(g43225);
assign #GATE_DELAY g43225 = rst ? 1'bz : ((0|g43226|g43224) ? 1'b0 : 1'bz);
// Gate A16-U150A
pullup(g43140);
assign #GATE_DELAY g43140 = rst ? 0 : ((0|RCH05_|g43138) ? 1'b0 : 1'bz);
// Gate A16-U201B
pullup(ZOPCDU);
assign #GATE_DELAY ZOPCDU = rst ? 0 : ((0|g43303) ? 1'b0 : 1'bz);
// Gate A16-U103A
pullup(g43257);
assign #GATE_DELAY g43257 = rst ? 0 : ((0|CCH06|g43256) ? 1'b0 : 1'bz);
// Gate A16-U102B
pullup(g43255);
assign #GATE_DELAY g43255 = rst ? 0 : ((0|WCH06_|CHWL01_) ? 1'b0 : 1'bz);
// Gate A16-U119A
pullup(g43224);
assign #GATE_DELAY g43224 = rst ? 0 : ((0|CHWL07_|WCH12_) ? 1'b0 : 1'bz);
// Gate A16-U243A
pullup(g43428);
assign #GATE_DELAY g43428 = rst ? 0 : ((0|RCH11_|g43430) ? 1'b0 : 1'bz);
...
// Gate A16-U222A
pullup(g43345);
assign #GATE_DELAY g43345 = rst ? 0 : ((0|WCH12_|CHWL11_) ? 1'b0 : 1'bz);
// Gate A16-U250A
pullup(g43445);
assign #GATE_DELAY g43445 = rst ? 0 : ((0|CHWL07_|WCH11_) ? 1'b0 : 1'bz);
// Gate A16-U107A
pullup(g43246);
assign #GATE_DELAY g43246 = rst ? 1'bz : ((0|g43247|g43245) ? 1'b0 : 1'bz);
// Gate A16-U111A
pullup(RCpYpR);
...
// Gate A16-U112A
pullup(g43236);
assign #GATE_DELAY g43236 = rst ? 1'bz : ((0|g43237|g43235) ? 1'b0 : 1'bz);
// Gate A16-U233B
pullup(ISSWAR);
...
// Gate A16-U260A
pullup(g43355);
assign #GATE_DELAY g43355 = rst ? 0 : ((0|XB2_|XT1_) ? 1'b0 : 1'bz);
// Gate A16-U131A
pullup(g43102);
assign #GATE_DELAY g43102 = rst ? 1'bz : ((0|g43101|g43103) ? 1'b0 : 1'bz);
// Gate A16-U131B
pullup(g43101);
...
// Gate A16-U204A
pullup(g43309);
assign #GATE_DELAY g43309 = rst ? 0 : ((0|g43307|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U212A
pullup(g43321);
assign #GATE_DELAY g43321 = rst ? 0 : ((0|g43323|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U137A
pullup(g43113);
assign #GATE_DELAY g43113 = rst ? 0 : ((0|WCH05_|CHWL03_) ? 1'b0 : 1'bz);
// Gate A16-U134B A16-U234A
pullup(CHOR02_);
assign #GATE_DELAY CHOR02_ = rst ? 1'bz : ((0|CH3202|g43253|g43110|g43411|g43309|CH1502) ? 1'b0 : 1'bz);
// Gate A16-U138B
pullup(g43115);
...
// Gate A16-U231A
pullup(g43405);
assign #GATE_DELAY g43405 = rst ? 0 : ((0|WCH11_|CHWL01_) ? 1'b0 : 1'bz);
// Gate A16-U232B
pullup(g43403);
...
// Gate A16-U136A
pullup(g43108);
assign #GATE_DELAY g43108 = rst ? 1'bz : ((0|g43109|g43107) ? 1'b0 : 1'bz);
// Gate A16-U210A
pullup(COARSE);
assign #GATE_DELAY COARSE = rst ? 0 : ((0|g43317) ? 1'b0 : 1'bz);
// Gate A16-U227A
pullup(g43455);
assign #GATE_DELAY g43455 = rst ? 0 : ((0|WCH12_|CHWL13_) ? 1'b0 : 1'bz);
// Gate A16-U142B
pullup(g43121);
...
// Gate A16-U202A
pullup(g43301);
assign #GATE_DELAY g43301 = rst ? 0 : ((0|g43303|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U114B
pullup(g43230);
assign #GATE_DELAY g43230 = rst ? 0 : ((0|WCH06_|CHWL06_) ? 1'b0 : 1'bz);
// Gate A16-U115A
pullup(g43232);
assign #GATE_DELAY g43232 = rst ? 0 : ((0|CCH06|g43231) ? 1'b0 : 1'bz);
// Gate A16-U114A
pullup(g43231);
assign #GATE_DELAY g43231 = rst ? 1'bz : ((0|g43232|g43230) ? 1'b0 : 1'bz);
// Gate A16-U134A A16-U234B
pullup(CHOR01_);
assign #GATE_DELAY CHOR01_ = rst ? 1'bz : ((0|g43104|CH3201|g43258|g43402|g43301|CH1501) ? 1'b0 : 1'bz);
// Gate A16-U209B
pullup(g43317);
...
// Gate A16-U209A
pullup(g43319);
assign #GATE_DELAY g43319 = rst ? 0 : ((0|g43317|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U116A
pullup(RCmYmR);
...
// Gate A16-U206A
pullup(g43315);
assign #GATE_DELAY g43315 = rst ? 0 : ((0|WCH12_|CHWL03_) ? 1'b0 : 1'bz);
// Gate A16-U210B
pullup(g43318);
assign #GATE_DELAY g43318 = rst ? 0 : ((0|g43317|CCH12) ? 1'b0 : 1'bz);
// Gate A16-U216A
pullup(g43333);
assign #GATE_DELAY g43333 = rst ? 1'bz : ((0|g43334|g43335) ? 1'b0 : 1'bz);
// Gate A16-U256B
pullup(g43351);
...
// Gate A16-U248A
pullup(g43436);
assign #GATE_DELAY g43436 = rst ? 0 : ((0|RCH11_|g43434) ? 1'b0 : 1'bz);
// Gate A16-U241A
pullup(g43423);
assign #GATE_DELAY g43423 = rst ? 0 : ((0|RCH11_|g43421) ? 1'b0 : 1'bz);
...
// Gate A16-U232A
pullup(g43402);
assign #GATE_DELAY g43402 = rst ? 0 : ((0|RCH11_|g43404) ? 1'b0 : 1'bz);
// Gate A16-U151A
pullup(g43143);
assign #GATE_DELAY g43143 = rst ? 0 : ((0|WCH05_|CHWL08_) ? 1'b0 : 1'bz);
// Gate A16-U237B
pullup(g43416);
...
// Gate A16-U153A
pullup(g43146);
assign #GATE_DELAY g43146 = rst ? 0 : ((0|g43144|RCH05_) ? 1'b0 : 1'bz);
// Gate A16-U237A
pullup(g43417);
assign #GATE_DELAY g43417 = rst ? 0 : ((0|WCH11_|CHWL03_) ? 1'b0 : 1'bz);
// Gate A16-U218B
pullup(g43338);
...
// Gate A16-U208A
pullup(g43316);
assign #GATE_DELAY g43316 = rst ? 0 : ((0|WCH12_|CHWL04_) ? 1'b0 : 1'bz);
// Gate A16-U236B
pullup(g43410);
...
// Gate A16-U121A
pullup(g43221);
assign #GATE_DELAY g43221 = rst ? 0 : ((0|CCH06|g43220) ? 1'b0 : 1'bz);
// Gate A16-U102A
pullup(g43256);
assign #GATE_DELAY g43256 = rst ? 1'bz : ((0|g43257|g43255) ? 1'b0 : 1'bz);
// Gate A16-U252A A16-U253A
pullup(OPEROR);
assign #GATE_DELAY OPEROR = rst ? 0 : ((0|FLASH|g43444) ? 1'b0 : 1'bz);
// Gate A16-U108A
pullup(g43247);
assign #GATE_DELAY g43247 = rst ? 0 : ((0|CCH06|g43246) ? 1'b0 : 1'bz);
// Gate A16-U214A
pullup(g43326);
assign #GATE_DELAY g43326 = rst ? 0 : ((0|WCH12_|CHWL06_) ? 1'b0 : 1'bz);
// Gate A16-U250B
pullup(g43444);
assign #GATE_DELAY g43444 = rst ? 1'bz : ((0|g43445|g43443) ? 1'b0 : 1'bz);
// Gate A16-U230A
pullup(CH1214);
assign #GATE_DELAY CH1214 = rst ? 0 : ((0|g43457|RCH12_) ? 1'b0 : 1'bz);
// Gate A16-U116B
pullup(OT1207_);
...
// Gate A16-U152A
pullup(CHOR08_);
assign #GATE_DELAY CHOR08_ = rst ? 1'bz : ((0|g43146|g43204|CH3208) ? 1'b0 : 1'bz);
