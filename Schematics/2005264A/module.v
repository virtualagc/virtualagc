...
// Gate A14-U109A A14-U102B A14-U103B
pullup(ERAS);
assign #GATE_DELAY ERAS = rst ? 0 : ((0|MP1|MAMU|INOUT|GOJ1|CHINC|S12|S11|TCSAJ3) ? 1'b0 : 1'bz);
// Gate A14-U122A
pullup(g42217);
...
// Gate A14-U214A A14-U214B A14-U213B
pullup(XB6_);
...
// Gate A14-U233A A14-U233B A14-U232A
pullup(R1C);
...
// Gate A14-U244A
pullup(g42436);
assign #GATE_DELAY g42436 = rst ? 0 : ((0|g42434|RILP1|g42440) ? 1'b0 : 1'bz);
// Gate A14-U244B A14-U243A
pullup(g42434);
assign #GATE_DELAY g42434 = rst ? 0 : ((0|XT0|XT3|XT5|XT6) ? 1'b0 : 1'bz);
// Gate A14-U260B
pullup(XT0);
...
// Gate A14-U240A
pullup(g42435);
assign #GATE_DELAY g42435 = rst ? 1'bz : ((0|g42434) ? 1'b0 : 1'bz);
// Gate A14-U240B
pullup(g42442);
...
// Gate A14-U242B
pullup(g42438);
assign #GATE_DELAY g42438 = rst ? 0 : ((0|g42442|g42434|RILP1_) ? 1'b0 : 1'bz);
// Gate A14-U209A
pullup(YB0);
...
// Gate A14-U205A
pullup(RILP1);
assign #GATE_DELAY RILP1 = rst ? 1'bz : ((0|YB3|YB0) ? 1'b0 : 1'bz);
// Gate A14-U205B
pullup(YB2_);
