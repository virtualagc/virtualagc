...
initial $display("Gate delay (A14) will be %f ns.", GATE_DELAY*100);

// Gate A14-U147A
pullup(g42126);
assign #GATE_DELAY g42126 = rst ? 0 : ((0|T08|GOJAM|g42127) ? 1'b0 : 1'bz);
// Gate A14-U222A
pullup(XB2E);
assign #GATE_DELAY XB2E = rst ? 0 : ((0|XB2_) ? 1'b0 : 1'bz);
// Gate A14-U243B
pullup(g42441);
assign #GATE_DELAY g42441 = rst ? 1'bz : ((0|XB6|XB5) ? 1'b0 : 1'bz);
// Gate A14-U146B
pullup(g42129);
...
pullup(ERAS);
assign #GATE_DELAY ERAS = rst ? 0 : ((0|S12|S11|TCSAJ3|MAMU|MP1|INOUT|GOJ1|CHINC) ? 1'b0 : 1'bz);
...
// Gate A14-U116A
pullup(g42229);
assign #GATE_DELAY g42229 = rst ? 0 : ((0|GOJAM|g42228|g42232) ? 1'b0 : 1'bz);
// Gate A14-U239B
pullup(ILP_);
assign #GATE_DELAY ILP_ = rst ? 0 : ((0|g42443) ? 1'b0 : 1'bz);
// Gate A14-U138A
pullup(g42144);
assign #GATE_DELAY g42144 = rst ? 0 : ((0|ROP_|T02_) ? 1'b0 : 1'bz);
...
// Gate A14-U117A
pullup(g42227);
assign #GATE_DELAY g42227 = rst ? 0 : ((0|T03_|ERAS_) ? 1'b0 : 1'bz);
// Gate A14-U258A
pullup(XT0E);
assign #GATE_DELAY XT0E = rst ? 1'bz : ((0|XT0_) ? 1'b0 : 1'bz);
// Gate A14-U123A
pullup(g42215);
assign #GATE_DELAY g42215 = rst ? 0 : ((0|PHS4_|T02_) ? 1'b0 : 1'bz);
// Gate A14-U127A
pullup(g42209);
assign #GATE_DELAY g42209 = rst ? 1'bz : ((0|g42214|g42210) ? 1'b0 : 1'bz);
// Gate A14-U128B
pullup(g42206);
...
// Gate A14-U143A
pullup(g42132);
assign #GATE_DELAY g42132 = rst ? 1'bz : ((0|g42131|CLEARB) ? 1'b0 : 1'bz);
...
// Gate A14-U129A
pullup(g42201);
assign #GATE_DELAY g42201 = rst ? 1'bz : ((0|T12_|PHS3_) ? 1'b0 : 1'bz);
// Gate A14-U119A A14-U119B
pullup(ZID);
assign #GATE_DELAY ZID = rst ? 0 : ((0|MYCLMP|g42221) ? 1'b0 : 1'bz);
// Gate A14-U130A
pullup(g42202);
assign #GATE_DELAY g42202 = rst ? 0 : ((0|g42203|g42201) ? 1'b0 : 1'bz);
// Gate A14-U136A
pullup(g42151);
assign #GATE_DELAY g42151 = rst ? 0 : ((0|GOJAM|T07|g42149) ? 1'b0 : 1'bz);
// Gate A14-U126B
pullup(WEY);
...
// Gate A14-U106A
pullup(TPARG_);
assign #GATE_DELAY TPARG_ = rst ? 1'bz : ((0|TPGE|TPGF) ? 1'b0 : 1'bz);
// Gate A14-U213A
pullup(XB7);
assign #GATE_DELAY XB7 = rst ? 0 : ((0|S03_|S02_|S01_) ? 1'b0 : 1'bz);
// Gate A14-U215B
pullup(XB6);
...
// Gate A14-U223A
pullup(XB3);
assign #GATE_DELAY XB3 = rst ? 0 : ((0|S03|S01_|S02_) ? 1'b0 : 1'bz);
// Gate A14-U116B
pullup(g42228);
assign #GATE_DELAY g42228 = rst ? 1'bz : ((0|g42229|g42227) ? 1'b0 : 1'bz);
// Gate A14-U246B
pullup(XT7E);
assign #GATE_DELAY XT7E = rst ? 0 : ((0|XT7_) ? 1'b0 : 1'bz);
// Gate A14-U245A
pullup(XT7_);
assign #GATE_DELAY XT7_ = rst ? 1'bz : ((0|XT7) ? 1'b0 : 1'bz);
// Gate A14-U113A
pullup(g42235);
assign #GATE_DELAY g42235 = rst ? 0 : ((0|GOJAM|g42234|REDRST) ? 1'b0 : 1'bz);
// Gate A14-U205A
pullup(RILP1);
assign #GATE_DELAY RILP1 = rst ? 1'bz : ((0|YB0|YB3) ? 1'b0 : 1'bz);
// Gate A14-U115A
pullup(g42233);
assign #GATE_DELAY g42233 = rst ? 0 : ((0|PHS3_|ERAS_|T03_) ? 1'b0 : 1'bz);
// Gate A14-U137A
pullup(g42147);
...
// Gate A14-U112A
pullup(g42238);
assign #GATE_DELAY g42238 = rst ? 1'bz : ((0|g42239|g42240) ? 1'b0 : 1'bz);
// Gate A14-U242A
pullup(g43437);
assign #GATE_DELAY g43437 = rst ? 0 : ((0|RILP1|g42442|g42435) ? 1'b0 : 1'bz);
// Gate A14-U244A
pullup(g42436);
assign #GATE_DELAY g42436 = rst ? 0 : ((0|g42441|RILP1|g42433) ? 1'b0 : 1'bz);
// Gate A14-U225A
pullup(XB2);
assign #GATE_DELAY XB2 = rst ? 0 : ((0|S01|S03|S02_) ? 1'b0 : 1'bz);
// Gate A14-U142A
pullup(g42136);
assign #GATE_DELAY g42136 = rst ? 1'bz : ((0|g42135|CLEARC) ? 1'b0 : 1'bz);
// Gate A14-U237A
pullup(g42445);
assign #GATE_DELAY g42445 = rst ? 0 : ((0|g42443) ? 1'b0 : 1'bz);
// Gate A14-U205B
pullup(YB2_);
...
// Gate A14-U139A
pullup(g42138);
assign #GATE_DELAY g42138 = rst ? 1'bz : ((0|g42137|CLEARD) ? 1'b0 : 1'bz);
...
// Gate A14-U247B
pullup(XT7);
assign #GATE_DELAY XT7 = rst ? 0 : ((0|S04_|S06_|S05_) ? 1'b0 : 1'bz);
// Gate A14-U245B
pullup(WL16_);
assign #GATE_DELAY WL16_ = rst ? 1'bz : ((0|WL16) ? 1'b0 : 1'bz);
// Gate A14-U110A
pullup(REDRST);
assign #GATE_DELAY REDRST = rst ? 1'bz : ((0|T05|g42242) ? 1'b0 : 1'bz);
// Gate A14-U248B
pullup(XT6);
...
pullup(g42149);
assign #GATE_DELAY g42149 = rst ? 1'bz : ((0|g42151|g42148) ? 1'b0 : 1'bz);
...
// Gate A14-U209A
pullup(YB0);
assign #GATE_DELAY YB0 = rst ? 0 : ((0|S07|S08) ? 1'b0 : 1'bz);
// Gate A14-U206A
pullup(YB1);
assign #GATE_DELAY YB1 = rst ? 0 : ((0|S07_|S08) ? 1'b0 : 1'bz);
// Gate A14-U206B
pullup(YB2);
assign #GATE_DELAY YB2 = rst ? 1'bz : ((0|S07|S08_) ? 1'b0 : 1'bz);
// Gate A14-U243A A14-U244B
pullup(g42433);
assign #GATE_DELAY g42433 = rst ? 0 : ((0|XT6|XT5|XT0|XT3) ? 1'b0 : 1'bz);
// Gate A14-U146A
pullup(g42128);
assign #GATE_DELAY g42128 = rst ? 0 : ((0|PHS3_|T05_|ROP_) ? 1'b0 : 1'bz);
// Gate A14-U232B
pullup(BR12B_);
...
// Gate A14-U203A
pullup(YB3E);
assign #GATE_DELAY YB3E = rst ? 0 : ((0|YB3_) ? 1'b0 : 1'bz);
// Gate A14-U111A
pullup(REX);
...
// Gate A14-U238A
pullup(ILP);
assign #GATE_DELAY ILP = rst ? 1'bz : ((0|g42445) ? 1'b0 : 1'bz);
// Gate A14-U154A
pullup(g42112);
assign #GATE_DELAY g42112 = rst ? 1'bz : ((0|g42111|g42113) ? 1'b0 : 1'bz);
// Gate A14-U143B
pullup(g42135);
...
pullup(XB7_);
assign #GATE_DELAY XB7_ = rst ? 1'bz : ((0|XB7) ? 1'b0 : 1'bz);
// Gate A14-U249A
pullup(XT4E);
...
// Gate A14-U252A
pullup(XT4);
assign #GATE_DELAY XT4 = rst ? 0 : ((0|S05|S04|S06_) ? 1'b0 : 1'bz);
// Gate A14-U256B
pullup(XT2);
assign #GATE_DELAY XT2 = rst ? 0 : ((0|S05_|S06|S04) ? 1'b0 : 1'bz);
// Gate A14-U259A
pullup(XT1);
assign #GATE_DELAY XT1 = rst ? 0 : ((0|S05|S06|S04_) ? 1'b0 : 1'bz);
// Gate A14-U202B
pullup(RILP1_);
assign #GATE_DELAY RILP1_ = rst ? 0 : ((0|RILP1) ? 1'b0 : 1'bz);
// Gate A14-U133A
pullup(WHOMPA);
...
// Gate A14-U121A
pullup(RSTK_);
assign #GATE_DELAY RSTK_ = rst ? 1'bz : ((0|g42216|g42218) ? 1'b0 : 1'bz);
// Gate A14-U218A
pullup(XB5);
assign #GATE_DELAY XB5 = rst ? 0 : ((0|S02|S01_|S03_) ? 1'b0 : 1'bz);
// Gate A14-U212B
pullup(XB7E);
assign #GATE_DELAY XB7E = rst ? 0 : ((0|XB7_) ? 1'b0 : 1'bz);
...
// Gate A14-U122A
pullup(g42217);
assign #GATE_DELAY g42217 = rst ? 0 : ((0|FNERAS_|T10_) ? 1'b0 : 1'bz);
// Gate A14-U120B
pullup(g42220);
assign #GATE_DELAY g42220 = rst ? 0 : ((0|g42221|T01|TIMR) ? 1'b0 : 1'bz);
// Gate A14-U132A
pullup(g42155);
assign #GATE_DELAY g42155 = rst ? 1'bz : ((0|g42156|g42154) ? 1'b0 : 1'bz);
// Gate A14-U132B
pullup(g42154);
...
// Gate A14-U125A
pullup(g42211);
assign #GATE_DELAY g42211 = rst ? 0 : ((0|T10|g42212) ? 1'b0 : 1'bz);
// Gate A14-U125B
pullup(g42212);
assign #GATE_DELAY g42212 = rst ? 1'bz : ((0|g42216|g42213) ? 1'b0 : 1'bz);
// Gate A14-U148A
pullup(g42125);
assign #GATE_DELAY g42125 = rst ? 0 : ((0|T07_|PHS3_) ? 1'b0 : 1'bz);
// Gate A14-U124A
pullup(g42213);
assign #GATE_DELAY g42213 = rst ? 0 : ((0|T11|TIMR|g42212) ? 1'b0 : 1'bz);
// Gate A14-U118B
pullup(g42226);
assign #GATE_DELAY g42226 = rst ? 0 : ((0|FNERAS_|GOJAM|T12A) ? 1'b0 : 1'bz);
// Gate A14-U220A
pullup(XB4);
assign #GATE_DELAY XB4 = rst ? 0 : ((0|S01|S02|S03_) ? 1'b0 : 1'bz);
// Gate A14-U153A
pullup(g42114);
assign #GATE_DELAY g42114 = rst ? 0 : ((0|S09|g42112) ? 1'b0 : 1'bz);
// Gate A14-U149B
pullup(g42123);
...
// Gate A14-U241A
pullup(g42440);
assign #GATE_DELAY g42440 = rst ? 0 : ((0|XB3|XB0) ? 1'b0 : 1'bz);
// Gate A14-U150B
pullup(SBF);
assign #GATE_DELAY SBF = rst ? 0 : ((0|g42123) ? 1'b0 : 1'bz);
// Gate A14-U101A
pullup(g42244);
assign #GATE_DELAY g42244 = rst ? 0 : ((0|PHS3_|T05_) ? 1'b0 : 1'bz);
// Gate A14-U105B
pullup(SBE);
...
// Gate A14-U120A
pullup(g42221);
assign #GATE_DELAY g42221 = rst ? 1'bz : ((0|g42217|g42220) ? 1'b0 : 1'bz);
// Gate A14-U156A
pullup(IHENV);
...
// Gate A14-U204B
pullup(YB3);
assign #GATE_DELAY YB3 = rst ? 0 : ((0|S08_|S07_) ? 1'b0 : 1'bz);
// Gate A14-U110B
pullup(g42240);
assign #GATE_DELAY g42240 = rst ? 0 : ((0|ERAS_|PHS4_|T03_) ? 1'b0 : 1'bz);
// Gate A14-U158A
pullup(g42106);
assign #GATE_DELAY g42106 = rst ? 0 : ((0|T08|ROP_|g42104) ? 1'b0 : 1'bz);
// Gate A14-U115B
pullup(g42232);
assign #GATE_DELAY g42232 = rst ? 0 : ((0|PHS3_|T06_) ? 1'b0 : 1'bz);
// Gate A14-U157A
pullup(g42109);
assign #GATE_DELAY g42109 = rst ? 0 : ((0|g42110|TIMR|g42107) ? 1'b0 : 1'bz);
// Gate A14-U145A
pullup(g42131);
assign #GATE_DELAY g42131 = rst ? 0 : ((0|S09|S08_|g42127) ? 1'b0 : 1'bz);
// Gate A14-U258B
pullup(XT1E);
...
// Gate A14-U108A
pullup(SBESET);
assign #GATE_DELAY SBESET = rst ? 0 : ((0|T04_|ERAS_|SCAD) ? 1'b0 : 1'bz);
// Gate A14-U241B
pullup(g42439);
assign #GATE_DELAY g42439 = rst ? 0 : ((0|g42441|g42435|RILP1_) ? 1'b0 : 1'bz);
// Gate A14-U155A
pullup(g42110);
...
pullup(g42443);
assign #GATE_DELAY g42443 = rst ? 1'bz : ((0|g42439|g42438|g42436|g43437) ? 1'b0 : 1'bz);
// Gate A14-U122B
pullup(NOTEST_);
...
// Gate A14-U234A
pullup(g42448);
assign #GATE_DELAY g42448 = rst ? 0 : ((0|RSC_|SCAD_|RT_) ? 1'b0 : 1'bz);
// Gate A14-U208B
pullup(YB0E);
...
// Gate A14-U118A
pullup(FNERAS_);
assign #GATE_DELAY FNERAS_ = rst ? 1'bz : ((0|g42224|g42226) ? 1'b0 : 1'bz);
// Gate A14-U107A A14-U105A
pullup(TPGE);
assign #GATE_DELAY TPGE = rst ? 0 : ((0|SCAD|GOJAM|ERAS_|PHS3_|T05_) ? 1'b0 : 1'bz);
// Gate A14-U227A
pullup(XB1E);
assign #GATE_DELAY XB1E = rst ? 0 : ((0|XB1_) ? 1'b0 : 1'bz);
// Gate A14-U139B A14-U140A A14-U140B
pullup(TPGF);
assign #GATE_DELAY TPGF = rst ? 0 : ((0|T08_|DV3764|ROP_|TCSAJ3|GOJAM|GOJ1|PHS2_|MP1) ? 1'b0 : 1'bz);
// Gate A14-U158B
pullup(g42105);
...
// Gate A14-U159A
pullup(g42104);
assign #GATE_DELAY g42104 = rst ? 1'bz : ((0|g42103|g42105) ? 1'b0 : 1'bz);
// Gate A14-U249B
pullup(XT5E);
...
pullup(SBFSET);
assign #GATE_DELAY SBFSET = rst ? 0 : ((0|T06_|DV3764|ROP_|PHS4_|MNHSBF|MP1) ? 1'b0 : 1'bz);
// Gate A14-U128A
pullup(g42205);
assign #GATE_DELAY g42205 = rst ? 0 : ((0|g42204|g42206|TIMR) ? 1'b0 : 1'bz);
// Gate A14-U246A
pullup(XT6E);
