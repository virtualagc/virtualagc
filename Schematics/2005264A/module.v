...
// Gate A14-U147A
pullup(g42126);
assign #GATE_DELAY g42126 = rst ? 1'bz : ((0|g42127|GOJAM|T08) ? 1'b0 : 1'bz);
// Gate A14-U222A
pullup(XB2E);
...
// Gate A14-U146B
pullup(g42129);
assign #GATE_DELAY g42129 = rst ? 1'bz : ((0|S08|g42127|S09) ? 1'b0 : 1'bz);
...
// Gate A14-U116A
pullup(g42229);
assign #GATE_DELAY g42229 = rst ? 1'bz : ((0|g42232|g42228|GOJAM) ? 1'b0 : 1'bz);
// Gate A14-U239B
pullup(ILP_);
...
// Gate A14-U130B
pullup(g42203);
assign #GATE_DELAY g42203 = rst ? 0 : ((0|g42202|T01) ? 1'b0 : 1'bz);
// Gate A14-U129A
pullup(g42201);
...
// Gate A14-U130A
pullup(g42202);
assign #GATE_DELAY g42202 = rst ? 1'bz : ((0|g42201|g42203) ? 1'b0 : 1'bz);
// Gate A14-U136A
pullup(g42151);
...
// Gate A14-U213A
pullup(XB7);
assign #GATE_DELAY XB7 = rst ? 0 : ((0|S01_|S02_|S03_) ? 1'b0 : 1'bz);
// Gate A14-U215B
pullup(XB6);
...
// Gate A14-U244A
pullup(g42436);
assign #GATE_DELAY g42436 = rst ? 0 : ((0|g42433|RILP1|g42441) ? 1'b0 : 1'bz);
// Gate A14-U225A
pullup(XB2);
...
// Gate A14-U145B
pullup(g42130);
assign #GATE_DELAY g42130 = rst ? 0 : ((0|CLEARA|g42129) ? 1'b0 : 1'bz);
// Gate A14-U148B
pullup(STBF);
assign #GATE_DELAY STBF = rst ? 1'bz : ((0|GOJAM|g42125|g42123) ? 1'b0 : 1'bz);
// Gate A14-U106B
pullup(STBE);
...
pullup(SETEK);
assign #GATE_DELAY SETEK = rst ? 1'bz : ((0|MYCLMP|g42228) ? 1'b0 : 1'bz);
// Gate A14-U204A
pullup(YB3_);
...
// Gate A14-U144B
pullup(RESETA);
assign #GATE_DELAY RESETA = rst ? 1'bz : ((0|g42130) ? 1'b0 : 1'bz);
// Gate A14-U141B
pullup(RESETC);
...
// Gate A14-U147B
pullup(g42127);
assign #GATE_DELAY g42127 = rst ? 0 : ((0|g42128|g42126) ? 1'b0 : 1'bz);
...
// Gate A14-U149B
pullup(g42123);
assign #GATE_DELAY g42123 = rst ? 0 : ((0|STBF|SBFSET) ? 1'b0 : 1'bz);
// Gate A14-U238B
pullup(SBYREL_);
...
// Gate A14-U241A
pullup(g42440);
assign #GATE_DELAY g42440 = rst ? 0 : ((0|XB0|XB3) ? 1'b0 : 1'bz);
// Gate A14-U150B
pullup(SBF);
assign #GATE_DELAY SBF = rst ? 1'bz : ((0|g42123) ? 1'b0 : 1'bz);
// Gate A14-U101A
pullup(g42244);
...
pullup(g42443);
assign #GATE_DELAY g42443 = rst ? 1'bz : ((0|g42438|g42439|g42436|g43437) ? 1'b0 : 1'bz);
// Gate A14-U122B
pullup(NOTEST_);
...
// Gate A14-U128A
pullup(g42205);
assign #GATE_DELAY g42205 = rst ? 1'bz : ((0|TIMR|g42206|g42204) ? 1'b0 : 1'bz);
// Gate A14-U246A
pullup(XT6E);
