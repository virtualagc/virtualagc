...
// Gate A14-U243B
pullup(g42441);
assign #0.2  g42441 = rst ? 0 : ((0|XB6|XB5) ? 1'b0 : 1'bz);
// Gate A14-U146B
pullup(g42129);
...
pullup(ERAS);
assign #0.2  ERAS = rst ? 0 : ((0|S12|S11|TCSAJ3|MAMU|MP1|INOUT|GOJ1|CHINC) ? 1'b0 : 1'bz);
// Gate A14-U217A A14-U215A A14-U218B
pullup(XB5_);
assign #0.2  XB5_ = rst ? 0 : ((0|XB5) ? 1'b0 : 1'bz);
...
pullup(ERAS_);
assign #0.2  ERAS_ = rst ? 1'bz : ((0|ERAS) ? 1'b0 : 1'bz);
// Gate A14-U121B
pullup(g42218);
...
// Gate A14-U258A
pullup(XT0E);
assign #0.2  XT0E = rst ? 0 : ((0|XT0_) ? 1'b0 : 1'bz);
// Gate A14-U123A
pullup(g42215);
...
// Gate A14-U130B
pullup(g42203);
assign #0.2  g42203 = rst ? 1'bz : ((0|g42202|T01) ? 1'b0 : 1'bz);
// Gate A14-U129A
pullup(g42201);
...
// Gate A14-U130A
pullup(g42202);
assign #0.2  g42202 = rst ? 0 : ((0|g42203|g42201) ? 1'b0 : 1'bz);
// Gate A14-U136A
pullup(g42151);
...
// Gate A14-U228B
pullup(XB1);
assign #0.2  XB1 = rst ? 0 : ((0|S01_|S02|S03) ? 1'b0 : 1'bz);
// Gate A14-U230B
pullup(XB0);
...
// Gate A14-U246B
pullup(XT7E);
assign #0.2  XT7E = rst ? 1'bz : ((0|XT7_) ? 1'b0 : 1'bz);
// Gate A14-U245A
pullup(XT7_);
assign #0.2  XT7_ = rst ? 0 : ((0|XT7) ? 1'b0 : 1'bz);
// Gate A14-U113A
pullup(g42235);
assign #0.2  g42235 = rst ? 0 : ((0|GOJAM|g42234|REDRST) ? 1'b0 : 1'bz);
// Gate A14-U205A
pullup(RILP1);
assign #0.2  RILP1 = rst ? 0 : ((0|YB0|YB3) ? 1'b0 : 1'bz);
// Gate A14-U115A
pullup(g42233);
assign #0.2  g42233 = rst ? 0 : ((0|PHS3_|ERAS_|T03_) ? 1'b0 : 1'bz);
// Gate A14-U137A
pullup(g42147);
assign #0.2  g42147 = rst ? 1'bz : ((0|ROP_) ? 1'b0 : 1'bz);
// Gate A14-U227B
pullup(XB0E);
...
// Gate A14-U242A
pullup(g43437);
assign #0.2  g43437 = rst ? 1'bz : ((0|RILP1|g42442|g42435) ? 1'b0 : 1'bz);
// Gate A14-U244A
pullup(g42436);
...
// Gate A14-U205B
pullup(YB2_);
assign #0.2  YB2_ = rst ? 1'bz : ((0|YB2) ? 1'b0 : 1'bz);
// Gate A14-U142B
pullup(g42137);
...
pullup(ROP_);
assign #0.2  ROP_ = rst ? 0 : ((0|S12|S11) ? 1'b0 : 1'bz);
// Gate A14-U155B
pullup(g42111);
...
// Gate A14-U203B
pullup(YB2E);
assign #0.2  YB2E = rst ? 0 : ((0|YB2_) ? 1'b0 : 1'bz);
// Gate A14-U247B
pullup(XT7);
assign #0.2  XT7 = rst ? 1'bz : ((0|S04_|S06_|S05_) ? 1'b0 : 1'bz);
// Gate A14-U245B
pullup(WL16_);
...
// Gate A14-U204A
pullup(YB3_);
assign #0.2  YB3_ = rst ? 0 : ((0|YB3) ? 1'b0 : 1'bz);
// Gate A14-U209A
pullup(YB0);
...
// Gate A14-U206B
pullup(YB2);
assign #0.2  YB2 = rst ? 0 : ((0|S07|S08_) ? 1'b0 : 1'bz);
// Gate A14-U243A A14-U244B
pullup(g42433);
assign #0.2  g42433 = rst ? 1'bz : ((0|XT6|XT5|XT0|XT3) ? 1'b0 : 1'bz);
// Gate A14-U146A
pullup(g42128);
...
pullup(XB1_);
assign #0.2  XB1_ = rst ? 1'bz : ((0|XB1) ? 1'b0 : 1'bz);
// Gate A14-U203A
pullup(YB3E);
assign #0.2  YB3E = rst ? 1'bz : ((0|YB3_) ? 1'b0 : 1'bz);
// Gate A14-U111A
pullup(REX);
...
// Gate A14-U202B
pullup(RILP1_);
assign #0.2  RILP1_ = rst ? 1'bz : ((0|RILP1) ? 1'b0 : 1'bz);
// Gate A14-U133A
pullup(WHOMPA);
...
// Gate A14-U218A
pullup(XB5);
assign #0.2  XB5 = rst ? 1'bz : ((0|S02|S01_|S03_) ? 1'b0 : 1'bz);
// Gate A14-U212B
pullup(XB7E);
...
// Gate A14-U231A
pullup(CXB1_);
assign #0.2  CXB1_ = rst ? 1'bz : ((0|XB1) ? 1'b0 : 1'bz);
// Gate A14-U231B
pullup(NOTEST);
...
// Gate A14-U240A
pullup(g42435);
assign #0.2  g42435 = rst ? 0 : ((0|g42433) ? 1'b0 : 1'bz);
// Gate A14-U241A
pullup(g42440);
...
// Gate A14-U216B
pullup(XB5E);
assign #0.2  XB5E = rst ? 1'bz : ((0|XB5_) ? 1'b0 : 1'bz);
// Gate A14-U204B
pullup(YB3);
assign #0.2  YB3 = rst ? 1'bz : ((0|S08_|S07_) ? 1'b0 : 1'bz);
// Gate A14-U110B
pullup(g42240);
...
// Gate A14-U156B
pullup(g42158);
assign #0.2  g42158 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A14-U137B
pullup(STRGAT);
...
// Gate A14-U155A
pullup(g42110);
assign #0.2  g42110 = rst ? 0 : ((0|T01_) ? 1'b0 : 1'bz);
// Gate A14-U248A
pullup(RB1);
...
// Gate A14-U260B
pullup(XT0);
assign #0.2  XT0 = rst ? 0 : ((0|S04|S06|S05) ? 1'b0 : 1'bz);
// Gate A14-U154B
pullup(g42113);
...
// Gate A14-U227A
pullup(XB1E);
assign #0.2  XB1E = rst ? 0 : ((0|XB1_) ? 1'b0 : 1'bz);
...
// Gate A14-U242B
pullup(g42438);
assign #0.2  g42438 = rst ? 0 : ((0|g42442|g42433|RILP1_) ? 1'b0 : 1'bz);
// Gate A14-U216A
pullup(XB4E);
