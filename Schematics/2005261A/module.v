...
pullup(g39251);
assign #GATE_DELAY g39251 = rst ? 1'bz : ((0|C41P|C40P|C37P|C44P|C43P|C42P|C24A|C25A|C26A|C27A|C30A) ? 1'b0 : 1'bz);
// Gate A5-U120A A5-U154A A5-U221A A5-U221B
pullup(RC_);
assign #GATE_DELAY RC_ = rst ? 1'bz : ((0|g39225|g39241|g39143|g39129|g39432|g39406|g39439|g39451) ? 1'b0 : 1'bz);
...
// Gate A5-U127B
pullup(PINC_);
assign #GATE_DELAY PINC_ = rst ? 0 : ((0|g39254|PINC) ? 1'b0 : 1'bz);
// Gate A5-U126B
pullup(g39239);
...
// Gate A5-U125B
pullup(PINC);
assign #GATE_DELAY PINC = rst ? 1'bz : ((0|T12|PINC_) ? 1'b0 : 1'bz);
// Gate A5-U124A
pullup(g39241);
...
pullup(RB_);
assign #GATE_DELAY RB_ = rst ? 1'bz : ((0|g39109|g39120|g39145|g39138|g39203|g39223|_A5_2_5XP19|g39341) ? 1'b0 : 1'bz);
// Gate A5-U132B
pullup(MONEX_);
assign #GATE_DELAY MONEX_ = rst ? 1'bz : ((0|g39103|d10XP6|_A5_1_10XP7) ? 1'b0 : 1'bz);
// Gate A5-U128A A5-U155B A5-U249B
pullup(WY_);
assign #GATE_DELAY WY_ = rst ? 1'bz : ((0|g39233|g39225|g39227|g39140|g39143|g39149|_A5_2_10XP10|g39330|d2XP8) ? 1'b0 : 1'bz);
// Gate A5-U138A
pullup(g39116);
...
pullup(TSUDO_);
assign #GATE_DELAY TSUDO_ = rst ? 1'bz : ((0|MP3|IC3|RSM3|IC16) ? 1'b0 : 1'bz);
// Gate A5-U108B
pullup(RAD);
...
pullup(RU_);
assign #GATE_DELAY RU_ = rst ? 1'bz : ((0|g39214|g39201|d9XP5|g39441|g39436|g39452|d5XP11|d6XP8|g39416) ? 1'b0 : 1'bz);
...
// Gate A5-U224A
pullup(g39412);
assign #GATE_DELAY g39412 = rst ? 0 : ((0|T05_|g39410) ? 1'b0 : 1'bz);
// Gate A5-U224B
pullup(g39406);
...
pullup(g39301);
assign #GATE_DELAY g39301 = rst ? 1'bz : ((0|DXCH0|IC9|INOUT|PRINC|DAS1|DAS0|IC12) ? 1'b0 : 1'bz);
...
// Gate A5-U254A
pullup(Z16_);
assign #GATE_DELAY Z16_ = rst ? 1'bz : ((0|g39411) ? 1'b0 : 1'bz);
