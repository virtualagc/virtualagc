...
initial $display("Gate delay (A23) will be %f ns.", GATE_DELAY);

// Gate A23-U147A
pullup(NOXM);
assign #GATE_DELAY NOXM = rst ? 0 : ((0|PIPGXm|g48150) ? 1'b0 : 1'bz);
// Gate A23-U147B
pullup(g48150);
assign #GATE_DELAY g48150 = rst ? 1'bz : ((0|NOXM|F18AX) ? 1'b0 : 1'bz);
// Gate A23-U146A
pullup(g48130);
...
// Gate A23-U121A
pullup(g48238);
assign #GATE_DELAY g48238 = rst ? 1'bz : ((0|g48239|g48236) ? 1'b0 : 1'bz);
// Gate A23-U121B
pullup(g48239);
...
// Gate A23-U115B A23-U116A A23-U116B
pullup(CCH34);
...
// Gate A23-U128A
pullup(MISSY);
assign #GATE_DELAY MISSY = rst ? 1'bz : ((0|PIPGYp|PIPGYm|g48257) ? 1'b0 : 1'bz);
// Gate A23-U128B
pullup(g48257);
assign #GATE_DELAY g48257 = rst ? 0 : ((0|F5ASB2|MISSY) ? 1'b0 : 1'bz);
// Gate A23-U129A
pullup(NOYP);
...
// Gate A23-U105A
pullup(g48248);
assign #GATE_DELAY g48248 = rst ? 1'bz : ((0|g48249|g48246) ? 1'b0 : 1'bz);
// Gate A23-U105B
pullup(g48249);
...
// Gate A23-U107A
pullup(g48244);
assign #GATE_DELAY g48244 = rst ? 0 : ((0|g48245|g48241|g48240) ? 1'b0 : 1'bz);
// Gate A23-U107B
pullup(g48245);
...
// Gate A23-U136A
pullup(g48104);
assign #GATE_DELAY g48104 = rst ? 0 : ((0|MISSX|MISSZ|MISSY) ? 1'b0 : 1'bz);
// Gate A23-U136B
pullup(g48105);
assign #GATE_DELAY g48105 = rst ? 0 : ((0|F5ASB0_|g48104) ? 1'b0 : 1'bz);
// Gate A23-U137A A23-U138A
pullup(g48106);
assign #GATE_DELAY g48106 = rst ? 0 : ((0|g48105|g48103|PIPAFL|BOTHX|BOTHY|BOTHZ) ? 1'b0 : 1'bz);
// Gate A23-U137B
pullup(PIPAFL);
assign #GATE_DELAY PIPAFL = rst ? 1'bz : ((0|CCH33|g48106) ? 1'b0 : 1'bz);
// Gate A23-U139A
pullup(g48103);
assign #GATE_DELAY g48103 = rst ? 0 : ((0|g48101|F18B_) ? 1'b0 : 1'bz);
// Gate A23-U139B A23-U138B
pullup(g48101);
assign #GATE_DELAY g48101 = rst ? 0 : ((0|NOZM|NOZP|NOYM|NOXM|NOXP|NOYP) ? 1'b0 : 1'bz);
// Gate A23-U231A
pullup(g48402);
assign #GATE_DELAY g48402 = rst ? 0 : ((0|g48401|E5) ? 1'b0 : 1'bz);
// Gate A23-U231B
pullup(g48401);
assign #GATE_DELAY g48401 = rst ? 0 : ((0|WCH07_|CHWL05_) ? 1'b0 : 1'bz);
// Gate A23-U232A
pullup(E5);
assign #GATE_DELAY E5 = rst ? 1'bz : ((0|g48402|CCH07) ? 1'b0 : 1'bz);
// Gate A23-U232B
pullup(CH0705);
...
// Gate A23-U236A
pullup(g48411);
assign #GATE_DELAY g48411 = rst ? 1'bz : ((0|E7_|CCH07) ? 1'b0 : 1'bz);
// Gate A23-U236B
pullup(E7_);
