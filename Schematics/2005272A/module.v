...
// Gate A23-U136A
assign #0.2  g48104 = rst ? 0 : ~(0|MISSY|MISSZ|MISSX);
// Gate A23-U125A
...
// Gate A23-U234A
assign #0.2  g48406 = rst ? 1 : ~(0|E6|g48405);
// Gate A23-U252B
...
// Gate A23-U121B
assign #0.2  g48239 = rst ? 1 : ~(0|g48238|g48237);
// Gate A23-U236A
...
// Gate A23-U233B
assign #0.2  E6 = rst ? 0 : ~(0|g48406|CCH07);
// Gate A23-U229A
...
// Gate A23-U121A
assign #0.2  g48238 = rst ? 0 : ~(0|g48236|g48239);
