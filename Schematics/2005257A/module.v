...
// Gate A10-U151A
pullup(g53127);
assign #GATE_DELAY g53127 = rst ? 1'bz : ((0|L09_|CLG1G) ? 1'b0 : 1'bz);
// Gate A10-U235B
pullup(PIPAXm_);
...
// Gate A10-U151B
pullup(g53108);
assign #GATE_DELAY g53108 = rst ? 0 : ((0|g53107|CUG) ? 1'b0 : 1'bz);
// Gate A10-U143A
pullup(g53263);
...
// Gate A10-U153B
pullup(g53107);
assign #GATE_DELAY g53107 = rst ? 1'bz : ((0|g53106|g53108|g53105) ? 1'b0 : 1'bz);
// Gate A10-U160A
pullup(g53118);
...
// Gate A10-U157B
pullup(XUY09_);
assign #GATE_DELAY XUY09_ = rst ? 1'bz : ((0|g53108|g53104) ? 1'b0 : 1'bz);
// Gate A10-U130A
pullup(g53218);
