...
// Gate A10-U253B
pullup(G12);
assign #GATE_DELAY G12 = rst ? 0 : ((0|CGG|G12_) ? 1'b0 : 1'bz);
// Gate A10-U137A
pullup(g53131);
...
// Gate A10-U251A
pullup(GEM12);
assign #GATE_DELAY GEM12 = rst ? 0 : ((0|G12_) ? 1'b0 : 1'bz);
// Gate A10-U221A
pullup(GEM11);
...
pullup(G12_);
assign #GATE_DELAY G12_ = rst ? 1'bz : ((0|g53344|SA12|g53343|g53345|G12|g53346) ? 1'b0 : 1'bz);
// Gate A10-U216A
pullup(g53442);
