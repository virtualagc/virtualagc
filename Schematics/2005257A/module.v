...
// Gate A10-U127A
assign #0.2  A10U127Pad1 = rst ? 1 : ~(0|CAG|A10_);
// Gate A10-U131A
assign #0.2  A10U131Pad1 = rst ? 0 : ~(0|WL09_|WZG_);
// Gate A10-U237A
assign #0.2  A10U237Pad1 = rst ? 0 : ~(0|WLG_|WL12_);
// Gate A10-U128B
assign #0.2  A10U127Pad8 = rst ? 0 : ~(0|CUG|A10U120Pad7|CLXC);
// Gate A10-U115B
...
// Gate A10-U118B
assign #0.2  A10U115Pad7 = rst ? 1 : ~(0|A10U116Pad7|XUY10_);
// Gate A10-U117A
...
// Gate A10-U234A
assign #0.2  A10U233Pad4 = rst ? 1 : ~(0|A12_|CAG);
// Gate A10-U120A
...
// Gate A10-U108A
assign #0.2  A10U106Pad2 = rst ? 0 : ~(0|A10U108Pad2|A10U107Pad1);
// Gate A10-U260A
...
// Gate A10-U120B
assign #0.2  A10U116Pad7 = rst ? 0 : ~(0|A10U120Pad7|A10U120Pad8);
// Gate A10-U127B
...
// Gate A10-U242B
assign #0.2  SUMA12_ = rst ? 1 : ~(0|A10U241Pad9|XUY12_|CI12_);
// Gate A10-U119A
...
// Gate A10-U157A
assign #0.2  A10U157Pad1 = rst ? 1 : ~(0|CAG|A09_);
// Gate A10-U205B
assign #0.2  CO04 = rst ? 1 : ~(0|WHOMPA);
// Gate A10-U213A
assign #0.2  A10U213Pad1 = rst ? 1 : ~(0|A10U213Pad2|A10U212Pad1);
// Gate A10-U256A
assign #0.2  A10U256Pad1 = rst ? 0 : ~(0|Z12_|RZG_);
// Gate A10-U158B
assign #0.2  A10U157Pad8 = rst ? 0 : ~(0|CUG|A10U150Pad7|CLXC);
// Gate A10-U214A
assign #0.2  A10U213Pad2 = rst ? 0 : ~(0|A10U213Pad1|CBG);
// Gate A10-U125A A10-U114A A10-U143B A10-U104A
assign #0.2  RL10_ = rst ? 1 : ~(0|CH10|A10U125Pad3|A10U114Pad9|A10U114Pad2|A10U114Pad3|A10U109Pad1|MDT10|R1C|A10U104Pad2|A10U104Pad3|A10J2Pad240);
// Gate A10-U136B
assign #0.2  A10U136Pad9 = rst ? 0 : ~(0|WG1G_|WL09_);
// Gate A10-U154B
assign #0.2  A10U153Pad8 = rst ? 0 : ~(0|WYLOG_|WL09_);
// Gate A10-U138A
assign #0.2  A10U136Pad2 = rst ? 1 : ~(0|A10U138Pad2|A10U137Pad1);
// Gate A10-U155A
assign #0.2  A10U155Pad1 = rst ? 0 : ~(0|A09_|RAG_);
// Gate A10-U146B
assign #0.2  CI10_ = rst ? 0 : ~(0|SUMA09_|A10U146Pad8);
// Gate A10-U107A
assign #0.2  A10U107Pad1 = rst ? 1 : ~(0|CQG|A10U106Pad2);
// Gate A10-U126A
...
// Gate A10-U233A
assign #0.2  A12_ = rst ? 0 : ~(0|A10U231Pad1|A10U232Pad1|A10U233Pad4);
// Gate A10-U145A
assign #0.2  A10U144Pad2 = rst ? 0 : ~(0|A10U145Pad2|RCG_);
// Gate A10-U149B
assign #0.2  SUMA09_ = rst ? 1 : ~(0|A10U146Pad8|XUY09_|CI09_);
// Gate A10-U123A
...
// Gate A10-U203A
assign #0.2  A11_ = rst ? 0 : ~(0|A10U201Pad1|A10U202Pad1|A10U203Pad4);
// Gate A10-U214B
...
// Gate A10-U148A
assign #0.2  A10U146Pad3 = rst ? 0 : ~(0|A10U148Pad2|A10U145Pad2);
// Gate A10-U226A
assign #0.2  A10U226Pad1 = rst ? 0 : ~(0|Z11_|RZG_);
// Gate A10-U241B
assign #0.2  A10U241Pad9 = rst ? 0 : ~(0|A10U238Pad9|A10U231Pad9);
// Gate A10-U150B
assign #0.2  A10U146Pad8 = rst ? 0 : ~(0|A10U150Pad7|A10U150Pad8);
// Gate A10-U215B
...
// Gate A10-U243B
assign #0.2  A10U243Pad9 = rst ? 1 : ~(0|XUY12_|A10U241Pad9);
// Gate A10-U103A
assign #0.2  A10U102Pad2 = rst ? 1 : ~(0|Z10_|CZG);
// Gate A10-U133A
assign #0.2  A10U132Pad2 = rst ? 1 : ~(0|Z09_|CZG);
// Gate A10-U222B A10-U221B
assign #0.2  G11_ = rst ? 1 : ~(0|A10U222Pad6|G11|A10U222Pad8|A10U220Pad9|SA11|A10U219Pad9);
// Gate A10-U243A
assign #0.2  A10U243Pad1 = rst ? 0 : ~(0|A10U243Pad2|A10U242Pad1);
// Gate A10-U147A
assign #0.2  A10U145Pad2 = rst ? 1 : ~(0|CBG|A10U146Pad3);
// Gate A10-U132A
assign #0.2  Z09_ = rst ? 0 : ~(0|A10U132Pad2|A10U131Pad1);
// Gate A10-U148B
assign #0.2  A10U145Pad7 = rst ? 1 : ~(0|A10U146Pad8|XUY09_);
// Gate A10-U218B A10-U236A A10-U257A A10-U247A
assign #0.2  RL12_ = rst ? 1 : ~(0|R1C|MDT12|A10U235Pad1|CH12|A10U236Pad4|A10U255Pad1|A10U256Pad1|A10J3Pad340|A10U245Pad1|A10U246Pad1|A10U247Pad4);
// Gate A10-U147B
...
// Gate A10-U254A
assign #0.2  A10U253Pad2 = rst ? 1 : ~(0|A10U253Pad1|CQG);
// Gate A10-U256B
assign #0.2  WL12 = rst ? 0 : ~(0|RL12_);
// Gate A10-U156B A10-U113B A10-U134A A10-U144A
assign #0.2  RL09_ = rst ? 1 : ~(0|A10U144Pad9|A10U155Pad1|CH09|MDT09|R1C|A10J1Pad140|A10U134Pad3|A10U134Pad4|A10U144Pad2|A10U144Pad3|A10U139Pad1);
// Gate A10-U231A
assign #0.2  A10U231Pad1 = rst ? 0 : ~(0|WL12_|WAG_);
// Gate A10-U227A A10-U248B A10-U217A A10-U205A
assign #0.2  RL11_ = rst ? 1 : ~(0|A10U225Pad1|A10U226Pad1|A10J4Pad440|R1C|MDT11|A10U215Pad1|A10U217Pad3|A10U216Pad1|A10U205Pad2|CH11|A10U205Pad4);
// Gate A10-U122A
assign #0.2  L10_ = rst ? 0 : ~(0|A10U122Pad2|A10U122Pad3|A10U121Pad1);
// Gate A10-U122B
...
// Gate A10-U130B
assign #0.2  A10U120Pad7 = rst ? 1 : ~(0|A10U129Pad9|A10U127Pad8|MONEX);
// Gate A10-U238A
...
// Gate A10-U253A
assign #0.2  A10U253Pad1 = rst ? 0 : ~(0|A10U253Pad2|A10U250Pad1);
// Gate A10-U206A
...
// Gate A10-U204A
assign #0.2  A10U203Pad4 = rst ? 1 : ~(0|A11_|CAG);
// Gate A10-U157B
...
// Gate A10-U119B
assign #0.2  SUMA10_ = rst ? 1 : ~(0|A10U116Pad7|CI10_|XUY10_);
// Gate A10-U251B A10-U252B
assign #0.2  G12_ = rst ? 1 : ~(0|A10U250Pad9|SA12|A10U249Pad9|A10U252Pad6|G12|A10U252Pad8);
// Gate A10-U216A
assign #0.2  A10U216Pad1 = rst ? 0 : ~(0|RCG_|A10U213Pad2);
// Gate A10-U231B
assign #0.2  A10U231Pad9 = rst ? 1 : ~(0|A10U231Pad6|MONEX|A10U231Pad8);
// Gate A10-U202A
...
// Gate A10-U233B
assign #0.2  A10U231Pad8 = rst ? 0 : ~(0|A10U231Pad9|CLXC|CUG);
// Gate A10-U258A
assign #0.2  A10U258Pad1 = rst ? 1 : ~(0|CZG|Z12_);
// Gate A10-U219A
assign #0.2  PIPAYp_ = rst ? 1 : ~(0|PIPAYp);
// Gate A10-U121A
assign #0.2  A10U121Pad1 = rst ? 1 : ~(0|L10_|CLG1G);
// Gate A10-U240A
...
// Gate A10-U158A
assign #0.2  A09_ = rst ? 0 : ~(0|A10U158Pad2|A10U158Pad3|A10U157Pad1);
// Gate A10-U212B
