...
// Gate A10-U127A
pullup(g53221);
assign #GATE_DELAY g53221 = rst ? 0 : ((0|A10_|CAG) ? 1'b0 : 1'bz);
// Gate A10-U131A
pullup(g53134);
...
// Gate A10-U128A
pullup(A10_);
assign #GATE_DELAY A10_ = rst ? 1'bz : ((0|g53221|g53218|g53219) ? 1'b0 : 1'bz);
// Gate A10-U152B
pullup(g53106);
...
// Gate A10-U234A
pullup(g53321);
assign #GATE_DELAY g53321 = rst ? 0 : ((0|CAG|A12_) ? 1'b0 : 1'bz);
// Gate A10-U120A
pullup(g53228);
...
// Gate A10-U244A
pullup(g53340);
assign #GATE_DELAY g53340 = rst ? 0 : ((0|CBG|g53339) ? 1'b0 : 1'bz);
// Gate A10-U139A
pullup(g53151);
...
// Gate A10-U151A
pullup(g53127);
assign #GATE_DELAY g53127 = rst ? 0 : ((0|L09_|CLG1G) ? 1'b0 : 1'bz);
// Gate A10-U235B
pullup(PIPAXm_);
...
// Gate A10-U233A
pullup(A12_);
assign #GATE_DELAY A12_ = rst ? 1'bz : ((0|g53321|g53319|g53318) ? 1'b0 : 1'bz);
// Gate A10-U145A
pullup(g53142);
...
// Gate A10-U243A
pullup(g53339);
assign #GATE_DELAY g53339 = rst ? 1'bz : ((0|g53338|g53340) ? 1'b0 : 1'bz);
// Gate A10-U147A
pullup(g53140);
