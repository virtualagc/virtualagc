...
// Gate A10-U132B A10-U131B A10-U133B
pullup(WL09_);
...
// Gate A10-U158A
pullup(A09_);
assign #GATE_DELAY A09_ = rst ? 1'bz : ((0|g53121|g53118|g53119) ? 1'b0 : 1'bz);
// Gate A10-U158B
pullup(g53104);
...
// Gate A10-U152A
pullup(L09_);
assign #GATE_DELAY L09_ = rst ? 1'bz : ((0|g53127|g53124|g53125) ? 1'b0 : 1'bz);
// Gate A10-U152B
pullup(g53106);
assign #GATE_DELAY g53106 = rst ? 0 : ((0|WYDG_|WL08_) ? 1'b0 : 1'bz);
// Gate A10-U157A
pullup(g53121);
assign #GATE_DELAY g53121 = rst ? 0 : ((0|A09_|CAG) ? 1'b0 : 1'bz);
// Gate A10-U157B
pullup(XUY09_);
assign #GATE_DELAY XUY09_ = rst ? 0 : ((0|g53108|g53104) ? 1'b0 : 1'bz);
// Gate A10-U117A
pullup(g53240);
assign #GATE_DELAY g53240 = rst ? 0 : ((0|g53239|CBG) ? 1'b0 : 1'bz);
// Gate A10-U117B
pullup(g53211);
...
// Gate A10-U114A A10-U125A A10-U104A A10-U143B
pullup(RL10_);
assign #GATE_DELAY RL10_ = rst ? 1'bz : ((0|g53251|g53242|g53241|g53217|g53222|CH10|g53228|g53232|g53237|MDT10|R1C) ? 1'b0 : 1'bz);
// Gate A10-U114B
pullup(g53217);
...
// Gate A10-U118A
pullup(g53239);
assign #GATE_DELAY g53239 = rst ? 1'bz : ((0|g53240|g53238) ? 1'b0 : 1'bz);
// Gate A10-U118B
pullup(g53213);
...
// Gate A10-U122A
pullup(L10_);
assign #GATE_DELAY L10_ = rst ? 0 : ((0|g53227|g53224|g53225) ? 1'b0 : 1'bz);
// Gate A10-U122B
pullup(g53206);
...
// Gate A10-U121A
pullup(g53227);
assign #GATE_DELAY g53227 = rst ? 1'bz : ((0|CLG1G|L10_) ? 1'b0 : 1'bz);
// Gate A10-U121B
pullup(g53208);
...
// Gate A10-U101B A10-U102B A10-U103B
pullup(WL10_);
...
// Gate A10-U102A
pullup(Z10_);
assign #GATE_DELAY Z10_ = rst ? 0 : ((0|g53234|g53236) ? 1'b0 : 1'bz);
// Gate A10-U105A
pullup(g53237);
...
// Gate A10-U110B A10-U109B
pullup(G10_);
assign #GATE_DELAY G10_ = rst ? 0 : ((0|g53244|g53243|SA10|g53246|g53245|G10) ? 1'b0 : 1'bz);
// Gate A10-U109A
pullup(g53251);
assign #GATE_DELAY g53251 = rst ? 0 : ((0|G10_|RGG_) ? 1'b0 : 1'bz);
// Gate A10-U103A
pullup(g53236);
assign #GATE_DELAY g53236 = rst ? 1'bz : ((0|CZG|Z10_) ? 1'b0 : 1'bz);
// Gate A10-U133A
pullup(g53136);
...
// Gate A10-U134A A10-U144A A10-U113B A10-U156B
pullup(RL09_);
assign #GATE_DELAY RL09_ = rst ? 1'bz : ((0|g53132|g53137|g53128|g53151|g53141|g53142|MDT09|R1C|g53117|g53122|CH09) ? 1'b0 : 1'bz);
// Gate A10-U134B
pullup(MWL09);
...
// Gate A10-U148A
pullup(g53139);
assign #GATE_DELAY g53139 = rst ? 1'bz : ((0|g53140|g53138) ? 1'b0 : 1'bz);
// Gate A10-U148B
pullup(g53113);
...
// Gate A10-U147A
pullup(g53140);
assign #GATE_DELAY g53140 = rst ? 0 : ((0|g53139|CBG) ? 1'b0 : 1'bz);
// Gate A10-U147B
pullup(g53111);
...
// Gate A10-U259A
pullup(Z12_);
assign #GATE_DELAY Z12_ = rst ? 1'bz : ((0|g53336|g53334) ? 1'b0 : 1'bz);
// Gate A10-U259B A10-U258B A10-U260B
pullup(WL12_);
assign #GATE_DELAY WL12_ = rst ? 1'bz : ((0|WL12) ? 1'b0 : 1'bz);
// Gate A10-U258A
pullup(g53336);
assign #GATE_DELAY g53336 = rst ? 0 : ((0|Z12_|CZG) ? 1'b0 : 1'bz);
// Gate A10-U243A
pullup(g53339);
...
// Gate A10-U254A
pullup(g53331);
assign #GATE_DELAY g53331 = rst ? 1'bz : ((0|CQG|g53330) ? 1'b0 : 1'bz);
// Gate A10-U254B
pullup(g53345);
...
// Gate A10-U218B A10-U247A A10-U257A A10-U236A
pullup(RL12_);
assign #GATE_DELAY RL12_ = rst ? 1'bz : ((0|R1C|MDT12|g53351|g53342|g53341|g53328|g53337|g53332|g53317|CH12|g53322) ? 1'b0 : 1'bz);
// Gate A10-U245A
pullup(g53341);
...
// Gate A10-U253A
pullup(g53330);
assign #GATE_DELAY g53330 = rst ? 0 : ((0|g53329|g53331) ? 1'b0 : 1'bz);
// Gate A10-U253B
pullup(G12);
...
// Gate A10-U217A A10-U205A A10-U248B A10-U227A
pullup(RL11_);
assign #GATE_DELAY RL11_ = rst ? 1'bz : ((0|g53442|g53451|g53441|g53417|CH11|g53422|R1C|MDT11|g53428|g53437|g53432) ? 1'b0 : 1'bz);
// Gate A10-U217B
pullup(g53417);
...
// Gate A10-U242B
pullup(SUMA12_);
assign #GATE_DELAY SUMA12_ = rst ? 1'bz : ((0|g53309|XUY12_|CI12_) ? 1'b0 : 1'bz);
...
// Gate A10-U213A
pullup(g53439);
assign #GATE_DELAY g53439 = rst ? 0 : ((0|g53438|g53440) ? 1'b0 : 1'bz);
// Gate A10-U213B
pullup(g53413);
...
// Gate A10-U228B A10-U229B A10-U230B
pullup(WL11_);
...
// Gate A10-U210A
pullup(g53427);
assign #GATE_DELAY g53427 = rst ? 0 : ((0|L11_|CLG1G) ? 1'b0 : 1'bz);
// Gate A10-U210B
pullup(g53408);
assign #GATE_DELAY g53408 = rst ? 1'bz : ((0|CUG|g53407) ? 1'b0 : 1'bz);
// Gate A10-U209A
pullup(L11_);
assign #GATE_DELAY L11_ = rst ? 1'bz : ((0|g53427|g53425|g53424) ? 1'b0 : 1'bz);
// Gate A10-U209B
pullup(g53406);
...
// Gate A10-U214A
pullup(g53440);
assign #GATE_DELAY g53440 = rst ? 1'bz : ((0|CBG|g53439) ? 1'b0 : 1'bz);
// Gate A10-U214B
pullup(g53411);
...
// Gate A10-U221B A10-U222B
pullup(G11_);
assign #GATE_DELAY G11_ = rst ? 0 : ((0|g53444|SA11|g53443|g53445|G11|g53446) ? 1'b0 : 1'bz);
// Gate A10-U222A
pullup(g53451);
