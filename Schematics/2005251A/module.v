...
// Gate A3-U135B
pullup(SQR16);
assign #GATE_DELAY SQR16 = rst ? 0 : ((0|RPTFRC|g30016|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U145A A3-U147A
pullup(g30029);
assign #GATE_DELAY g30029 = rst ? 1'bz : ((0|g30015|SQR13) ? 1'b0 : 1'bz);
// Gate A3-U145B
pullup(SQ4_);
...
// Gate A3-U121A A3-U122A
pullup(QC0);
assign #GATE_DELAY QC0 = rst ? 1'bz : ((0|SQR12|SQR11) ? 1'b0 : 1'bz);
// Gate A3-U121B
pullup(g30119);
...
// Gate A3-U157B
pullup(g30044);
assign #GATE_DELAY g30044 = rst ? 0 : ((0|g30026|g30031|g30029) ? 1'b0 : 1'bz);
// Gate A3-U122B
pullup(g30114);
...
// Gate A3-U155B
pullup(g30041);
assign #GATE_DELAY g30041 = rst ? 0 : ((0|g30032|g30026|g30029) ? 1'b0 : 1'bz);
// Gate A3-U134A
pullup(g30060);
assign #GATE_DELAY g30060 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U134B
pullup(g30043);
assign #GATE_DELAY g30043 = rst ? 0 : ((0|g30036|g30026|g30031) ? 1'b0 : 1'bz);
// Gate A3-U133A
pullup(g30023);
...
pullup(CSQG);
assign #GATE_DELAY CSQG = rst ? 1'bz : ((0|CT_|g30005|T12_) ? 1'b0 : 1'bz);
// Gate A3-U151B
pullup(g30038);
assign #GATE_DELAY g30038 = rst ? 0 : ((0|g30032|g30034|g30029) ? 1'b0 : 1'bz);
// Gate A3-U147B
pullup(g30036);
assign #GATE_DELAY g30036 = rst ? 0 : ((0|g30029) ? 1'b0 : 1'bz);
// Gate A3-U108A
pullup(MSQ11);
...
// Gate A3-U138B A3-U137B A3-U140B
pullup(SQ2_);
...
// Gate A3-U140A
pullup(SQR14);
assign #GATE_DELAY SQR14 = rst ? 0 : ((0|CSQG|RPTFRC|g30026) ? 1'b0 : 1'bz);
// Gate A3-U146A
pullup(SQR13);
assign #GATE_DELAY SQR13 = rst ? 0 : ((0|g30029|RPTFRC|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U146B
pullup(g30037);
...
// Gate A3-U154B
pullup(SQ5);
assign #GATE_DELAY SQ5 = rst ? 0 : ((0|g30031|g30029|g30034) ? 1'b0 : 1'bz);
// Gate A3-U136A
pullup(g30016);
assign #GATE_DELAY g30016 = rst ? 1'bz : ((0|SQR16|g30013) ? 1'b0 : 1'bz);
// Gate A3-U136B
pullup(g30040);
assign #GATE_DELAY g30040 = rst ? 0 : ((0|g30036|g30032|g30026) ? 1'b0 : 1'bz);
...
// Gate A3-U41B
pullup(g30034);
assign #GATE_DELAY g30034 = rst ? 0 : ((0|g30026) ? 1'b0 : 1'bz);
// Gate A3-U144A
pullup(MSQ14);
assign #GATE_DELAY MSQ14 = rst ? 0 : ((0|g30026) ? 1'b0 : 1'bz);
// Gate A3-U144B
pullup(MSQ13);
assign #GATE_DELAY MSQ13 = rst ? 0 : ((0|g30029) ? 1'b0 : 1'bz);
// Gate A3-U141A A3-U142A
pullup(g30026);
assign #GATE_DELAY g30026 = rst ? 1'bz : ((0|SQR14|g30014) ? 1'b0 : 1'bz);
// Gate A3-U142B
pullup(INKBT1);
...
// Gate A3-U125A
pullup(g30136);
assign #GATE_DELAY g30136 = rst ? 1'bz : ((0|RPTFRC|g30131|g30137) ? 1'b0 : 1'bz);
// Gate A3-U125B
pullup(FUTEXT);
...
// Gate A3-U112A
pullup(g30132);
assign #GATE_DELAY g30132 = rst ? 1'bz : ((0|RPTFRC|g30129|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U112B
pullup(IIP_);
...
// Gate A3-U116B A3-U124B
pullup(SQEXT);
assign #GATE_DELAY SQEXT = rst ? 0 : ((0|g30119) ? 1'b0 : 1'bz);
// Gate A3-U124A
pullup(g30137);
assign #GATE_DELAY g30137 = rst ? 0 : ((0|CSQG|g30136) ? 1'b0 : 1'bz);
...
// Gate A3-U109A
pullup(SQR11);
assign #GATE_DELAY SQR11 = rst ? 0 : ((0|g30134|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U115B
pullup(g30103);
assign #GATE_DELAY g30103 = rst ? 1'bz : ((0|INHPLS|INHINT) ? 1'b0 : 1'bz);
// Gate A3-U114A
pullup(SQR12);
assign #GATE_DELAY SQR12 = rst ? 0 : ((0|CSQG|g30132) ? 1'b0 : 1'bz);
// Gate A3-U114B
pullup(INHINT);
...
// Gate A3-U104A
pullup(g30144);
assign #GATE_DELAY g30144 = rst ? 0 : ((0|g30134|g30132) ? 1'b0 : 1'bz);
...
// Gate A3-U117B A3-U118B
pullup(SQEXT_);
assign #GATE_DELAY SQEXT_ = rst ? 1'bz : ((0|g30120) ? 1'b0 : 1'bz);
// Gate A3-U101A
pullup(g30134);
assign #GATE_DELAY g30134 = rst ? 1'bz : ((0|SQR11|g30130|RPTFRC) ? 1'b0 : 1'bz);
// Gate A3-U101B
pullup(g30159);
...
// Gate A3-U209B A3-U207B
pullup(IC9_);
assign #GATE_DELAY IC9_ = rst ? 1'bz : ((0|LXCH0|QXCH0|IC5|TS0) ? 1'b0 : 1'bz);
// Gate A3-U207A
pullup(IC13);
assign #GATE_DELAY IC13 = rst ? 0 : ((0|IC13_) ? 1'b0 : 1'bz);
// Gate A3-U213A A3-U214A
pullup(DXCH0);
assign #GATE_DELAY DXCH0 = rst ? 0 : ((0|NEXST0_|QC1_|SQ5_) ? 1'b0 : 1'bz);
// Gate A3-U213B A3-U214B
pullup(DAS0);
assign #GATE_DELAY DAS0 = rst ? 0 : ((0|NEXST0_|SQ2_|QC0_) ? 1'b0 : 1'bz);
// Gate A3-U241A
pullup(NDXX1);
...
// Gate A3-U204A A3-U202A A3-U205A
pullup(NEXST0_);
