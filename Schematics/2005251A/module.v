...
initial $display("Gate delay (A3) will be %f ns.", GATE_DELAY*100);
...
// Gate A3-U117A
pullup(g30142);
assign #GATE_DELAY g30142 = rst ? 0 : ((0|g30134|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U218B
pullup(g30315);
...
// Gate A3-U154A
pullup(g30010);
assign #GATE_DELAY g30010 = rst ? 0 : ((0|g30006|WT_) ? 1'b0 : 1'bz);
// Gate A3-U151A A3-U150A
pullup(CSQG);
assign #GATE_DELAY CSQG = rst ? 1'bz : ((0|T12_|g30005|CT_) ? 1'b0 : 1'bz);
// Gate A3-U137A
pullup(g30013);
assign #GATE_DELAY g30013 = rst ? 0 : ((0|WL16_|WSQG_) ? 1'b0 : 1'bz);
// Gate A3-U104A
pullup(g30144);
assign #GATE_DELAY g30144 = rst ? 0 : ((0|g30132|g30134) ? 1'b0 : 1'bz);
// Gate A3-U101B
pullup(g30059);
assign #GATE_DELAY g30059 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U112B
pullup(IIP_);
assign #GATE_DELAY IIP_ = rst ? 1'bz : ((0|KRPT|IIP) ? 1'b0 : 1'bz);
// Gate A3-U103B
pullup(g30128);
assign #GATE_DELAY g30128 = rst ? 0 : ((0|g30121) ? 1'b0 : 1'bz);
// Gate A3-U129A
pullup(g30130);
assign #GATE_DELAY g30130 = rst ? 0 : ((0|WSQG_|WL11_) ? 1'b0 : 1'bz);
// Gate A3-U202B
pullup(IC5_);
...
pullup(QC3_);
assign #GATE_DELAY QC3_ = rst ? 1'bz : ((0|g30144) ? 1'b0 : 1'bz);
// Gate A3-U136A
pullup(g30016);
assign #GATE_DELAY g30016 = rst ? 1'bz : ((0|g30013|SQR16) ? 1'b0 : 1'bz);
// Gate A3-U132B
pullup(SCAS10);
...
// Gate A3-U241A
pullup(NDXX1);
assign #GATE_DELAY NDXX1 = rst ? 0 : ((0|SQEXT_|SQ5_|ST1_) ? 1'b0 : 1'bz);
// Gate A3-U230B
pullup(g30301);
assign #GATE_DELAY g30301 = rst ? 0 : ((0|SQ5_|QC0_) ? 1'b0 : 1'bz);
// Gate A3-U243A
pullup(NDX0);
assign #GATE_DELAY NDX0 = rst ? 0 : ((0|NEXST0_|SQ5_|QC0_) ? 1'b0 : 1'bz);
...
pullup(IC13_);
assign #GATE_DELAY IC13_ = rst ? 1'bz : ((0|IC11|IC6|IC7|DCS0|IC1|DCA0) ? 1'b0 : 1'bz);
// Gate A3-U123A
pullup(SQR10_);
assign #GATE_DELAY SQR10_ = rst ? 1'bz : ((0|g30137) ? 1'b0 : 1'bz);
// Gate A3-U126A
pullup(SQR10);
assign #GATE_DELAY SQR10 = rst ? 0 : ((0|g30136) ? 1'b0 : 1'bz);
// Gate A3-U109A
pullup(SQR11);
assign #GATE_DELAY SQR11 = rst ? 0 : ((0|CSQG|g30134) ? 1'b0 : 1'bz);
// Gate A3-U114A
pullup(SQR12);
assign #GATE_DELAY SQR12 = rst ? 0 : ((0|g30132|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U146A
pullup(SQR13);
assign #GATE_DELAY SQR13 = rst ? 0 : ((0|CSQG|g30128|g30020) ? 1'b0 : 1'bz);
// Gate A3-U140A
pullup(SQR14);
assign #GATE_DELAY SQR14 = rst ? 0 : ((0|g30018|g30128|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U135B
pullup(SQR16);
assign #GATE_DELAY SQR16 = rst ? 0 : ((0|g30128|g30016|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U111A A3-U111B A3-U109B
pullup(RPTSET);
assign #GATE_DELAY RPTSET = rst ? 0 : ((0|T12_|NISQL_|FUTEXT|OVNHRP|INHINT|IIP|PHS2_|MNHRPT|RUPTOR_) ? 1'b0 : 1'bz);
// Gate A3-U128A
pullup(g30131);
assign #GATE_DELAY g30131 = rst ? 0 : ((0|WSQG_|WL10_) ? 1'b0 : 1'bz);
// Gate A3-U159B
pullup(CON2);
...
// Gate A3-U147B
pullup(g30036);
assign #GATE_DELAY g30036 = rst ? 0 : ((0|g30020) ? 1'b0 : 1'bz);
// Gate A3-U142A A3-U141A
pullup(g30018);
assign #GATE_DELAY g30018 = rst ? 1'bz : ((0|SQR14|g30014) ? 1'b0 : 1'bz);
// Gate A3-U134A
pullup(g30060);
...
// Gate A3-U133A
pullup(g30023);
assign #GATE_DELAY g30023 = rst ? 0 : ((0|g30016|INKL) ? 1'b0 : 1'bz);
// Gate A3-U239B
pullup(GOJ1);
...
// Gate A3-U133B
pullup(g30031);
assign #GATE_DELAY g30031 = rst ? 1'bz : ((0|g30023) ? 1'b0 : 1'bz);
// Gate A3-U107B
pullup(SQR12_);
assign #GATE_DELAY SQR12_ = rst ? 1'bz : ((0|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U113A
pullup(MINHL);
...
// Gate A3-U212A
pullup(IC10_);
assign #GATE_DELAY IC10_ = rst ? 1'bz : ((0|DXCH0|DAS0|IC4) ? 1'b0 : 1'bz);
// Gate A3-U118B A3-U117B
pullup(SQEXT_);
assign #GATE_DELAY SQEXT_ = rst ? 1'bz : ((0|g30120) ? 1'b0 : 1'bz);
// Gate A3-U131A
pullup(g30024);
assign #GATE_DELAY g30024 = rst ? 0 : ((0|INKL|SQR16) ? 1'b0 : 1'bz);
// Gate A3-U204B
pullup(g30337);
...
// Gate A3-U240A
pullup(MP1);
assign #GATE_DELAY MP1 = rst ? 0 : ((0|ST1_|SQEXT_|SQ7_) ? 1'b0 : 1'bz);
// Gate A3-U210A
pullup(IC4_);
assign #GATE_DELAY IC4_ = rst ? 1'bz : ((0|DCA0|DCS0) ? 1'b0 : 1'bz);
// Gate A3-U131B
pullup(g30032);
...
// Gate A3-U225A
pullup(TCF0);
assign #GATE_DELAY TCF0 = rst ? 0 : ((0|QC0|SQ1_|NEXST0_) ? 1'b0 : 1'bz);
...
// Gate A3-U124A
pullup(g30137);
assign #GATE_DELAY g30137 = rst ? 0 : ((0|g30136|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U248A
pullup(DIM0_);
...
// Gate A3-U228A
pullup(TC0);
assign #GATE_DELAY TC0 = rst ? 0 : ((0|SQ0_|NEXST0_) ? 1'b0 : 1'bz);
...
// Gate A3-U110A
pullup(g30121);
assign #GATE_DELAY g30121 = rst ? 1'bz : ((0|RPTSET|g30122) ? 1'b0 : 1'bz);
// Gate A3-U240B
pullup(GOJ1_);
assign #GATE_DELAY GOJ1_ = rst ? 1'bz : ((0|GOJ1) ? 1'b0 : 1'bz);
// Gate A3-U251A
pullup(MSU0);
assign #GATE_DELAY MSU0 = rst ? 0 : ((0|SQ2_|QC0_|EXST0_) ? 1'b0 : 1'bz);
// Gate A3-U214B A3-U213B
pullup(DAS0);
assign #GATE_DELAY DAS0 = rst ? 0 : ((0|QC0_|SQ2_|NEXST0_) ? 1'b0 : 1'bz);
// Gate A3-U101A
pullup(g30134);
assign #GATE_DELAY g30134 = rst ? 1'bz : ((0|g30128|g30130|SQR11) ? 1'b0 : 1'bz);
// Gate A3-U218A
pullup(TS0);
assign #GATE_DELAY TS0 = rst ? 0 : ((0|SQ5_|QC2_|NEXST0_) ? 1'b0 : 1'bz);
// Gate A3-U136B
pullup(g30040);
...
pullup(gNNNNN);
assign #GATE_DELAY gNNNNN = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U125B
pullup(FUTEXT);
...
// Gate A3-U256A
pullup(g30407);
assign #GATE_DELAY g30407 = rst ? 0 : ((0|BR2_|BZF0_) ? 1'b0 : 1'bz);
// Gate A3-U211B
pullup(QXCH0);
assign #GATE_DELAY QXCH0 = rst ? 0 : ((0|QC1_|SQ2_|EXST0_) ? 1'b0 : 1'bz);
// Gate A3-U221B
pullup(g30314);
assign #GATE_DELAY g30314 = rst ? 0 : ((0|ST1_|SQEXT_) ? 1'b0 : 1'bz);
// Gate A3-U217A
pullup(DCA0);
assign #GATE_DELAY DCA0 = rst ? 0 : ((0|SQ3_|EXST0_) ? 1'b0 : 1'bz);
// Gate A3-U156A
pullup(g30006);
...
pullup(DXCH0);
assign #GATE_DELAY DXCH0 = rst ? 0 : ((0|NEXST0_|QC1_|SQ5_) ? 1'b0 : 1'bz);
// Gate A3-U115B
pullup(g30103);
assign #GATE_DELAY g30103 = rst ? 1'bz : ((0|INHPLS|INHINT) ? 1'b0 : 1'bz);
// Gate A3-U132A
pullup(MSQ16);
assign #GATE_DELAY MSQ16 = rst ? 0 : ((0|g30016) ? 1'b0 : 1'bz);
// Gate A3-U249A
pullup(DIM0);
assign #GATE_DELAY DIM0 = rst ? 0 : ((0|SQ2_|EXST0_|QC3_) ? 1'b0 : 1'bz);
// Gate A3-U144A
pullup(MSQ14);
assign #GATE_DELAY MSQ14 = rst ? 0 : ((0|g30018) ? 1'b0 : 1'bz);
// Gate A3-U144B
pullup(MSQ13);
assign #GATE_DELAY MSQ13 = rst ? 0 : ((0|g30020) ? 1'b0 : 1'bz);
// Gate A3-U108B
pullup(MSQ12);
assign #GATE_DELAY MSQ12 = rst ? 0 : ((0|g30132) ? 1'b0 : 1'bz);
// Gate A3-U108A
pullup(MSQ11);
assign #GATE_DELAY MSQ11 = rst ? 0 : ((0|g30134) ? 1'b0 : 1'bz);
// Gate A3-U127A
pullup(MSQ10);
assign #GATE_DELAY MSQ10 = rst ? 0 : ((0|g30136) ? 1'b0 : 1'bz);
// Gate A3-U238A
pullup(TCSAJ3);
assign #GATE_DELAY TCSAJ3 = rst ? 0 : ((0|SQ0_|SQEXT|ST3_) ? 1'b0 : 1'bz);
// Gate A3-U250B
pullup(AUG0);
...
// Gate A3-U158A
pullup(g30003);
assign #GATE_DELAY g30003 = rst ? 0 : ((0|g30001|g30128|T12_) ? 1'b0 : 1'bz);
// Gate A3-U232A
pullup(MASK0_);
...
// Gate A3-U203A
pullup(NEXST0);
assign #GATE_DELAY NEXST0 = rst ? 0 : ((0|ST0_|SQEXT) ? 1'b0 : 1'bz);
// Gate A3-U130A
pullup(g30129);
assign #GATE_DELAY g30129 = rst ? 0 : ((0|WSQG_|WL12_) ? 1'b0 : 1'bz);
// Gate A3-U208B
pullup(IC8_);
...
// Gate A3-U231A
pullup(MASK0);
assign #GATE_DELAY MASK0 = rst ? 0 : ((0|NEXST0_|SQ7_) ? 1'b0 : 1'bz);
// Gate A3-U107A
pullup(g30143);
assign #GATE_DELAY g30143 = rst ? 0 : ((0|SQR11|g30132) ? 1'b0 : 1'bz);
// Gate A3-U129B
pullup(STRTFC);
...
// Gate A3-U253A
pullup(CCS0);
assign #GATE_DELAY CCS0 = rst ? 0 : ((0|SQ1_|NEXST0_|QC0_) ? 1'b0 : 1'bz);
// Gate A3-U138A
pullup(g30014);
assign #GATE_DELAY g30014 = rst ? 0 : ((0|WL14_|WSQG_) ? 1'b0 : 1'bz);
// Gate A3-U112A
pullup(g30132);
assign #GATE_DELAY g30132 = rst ? 1'bz : ((0|SQR12|g30129|g30128) ? 1'b0 : 1'bz);
// Gate A3-U258A
pullup(IC17);
assign #GATE_DELAY IC17 = rst ? 0 : ((0|IC16|IC15_) ? 1'b0 : 1'bz);
// Gate A3-U160B
pullup(g30002);
...
// Gate A3-U223A
pullup(IC11);
assign #GATE_DELAY IC11 = rst ? 0 : ((0|ST0_|g30360|SQ6_) ? 1'b0 : 1'bz);
// Gate A3-U211A
pullup(IC10);
...
// Gate A3-U143A
pullup(g30015);
assign #GATE_DELAY g30015 = rst ? 0 : ((0|WL13_|WSQG_) ? 1'b0 : 1'bz);
// Gate A3-U127B
pullup(MSQEXT);
assign #GATE_DELAY MSQEXT = rst ? 0 : ((0|g30119) ? 1'b0 : 1'bz);
// Gate A3-U215A
pullup(DCS0);
assign #GATE_DELAY DCS0 = rst ? 0 : ((0|SQ4_|EXST0_) ? 1'b0 : 1'bz);
// Gate A3-U143B
pullup(g30042);
...
// Gate A3-U155A
pullup(RBSQ);
assign #GATE_DELAY RBSQ = rst ? 0 : ((0|g30006|RT_) ? 1'b0 : 1'bz);
// Gate A3-U152B
pullup(g30047);
...
// Gate A3-U157B
pullup(g30044);
assign #GATE_DELAY g30044 = rst ? 0 : ((0|g30018|g30031|g30020) ? 1'b0 : 1'bz);
...
// Gate A3-U206A
pullup(g30335);
assign #GATE_DELAY g30335 = rst ? 0 : ((0|QC1_|ST1_) ? 1'b0 : 1'bz);
// Gate A3-U151B
pullup(g30038);
...
// Gate A3-U125A
pullup(g30136);
assign #GATE_DELAY g30136 = rst ? 1'bz : ((0|g30137|g30131|g30128) ? 1'b0 : 1'bz);
// Gate A3-U110B
pullup(IIP);
assign #GATE_DELAY IIP = rst ? 0 : ((0|d5XP4|GOJAM|IIP_) ? 1'b0 : 1'bz);
// Gate A3-U226A
pullup(IC3_);
assign #GATE_DELAY IC3_ = rst ? 1'bz : ((0|TC0|STD2|TCF0) ? 1'b0 : 1'bz);
// Gate A3-U250A
pullup(INCR0);
assign #GATE_DELAY INCR0 = rst ? 0 : ((0|SQ2_|NEXST0_|QC2_) ? 1'b0 : 1'bz);
// Gate A3-U155B
pullup(g30041);
assign #GATE_DELAY g30041 = rst ? 0 : ((0|g30032|g30018|g30020) ? 1'b0 : 1'bz);
// Gate A3-U245A A3-U245B
pullup(DAS1_);
assign #GATE_DELAY DAS1_ = rst ? 1'bz : ((0|g30418|ADS0) ? 1'b0 : 1'bz);
// Gate A3-U225B
pullup(g30360);
assign #GATE_DELAY g30360 = rst ? 0 : ((0|QC0|SQEXT_) ? 1'b0 : 1'bz);
// Gate A3-U247B A3-U246A
pullup(g30418);
assign #GATE_DELAY g30418 = rst ? 0 : ((0|SQ2_|QC0_|ST1_|SQEXT) ? 1'b0 : 1'bz);
// Gate A3-U206B
pullup(IC9);
assign #GATE_DELAY IC9 = rst ? 0 : ((0|IC9_) ? 1'b0 : 1'bz);
// Gate A3-U158B
pullup(SQ7_);
assign #GATE_DELAY SQ7_ = rst ? 1'bz : ((0|g30044) ? 1'b0 : 1'bz);
...
// Gate A3-U227B
pullup(g30304);
assign #GATE_DELAY g30304 = rst ? 1'bz : ((0|g30301|g30302) ? 1'b0 : 1'bz);
// Gate A3-U215B
pullup(IC7);
...
// Gate A3-U257A
pullup(IC15_);
assign #GATE_DELAY IC15_ = rst ? 1'bz : ((0|BMF0|BZF0) ? 1'b0 : 1'bz);
// Gate A3-U134B
pullup(g30043);
...
// Gate A3-U157A
pullup(g30005);
assign #GATE_DELAY g30005 = rst ? 0 : ((0|g30003|STRTFC) ? 1'b0 : 1'bz);
// Gate A3-U160A
pullup(g30001);
assign #GATE_DELAY g30001 = rst ? 1'bz : ((0|g30002|NISQ) ? 1'b0 : 1'bz);
// Gate A3-U146B
pullup(g30037);
...
pullup(QC0);
assign #GATE_DELAY QC0 = rst ? 1'bz : ((0|SQR11|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U258B
pullup(IC16);
...
pullup(g30020);
assign #GATE_DELAY g30020 = rst ? 1'bz : ((0|g30015|SQR13) ? 1'b0 : 1'bz);
// Gate A3-U120A A3-U119A A3-U118A
pullup(QC0_);
assign #GATE_DELAY QC0_ = rst ? 0 : ((0|QC0) ? 1'b0 : 1'bz);
// Gate A3-U227A
pullup(TC0_);
