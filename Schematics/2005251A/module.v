...
// Gate A3-U101A
pullup(g30134);
assign #GATE_DELAY g30134 = rst ? 1'bz : ((0|SQR11|g30130|g30128) ? 1'b0 : 1'bz);
// Gate A3-U218A
pullup(TS0);
...
// Gate A3-U112A
pullup(g30132);
assign #GATE_DELAY g30132 = rst ? 1'bz : ((0|g30128|g30129|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U258A
pullup(IC17);
...
// Gate A3-U125A
pullup(g30136);
assign #GATE_DELAY g30136 = rst ? 1'bz : ((0|g30128|g30131|g30137) ? 1'b0 : 1'bz);
// Gate A3-U110B
pullup(IIP);
