...
// Gate A3-U104B
pullup(RPTFRC);
assign #GATE_DELAY RPTFRC = rst ? 1'bz : ((0|g30121) ? 1'b0 : 1'bz);
// Gate A3-U154A
pullup(g30010);
...
// Gate A3-U112B
pullup(IIP_);
assign #GATE_DELAY IIP_ = rst ? 0 : ((0|KRPT|IIP) ? 1'b0 : 1'bz);
// Gate A3-U103B
pullup(g30128);
assign #GATE_DELAY g30128 = rst ? 1'bz : ((0|g30121) ? 1'b0 : 1'bz);
// Gate A3-U129A
pullup(g30130);
...
// Gate A3-U136A
pullup(g30016);
assign #GATE_DELAY g30016 = rst ? 1'bz : ((0|SQR16|g30013) ? 1'b0 : 1'bz);
// Gate A3-U132B
pullup(SCAS10);
...
// Gate A3-U146A
pullup(SQR13);
assign #GATE_DELAY SQR13 = rst ? 0 : ((0|g30020|g30128|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U140A
pullup(SQR14);
assign #GATE_DELAY SQR14 = rst ? 0 : ((0|CSQG|g30128|g30018) ? 1'b0 : 1'bz);
// Gate A3-U135B
pullup(SQR16);
assign #GATE_DELAY SQR16 = rst ? 0 : ((0|g30128|g30016|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U111A A3-U111B A3-U109B
pullup(RPTSET);
assign #GATE_DELAY RPTSET = rst ? 0 : ((0|FUTEXT|NISQL_|T12_|OVNHRP|INHINT|IIP|PHS2_|MNHRPT|RUPTOR_) ? 1'b0 : 1'bz);
// Gate A3-U128A
pullup(g30131);
...
pullup(g30018);
assign #GATE_DELAY g30018 = rst ? 1'bz : ((0|g30014|SQR14) ? 1'b0 : 1'bz);
// Gate A3-U134A
pullup(g30060);
...
// Gate A3-U133A
pullup(g30023);
assign #GATE_DELAY g30023 = rst ? 0 : ((0|INKL|g30016) ? 1'b0 : 1'bz);
// Gate A3-U239B
pullup(GOJ1);
...
// Gate A3-U113A
pullup(MINHL);
assign #GATE_DELAY MINHL = rst ? 1'bz : ((0|g30103) ? 1'b0 : 1'bz);
// Gate A3-U121B
pullup(g30119);
assign #GATE_DELAY g30119 = rst ? 0 : ((0|RPTFRC|g30120|g30114) ? 1'b0 : 1'bz);
// Gate A3-U212A
pullup(IC10_);
assign #GATE_DELAY IC10_ = rst ? 1'bz : ((0|IC4|DAS0|DXCH0) ? 1'b0 : 1'bz);
// Gate A3-U118B A3-U117B
pullup(SQEXT_);
assign #GATE_DELAY SQEXT_ = rst ? 0 : ((0|g30120) ? 1'b0 : 1'bz);
// Gate A3-U131A
pullup(g30024);
...
// Gate A3-U130B
pullup(g30101);
assign #GATE_DELAY g30101 = rst ? 1'bz : ((0|GOJAM|MTCSAI) ? 1'b0 : 1'bz);
// Gate A3-U240A
pullup(MP1);
...
// Gate A3-U113B
pullup(MIIP);
assign #GATE_DELAY MIIP = rst ? 1'bz : ((0|IIP_) ? 1'b0 : 1'bz);
// Gate A3-U225A
pullup(TCF0);
...
// Gate A3-U119B
pullup(g30115);
assign #GATE_DELAY g30115 = rst ? 0 : ((0|FUTEXT|g30113) ? 1'b0 : 1'bz);
// Gate A3-U128B
pullup(g30113);
assign #GATE_DELAY g30113 = rst ? 1'bz : ((0|STRTFC|g30108) ? 1'b0 : 1'bz);
// Gate A3-U156B
pullup(SQ3_);
...
pullup(SQEXT);
assign #GATE_DELAY SQEXT = rst ? 1'bz : ((0|g30119) ? 1'b0 : 1'bz);
// Gate A3-U241B
pullup(MP1_);
assign #GATE_DELAY MP1_ = rst ? 1'bz : ((0|MP1) ? 1'b0 : 1'bz);
// Gate A3-U110A
pullup(g30121);
assign #GATE_DELAY g30121 = rst ? 0 : ((0|g30122|RPTSET) ? 1'b0 : 1'bz);
// Gate A3-U240B
pullup(GOJ1_);
...
// Gate A3-U101A
pullup(g30134);
assign #GATE_DELAY g30134 = rst ? 0 : ((0|SQR11|g30130|g30128) ? 1'b0 : 1'bz);
// Gate A3-U218A
pullup(TS0);
...
// Gate A3-U115B
pullup(g30103);
assign #GATE_DELAY g30103 = rst ? 0 : ((0|INHPLS|INHINT) ? 1'b0 : 1'bz);
// Gate A3-U132A
pullup(MSQ16);
...
// Gate A3-U158A
pullup(g30003);
assign #GATE_DELAY g30003 = rst ? 0 : ((0|T12_|g30128|g30001) ? 1'b0 : 1'bz);
// Gate A3-U232A
pullup(MASK0_);
...
// Gate A3-U105B
pullup(g30122);
assign #GATE_DELAY g30122 = rst ? 1'bz : ((0|T02|g30121|STRTFC) ? 1'b0 : 1'bz);
// Gate A3-U203A
pullup(NEXST0);
...
// Gate A3-U114B
pullup(INHINT);
assign #GATE_DELAY INHINT = rst ? 1'bz : ((0|RELPLS|g30103|GOJAM) ? 1'b0 : 1'bz);
// Gate A3-U231A
pullup(MASK0);
...
// Gate A3-U129B
pullup(STRTFC);
assign #GATE_DELAY STRTFC = rst ? 0 : ((0|g30101) ? 1'b0 : 1'bz);
// Gate A3-U120B
pullup(g30120);
assign #GATE_DELAY g30120 = rst ? 1'bz : ((0|g30119|g30115) ? 1'b0 : 1'bz);
// Gate A3-U253A
pullup(CCS0);
...
// Gate A3-U112A
pullup(g30132);
assign #GATE_DELAY g30132 = rst ? 0 : ((0|g30128|g30129|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U258A
pullup(IC17);
...
// Gate A3-U127B
pullup(MSQEXT);
assign #GATE_DELAY MSQEXT = rst ? 1'bz : ((0|g30119) ? 1'b0 : 1'bz);
// Gate A3-U215A
pullup(DCS0);
...
// Gate A3-U125A
pullup(g30136);
assign #GATE_DELAY g30136 = rst ? 0 : ((0|g30128|g30131|g30137) ? 1'b0 : 1'bz);
// Gate A3-U110B
pullup(IIP);
assign #GATE_DELAY IIP = rst ? 1'bz : ((0|d5XP4|GOJAM|IIP_) ? 1'b0 : 1'bz);
// Gate A3-U226A
pullup(IC3_);
...
// Gate A3-U225B
pullup(g30360);
assign #GATE_DELAY g30360 = rst ? 1'bz : ((0|QC0|SQEXT_) ? 1'b0 : 1'bz);
...
// Gate A3-U157A
pullup(g30005);
assign #GATE_DELAY g30005 = rst ? 1'bz : ((0|STRTFC|g30003) ? 1'b0 : 1'bz);
// Gate A3-U160A
pullup(g30001);
...
pullup(g30020);
assign #GATE_DELAY g30020 = rst ? 1'bz : ((0|SQR13|g30015) ? 1'b0 : 1'bz);
