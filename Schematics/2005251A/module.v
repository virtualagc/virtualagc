...
// Gate A3-U117A
pullup(g30142);
assign #0.2  g30142 = rst ? 1'bz : ((0|g30134|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U218B
pullup(g30315);
assign #0.2  g30315 = rst ? 1'bz : ((0|g30314|NEXST0) ? 1'b0 : 1'bz);
// Gate A3-U104B
pullup(RPTFRC);
...
// Gate A3-U104A
pullup(g30144);
assign #0.2  g30144 = rst ? 0 : ((0|g30132|g30134) ? 1'b0 : 1'bz);
// Gate A3-U101B
pullup(g30059);
assign #0.2  g30059 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U112B
pullup(IIP_);
...
pullup(QC3_);
assign #0.2  QC3_ = rst ? 1'bz : ((0|g30144) ? 1'b0 : 1'bz);
// Gate A3-U136A
pullup(g30016);
assign #0.2  g30016 = rst ? 1'bz : ((0|g30013|SQR16) ? 1'b0 : 1'bz);
// Gate A3-U132B
pullup(SCAS10);
assign #0.2  SCAS10 = rst ? 1'bz : ((0|FS10|CON2) ? 1'b0 : 1'bz);
// Gate A3-U216A
pullup(g30334);
assign #0.2  g30334 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U241A
pullup(NDXX1);
...
pullup(IC13_);
assign #0.2  IC13_ = rst ? 1'bz : ((0|IC11|IC6|IC7|DCS0|IC1|DCA0) ? 1'b0 : 1'bz);
// Gate A3-U123A
pullup(SQR10_);
...
// Gate A3-U114A
pullup(SQR12);
assign #0.2  SQR12 = rst ? 0 : ((0|g30132|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U146A
pullup(SQR13);
assign #0.2  SQR13 = rst ? 1'bz : ((0|CSQG|g30128|g30020) ? 1'b0 : 1'bz);
// Gate A3-U140A
pullup(SQR14);
assign #0.2  SQR14 = rst ? 1'bz : ((0|g30018|g30128|CSQG) ? 1'b0 : 1'bz);
// Gate A3-U135B
pullup(SQR16);
assign #0.2  SQR16 = rst ? 0 : ((0|g30128|g30016|CSQG) ? 1'b0 : 1'bz);
...
// Gate A3-U147B
pullup(g30036);
assign #0.2  g30036 = rst ? 1'bz : ((0|g30020) ? 1'b0 : 1'bz);
// Gate A3-U142A A3-U141A
pullup(g30018);
assign #0.2  g30018 = rst ? 0 : ((0|SQR14|g30014) ? 1'b0 : 1'bz);
// Gate A3-U134A
pullup(g30060);
assign #0.2  g30060 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U244A
pullup(DAS1);
assign #0.2  DAS1 = rst ? 0 : ((0|DAS1_) ? 1'b0 : 1'bz);
// Gate A3-U133A
pullup(g30023);
assign #0.2  g30023 = rst ? 0 : ((0|g30016|INKL) ? 1'b0 : 1'bz);
// Gate A3-U239B
pullup(GOJ1);
...
// Gate A3-U133B
pullup(g30031);
assign #0.2  g30031 = rst ? 1'bz : ((0|g30023) ? 1'b0 : 1'bz);
// Gate A3-U107B
pullup(SQR12_);
assign #0.2  SQR12_ = rst ? 1'bz : ((0|SQR12) ? 1'b0 : 1'bz);
// Gate A3-U113A
pullup(MINHL);
...
// Gate A3-U204B
pullup(g30337);
assign #0.2  g30337 = rst ? 1'bz : ((0|g30335|g30336) ? 1'b0 : 1'bz);
// Gate A3-U130B
pullup(g30101);
...
pullup(gNNNNN);
assign #0.2  gNNNNN = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U125B
pullup(FUTEXT);
...
// Gate A3-U243B
pullup(AD0);
assign #0.2  AD0 = rst ? 0 : ((0|NEXST0_|SQ6_) ? 1'b0 : 1'bz);
// Gate A3-U249B
pullup(AUG0_);
...
// Gate A3-U132A
pullup(MSQ16);
assign #0.2  MSQ16 = rst ? 0 : ((0|g30016) ? 1'b0 : 1'bz);
// Gate A3-U249A
pullup(DIM0);
...
// Gate A3-U144B
pullup(MSQ13);
assign #0.2  MSQ13 = rst ? 1'bz : ((0|g30020) ? 1'b0 : 1'bz);
// Gate A3-U108B
pullup(MSQ12);
assign #0.2  MSQ12 = rst ? 0 : ((0|g30132) ? 1'b0 : 1'bz);
// Gate A3-U108A
pullup(MSQ11);
...
// Gate A3-U203A
pullup(NEXST0);
assign #0.2  NEXST0 = rst ? 0 : ((0|ST0_|SQEXT) ? 1'b0 : 1'bz);
// Gate A3-U130A
pullup(g30129);
...
// Gate A3-U112A
pullup(g30132);
assign #0.2  g30132 = rst ? 1'bz : ((0|SQR12|g30129|g30128) ? 1'b0 : 1'bz);
// Gate A3-U258A
pullup(IC17);
...
// Gate A3-U207A
pullup(IC13);
assign #0.2  IC13 = rst ? 0 : ((0|IC13_) ? 1'b0 : 1'bz);
// Gate A3-U252A
pullup(IC12);
assign #0.2  IC12 = rst ? 0 : ((0|IC12_) ? 1'b0 : 1'bz);
// Gate A3-U223A
pullup(IC11);
assign #0.2  IC11 = rst ? 0 : ((0|ST0_|g30360|SQ6_) ? 1'b0 : 1'bz);
// Gate A3-U211A
pullup(IC10);
...
// Gate A3-U152B
pullup(g30047);
assign #0.2  g30047 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A3-U122B
pullup(g30114);
...
// Gate A3-U205B
pullup(g30336);
assign #0.2  g30336 = rst ? 0 : ((0|ST0_|QC3_) ? 1'b0 : 1'bz);
// Gate A3-U210B
pullup(QXCH0_);
assign #0.2  QXCH0_ = rst ? 1'bz : ((0|QXCH0) ? 1'b0 : 1'bz);
// Gate A3-U205A A3-U204A A3-U202A
pullup(NEXST0_);
assign #0.2  NEXST0_ = rst ? 1'bz : ((0|NEXST0) ? 1'b0 : 1'bz);
// Gate A3-U206A
pullup(g30335);
...
// Gate A3-U142B
pullup(INKBT1);
assign #0.2  INKBT1 = rst ? 0 : ((0|INKL|T01_) ? 1'b0 : 1'bz);
...
pullup(QC1_);
assign #0.2  QC1_ = rst ? 0 : ((0|g30142) ? 1'b0 : 1'bz);
...
// Gate A3-U134B
pullup(g30043);
assign #0.2  g30043 = rst ? 0 : ((0|g30036|g30018|g30031) ? 1'b0 : 1'bz);
// Gate A3-U239A
pullup(TCSAJ3_);
...
// Gate A3-U135A
pullup(SQ6_);
assign #0.2  SQ6_ = rst ? 1'bz : ((0|g30043) ? 1'b0 : 1'bz);
// Gate A3-U222B
pullup(IC2_);
assign #0.2  IC2_ = rst ? 1'bz : ((0|IC2) ? 1'b0 : 1'bz);
// Gate A3-U147A A3-U145A
pullup(g30020);
assign #0.2  g30020 = rst ? 0 : ((0|g30015|SQR13) ? 1'b0 : 1'bz);
