...
// Gate A17-U132A A17-U132B A17-U131A
pullup(RCH30_);
...
// Gate A17-U136A A17-U133A A17-U133B
pullup(RCH31_);
...
// Gate A17-U121A
pullup(g44254);
assign #GATE_DELAY g44254 = rst ? 0 : ((0|g44255|TRP32|GOJAM) ? 1'b0 : 1'bz);
// Gate A17-U121B
pullup(g44219);
...
// Gate A17-U105A A17-U107A A17-U107B A17-U106B
pullup(g44248);
assign #GATE_DELAY g44248 = rst ? 1'bz : ((0|MNIMpR|TRST9|MNIMmR|PCHGOF|ROLGOF|TRST10|MNIMpP|MNIMpY|MNIMmY|MNIMmP) ? 1'b0 : 1'bz);
// Gate A17-U106A
pullup(CH3206);
...
// Gate A17-U123A
pullup(g44252);
assign #GATE_DELAY g44252 = rst ? 0 : ((0|g44248|g44251|F05D) ? 1'b0 : 1'bz);
// Gate A17-U123B
pullup(g44205);
...
// Gate A17-U146B A17-U145A A17-U145B
pullup(RCH33_);
...
// Gate A17-U124B
pullup(g44250);
assign #GATE_DELAY g44250 = rst ? 0 : ((0|g44255|g44248|F05A_) ? 1'b0 : 1'bz);
// Gate A17-U118A
pullup(g44255);
assign #GATE_DELAY g44255 = rst ? 1'bz : ((0|g44256|g44254) ? 1'b0 : 1'bz);
// Gate A17-U118B
pullup(g44256);
assign #GATE_DELAY g44256 = rst ? 0 : ((0|WCH13_|CHWL14_) ? 1'b0 : 1'bz);
// Gate A17-U130A
pullup(g44212);
assign #GATE_DELAY g44212 = rst ? 0 : ((0|TRP31A|GOJAM|g44213) ? 1'b0 : 1'bz);
// Gate A17-U130B
pullup(g44213);
...
// Gate A17-U255A A17-U253B A17-U254A
pullup(WCH11_);
...
// Gate A17-U257A A17-U256A A17-U256B
pullup(CCH11);
...
// Gate A17-U252A A17-U251A A17-U253A
pullup(RCH10_);
...
// Gate A17-U201A
pullup(g44357);
assign #GATE_DELAY g44357 = rst ? 0 : ((0|CCH10|g44356) ? 1'b0 : 1'bz);
// Gate A17-U201B
pullup(g44355);
...
// Gate A17-U213A
pullup(g44333);
assign #GATE_DELAY g44333 = rst ? 0 : ((0|CCH10|g44332) ? 1'b0 : 1'bz);
// Gate A17-U213B
pullup(g44332);
assign #GATE_DELAY g44332 = rst ? 1'bz : ((0|g44333|g44331) ? 1'b0 : 1'bz);
// Gate A17-U205A
pullup(g44351);
assign #GATE_DELAY g44351 = rst ? 0 : ((0|CCH10|g44350) ? 1'b0 : 1'bz);
// Gate A17-U205B
pullup(g44350);
assign #GATE_DELAY g44350 = rst ? 1'bz : ((0|g44349|g44351) ? 1'b0 : 1'bz);
// Gate A17-U207A
pullup(g44345);
assign #GATE_DELAY g44345 = rst ? 0 : ((0|CCH10|g44344) ? 1'b0 : 1'bz);
// Gate A17-U207B
pullup(g44344);
...
// Gate A17-U230A
pullup(g44302);
assign #GATE_DELAY g44302 = rst ? 1'bz : ((0|g44303|g44301) ? 1'b0 : 1'bz);
// Gate A17-U230B
pullup(g44301);
...
// Gate A17-U225A
pullup(g44309);
assign #GATE_DELAY g44309 = rst ? 0 : ((0|CCH10|g44308) ? 1'b0 : 1'bz);
// Gate A17-U225B
pullup(g44308);
assign #GATE_DELAY g44308 = rst ? 1'bz : ((0|g44309|g44307) ? 1'b0 : 1'bz);
// Gate A17-U229A
pullup(g44303);
assign #GATE_DELAY g44303 = rst ? 0 : ((0|CCH10|g44302) ? 1'b0 : 1'bz);
// Gate A17-U229B
pullup(RLYB01);
...
// Gate A17-U219A
pullup(g44321);
assign #GATE_DELAY g44321 = rst ? 0 : ((0|CCH10|g44320) ? 1'b0 : 1'bz);
// Gate A17-U219B
pullup(g44320);
assign #GATE_DELAY g44320 = rst ? 1'bz : ((0|g44321|g44319) ? 1'b0 : 1'bz);
// Gate A17-U223A
pullup(g44315);
assign #GATE_DELAY g44315 = rst ? 0 : ((0|CCH10|g44314) ? 1'b0 : 1'bz);
// Gate A17-U223B
pullup(g44314);
...
// Gate A17-U217A
pullup(g44327);
assign #GATE_DELAY g44327 = rst ? 0 : ((0|CCH10|g44326) ? 1'b0 : 1'bz);
// Gate A17-U217B
pullup(g44326);
...
// Gate A17-U241A
pullup(g44421);
assign #GATE_DELAY g44421 = rst ? 0 : ((0|CCH10|g44420) ? 1'b0 : 1'bz);
// Gate A17-U241B
pullup(g44420);
assign #GATE_DELAY g44420 = rst ? 1'bz : ((0|g44419|g44421) ? 1'b0 : 1'bz);
// Gate A17-U238A
pullup(g44415);
assign #GATE_DELAY g44415 = rst ? 0 : ((0|CCH10|g44414) ? 1'b0 : 1'bz);
// Gate A17-U238B
pullup(g44414);
assign #GATE_DELAY g44414 = rst ? 1'bz : ((0|g44413|g44415) ? 1'b0 : 1'bz);
// Gate A17-U244A
pullup(g44427);
assign #GATE_DELAY g44427 = rst ? 0 : ((0|CCH10|g44426) ? 1'b0 : 1'bz);
// Gate A17-U244B
pullup(g44426);
assign #GATE_DELAY g44426 = rst ? 1'bz : ((0|g44425|g44427) ? 1'b0 : 1'bz);
// Gate A17-U235A
pullup(g44409);
assign #GATE_DELAY g44409 = rst ? 0 : ((0|CCH10|g44408) ? 1'b0 : 1'bz);
// Gate A17-U235B
pullup(g44408);
assign #GATE_DELAY g44408 = rst ? 1'bz : ((0|g44407|g44409) ? 1'b0 : 1'bz);
// Gate A17-U232A
pullup(g44403);
assign #GATE_DELAY g44403 = rst ? 0 : ((0|g44402|CCH10) ? 1'b0 : 1'bz);
// Gate A17-U232B
pullup(g44402);
