...
// Gate A11-U223A
pullup(g54430);
assign #GATE_DELAY g54430 = rst ? 1'bz : ((0|g54429|g54431) ? 1'b0 : 1'bz);
// Gate A11-U223B
pullup(G15);
...
// Gate A11-U224A
pullup(g54431);
assign #GATE_DELAY g54431 = rst ? 0 : ((0|CQG|g54430) ? 1'b0 : 1'bz);
// Gate A11-U224B
pullup(g54445);
...
// Gate A11-U258A
pullup(g54336);
assign #GATE_DELAY g54336 = rst ? 0 : ((0|Z16_|CZG) ? 1'b0 : 1'bz);
// Gate A11-U259A
pullup(Z16_);
assign #GATE_DELAY Z16_ = rst ? 1'bz : ((0|g54336|g54334) ? 1'b0 : 1'bz);
// Gate A11-U256A
pullup(g54337);
