...
initial $display("Gate delay (A11) will be %f ns.", GATE_DELAY);

// Gate A11-U156A
pullup(SUMA04_);
assign #GATE_DELAY SUMA04_ = rst ? 1'bz : ((0|WHOMP) ? 1'b0 : 1'bz);
// Gate A11-U156B A11-U144A A11-U113B A11-U134A
pullup(RL13_);
assign #GATE_DELAY RL13_ = rst ? 1'bz : ((0|g54117|g54122|CH13|g54151|g54141|g54142|MDT13|R1C|g54132|g54137|g54128) ? 1'b0 : 1'bz);
// Gate A11-U144B
pullup(g54117);
...
// Gate A11-U133B A11-U132B A11-U131B
pullup(WL13_);
...
// Gate A11-U110B A11-U109B
pullup(G14_);
assign #GATE_DELAY G14_ = rst ? 0 : ((0|g54244|g54243|SA14|g54246|g54245|G14) ? 1'b0 : 1'bz);
// Gate A11-U115A
pullup(g54242);
assign #GATE_DELAY g54242 = rst ? 0 : ((0|RCG_|g54240) ? 1'b0 : 1'bz);
// Gate A11-U115B
pullup(SUMB14_);
assign #GATE_DELAY SUMB14_ = rst ? 1'bz : ((0|g54213|g54211) ? 1'b0 : 1'bz);
// Gate A11-U116A
pullup(g54241);
...
// Gate A11-U143A A11-U112A
pullup(WHOMP);
assign #GATE_DELAY WHOMP = rst ? 0 : ((0|GOJAM|NISQ|DVXP1|WHOMP_) ? 1'b0 : 1'bz);
// Gate A11-U143B A11-U114A A11-U104A A11-U125A
pullup(RL14_);
assign #GATE_DELAY RL14_ = rst ? 1'bz : ((0|MDT14|R1C|g54251|g54242|g54241|g54228|g54232|g54237|g54217|g54222|CH14) ? 1'b0 : 1'bz);
// Gate A11-U114B
pullup(g54217);
...
// Gate A11-U118A
pullup(g54239);
assign #GATE_DELAY g54239 = rst ? 0 : ((0|g54240|g54238) ? 1'b0 : 1'bz);
// Gate A11-U118B
pullup(g54213);
assign #GATE_DELAY g54213 = rst ? 0 : ((0|g54209|XUY14_) ? 1'b0 : 1'bz);
// Gate A11-U103A
pullup(g54236);
assign #GATE_DELAY g54236 = rst ? 1'bz : ((0|CZG|Z14_) ? 1'b0 : 1'bz);
// Gate A11-U117A
pullup(g54240);
assign #GATE_DELAY g54240 = rst ? 1'bz : ((0|g54239|CBG) ? 1'b0 : 1'bz);
// Gate A11-U117B
pullup(g54211);
assign #GATE_DELAY g54211 = rst ? 0 : ((0|CI14_) ? 1'b0 : 1'bz);
// Gate A11-U119A
pullup(g54238);
...
// Gate A11-U107A
pullup(g54231);
assign #GATE_DELAY g54231 = rst ? 0 : ((0|g54230|CQG) ? 1'b0 : 1'bz);
// Gate A11-U107B
pullup(g54245);
...
// Gate A11-U102A
pullup(Z14_);
assign #GATE_DELAY Z14_ = rst ? 0 : ((0|g54234|g54236) ? 1'b0 : 1'bz);
// Gate A11-U106A
pullup(g54232);
...
// Gate A11-U108A
pullup(g54230);
assign #GATE_DELAY g54230 = rst ? 1'bz : ((0|g54231|g54229) ? 1'b0 : 1'bz);
// Gate A11-U108B
pullup(G14);
...
// Gate A11-U146B
pullup(CI14_);
assign #GATE_DELAY CI14_ = rst ? 1'bz : ((0|SUMA13_|g54109) ? 1'b0 : 1'bz);
// Gate A11-U145A
pullup(g54142);
...
// Gate A11-U155B A11-U125B
pullup(CO16);
assign #GATE_DELAY CO16 = rst ? 0 : ((0|CI13_|XUY13_|XUY15_|XUY14_|XUY16_) ? 1'b0 : 1'bz);
// Gate A11-U136A
pullup(g54132);
...
// Gate A11-U150B
pullup(g54109);
assign #GATE_DELAY g54109 = rst ? 0 : ((0|g54103|g54107) ? 1'b0 : 1'bz);
// Gate A11-U142A
pullup(WHOMP_);
...
// Gate A11-U153B
pullup(g54107);
assign #GATE_DELAY g54107 = rst ? 1'bz : ((0|g54106|g54108|g54105) ? 1'b0 : 1'bz);
// Gate A11-U151A
pullup(g54127);
assign #GATE_DELAY g54127 = rst ? 1'bz : ((0|L13_|CLG2G) ? 1'b0 : 1'bz);
// Gate A11-U151B
pullup(g54108);
assign #GATE_DELAY g54108 = rst ? 0 : ((0|g54107|CUG) ? 1'b0 : 1'bz);
// Gate A11-U160A
pullup(g54118);
assign #GATE_DELAY g54118 = rst ? 0 : ((0|WL13_|WAG_) ? 1'b0 : 1'bz);
// Gate A11-U160B
pullup(g54103);
assign #GATE_DELAY g54103 = rst ? 1'bz : ((0|g54102|g54104|MONEX) ? 1'b0 : 1'bz);
// Gate A11-U158A
pullup(A13_);
assign #GATE_DELAY A13_ = rst ? 0 : ((0|g54121|g54118|g54119) ? 1'b0 : 1'bz);
// Gate A11-U158B
pullup(g54104);
assign #GATE_DELAY g54104 = rst ? 0 : ((0|CUG|g54103|CLXC) ? 1'b0 : 1'bz);
// Gate A11-U159A
pullup(g54119);
...
// Gate A11-U157A
pullup(g54121);
assign #GATE_DELAY g54121 = rst ? 1'bz : ((0|A13_|CAG) ? 1'b0 : 1'bz);
// Gate A11-U157B
pullup(XUY13_);
assign #GATE_DELAY XUY13_ = rst ? 1'bz : ((0|g54108|g54104) ? 1'b0 : 1'bz);
// Gate A11-U141A
pullup(g54129);
...
// Gate A11-U138A
pullup(g54130);
assign #GATE_DELAY g54130 = rst ? 0 : ((0|g54131|g54129) ? 1'b0 : 1'bz);
// Gate A11-U138B
pullup(G13);
assign #GATE_DELAY G13 = rst ? 1'bz : ((0|G13_|CGG) ? 1'b0 : 1'bz);
// Gate A11-U152A
pullup(L13_);
assign #GATE_DELAY L13_ = rst ? 0 : ((0|g54127|g54124|g54125) ? 1'b0 : 1'bz);
// Gate A11-U152B
pullup(g54106);
...
// Gate A11-U140B A11-U139B
pullup(G13_);
assign #GATE_DELAY G13_ = rst ? 0 : ((0|g54144|g54143|SA13|g54145|g54146|G13) ? 1'b0 : 1'bz);
// Gate A11-U139A
pullup(g54151);
assign #GATE_DELAY g54151 = rst ? 0 : ((0|G13_|RGG_) ? 1'b0 : 1'bz);
// Gate A11-U137A
pullup(g54131);
assign #GATE_DELAY g54131 = rst ? 1'bz : ((0|g54130|CQG) ? 1'b0 : 1'bz);
// Gate A11-U137B
pullup(g54145);
assign #GATE_DELAY g54145 = rst ? 0 : ((0|L12_|L2GDG_) ? 1'b0 : 1'bz);
// Gate A11-U122A
pullup(L14_);
assign #GATE_DELAY L14_ = rst ? 0 : ((0|g54227|g54224|g54225) ? 1'b0 : 1'bz);
// Gate A11-U122B
pullup(g54206);
assign #GATE_DELAY g54206 = rst ? 0 : ((0|WYDG_|WL13_) ? 1'b0 : 1'bz);
// Gate A11-U121A
pullup(g54227);
assign #GATE_DELAY g54227 = rst ? 1'bz : ((0|CLG2G|L14_) ? 1'b0 : 1'bz);
// Gate A11-U121B
pullup(g54208);
...
// Gate A11-U215B
pullup(CI16_);
assign #GATE_DELAY CI16_ = rst ? 1'bz : ((0|SUMA15_|g54409) ? 1'b0 : 1'bz);
// Gate A11-U217A A11-U248B A11-U227A A11-U205A
pullup(RL15_);
assign #GATE_DELAY RL15_ = rst ? 1'bz : ((0|g54442|g54451|g54441|RL16|R1C|MDT15|g54437|g54432|g54417|CH16|g54422) ? 1'b0 : 1'bz);
// Gate A11-U217B
pullup(g54417);
assign #GATE_DELAY g54417 = rst ? 0 : ((0|RULOG_|SUMB15_|SUMA15_) ? 1'b0 : 1'bz);
// Gate A11-U248A
pullup(SUMA12_);
assign #GATE_DELAY SUMA12_ = rst ? 1'bz : ((0|WHOMP) ? 1'b0 : 1'bz);
// Gate A11-U212A
pullup(g54438);
...
// Gate A11-U228B A11-U230B A11-U229B
pullup(WL15_);
...
// Gate A11-U221B A11-U222B
pullup(G15_);
assign #GATE_DELAY G15_ = rst ? 0 : ((0|g54444|SA16|g54443|g54445|G15|g54446) ? 1'b0 : 1'bz);
// Gate A11-U222A
pullup(g54451);
...
// Gate A11-U240A
pullup(g54327);
assign #GATE_DELAY g54327 = rst ? 1'bz : ((0|L16_|CLG1G) ? 1'b0 : 1'bz);
// Gate A11-U240B
pullup(g54308);
assign #GATE_DELAY g54308 = rst ? 0 : ((0|CUG|g54307) ? 1'b0 : 1'bz);
// Gate A11-U233A
pullup(A16_);
assign #GATE_DELAY A16_ = rst ? 0 : ((0|g54321|g54319|g54318) ? 1'b0 : 1'bz);
// Gate A11-U233B
pullup(g54304);
assign #GATE_DELAY g54304 = rst ? 0 : ((0|g54303|CLXC|CUG) ? 1'b0 : 1'bz);
// Gate A11-U234A
pullup(g54321);
assign #GATE_DELAY g54321 = rst ? 1'bz : ((0|CAG|A16_) ? 1'b0 : 1'bz);
// Gate A11-U234B
pullup(XUY16_);
...
// Gate A11-U243A
pullup(g54339);
assign #GATE_DELAY g54339 = rst ? 1'bz : ((0|g54338|g54340) ? 1'b0 : 1'bz);
// Gate A11-U243B
pullup(g54313);
assign #GATE_DELAY g54313 = rst ? 0 : ((0|XUY16_|g54309) ? 1'b0 : 1'bz);
// Gate A11-U244A
pullup(g54340);
assign #GATE_DELAY g54340 = rst ? 0 : ((0|CBG|g54339) ? 1'b0 : 1'bz);
// Gate A11-U244B
pullup(g54311);
assign #GATE_DELAY g54311 = rst ? 0 : ((0|CI16_) ? 1'b0 : 1'bz);
// Gate A11-U235A
pullup(g54322);
...
// Gate A11-U242B A11-U218A
pullup(SUMA16_);
assign #GATE_DELAY SUMA16_ = rst ? 0 : ((0|g54309|XUY16_|CI16_|WHOMPA) ? 1'b0 : 1'bz);
// Gate A11-U236A A11-U247A A11-U257A A11-U218B
pullup(RL16_);
assign #GATE_DELAY RL16_ = rst ? 1'bz : ((0|g54317|CH16|g54322|g54351|g54342|g54341|RL16|g54337|g54332|US2SG|R1C|MDT16) ? 1'b0 : 1'bz);
...
// Gate A11-U246B
pullup(SUMB16_);
assign #GATE_DELAY SUMB16_ = rst ? 1'bz : ((0|g54311|g54313) ? 1'b0 : 1'bz);
// Gate A11-U247B
pullup(g54317);
...
// Gate A11-U239A
pullup(L16_);
assign #GATE_DELAY L16_ = rst ? 0 : ((0|g54324|g54325|g54327) ? 1'b0 : 1'bz);
// Gate A11-U239B
pullup(g54306);
...
// Gate A11-U259B A11-U258B A11-U260B
pullup(WL16_);
...
// Gate A11-U208B
pullup(g54407);
assign #GATE_DELAY g54407 = rst ? 1'bz : ((0|g54406|g54405|g54408) ? 1'b0 : 1'bz);
// Gate A11-U210A
pullup(g54427);
assign #GATE_DELAY g54427 = rst ? 1'bz : ((0|L15_|CLG1G) ? 1'b0 : 1'bz);
// Gate A11-U210B
pullup(g54408);
assign #GATE_DELAY g54408 = rst ? 0 : ((0|CUG|g54407) ? 1'b0 : 1'bz);
// Gate A11-U203A
pullup(A15_);
assign #GATE_DELAY A15_ = rst ? 1'bz : ((0|g54421|g54419|g54418) ? 1'b0 : 1'bz);
// Gate A11-U203B
pullup(g54404);
assign #GATE_DELAY g54404 = rst ? 0 : ((0|g54403|CLXC|CUG) ? 1'b0 : 1'bz);
// Gate A11-U201A
pullup(g54418);
assign #GATE_DELAY g54418 = rst ? 0 : ((0|WAG_|WL15_) ? 1'b0 : 1'bz);
// Gate A11-U201B
pullup(g54403);
assign #GATE_DELAY g54403 = rst ? 1'bz : ((0|g54402|BXVX|g54404) ? 1'b0 : 1'bz);
// Gate A11-U202A
pullup(g54419);
...
// Gate A11-U204B
pullup(XUY15_);
assign #GATE_DELAY XUY15_ = rst ? 1'bz : ((0|g54404|g54408) ? 1'b0 : 1'bz);
// Gate A11-U211B
pullup(g54409);
assign #GATE_DELAY g54409 = rst ? 0 : ((0|g54407|g54403) ? 1'b0 : 1'bz);
// Gate A11-U206A
pullup(g54422);
assign #GATE_DELAY g54422 = rst ? 0 : ((0|A15_|RAG_) ? 1'b0 : 1'bz);
// Gate A11-U209A
pullup(L15_);
assign #GATE_DELAY L15_ = rst ? 0 : ((0|g54427|g54425|g54424) ? 1'b0 : 1'bz);
// Gate A11-U209B
pullup(g54406);
