...
assign #0.2  G15_ = rst ? 1 : ~(0|A11U222Pad6|G15|A11U222Pad8|A11U220Pad9|SA16|A11U219Pad9);
// Gate A11-U202B
...
assign #0.2  RL16_ = rst ? 1 : ~(0|US2SG|R1C|MDT16|A11U235Pad1|CH16|A11U236Pad4|A11U255Pad1|A11U256Pad1|RL16|A11U245Pad1|A11U246Pad1|A11U247Pad4);
// Gate A11-U201B
...
// Gate A11-U209A
assign #0.2  L15_ = rst ? 1 : ~(0|A11U207Pad1|A11U208Pad1|A11U209Pad4);
// Gate A11-U234B
...
assign #0.2  G14_ = rst ? 1 : ~(0|A11U106Pad9|A11U107Pad9|G14|A11U110Pad6|A11U110Pad7|SA14);
// Gate A11-U217B
...
// Gate A11-U243B
assign #0.2  A11U243Pad9 = rst ? 0 : ~(0|XUY16_|A11U241Pad9);
// Gate A11-U241B
assign #0.2  A11U241Pad9 = rst ? 1 : ~(0|A11U238Pad9|A11U231Pad9);
// Gate A11-U129B
assign #0.2  A11U129Pad9 = rst ? 0 : ~(0|A14_|A2XG_);
// Gate A11-U240A
assign #0.2  A11U239Pad2 = rst ? 1 : ~(0|CLG1G|L16_);
// Gate A11-U132A
assign #0.2  Z13_ = rst ? 1 : ~(0|A11U132Pad2|A11U131Pad1);
// Gate A11-U204B
assign #0.2  XUY15_ = rst ? 0 : ~(0|A11U201Pad8|A11U204Pad8);
// Gate A11-U224A
assign #0.2  A11U223Pad2 = rst ? 1 : ~(0|A11U223Pad1|CQG);
// Gate A11-U233A
assign #0.2  A16_ = rst ? 0 : ~(0|A11U231Pad1|A11U232Pad1|A11U233Pad4);
// Gate A11-U212B
...
assign #0.2  G16_ = rst ? 1 : ~(0|A11U250Pad9|SA16|A11U249Pad9|A11U252Pad6|G16|A11U252Pad8);
// Gate A11-U224B
...
// Gate A11-U228A
assign #0.2  A11U228Pad1 = rst ? 1 : ~(0|CZG|Z15_);
// Gate A11-U122B
...
// Gate A11-U223A
assign #0.2  A11U223Pad1 = rst ? 0 : ~(0|A11U223Pad2|A11U220Pad1);
// Gate A11-U230A
...
// Gate A11-U240B
assign #0.2  A11U234Pad8 = rst ? 1 : ~(0|CUG|A11U238Pad9);
// Gate A11-U115B
...
// Gate A11-U147A
assign #0.2  A11U145Pad2 = rst ? 1 : ~(0|CBG|A11U146Pad3);
...
assign #0.2  SUMA16_ = rst ? 0 : ~(0|WHOMPA|A11U241Pad9|XUY16_|CI16_);
// Gate A11-U249A
...
// Gate A11-U221A
assign #0.2  A11J4Pad447 = rst ? 0 : ~(0|G15_);
// Gate A11-U210A
assign #0.2  A11U209Pad4 = rst ? 0 : ~(0|CLG1G|L15_);
// Gate A11-U121A
assign #0.2  A11U121Pad1 = rst ? 1 : ~(0|L14_|CLG2G);
// Gate A11-U156B A11-U113B A11-U134A A11-U144A
assign #0.2  RL13_ = rst ? 1 : ~(0|A11U144Pad9|A11U155Pad1|CH13|MDT13|R1C|A11J1Pad140|A11U134Pad3|A11U134Pad4|A11U144Pad2|A11U144Pad3|A11U139Pad1);
// Gate A11-U209B
...
// Gate A11-U103A
assign #0.2  A11U102Pad2 = rst ? 1 : ~(0|Z14_|CZG);
// Gate A11-U245B
...
// Gate A11-U253A
assign #0.2  A11U253Pad1 = rst ? 0 : ~(0|A11U253Pad2|A11U250Pad1);
// Gate A11-U254A
assign #0.2  A11U253Pad2 = rst ? 1 : ~(0|A11U253Pad1|CQG);
// Gate A11-U120B
assign #0.2  A11U116Pad7 = rst ? 1 : ~(0|A11U120Pad7|A11U120Pad8);
// Gate A11-U118A
assign #0.2  A11U116Pad3 = rst ? 0 : ~(0|A11U118Pad2|A11U115Pad2);
// Gate A11-U106A
...
// Gate A11-U133A
assign #0.2  A11U132Pad2 = rst ? 0 : ~(0|Z13_|CZG);
// Gate A11-U123B
assign #0.2  A11U120Pad8 = rst ? 0 : ~(0|A11U122Pad9|A11U121Pad9|A11U123Pad8);
// Gate A11-U148A
assign #0.2  A11U146Pad3 = rst ? 0 : ~(0|A11U148Pad2|A11U145Pad2);
// Gate A11-U150B
...
// Gate A11-U117A
assign #0.2  A11U115Pad2 = rst ? 1 : ~(0|CBG|A11U116Pad3);
// Gate A11-U116B
...
// Gate A11-U258A
assign #0.2  A11U258Pad1 = rst ? 1 : ~(0|CZG|Z16_);
// Gate A11-U136B
assign #0.2  A11U136Pad9 = rst ? 0 : ~(0|WG1G_|WL13_);
// Gate A11-U212A
assign #0.2  A11U212Pad1 = rst ? 0 : ~(0|WL15_|WBG_);
// Gate A11-U138A
assign #0.2  A11U136Pad2 = rst ? 0 : ~(0|A11U138Pad2|A11U137Pad1);
// Gate A11-U131B A11-U132B A11-U133B
assign #0.2  WL13_ = rst ? 1 : ~(0|WL13);
// Gate A11-U102A
assign #0.2  Z14_ = rst ? 0 : ~(0|A11U102Pad2|A11U101Pad1);
// Gate A11-U238B
assign #0.2  A11U238Pad9 = rst ? 0 : ~(0|A11U238Pad6|A11U237Pad9|A11U234Pad8);
// Gate A11-U216B
...
// Gate A11-U137A
assign #0.2  A11U137Pad1 = rst ? 1 : ~(0|CQG|A11U136Pad2);
// Gate A11-U125A A11-U114A A11-U143B A11-U104A
assign #0.2  RL14_ = rst ? 1 : ~(0|CH14|A11U125Pad3|A11U114Pad9|A11U114Pad2|A11U114Pad3|A11U109Pad1|MDT14|R1C|A11U104Pad2|A11U104Pad3|A11J2Pad240);
// Gate A11-U127A
...
// Gate A11-U234A
assign #0.2  A11U233Pad4 = rst ? 1 : ~(0|A16_|CAG);
// Gate A11-U213A
