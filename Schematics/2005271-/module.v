...
// Gate A22-U130A
pullup(DKCTR5);
assign #GATE_DELAY DKCTR5 = rst ? 1'bz : ((0|g47140|DKCTR5_) ? 1'b0 : 1'bz);
// Gate A22-U112B
pullup(DKCTR2);
assign #GATE_DELAY DKCTR2 = rst ? 1'bz : ((0|g47122) ? 1'b0 : 1'bz);
// Gate A22-U124B
pullup(DKCTR3);
...
// Gate A22-U219A
pullup(g47324);
assign #GATE_DELAY g47324 = rst ? 0 : ((0|g47323|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U131B
pullup(DKDAT_);
...
// Gate A22-U105A
pullup(g47111);
assign #GATE_DELAY g47111 = rst ? 1'bz : ((0|g47108|g47112|g47110) ? 1'b0 : 1'bz);
// Gate A22-U105B
pullup(g47110);
...
// Gate A22-U103B
pullup(RDOUT_);
assign #GATE_DELAY RDOUT_ = rst ? 1'bz : ((0|g47104|DLKCLR) ? 1'b0 : 1'bz);
// Gate A22-U247B
pullup(g47442);
assign #GATE_DELAY g47442 = rst ? 0 : ((0|LOW6_|HIGH2_|g47440) ? 1'b0 : 1'bz);
// Gate A22-U229A
pullup(g47302);
assign #GATE_DELAY g47302 = rst ? 1'bz : ((0|g47303|g47301) ? 1'b0 : 1'bz);
// Gate A22-U223A
pullup(g47315);
...
pullup(DATA_);
assign #GATE_DELAY DATA_ = rst ? 1'bz : ((0|g47251|g47250|WRD2B2|WRD1BP|WRD2B3|WRD1B1|g47320|g47316|g47312|g47325|g47329|g47333|g47442|g47446|g47451|g47455|g47459|g47412|g47433|g47438|g47429|g47416|g47420|g47425|g47359|g47355|g47351|g47342|g47347|g47338) ? 1'b0 : 1'bz);
// Gate A22-U250B
pullup(g47430);
...
// Gate A22-U209A
pullup(g47345);
assign #GATE_DELAY g47345 = rst ? 1'bz : ((0|g47346|g47344) ? 1'b0 : 1'bz);
// Gate A22-U221A
pullup(g47318);
assign #GATE_DELAY g47318 = rst ? 1'bz : ((0|g47319|g47317) ? 1'b0 : 1'bz);
// Gate A22-U222A
pullup(g47319);
assign #GATE_DELAY g47319 = rst ? 0 : ((0|g47318|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U108A
pullup(DKCTR1_);
...
// Gate A22-U218A
pullup(g47323);
assign #GATE_DELAY g47323 = rst ? 1'bz : ((0|g47324|g47322) ? 1'b0 : 1'bz);
// Gate A22-U138B
pullup(g47242);
assign #GATE_DELAY g47242 = rst ? 1'bz : ((0|DKCTR1_|DKCTR3_|DKCTR2_) ? 1'b0 : 1'bz);
// Gate A22-U208A
pullup(g47346);
assign #GATE_DELAY g47346 = rst ? 0 : ((0|g47345|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U156A
pullup(g47206);
assign #GATE_DELAY g47206 = rst ? 0 : ((0|GOJAM|g47205) ? 1'b0 : 1'bz);
// Gate A22-U158B
pullup(g47205);
...
// Gate A22-U138A
pullup(LOW7_);
assign #GATE_DELAY LOW7_ = rst ? 0 : ((0|g47242) ? 1'b0 : 1'bz);
// Gate A22-U234B
pullup(WRD2B3);
...
// Gate A22-U112A
pullup(DKCTR2_);
assign #GATE_DELAY DKCTR2_ = rst ? 0 : ((0|g47121) ? 1'b0 : 1'bz);
// Gate A22-U214A
pullup(g47331);
assign #GATE_DELAY g47331 = rst ? 1'bz : ((0|g47332|g47330) ? 1'b0 : 1'bz);
// Gate A22-U215A
pullup(g47332);
assign #GATE_DELAY g47332 = rst ? 0 : ((0|g47331|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U223B
pullup(g47316);
...
// Gate A22-U153A
pullup(g47219);
assign #GATE_DELAY g47219 = rst ? 0 : ((0|g47218|GOJAM) ? 1'b0 : 1'bz);
// Gate A22-U212B
pullup(g47338);
...
// Gate A22-U102B
pullup(g47104);
assign #GATE_DELAY g47104 = rst ? 0 : ((0|END|RDOUT_) ? 1'b0 : 1'bz);
// Gate A22-U135B
pullup(g47247);
...
// Gate A22-U130B
pullup(DKCTR5_);
assign #GATE_DELAY DKCTR5_ = rst ? 0 : ((0|DLKCLR|g47141|DKCTR5) ? 1'b0 : 1'bz);
// Gate A22-U257B
pullup(g47420);
...
// Gate A22-U213A
pullup(g47336);
assign #GATE_DELAY g47336 = rst ? 1'bz : ((0|g47337|g47335) ? 1'b0 : 1'bz);
// Gate A22-U212A
pullup(g47337);
assign #GATE_DELAY g47337 = rst ? 0 : ((0|CCH34|g47336) ? 1'b0 : 1'bz);
// Gate A22-U253A
pullup(g47428);
...
// Gate A22-U109A
pullup(g47119);
assign #GATE_DELAY g47119 = rst ? 1'bz : ((0|g47112|g47120|g47118) ? 1'b0 : 1'bz);
// Gate A22-U109B
pullup(g47118);
assign #GATE_DELAY g47118 = rst ? 0 : ((0|g47119|g47112|g47117) ? 1'b0 : 1'bz);
// Gate A22-U110A
pullup(g47120);
...
// Gate A22-U230A
pullup(g47303);
assign #GATE_DELAY g47303 = rst ? 0 : ((0|g47302|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U106B
pullup(d1CNT);
...
// Gate A22-U202A
pullup(g47358);
assign #GATE_DELAY g47358 = rst ? 0 : ((0|g47357|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U201B
pullup(g47356);
assign #GATE_DELAY g47356 = rst ? 0 : ((0|WCH34_|CHWL03_) ? 1'b0 : 1'bz);
// Gate A22-U201A
pullup(g47357);
assign #GATE_DELAY g47357 = rst ? 1'bz : ((0|g47358|g47356) ? 1'b0 : 1'bz);
// Gate A22-U235B
pullup(g47409);
...
// Gate A22-U111B
pullup(g47122);
assign #GATE_DELAY g47122 = rst ? 0 : ((0|g47119|DLKCLR|g47121) ? 1'b0 : 1'bz);
// Gate A22-U260B
pullup(g47413);
...
// Gate A22-U111A
pullup(g47121);
assign #GATE_DELAY g47121 = rst ? 1'bz : ((0|g47118|g47122) ? 1'b0 : 1'bz);
// Gate A22-U140A
pullup(LOW5_);
...
// Gate A22-U227A
pullup(g47306);
assign #GATE_DELAY g47306 = rst ? 1'bz : ((0|g47307|g47305) ? 1'b0 : 1'bz);
// Gate A22-U113B
pullup(F14H);
...
// Gate A22-U128B
pullup(g47140);
assign #GATE_DELAY g47140 = rst ? 0 : ((0|g47141|g47136|d16CNT) ? 1'b0 : 1'bz);
// Gate A22-U128A
pullup(g47141);
assign #GATE_DELAY g47141 = rst ? 1'bz : ((0|g47136|d32CNT|g47140) ? 1'b0 : 1'bz);
// Gate A22-U225B
pullup(g47309);
assign #GATE_DELAY g47309 = rst ? 0 : ((0|WCH34_|CHWL02_) ? 1'b0 : 1'bz);
// Gate A22-U107A
pullup(g47113);
assign #GATE_DELAY g47113 = rst ? 1'bz : ((0|g47110|g47114) ? 1'b0 : 1'bz);
// Gate A22-U228A
pullup(g47307);
assign #GATE_DELAY g47307 = rst ? 0 : ((0|g47306|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U227B
pullup(g47305);
assign #GATE_DELAY g47305 = rst ? 0 : ((0|CHWL01_|WCH34_) ? 1'b0 : 1'bz);
// Gate A22-U132A
pullup(g47254);
assign #GATE_DELAY g47254 = rst ? 0 : ((0|WDORDR|DATA_) ? 1'b0 : 1'bz);
// Gate A22-U206B
pullup(g47351);
...
// Gate A22-U206A
pullup(g47350);
assign #GATE_DELAY g47350 = rst ? 0 : ((0|g47349|CCH34) ? 1'b0 : 1'bz);
// Gate A22-U205B
pullup(g47348);
assign #GATE_DELAY g47348 = rst ? 0 : ((0|WCH34_|CHWL05_) ? 1'b0 : 1'bz);
// Gate A22-U205A
pullup(g47349);
assign #GATE_DELAY g47349 = rst ? 1'bz : ((0|g47350|g47348) ? 1'b0 : 1'bz);
// Gate A22-U253B
pullup(g47429);
