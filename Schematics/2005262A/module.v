...
assign #0.2  g36133 = rst ? 0 : !(0|g36131|STG2);
// Gate A4-U256A
...
// Gate A4-U156B
assign #0.2  g36144 = rst ? 0 : !(0|STG2|STG1|g36148);
// Gate A4-U124A
assign #0.2  g36213 = rst ? 0 : !(0|SUMB16_|SUMA16_);
// Gate A4-U249B
...
assign #0.2  BR1_ = rst ? 1 : !(0|g36228);
...
// Gate A4-U113B
assign #0.2  MBR1 = rst ? 0 : !(0|g36222);
// Gate A4-U240B
assign #0.2  BRDIF_ = rst ? 1 : !(0|BR12B|BR1B2);
// Gate A4-U155B
assign #0.2  ST3_ = rst ? 0 : !(0|g36140);
// Gate A4-U228A
...
assign #0.2  g36222 = rst ? 1 : !(0|SGUM|g36216|g36228|g36221|g36218);
// Gate A4-U242B
...
// Gate A4-U137A
assign #0.2  g36115 = rst ? 0 : !(0|STG1|g36114);
...
// Gate A4-U135A
assign #0.2  MST1 = rst ? 1 : !(0|g36115);
// Gate A4-U139A
assign #0.2  MST2 = rst ? 1 : !(0|g36133);
// Gate A4-U148B
assign #0.2  MST3 = rst ? 0 : !(0|g36148);
// Gate A4-U213B
...
assign #0.2  g36228 = rst ? 0 : !(0|g36222|g36227|g36224|g36230|g36231);
...
// Gate A4-U147A
assign #0.2  g36148 = rst ? 1 : !(0|STG3|g36147);
...
// Gate A4-U156A
assign #0.2  ST376 = rst ? 1 : !(0|g36152|g36133);
// Gate A4-U138A
assign #0.2  STG1 = rst ? 1 : !(0|g36119|g36115);
// Gate A4-U142A
assign #0.2  STG2 = rst ? 1 : !(0|g36133|g36136);
// Gate A4-U159B A4-U147B
assign #0.2  STG3 = rst ? 0 : !(0|g36150|g36148);
// Gate A4-U129A
...
// Gate A4-U157A
assign #0.2  ST4_ = rst ? 1 : !(0|g36144);
...
// Gate A4-U155A
assign #0.2  g36140 = rst ? 1 : !(0|g36115|STG3|g36133);
// Gate A4-U158A
