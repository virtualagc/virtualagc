...
// Gate A4-U160B A4-U118B A4-U119B
pullup(BR1);
assign #GATE_DELAY BR1 = rst ? 0 : ((0|g36219) ? 1'b0 : 1'bz);
// Gate A4-U104B A4-U144B
pullup(g36149);
assign #GATE_DELAY g36149 = rst ? 0 : ((0|RSTSTG|T01|STRTFC|g36146) ? 1'b0 : 1'bz);
// Gate A4-U105B A4-U106B
pullup(BR2_);
assign #GATE_DELAY BR2_ = rst ? 0 : ((0|g36245) ? 1'b0 : 1'bz);
// Gate A4-U106A
pullup(BR2);
assign #GATE_DELAY BR2 = rst ? 1'bz : ((0|g36237) ? 1'b0 : 1'bz);
// Gate A4-U112A A4-U112B A4-U111A A4-U113A A4-U114A A4-U114B
pullup(g36254);
assign #GATE_DELAY g36254 = rst ? 0 : ((0|WL09_|WL08_|WL10_|WL11_|WL12_|WL13_|WL14_|WL15_|WL16_|WL05_|WL06_|WL07_|PHS4_|TMZ_|WL01_|WL03_|WL04_|WL02_) ? 1'b0 : 1'bz);
// Gate A4-U111B
pullup(g36239);
assign #GATE_DELAY g36239 = rst ? 1'bz : ((0|TSGN2) ? 1'b0 : 1'bz);
// Gate A4-U113B
pullup(MBR1);
assign #GATE_DELAY MBR1 = rst ? 0 : ((0|g36219) ? 1'b0 : 1'bz);
// Gate A4-U110A
pullup(g36244);
...
// Gate A4-U108A A4-U107A
pullup(g36237);
assign #GATE_DELAY g36237 = rst ? 0 : ((0|g36245|g36240|g36254|g36236|g36233) ? 1'b0 : 1'bz);
// Gate A4-U108B A4-U107B
pullup(g36245);
assign #GATE_DELAY g36245 = rst ? 1'bz : ((0|g36230|g36252|g36237|g36244) ? 1'b0 : 1'bz);
// Gate A4-U109A A4-U118A A4-U119A
pullup(BR1_);
assign #GATE_DELAY BR1_ = rst ? 1'bz : ((0|g36225) ? 1'b0 : 1'bz);
// Gate A4-U109B
pullup(g36252);
assign #GATE_DELAY g36252 = rst ? 0 : ((0|TMZ_|PHS3_) ? 1'b0 : 1'bz);
// Gate A4-U141A
pullup(g36136);
assign #GATE_DELAY g36136 = rst ? 1'bz : ((0|g36135|g36111) ? 1'b0 : 1'bz);
// Gate A4-U141B
pullup(g36131);
assign #GATE_DELAY g36131 = rst ? 0 : ((0|g36111|g36130) ? 1'b0 : 1'bz);
// Gate A4-U138A
pullup(STG1);
...
// Gate A4-U133A
pullup(g36110);
assign #GATE_DELAY g36110 = rst ? 1'bz : ((0|T12_|g36109|PHS3_) ? 1'b0 : 1'bz);
...
// Gate A4-U136A
pullup(g36114);
assign #GATE_DELAY g36114 = rst ? 1'bz : ((0|g36111|g36112) ? 1'b0 : 1'bz);
// Gate A4-U136B
pullup(g36118);
...
// Gate A4-U139A
pullup(MST2);
assign #GATE_DELAY MST2 = rst ? 0 : ((0|g36132) ? 1'b0 : 1'bz);
// Gate A4-U139B A4-U140B
pullup(g36130);
assign #GATE_DELAY g36130 = rst ? 1'bz : ((0|ST2|g36261|g36139|MTCSAI|g36135) ? 1'b0 : 1'bz);
// Gate A4-U140A
pullup(g36135);
assign #GATE_DELAY g36135 = rst ? 0 : ((0|GOJAM|g36130|T01) ? 1'b0 : 1'bz);
// Gate A4-U135A
pullup(MST1);
...
// Gate A4-U145A
pullup(g36146);
assign #GATE_DELAY g36146 = rst ? 1'bz : ((0|g36149|g36155) ? 1'b0 : 1'bz);
// Gate A4-U145B
pullup(g36155);
assign #GATE_DELAY g36155 = rst ? 0 : ((0|DVST_|g36132) ? 1'b0 : 1'bz);
// Gate A4-U143A
pullup(g36139);
assign #GATE_DELAY g36139 = rst ? 0 : ((0|DVST_|g36115) ? 1'b0 : 1'bz);
// Gate A4-U143B A4-U142B
pullup(g36132);
assign #GATE_DELAY g36132 = rst ? 1'bz : ((0|g36131|STG2) ? 1'b0 : 1'bz);
// Gate A4-U153A
pullup(ST1376_);
...
pullup(STD2);
assign #GATE_DELAY STD2 = rst ? 0 : ((0|g36132|STG3|INKL|STG1) ? 1'b0 : 1'bz);
// Gate A4-U154B
pullup(DV1376_);
...
// Gate A4-U142A
pullup(STG2);
assign #GATE_DELAY STG2 = rst ? 0 : ((0|g36136|g36132) ? 1'b0 : 1'bz);
// Gate A4-U156A
pullup(ST376);
assign #GATE_DELAY ST376 = rst ? 0 : ((0|g36132|g36152) ? 1'b0 : 1'bz);
// Gate A4-U156B
pullup(g36144);
assign #GATE_DELAY g36144 = rst ? 0 : ((0|STG2|STG1|g36148) ? 1'b0 : 1'bz);
// Gate A4-U155A
pullup(g36140);
assign #GATE_DELAY g36140 = rst ? 0 : ((0|g36132|STG3|g36115) ? 1'b0 : 1'bz);
// Gate A4-U155B
pullup(ST3_);
assign #GATE_DELAY ST3_ = rst ? 1'bz : ((0|g36140) ? 1'b0 : 1'bz);
// Gate A4-U101B
pullup(MBR2);
assign #GATE_DELAY MBR2 = rst ? 1'bz : ((0|g36237) ? 1'b0 : 1'bz);
// Gate A4-U147A
pullup(g36148);
...
// Gate A4-U146B
pullup(g36150);
assign #GATE_DELAY g36150 = rst ? 1'bz : ((0|g36149|g36111) ? 1'b0 : 1'bz);
...
// Gate A4-U127B A4-U126B A4-U125B
pullup(DV1_);
...
// Gate A4-U124A
pullup(g36213);
assign #GATE_DELAY g36213 = rst ? 0 : ((0|SUMA16_|SUMB16_) ? 1'b0 : 1'bz);
// Gate A4-U120A A4-U121A
pullup(g36225);
assign #GATE_DELAY g36225 = rst ? 0 : ((0|g36231|g36230|g36224|g36227|g36219) ? 1'b0 : 1'bz);
// Gate A4-U120B A4-U121B
pullup(g36219);
assign #GATE_DELAY g36219 = rst ? 1'bz : ((0|g36225|g36221|g36218|SGUM|g36216) ? 1'b0 : 1'bz);
// Gate A4-U103A
pullup(g36233);
...
// Gate A4-U230A A4-U229A A4-U253A
pullup(WG_);
assign #GATE_DELAY WG_ = rst ? 1'bz : ((0|g36343|g36351|g36354|g36340|d9XP1|g36435|g36407|g36360) ? 1'b0 : 1'bz);
...
// Gate A4-U225A
pullup(g36326);
assign #GATE_DELAY g36326 = rst ? 0 : ((0|QC3_|SQEXT) ? 1'b0 : 1'bz);
// Gate A4-U225B
pullup(g36329);
...
// Gate A4-U217A
pullup(RUPT0);
assign #GATE_DELAY RUPT0 = rst ? 0 : ((0|QC3_|SQR10_|g36304) ? 1'b0 : 1'bz);
// Gate A4-U217B
pullup(WCH_);
...
// Gate A4-U215A
pullup(RXOR0);
assign #GATE_DELAY RXOR0 = rst ? 0 : ((0|SQR10|QC3_|g36304) ? 1'b0 : 1'bz);
// Gate A4-U215B
pullup(d5XP28);
...
// Gate A4-U210A
pullup(WOR0);
assign #GATE_DELAY WOR0 = rst ? 0 : ((0|SQR10_|g36304|QC2_) ? 1'b0 : 1'bz);
// Gate A4-U210B
pullup(g36333);
assign #GATE_DELAY g36333 = rst ? 1'bz : ((0|ROR0|WOR0) ? 1'b0 : 1'bz);
// Gate A4-U202A A4-U201A
pullup(g36304);
assign #GATE_DELAY g36304 = rst ? 1'bz : ((0|g36303) ? 1'b0 : 1'bz);
// Gate A4-U212A
pullup(WAND0);
assign #GATE_DELAY WAND0 = rst ? 0 : ((0|QC1_|g36304|SQR10_) ? 1'b0 : 1'bz);
// Gate A4-U212B
pullup(RAND0);
assign #GATE_DELAY RAND0 = rst ? 0 : ((0|SQR10|QC1_|g36304) ? 1'b0 : 1'bz);
// Gate A4-U206A
pullup(WRITE0_);
assign #GATE_DELAY WRITE0_ = rst ? 1'bz : ((0|WRITE0) ? 1'b0 : 1'bz);
// Gate A4-U206B
pullup(WRITE0);
assign #GATE_DELAY WRITE0 = rst ? 0 : ((0|QC0_|SQR10_|g36304) ? 1'b0 : 1'bz);
// Gate A4-U204A
pullup(READ0_);
assign #GATE_DELAY READ0_ = rst ? 1'bz : ((0|READ0) ? 1'b0 : 1'bz);
// Gate A4-U204B
pullup(READ0);
assign #GATE_DELAY READ0 = rst ? 0 : ((0|SQR10|g36304|QC0_) ? 1'b0 : 1'bz);
// Gate A4-U201B
pullup(g36303);
assign #GATE_DELAY g36303 = rst ? 0 : ((0|EXST0_|SQ0_) ? 1'b0 : 1'bz);
// Gate A4-U211A
pullup(ROR0);
assign #GATE_DELAY ROR0 = rst ? 0 : ((0|SQR10|QC2_|g36304) ? 1'b0 : 1'bz);
// Gate A4-U211B
pullup(WOR0_);
...
// Gate A4-U242B
pullup(BR1B2B);
assign #GATE_DELAY BR1B2B = rst ? 0 : ((0|BR2|BR1) ? 1'b0 : 1'bz);
// Gate A4-U255A
pullup(MP0T10);
...
// Gate A4-U240B
pullup(BRDIF_);
assign #GATE_DELAY BRDIF_ = rst ? 0 : ((0|BR12B|BR1B2) ? 1'b0 : 1'bz);
// Gate A4-U250A
pullup(g36407);
...
// Gate A4-U243A
pullup(BR1B2);
assign #GATE_DELAY BR1B2 = rst ? 1'bz : ((0|BR1|BR2_) ? 1'b0 : 1'bz);
// Gate A4-U243B
pullup(BR1B2B_);
assign #GATE_DELAY BR1B2B_ = rst ? 1'bz : ((0|BR1B2B) ? 1'b0 : 1'bz);
// Gate A4-U238A
pullup(BR12B_);
assign #GATE_DELAY BR12B_ = rst ? 1'bz : ((0|BR12B) ? 1'b0 : 1'bz);
// Gate A4-U238B
pullup(BR1B2_);
assign #GATE_DELAY BR1B2_ = rst ? 0 : ((0|BR1B2) ? 1'b0 : 1'bz);
// Gate A4-U235A
pullup(R1C_);
