...
initial $display("Gate delay (A4) will be %f ns.", GATE_DELAY*100);
...
// Gate A4-U136A
pullup(g36114);
assign #GATE_DELAY g36114 = rst ? 1'bz : ((0|g36112|g36111) ? 1'b0 : 1'bz);
// Gate A4-U220B
pullup(g36354);
assign #GATE_DELAY g36354 = rst ? 0 : ((0|T05_|RXOR0_) ? 1'b0 : 1'bz);
// Gate A4-U240A
pullup(g36425);
assign #GATE_DELAY g36425 = rst ? 0 : ((0|BR1|MP0_|T04_) ? 1'b0 : 1'bz);
// Gate A4-U136B
pullup(g36118);
assign #GATE_DELAY g36118 = rst ? 1'bz : ((0|g36112|T01) ? 1'b0 : 1'bz);
// Gate A4-U144A
pullup(g36124);
assign #GATE_DELAY g36124 = rst ? 0 : ((0|STG3|DVST_) ? 1'b0 : 1'bz);
// Gate A4-U252B
pullup(g36427);
...
pullup(g36133);
assign #GATE_DELAY g36133 = rst ? 1'bz : ((0|g36131|STG2) ? 1'b0 : 1'bz);
// Gate A4-U256A
pullup(RB1_);
assign #GATE_DELAY RB1_ = rst ? 1'bz : ((0|g36436|g36451) ? 1'b0 : 1'bz);
// Gate A4-U210B
pullup(g36333);
...
// Gate A4-U248A
pullup(d1XP10);
assign #GATE_DELAY d1XP10 = rst ? 0 : ((0|T01_|DV0_) ? 1'b0 : 1'bz);
// Gate A4-U153B
pullup(DV1376);
...
// Gate A4-U124A
pullup(g36213);
assign #GATE_DELAY g36213 = rst ? 1'bz : ((0|SUMB16_|SUMA16_) ? 1'b0 : 1'bz);
// Gate A4-U249B
pullup(d2PP1);
...
// Gate A4-U211A
pullup(ROR0);
assign #GATE_DELAY ROR0 = rst ? 0 : ((0|g36307|QC2_|SQR10) ? 1'b0 : 1'bz);
...
pullup(STD2);
assign #GATE_DELAY STD2 = rst ? 0 : ((0|STG3|g36133|STG1|INKL) ? 1'b0 : 1'bz);
// Gate A4-U101B
pullup(MBR2);
...
// Gate A4-U155B
pullup(ST3_);
assign #GATE_DELAY ST3_ = rst ? 1'bz : ((0|g36140) ? 1'b0 : 1'bz);
// Gate A4-U228A
pullup(g36340);
assign #GATE_DELAY g36340 = rst ? 0 : ((0|T09_|RXOR0_) ? 1'b0 : 1'bz);
// Gate A4-U246B
pullup(KRPT);
...
// Gate A4-U225A
pullup(g36326);
assign #GATE_DELAY g36326 = rst ? 0 : ((0|SQEXT|QC3_) ? 1'b0 : 1'bz);
// Gate A4-U235A
pullup(R1C_);
assign #GATE_DELAY R1C_ = rst ? 1'bz : ((0|g36438|g36451) ? 1'b0 : 1'bz);
// Gate A4-U225B
pullup(g36329);
assign #GATE_DELAY g36329 = rst ? 1'bz : ((0|g36328) ? 1'b0 : 1'bz);
// Gate A4-U231A
pullup(g36413);
assign #GATE_DELAY g36413 = rst ? 0 : ((0|T03_|MP0_) ? 1'b0 : 1'bz);
// Gate A4-U215A
pullup(RXOR0);
assign #GATE_DELAY RXOR0 = rst ? 0 : ((0|g36307|QC3_|SQR10) ? 1'b0 : 1'bz);
// Gate A4-U234B
pullup(g36436);
...
// Gate A4-U234A
pullup(g36414);
assign #GATE_DELAY g36414 = rst ? 0 : ((0|INOUT_|T03_) ? 1'b0 : 1'bz);
// Gate A4-U218A
pullup(RUPT0_);
...
// Gate A4-U242A
pullup(BR12B);
assign #GATE_DELAY BR12B = rst ? 0 : ((0|BR1_|BR2) ? 1'b0 : 1'bz);
// Gate A4-U244B
pullup(g36431);
...
// Gate A4-U158B
pullup(ST376_);
assign #GATE_DELAY ST376_ = rst ? 1'bz : ((0|ST376) ? 1'b0 : 1'bz);
// Gate A4-U245B
pullup(g36444);
assign #GATE_DELAY g36444 = rst ? 0 : ((0|BRDIF_|MP0_|T09_) ? 1'b0 : 1'bz);
// Gate A4-U212A
pullup(WAND0);
assign #GATE_DELAY WAND0 = rst ? 0 : ((0|SQR10_|g36307|QC1_) ? 1'b0 : 1'bz);
// Gate A4-U116A A4-U124B
pullup(SGUM);
assign #GATE_DELAY SGUM = rst ? 0 : ((0|PHS3_|PHS4|SUMA16_|SUMB16_|TSGU_) ? 1'b0 : 1'bz);
// Gate A4-U137A
pullup(g36115);
assign #GATE_DELAY g36115 = rst ? 0 : ((0|STG1|g36114) ? 1'b0 : 1'bz);
// Gate A4-U222B A4-U220A
pullup(RUPT1);
assign #GATE_DELAY RUPT1 = rst ? 0 : ((0|SQR10_|EXST1_|QC3_|SQ0_) ? 1'b0 : 1'bz);
// Gate A4-U111B
pullup(g36239);
...
pullup(g36241);
assign #GATE_DELAY g36241 = rst ? 1'bz : ((0|g36233|g36236|g36243|g36240|g36249) ? 1'b0 : 1'bz);
// Gate A4-U138B A4-U101A
pullup(g36261);
assign #GATE_DELAY g36261 = rst ? 0 : ((0|XB7_|TRSM_|XT1_|NDR100_) ? 1'b0 : 1'bz);
// Gate A4-U203A
pullup(INOUT);
assign #GATE_DELAY INOUT = rst ? 0 : ((0|RUPT0|SQ0_|EXST0_) ? 1'b0 : 1'bz);
// Gate A4-U252A
pullup(RSC_);
assign #GATE_DELAY RSC_ = rst ? 1'bz : ((0|g36456|g36435|g36407) ? 1'b0 : 1'bz);
// Gate A4-U226B
pullup(g36343);
...
pullup(TSGN_);
assign #GATE_DELAY TSGN_ = rst ? 1'bz : ((0|g36413|g36431|g36456|MP0T10|d1XP10) ? 1'b0 : 1'bz);
// Gate A4-U214A
pullup(RXOR0_);
...
// Gate A4-U139A
pullup(MST2);
assign #GATE_DELAY MST2 = rst ? 0 : ((0|g36133) ? 1'b0 : 1'bz);
// Gate A4-U148B
pullup(MST3);
...
// Gate A4-U130A
pullup(DV376);
assign #GATE_DELAY DV376 = rst ? 0 : ((0|DIV_|ST376_) ? 1'b0 : 1'bz);
// Gate A4-U206A
pullup(WRITE0_);
assign #GATE_DELAY WRITE0_ = rst ? 1'bz : ((0|WRITE0) ? 1'b0 : 1'bz);
// Gate A4-U213A
pullup(g36334);
assign #GATE_DELAY g36334 = rst ? 0 : ((0|g36333|T03_) ? 1'b0 : 1'bz);
// Gate A4-U206B
pullup(WRITE0);
...
// Gate A4-U245A
pullup(g36446);
assign #GATE_DELAY g36446 = rst ? 0 : ((0|T09_|MP3_) ? 1'b0 : 1'bz);
// Gate A4-U236A
pullup(TSGN2);
assign #GATE_DELAY TSGN2 = rst ? 0 : ((0|T07_|MP0_) ? 1'b0 : 1'bz);
// Gate A4-U205A
pullup(INOUT_);
...
// Gate A4-U251A
pullup(g36401);
assign #GATE_DELAY g36401 = rst ? 1'bz : ((0|RUPT1|RSM3|RUPT0) ? 1'b0 : 1'bz);
// Gate A4-U143A
pullup(g36139);
assign #GATE_DELAY g36139 = rst ? 0 : ((0|g36115|DVST_) ? 1'b0 : 1'bz);
// Gate A4-U229A A4-U230A A4-U253A
pullup(WG_);
assign #GATE_DELAY WG_ = rst ? 1'bz : ((0|d9XP1|g36340|g36354|g36351|g36343|g36360|g36407|g36435) ? 1'b0 : 1'bz);
// Gate A4-U207B
pullup(d8PP4);
assign #GATE_DELAY d8PP4 = rst ? 1'bz : ((0|DV4|INOUT|PRINC) ? 1'b0 : 1'bz);
// Gate A4-U149A
pullup(ST1D);
assign #GATE_DELAY ST1D = rst ? 1'bz : ((0|g36115|STG2|STG3) ? 1'b0 : 1'bz);
// Gate A4-U140A
pullup(g36135);
assign #GATE_DELAY g36135 = rst ? 0 : ((0|T01|g36129|GOJAM) ? 1'b0 : 1'bz);
// Gate A4-U146A
pullup(g36147);
assign #GATE_DELAY g36147 = rst ? 0 : ((0|g36111|g36146) ? 1'b0 : 1'bz);
// Gate A4-U145A
pullup(g36146);
assign #GATE_DELAY g36146 = rst ? 1'bz : ((0|g36155|g36159) ? 1'b0 : 1'bz);
// Gate A4-U125A
pullup(DV1);
assign #GATE_DELAY DV1 = rst ? 0 : ((0|DIV_|ST1_) ? 1'b0 : 1'bz);
// Gate A4-U232A
pullup(d3XP2);
assign #GATE_DELAY d3XP2 = rst ? 0 : ((0|T03_|TS0_) ? 1'b0 : 1'bz);
// Gate A4-U146B
pullup(g36150);
assign #GATE_DELAY g36150 = rst ? 1'bz : ((0|g36159|g36111) ? 1'b0 : 1'bz);
// Gate A4-U238A
pullup(BR12B_);
assign #GATE_DELAY BR12B_ = rst ? 1'bz : ((0|BR12B) ? 1'b0 : 1'bz);
// Gate A4-U121A A4-U120A
pullup(g36228);
assign #GATE_DELAY g36228 = rst ? 0 : ((0|g36222|g36227|g36224|g36230|g36231) ? 1'b0 : 1'bz);
...
pullup(A4);
assign #GATE_DELAY A4 = rst ? 0 : ((0) ? 1'b0 : 1'bz);
// Gate A4-U154B
pullup(DV1376_);
...
pullup(WY_);
assign #GATE_DELAY WY_ = rst ? 1'bz : ((0|B15X|d7XP19|g36414|d8XP5|g36437|g36439) ? 1'b0 : 1'bz);
// Gate A4-U223A
pullup(g36328);
assign #GATE_DELAY g36328 = rst ? 0 : ((0|SQR12_|SQ2_|ST0_) ? 1'b0 : 1'bz);
...
// Gate A4-U123A
pullup(g36216);
assign #GATE_DELAY g36216 = rst ? 0 : ((0|UNF_|TOV_) ? 1'b0 : 1'bz);
// Gate A4-U122B
pullup(g36227);
...
// Gate A4-U217A
pullup(RUPT0);
assign #GATE_DELAY RUPT0 = rst ? 0 : ((0|g36307|SQR10_|QC3_) ? 1'b0 : 1'bz);
// Gate A4-U103A
pullup(g36233);
assign #GATE_DELAY g36233 = rst ? 0 : ((0|PHS4_|TPZG_|GEQZRO_) ? 1'b0 : 1'bz);
// Gate A4-U249A
pullup(g36406);
...
// Gate A4-U210A
pullup(WOR0);
assign #GATE_DELAY WOR0 = rst ? 0 : ((0|QC2_|g36307|SQR10_) ? 1'b0 : 1'bz);
// Gate A4-U233A
pullup(d4XP11);
assign #GATE_DELAY d4XP11 = rst ? 0 : ((0|INOUT_|T04_) ? 1'b0 : 1'bz);
// Gate A4-U241B
pullup(d8XP6);
...
// Gate A4-U147A
pullup(g36148);
assign #GATE_DELAY g36148 = rst ? 1'bz : ((0|STG3|g36147) ? 1'b0 : 1'bz);
...
// Gate A4-U237A
pullup(g36456);
assign #GATE_DELAY g36456 = rst ? 0 : ((0|DV1_|T07_) ? 1'b0 : 1'bz);
// Gate A4-U229B A4-U259A
pullup(RA_);
assign #GATE_DELAY RA_ = rst ? 1'bz : ((0|d2XP3|g36349|g36354|d1XP10|g36446|d8XP5) ? 1'b0 : 1'bz);
// Gate A4-U227A
pullup(d9XP1);
assign #GATE_DELAY d9XP1 = rst ? 0 : ((0|T09_|RUPT0_) ? 1'b0 : 1'bz);
// Gate A4-U132A
pullup(g36103);
assign #GATE_DELAY g36103 = rst ? 0 : ((0|PHS3_|T03_|T12USE_) ? 1'b0 : 1'bz);
// Gate A4-U131B
pullup(T12USE_);
...
// Gate A4-U156A
pullup(ST376);
assign #GATE_DELAY ST376 = rst ? 0 : ((0|g36152|g36133) ? 1'b0 : 1'bz);
// Gate A4-U138A
pullup(STG1);
assign #GATE_DELAY STG1 = rst ? 1'bz : ((0|g36119|g36115) ? 1'b0 : 1'bz);
// Gate A4-U142A
pullup(STG2);
assign #GATE_DELAY STG2 = rst ? 0 : ((0|g36133|g36136) ? 1'b0 : 1'bz);
// Gate A4-U159B A4-U147B
pullup(STG3);
assign #GATE_DELAY STG3 = rst ? 0 : ((0|g36150|g36148) ? 1'b0 : 1'bz);
// Gate A4-U129A
pullup(DV4);
assign #GATE_DELAY DV4 = rst ? 0 : ((0|DIV_|ST4_) ? 1'b0 : 1'bz);
// Gate A4-U117A
pullup(g36224);
assign #GATE_DELAY g36224 = rst ? 0 : ((0|PHS3_|TSGN_) ? 1'b0 : 1'bz);
// Gate A4-U122A
pullup(g36218);
assign #GATE_DELAY g36218 = rst ? 0 : ((0|g36217|L15_) ? 1'b0 : 1'bz);
// Gate A4-U127A
pullup(DV0);
assign #GATE_DELAY DV0 = rst ? 0 : ((0|DIV_|ST0_) ? 1'b0 : 1'bz);
// Gate A4-U259B
pullup(L16_);
assign #GATE_DELAY L16_ = rst ? 1'bz : ((0|g36451) ? 1'b0 : 1'bz);
// Gate A4-U157A
pullup(ST4_);
...
// Gate A4-U241A
pullup(g36437);
assign #GATE_DELAY g36437 = rst ? 0 : ((0|T09_|BR1|MP0_) ? 1'b0 : 1'bz);
// Gate A4-U248B
pullup(d6XP5);
assign #GATE_DELAY d6XP5 = rst ? 0 : ((0|T06_|DV1_) ? 1'b0 : 1'bz);
// Gate A4-U159A
pullup(DV3764);
assign #GATE_DELAY DV3764 = rst ? 0 : ((0|DIV_|g36156) ? 1'b0 : 1'bz);
// Gate A4-U203B A4-U202B
pullup(DV4_);
assign #GATE_DELAY DV4_ = rst ? 1'bz : ((0|DV4) ? 1'b0 : 1'bz);
// Gate A4-U244A
pullup(TL15);
assign #GATE_DELAY TL15 = rst ? 0 : ((0|MP3_|T06_) ? 1'b0 : 1'bz);
// Gate A4-U224A
pullup(g36342);
assign #GATE_DELAY g36342 = rst ? 1'bz : ((0|IC13|IC12|RUPT1) ? 1'b0 : 1'bz);
// Gate A4-U250A
pullup(g36407);
assign #GATE_DELAY g36407 = rst ? 0 : ((0|T02_|g36406) ? 1'b0 : 1'bz);
// Gate A4-U243A
pullup(BR1B2);
assign #GATE_DELAY BR1B2 = rst ? 0 : ((0|BR2_|BR1) ? 1'b0 : 1'bz);
// Gate A4-U260A
pullup(d8XP5);
assign #GATE_DELAY d8XP5 = rst ? 0 : ((0|DV1_|T08_) ? 1'b0 : 1'bz);
// Gate A4-U209A
pullup(d3XP7);
assign #GATE_DELAY d3XP7 = rst ? 0 : ((0|T03_|RXOR0_) ? 1'b0 : 1'bz);
// Gate A4-U256B
pullup(CI_);
...
// Gate A4-U110A
pullup(g36244);
assign #GATE_DELAY g36244 = rst ? 0 : ((0|PHS3_|g36239) ? 1'b0 : 1'bz);
// Gate A4-U207A
pullup(RRPA);
assign #GATE_DELAY RRPA = rst ? 0 : ((0|RUPT1_|T03_) ? 1'b0 : 1'bz);
// Gate A4-U145B
pullup(g36155);
assign #GATE_DELAY g36155 = rst ? 0 : ((0|DVST_|g36133) ? 1'b0 : 1'bz);
// Gate A4-U255A
pullup(MP0T10);
assign #GATE_DELAY MP0T10 = rst ? 0 : ((0|T10_|MP0_) ? 1'b0 : 1'bz);
// Gate A4-U247A
pullup(d2XP5);
assign #GATE_DELAY d2XP5 = rst ? 0 : ((0|T02_|DV0_|BR1) ? 1'b0 : 1'bz);
// Gate A4-U224B
pullup(d2XP3);
assign #GATE_DELAY d2XP3 = rst ? 0 : ((0|T02_|INOUT_) ? 1'b0 : 1'bz);
// Gate A4-U133A
pullup(g36110);
assign #GATE_DELAY g36110 = rst ? 1'bz : ((0|PHS3_|g36109|T12_) ? 1'b0 : 1'bz);
// Gate A4-U153A
pullup(ST1376_);
assign #GATE_DELAY ST1376_ = rst ? 0 : ((0|ST376|ST1D) ? 1'b0 : 1'bz);
// Gate A4-U149B
pullup(g36105);
assign #GATE_DELAY g36105 = rst ? 0 : ((0|STG3|STG1|STG2) ? 1'b0 : 1'bz);
// Gate A4-U133B A4-U134A
pullup(g36111);
assign #GATE_DELAY g36111 = rst ? 0 : ((0|g36103|g36110) ? 1'b0 : 1'bz);
// Gate A4-U131A
pullup(g36109);
assign #GATE_DELAY g36109 = rst ? 0 : ((0|RSTSTG|T12USE_|GOJAM) ? 1'b0 : 1'bz);
// Gate A4-U222A A4-U239A
pullup(RB_);
assign #GATE_DELAY RB_ = rst ? 1'bz : ((0|g36343|g36334|g36348|g36425|d7XP19|g36437) ? 1'b0 : 1'bz);
// Gate A4-U260B
pullup(g36451);
...
pullup(ST1_);
assign #GATE_DELAY ST1_ = rst ? 0 : ((0|ST1D) ? 1'b0 : 1'bz);
// Gate A4-U155A
pullup(g36140);
assign #GATE_DELAY g36140 = rst ? 0 : ((0|g36115|STG3|g36133) ? 1'b0 : 1'bz);
// Gate A4-U158A
pullup(g36156);
assign #GATE_DELAY g36156 = rst ? 1'bz : ((0|g36144|ST376) ? 1'b0 : 1'bz);
...
// Gate A4-U115A
pullup(g36230);
assign #GATE_DELAY g36230 = rst ? 0 : ((0|PHS2_|TOV_) ? 1'b0 : 1'bz);
// Gate A4-U141A
pullup(g36136);
assign #GATE_DELAY g36136 = rst ? 1'bz : ((0|g36111|g36135) ? 1'b0 : 1'bz);
// Gate A4-U130B
pullup(DV376_);
assign #GATE_DELAY DV376_ = rst ? 1'bz : ((0|DV376) ? 1'b0 : 1'bz);
// Gate A4-U114A A4-U114B A4-U112A A4-U112B A4-U113A A4-U111A
pullup(g36243);
assign #GATE_DELAY g36243 = rst ? 0 : ((0|WL01_|TMZ_|PHS4_|WL03_|WL04_|WL02_|WL10_|WL08_|WL09_|WL11_|WL12_|WL13_|WL07_|WL06_|WL05_|WL16_|WL15_|WL14_) ? 1'b0 : 1'bz);
// Gate A4-U110B
pullup(g36240);
assign #GATE_DELAY g36240 = rst ? 0 : ((0|PHS4_|WL16_|g36239) ? 1'b0 : 1'bz);
// Gate A4-U246A
pullup(g36439);
assign #GATE_DELAY g36439 = rst ? 0 : ((0|BR1_|T09_|MP0_) ? 1'b0 : 1'bz);
// Gate A4-U217B
pullup(WCH_);
