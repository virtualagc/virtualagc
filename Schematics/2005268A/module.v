...
// Gate A18-U116A
pullup(g45245);
assign #GATE_DELAY g45245 = rst ? 1'bz : ((0|g45239) ? 1'b0 : 1'bz);
// Gate A18-U116B
pullup(KYRPT2);
...
// Gate A18-U139A
pullup(STNDBY_);
assign #GATE_DELAY STNDBY_ = rst ? 0 : ((0|STNDBY) ? 1'b0 : 1'bz);
// Gate A18-U139B
pullup(g45152);
assign #GATE_DELAY g45152 = rst ? 0 : ((0|g45151|g45142) ? 1'b0 : 1'bz);
// Gate A18-U141A
pullup(g45154);
assign #GATE_DELAY g45154 = rst ? 0 : ((0|g45151|STNDBY) ? 1'b0 : 1'bz);
// Gate A18-U141B
pullup(STNDBY);
assign #GATE_DELAY STNDBY = rst ? 1'bz : ((0|g45154|g45152) ? 1'b0 : 1'bz);
// Gate A18-U132A
pullup(g45138);
...
// Gate A18-U137B
pullup(SBY);
assign #GATE_DELAY SBY = rst ? 1'bz : ((0|STNDBY_) ? 1'b0 : 1'bz);
// Gate A18-U140A
pullup(g45156);
assign #GATE_DELAY g45156 = rst ? 0 : ((0|STNDBY|ALTEST) ? 1'b0 : 1'bz);
// Gate A18-U140B
pullup(SBYLIT);
assign #GATE_DELAY SBYLIT = rst ? 1'bz : ((0|g45156) ? 1'b0 : 1'bz);
// Gate A18-U157A
pullup(g45130);
...
// Gate A18-U160A
pullup(g45135);
assign #GATE_DELAY g45135 = rst ? 1'bz : ((0|g45134|g45136) ? 1'b0 : 1'bz);
// Gate A18-U160B
pullup(g45136);
assign #GATE_DELAY g45136 = rst ? 0 : ((0|KYRPT1|g45135) ? 1'b0 : 1'bz);
// Gate A18-U130A
pullup(g45202);
assign #GATE_DELAY g45202 = rst ? 1'bz : ((0|g45223|g45201) ? 1'b0 : 1'bz);
// Gate A18-U130B
pullup(g45201);
assign #GATE_DELAY g45201 = rst ? 0 : ((0|g45202|NKEY1) ? 1'b0 : 1'bz);
// Gate A18-U125A
pullup(g45210);
...
// Gate A18-U128A
pullup(g45206);
assign #GATE_DELAY g45206 = rst ? 1'bz : ((0|g45205|g45223) ? 1'b0 : 1'bz);
// Gate A18-U128B
pullup(g45205);
...
// Gate A18-U124A
pullup(g45214);
assign #GATE_DELAY g45214 = rst ? 1'bz : ((0|g45213|g45223) ? 1'b0 : 1'bz);
// Gate A18-U124B
pullup(g45212);
assign #GATE_DELAY g45212 = rst ? 1'bz : ((0|g45209) ? 1'b0 : 1'bz);
// Gate A18-U123A
pullup(g45213);
assign #GATE_DELAY g45213 = rst ? 0 : ((0|g45214|NKEY4) ? 1'b0 : 1'bz);
// Gate A18-U123B
pullup(CH1603);
assign #GATE_DELAY CH1603 = rst ? 0 : ((0|g45209|g45236) ? 1'b0 : 1'bz);
// Gate A18-U117A
pullup(g45242);
assign #GATE_DELAY g45242 = rst ? 0 : ((0|g45241|g45239|F09D) ? 1'b0 : 1'bz);
// Gate A18-U117B
pullup(g45241);
assign #GATE_DELAY g45241 = rst ? 1'bz : ((0|g45242|g45240) ? 1'b0 : 1'bz);
// Gate A18-U126A A18-U119A
pullup(g45240);
assign #GATE_DELAY g45240 = rst ? 0 : ((0|g45223|g45239|g45247|F09A_) ? 1'b0 : 1'bz);
// Gate A18-U126B A18-U119B
pullup(g45239);
assign #GATE_DELAY g45239 = rst ? 0 : ((0|g45212|g45208|g45204|g45220|g45216) ? 1'b0 : 1'bz);
// Gate A18-U127A
pullup(g45208);
...
// Gate A18-U129A
pullup(g45204);
assign #GATE_DELAY g45204 = rst ? 1'bz : ((0|g45201) ? 1'b0 : 1'bz);
// Gate A18-U129B
pullup(CH1601);
...
// Gate A18-U251A A18-U250A
pullup(CNTOF9);
assign #GATE_DELAY CNTOF9 = rst ? 0 : ((0|F10A|g45418|g45410|g45431|g45425) ? 1'b0 : 1'bz);
// Gate A18-U251B
pullup(g45432);
assign #GATE_DELAY g45432 = rst ? 0 : ((0|g45429|g45431) ? 1'b0 : 1'bz);
// Gate A18-U247A A18-U248B
pullup(g45428);
assign #GATE_DELAY g45428 = rst ? 0 : ((0|g45426|RADRPT|g45419|g45429) ? 1'b0 : 1'bz);
// Gate A18-U247B A18-U238B
pullup(CHOR14_);
assign #GATE_DELAY CHOR14_ = rst ? 1'bz : ((0|CH1114|CHBT14|CH3314|CHAT14) ? 1'b0 : 1'bz);
// Gate A18-U244A
pullup(g45422);
assign #GATE_DELAY g45422 = rst ? 1'bz : ((0|g45412|g45420|g45423) ? 1'b0 : 1'bz);
// Gate A18-U244B
pullup(CH13);
...
// Gate A18-U256A
pullup(g45450);
assign #GATE_DELAY g45450 = rst ? 1'bz : ((0|DLKRPT|g45451) ? 1'b0 : 1'bz);
// Gate A18-U256B
pullup(DLKRPT);
...
// Gate A18-U257A
pullup(g45452);
assign #GATE_DELAY g45452 = rst ? 1'bz : ((0|g45451|F10A) ? 1'b0 : 1'bz);
// Gate A18-U257B
pullup(g45451);
...
// Gate A18-U236A
pullup(g45410);
assign #GATE_DELAY g45410 = rst ? 1'bz : ((0|g45411|g45406) ? 1'b0 : 1'bz);
// Gate A18-U236B
pullup(g45408);
assign #GATE_DELAY g45408 = rst ? 1'bz : ((0|g45409|g45406|g45404) ? 1'b0 : 1'bz);
// Gate A18-U235A
pullup(g45409);
...
// Gate A18-U234A
pullup(g45405);
assign #GATE_DELAY g45405 = rst ? 0 : ((0|RADRPT|g45406|g45410) ? 1'b0 : 1'bz);
// Gate A18-U234B A18-U233A
pullup(g45406);
assign #GATE_DELAY g45406 = rst ? 0 : ((0|g45404|g45408|RADRPT|g45405) ? 1'b0 : 1'bz);
// Gate A18-U233B
pullup(CHOR16_);
assign #GATE_DELAY CHOR16_ = rst ? 1'bz : ((0|CH1116|CH1216|CH3316) ? 1'b0 : 1'bz);
// Gate A18-U238A A18-U239A
pullup(g45414);
assign #GATE_DELAY g45414 = rst ? 0 : ((0|g45412|RADRPT|g45415|g45405) ? 1'b0 : 1'bz);
// Gate A18-U252B A18-U254B
pullup(CHOR12_);
assign #GATE_DELAY CHOR12_ = rst ? 1'bz : ((0|CHAT12|CHBT12|CH1112|CH1212) ? 1'b0 : 1'bz);
// Gate A18-U232A
pullup(g45403);
...
// Gate A18-U242A A18-U243A
pullup(g45420);
assign #GATE_DELAY g45420 = rst ? 0 : ((0|g45422|g45412|g45419|RADRPT) ? 1'b0 : 1'bz);
// Gate A18-U242B
pullup(g45419);
assign #GATE_DELAY g45419 = rst ? 0 : ((0|g45424|g45420) ? 1'b0 : 1'bz);
// Gate A18-U246A
pullup(g45425);
assign #GATE_DELAY g45425 = rst ? 0 : ((0|g45424|g45422) ? 1'b0 : 1'bz);
// Gate A18-U246B
pullup(g45426);
assign #GATE_DELAY g45426 = rst ? 0 : ((0|g45431|g45428) ? 1'b0 : 1'bz);
// Gate A18-U248A
pullup(g45429);
assign #GATE_DELAY g45429 = rst ? 1'bz : ((0|g45430|g45428|g45419) ? 1'b0 : 1'bz);
// Gate A18-U243B
pullup(CHOR13_);
assign #GATE_DELAY CHOR13_ = rst ? 1'bz : ((0|CH3313|CHBT13|CHAT13) ? 1'b0 : 1'bz);
// Gate A18-U245A
pullup(g45424);
assign #GATE_DELAY g45424 = rst ? 1'bz : ((0|g45420|g45425) ? 1'b0 : 1'bz);
// Gate A18-U245B
pullup(g45423);
...
// Gate A18-U241A
pullup(g45417);
assign #GATE_DELAY g45417 = rst ? 1'bz : ((0|g45414|g45418) ? 1'b0 : 1'bz);
// Gate A18-U241B
pullup(g45418);
assign #GATE_DELAY g45418 = rst ? 0 : ((0|g45415|g45417) ? 1'b0 : 1'bz);
// Gate A18-U240A
pullup(g45415);
assign #GATE_DELAY g45415 = rst ? 1'bz : ((0|g45416|g45414|g45405) ? 1'b0 : 1'bz);
// Gate A18-U240B
pullup(g45416);
