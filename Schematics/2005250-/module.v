...
pullup(g32021);
assign #GATE_DELAY g32021 = rst ? 0 : ((0|C57A|C55A|C53A|C47A|C51A|C33A|C35A|C37A|C31A|C27A|C25A|C45A|C43A|C41A) ? 1'b0 : 1'bz);
// Gate A21-U242A
pullup(C57A);
...
pullup(d32004K);
assign #GATE_DELAY d32004K = rst ? 1'bz : ((0|C36A|C37A|C30A|C31A|C32A|C33A|C34A|C35A) ? 1'b0 : 1'bz);
// Gate A21-U129B
pullup(SCAS17);
...
// Gate A21-U122A
pullup(MON_);
assign #GATE_DELAY MON_ = rst ? 0 : ((0|g32214|g32207) ? 1'b0 : 1'bz);
// Gate A21-U207B
pullup(CG26);
...
// Gate A21-U111A
pullup(g32238);
assign #GATE_DELAY g32238 = rst ? 0 : ((0|g32239|g32237) ? 1'b0 : 1'bz);
// Gate A21-U139A
pullup(BKTF_);
...
pullup(g32033);
assign #GATE_DELAY g32033 = rst ? 1'bz : ((0|C44A|C37A|C36A|C57A|C56A|C54A|C55A|C35A|C34A|C27A|C26A|C24A|C25A|C46A|C47A|C45A) ? 1'b0 : 1'bz);
// Gate A21-U235B
pullup(g32506);
...
// Gate A21-U146B
pullup(SHINC_);
assign #GATE_DELAY SHINC_ = rst ? 0 : ((0|SHINC|g32058) ? 1'b0 : 1'bz);
// Gate A21-U145B
pullup(d50SUM);
assign #GATE_DELAY d50SUM = rst ? 1'bz : ((0|g32044) ? 1'b0 : 1'bz);
// Gate A21-U118A
pullup(g32222);
...
// Gate A21-U122B
pullup(g32214);
assign #GATE_DELAY g32214 = rst ? 1'bz : ((0|g32218|g32213|GOJAM) ? 1'b0 : 1'bz);
...
// Gate A21-U144B
pullup(SHINC);
assign #GATE_DELAY SHINC = rst ? 1'bz : ((0|SHINC_|T12A) ? 1'b0 : 1'bz);
// Gate A21-U108A
pullup(g32244);
...
pullup(g32044);
assign #GATE_DELAY g32044 = rst ? 0 : ((0|C56A|C57A|C51A|C50A|C52A|C54A|C55A|C53A) ? 1'b0 : 1'bz);
// Gate A21-U236B
pullup(C42A);
...
pullup(g32015);
assign #GATE_DELAY g32015 = rst ? 1'bz : ((0|C24A|C25A|C26A|C60A|d30SUM|C27A) ? 1'b0 : 1'bz);
// Gate A21-U110B
pullup(g32239);
assign #GATE_DELAY g32239 = rst ? 1'bz : ((0|g32232|GOJAM|g32238) ? 1'b0 : 1'bz);
// Gate A21-U132A
pullup(DINC_);
...
// Gate A21-U123B
pullup(g32213);
assign #GATE_DELAY g32213 = rst ? 0 : ((0|g32212|g32214) ? 1'b0 : 1'bz);
// Gate A21-U133A
pullup(g32049);
assign #GATE_DELAY g32049 = rst ? 0 : ((0|INCSET_|g32068) ? 1'b0 : 1'bz);
// Gate A21-U137B A21-U138B A21-U135B
pullup(g32068);
assign #GATE_DELAY g32068 = rst ? 0 : ((0|C54A|C56A|C55A|C50A|C47A|C31A|C51A|C52A|C53A) ? 1'b0 : 1'bz);
// Gate A21-U205B A21-U204B
pullup(CXB0_);
assign #GATE_DELAY CXB0_ = rst ? 0 : ((0|XB0) ? 1'b0 : 1'bz);
// Gate A21-U127B
pullup(g32205);
