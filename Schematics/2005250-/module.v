...
// Gate A21-U143A
pullup(g32007);
assign #GATE_DELAY g32007 = rst ? 1'bz : ((0|d50SUM|d30SUM) ? 1'b0 : 1'bz);
// Gate A21-U143B
pullup(CAD1);
assign #GATE_DELAY CAD1 = rst ? 0 : ((0|RSCT_|g32011) ? 1'b0 : 1'bz);
// Gate A21-U158A A21-U155A A21-U156A
pullup(d32004K);
assign #GATE_DELAY d32004K = rst ? 1'bz : ((0|C30A|C31A|C32A|C33A|C34A|C35A|C36A|C37A) ? 1'b0 : 1'bz);
// Gate A21-U158B A21-U156B A21-U153B A21-U154B A21-U147A
pullup(g32042);
assign #GATE_DELAY g32042 = rst ? 1'bz : ((0|C32A|C26A|C27A|C33A|C36A|C37A|C46A|C42A|C43A|C53A|C52A|C47A|C56A|C57A) ? 1'b0 : 1'bz);
// Gate A21-U149A A21-U151A A21-U152A
pullup(g32034);
assign #GATE_DELAY g32034 = rst ? 1'bz : ((0|C56A|C57A|C54A|C55A|C53A|C51A|C50A|C52A) ? 1'b0 : 1'bz);
// Gate A21-U149B A21-U155B A21-U150B A21-U159B A21-U157B
pullup(g32011);
assign #GATE_DELAY g32011 = rst ? 1'bz : ((0|C57A|C55A|C45A|C43A|C41A|C53A|C47A|C51A|C31A|C27A|C25A|C33A|C35A|C37A) ? 1'b0 : 1'bz);
// Gate A21-U150A A21-U153A A21-U154A A21-U159A A21-U157A A21-U148A
pullup(g32053);
assign #GATE_DELAY g32053 = rst ? 0 : ((0|C56A|C54A|C55A|C46A|C47A|C45A|C44A|C37A|C36A|C26A|C24A|C25A|C35A|C34A|C27A|C57A) ? 1'b0 : 1'bz);
// Gate A21-U151B A21-U152B A21-U148B A21-U147B
pullup(g32036);
assign #GATE_DELAY g32036 = rst ? 1'bz : ((0|C45A|C44A|C43A|C40A|C41A|C42A|d50SUM|C46A|C47A|C60A) ? 1'b0 : 1'bz);
// Gate A21-U146A
pullup(d30SUM);
...
// Gate A21-U145A A21-U160A A21-U160B
pullup(g32025);
assign #GATE_DELAY g32025 = rst ? 0 : ((0|C60A|d30SUM|C27A|C24A|C25A|C26A) ? 1'b0 : 1'bz);
// Gate A21-U145B
pullup(d50SUM);
assign #GATE_DELAY d50SUM = rst ? 0 : ((0|g32034) ? 1'b0 : 1'bz);
// Gate A21-U141A
pullup(CAD3);
assign #GATE_DELAY CAD3 = rst ? 0 : ((0|RSCT_|g32053) ? 1'b0 : 1'bz);
// Gate A21-U141B
pullup(g32058);
assign #GATE_DELAY g32058 = rst ? 0 : ((0|g32056|INCSET_) ? 1'b0 : 1'bz);
// Gate A21-U142A
pullup(g32259);
assign #GATE_DELAY g32259 = rst ? 0 : ((0|CHINC|STORE1|FETCH1) ? 1'b0 : 1'bz);
// Gate A21-U142B
pullup(CAD2);
assign #GATE_DELAY CAD2 = rst ? 0 : ((0|RSCT_|g32042) ? 1'b0 : 1'bz);
// Gate A21-U135A
pullup(SHANC_);
assign #GATE_DELAY SHANC_ = rst ? 1'bz : ((0|g32062|SHANC) ? 1'b0 : 1'bz);
// Gate A21-U135B A21-U137B A21-U138B
pullup(g32067);
assign #GATE_DELAY g32067 = rst ? 1'bz : ((0|C51A|C52A|C53A|C54A|C56A|C55A|C50A|C47A|C31A) ? 1'b0 : 1'bz);
// Gate A21-U137A A21-U138A A21-U139B
pullup(g32056);
assign #GATE_DELAY g32056 = rst ? 1'bz : ((0|C46M|C45M|C57A|C60A) ? 1'b0 : 1'bz);
// Gate A21-U133A
pullup(g32049);
assign #GATE_DELAY g32049 = rst ? 0 : ((0|INCSET_|g32067) ? 1'b0 : 1'bz);
// Gate A21-U133B
pullup(g32061);
...
// Gate A21-U140A
pullup(CAD5);
assign #GATE_DELAY CAD5 = rst ? 0 : ((0|RSCT_|g32025) ? 1'b0 : 1'bz);
// Gate A21-U140B
pullup(CAD6);
assign #GATE_DELAY CAD6 = rst ? 0 : ((0|g32036|RSCT_) ? 1'b0 : 1'bz);
// Gate A21-U134A
pullup(g32062);
...
// Gate A21-U118A
pullup(g32222);
assign #GATE_DELAY g32222 = rst ? 0 : ((0|g32221|INOTLD) ? 1'b0 : 1'bz);
// Gate A21-U118B
pullup(INOTLD);
assign #GATE_DELAY INOTLD = rst ? 1'bz : ((0|g32233|g32222) ? 1'b0 : 1'bz);
// Gate A21-U113A
pullup(g32233);
...
// Gate A21-U112A
pullup(g32237);
assign #GATE_DELAY g32237 = rst ? 0 : ((0|g32236|PHS2_) ? 1'b0 : 1'bz);
// Gate A21-U112B
pullup(g32234);
assign #GATE_DELAY g32234 = rst ? 1'bz : ((0|g32233) ? 1'b0 : 1'bz);
// Gate A21-U115A
pullup(MREQIN);
assign #GATE_DELAY MREQIN = rst ? 1'bz : ((0|g32228) ? 1'b0 : 1'bz);
// Gate A21-U115B A21-U114B
pullup(g32228);
assign #GATE_DELAY g32228 = rst ? 0 : ((0|INOTLD|INOTRD|g32214|g32207) ? 1'b0 : 1'bz);
// Gate A21-U114A
pullup(MONpCH);
assign #GATE_DELAY MONpCH = rst ? 1'bz : ((0|g32228) ? 1'b0 : 1'bz);
// Gate A21-U122A
pullup(MON_);
...
// Gate A21-U128A A21-U129A
pullup(g32201);
assign #GATE_DELAY g32201 = rst ? 0 : ((0|PSEUDO|GNHNC|NISQL_|T12_|PHS4_) ? 1'b0 : 1'bz);
// Gate A21-U128B
pullup(g32203);
assign #GATE_DELAY g32203 = rst ? 1'bz : ((0|g32201) ? 1'b0 : 1'bz);
// Gate A21-U129B
pullup(SCAS17);
...
// Gate A21-U102B A21-U105A
pullup(INKL_);
assign #GATE_DELAY INKL_ = rst ? 0 : ((0|MONpCH|g32245) ? 1'b0 : 1'bz);
// Gate A21-U107A
pullup(g32245);
...
// Gate A21-U109B A21-U111B
pullup(g32236);
assign #GATE_DELAY g32236 = rst ? 1'bz : ((0|MLDCH|MRDCH|MREAD|MLOAD) ? 1'b0 : 1'bz);
// Gate A21-U111A
pullup(g32238);
...
// Gate A21-U221B
pullup(g32638);
assign #GATE_DELAY g32638 = rst ? 0 : ((0|g32637|g32630) ? 1'b0 : 1'bz);
// Gate A21-U224A
pullup(g32607);
assign #GATE_DELAY g32607 = rst ? 1'bz : ((0|C44R|g32606) ? 1'b0 : 1'bz);
// Gate A21-U224B
pullup(C46R);
assign #GATE_DELAY C46R = rst ? 0 : ((0|CA4_|CXB6_|g32611) ? 1'b0 : 1'bz);
// Gate A21-U226A
pullup(g32606);
assign #GATE_DELAY g32606 = rst ? 0 : ((0|g32607|g32605) ? 1'b0 : 1'bz);
// Gate A21-U226B
pullup(C46A);
...
// Gate A21-U211A
pullup(g32619);
assign #GATE_DELAY g32619 = rst ? 0 : ((0|g32620|g32618) ? 1'b0 : 1'bz);
// Gate A21-U211B
pullup(g32648);
...
// Gate A21-U208A
pullup(g32620);
assign #GATE_DELAY g32620 = rst ? 1'bz : ((0|g32619|C45R) ? 1'b0 : 1'bz);
// Gate A21-U208B
pullup(g32650);
...
// Gate A21-U239B
pullup(g32509);
assign #GATE_DELAY g32509 = rst ? 0 : ((0|g32510|BMAGXM) ? 1'b0 : 1'bz);
// Gate A21-U231A
pullup(g32530);
...
// Gate A21-U238B
pullup(g32510);
assign #GATE_DELAY g32510 = rst ? 1'bz : ((0|g32509|C42R) ? 1'b0 : 1'bz);
// Gate A21-U237A
pullup(C56R);
assign #GATE_DELAY C56R = rst ? 0 : ((0|g32511|CA5_|CXB6_) ? 1'b0 : 1'bz);
// Gate A21-U237B
pullup(g32507);
assign #GATE_DELAY g32507 = rst ? 1'bz : ((0|g32506|C42R) ? 1'b0 : 1'bz);
...
// Gate A21-U235B
pullup(g32506);
assign #GATE_DELAY g32506 = rst ? 0 : ((0|g32505|g32507) ? 1'b0 : 1'bz);
// Gate A21-U236A
pullup(g32533);
...
// Gate A21-U250B
pullup(g32519);
assign #GATE_DELAY g32519 = rst ? 0 : ((0|g32518|g32520) ? 1'b0 : 1'bz);
// Gate A21-U253B
pullup(g32520);
assign #GATE_DELAY g32520 = rst ? 1'bz : ((0|g32519|C43R) ? 1'b0 : 1'bz);
// Gate A21-U244A
pullup(g32511);
...
// Gate A21-U246B
pullup(g32516);
assign #GATE_DELAY g32516 = rst ? 1'bz : ((0|g32515|C43R) ? 1'b0 : 1'bz);
// Gate A21-U245A
pullup(g32544);
assign #GATE_DELAY g32544 = rst ? 0 : ((0|C60R|g32543) ? 1'b0 : 1'bz);
// Gate A21-U245B
pullup(g32515);
assign #GATE_DELAY g32515 = rst ? 0 : ((0|g32516|BMAGYP) ? 1'b0 : 1'bz);
// Gate A21-U248A
pullup(C60R);
assign #GATE_DELAY C60R = rst ? 0 : ((0|g32511|CXB0_|CA6_) ? 1'b0 : 1'bz);
// Gate A21-U248B
pullup(g32517);
assign #GATE_DELAY g32517 = rst ? 0 : ((0|g32516|g32525) ? 1'b0 : 1'bz);
// Gate A21-U232A
pullup(g32529);
...
// Gate A21-U233B
pullup(g32504);
assign #GATE_DELAY g32504 = rst ? 0 : ((0|g32510|g32503) ? 1'b0 : 1'bz);
// Gate A21-U202A
pullup(C45R);
assign #GATE_DELAY C45R = rst ? 0 : ((0|CXB5_|CA4_|g32611) ? 1'b0 : 1'bz);
// Gate A21-U202B A21-U203B
pullup(CXB6_);
...
// Gate A21-U229A
pullup(g32603);
assign #GATE_DELAY g32603 = rst ? 1'bz : ((0|C44R|g32602) ? 1'b0 : 1'bz);
// Gate A21-U229B
pullup(g32629);
assign #GATE_DELAY g32629 = rst ? 0 : ((0|g32630|RNRADP) ? 1'b0 : 1'bz);
// Gate A21-U230A
pullup(g32602);
assign #GATE_DELAY g32602 = rst ? 0 : ((0|g32603|BMAGZP) ? 1'b0 : 1'bz);
// Gate A21-U230B
pullup(g32630);
assign #GATE_DELAY g32630 = rst ? 1'bz : ((0|C46R|g32629) ? 1'b0 : 1'bz);
// Gate A21-U220A
pullup(C44R);
...
// Gate A21-U222A
pullup(g32609);
assign #GATE_DELAY g32609 = rst ? 0 : ((0|g32610|BMAGZM) ? 1'b0 : 1'bz);
// Gate A21-U222B
pullup(g32636);
assign #GATE_DELAY g32636 = rst ? 0 : ((0|g32637|RNRADM) ? 1'b0 : 1'bz);
// Gate A21-U223A
pullup(g32610);
assign #GATE_DELAY g32610 = rst ? 1'bz : ((0|g32609|C44R) ? 1'b0 : 1'bz);
// Gate A21-U223B
pullup(g32637);
assign #GATE_DELAY g32637 = rst ? 1'bz : ((0|g32636|C46R) ? 1'b0 : 1'bz);
// Gate A21-U215A
pullup(g32616);
...
// Gate A21-U227B
pullup(g32632);
assign #GATE_DELAY g32632 = rst ? 0 : ((0|g32633|g32631) ? 1'b0 : 1'bz);
// Gate A21-U218B
pullup(C46M);
assign #GATE_DELAY C46M = rst ? 0 : ((0|CA4_|CXB6_|g32636) ? 1'b0 : 1'bz);
// Gate A21-U228A
pullup(g32604);
assign #GATE_DELAY g32604 = rst ? 0 : ((0|g32610|g32603) ? 1'b0 : 1'bz);
// Gate A21-U228B
pullup(g32633);
assign #GATE_DELAY g32633 = rst ? 1'bz : ((0|g32632|C46R) ? 1'b0 : 1'bz);
// Gate A21-U206A
pullup(g32659);
