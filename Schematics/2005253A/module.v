...
// Gate A12-U221A
pullup(g34320);
assign #GATE_DELAY g34320 = rst ? 1'bz : ((0|g34319|CSG) ? 1'b0 : 1'bz);
...
// Gate A12-U220A
pullup(g34319);
assign #GATE_DELAY g34319 = rst ? 0 : ((0|g34320|g34318) ? 1'b0 : 1'bz);
// Gate A12-U238B
pullup(g34422);
...
pullup(T12A);
assign #GATE_DELAY T12A = rst ? 0 : ((0|T12_) ? 1'b0 : 1'bz);
// Gate A12-U258B
pullup(S07_);
...
// Gate A12-U129B
pullup(g34230);
assign #GATE_DELAY g34230 = rst ? 1'bz : ((0|PA09|PA06_|PA03_) ? 1'b0 : 1'bz);
// Gate A12-U114A
pullup(BRXP3);
