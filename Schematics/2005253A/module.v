...
// Gate A12-U241A
assign #0.2  A12U240Pad2 = rst ? 0 : ~(0|CSG|A12U240Pad1);
// Gate A12-U240A
assign #0.2  A12U240Pad1 = rst ? 1 : ~(0|A12U240Pad2|A12U238Pad1);
// Gate A12-U232A
...
assign #0.2  PA06 = rst ? 1 : ~(0|A12U137Pad9|A12U137Pad1|A12U138Pad1|A12U140Pad9);
// Gate A12-U235A
assign #0.2  RL04_ = rst ? 0 : ~(0|CAD4|RPTAD4);
// Gate A12-U143A
assign #0.2  A12U143Pad1 = rst ? 0 : ~(0|G08);
// Gate A12-U135A A12-U159B A12-U160B
assign #0.2  GNZRO = rst ? 0 : ~(0|G15|A12U148Pad9|A12U147Pad9|A12U154Pad1|A12U158Pad9);
// Gate A12-U145A
...
// Gate A12-U216B
assign #0.2  S11 = rst ? 1 : ~(0|A12U216Pad8);
// Gate A12-U260B
...
assign #0.2  S06 = rst ? 1 : ~(0|A12U252Pad1);
// Gate A12-U230A
...
assign #0.2  S03_ = rst ? 1 : ~(0|A12U240Pad2);
// Gate A12-U217A
...
// Gate A12-U145B
assign #0.2  A12U145Pad9 = rst ? 1 : ~(0|A12U143Pad1|A12U142Pad1|G09);
// Gate A12-U137B
assign #0.2  A12U137Pad9 = rst ? 0 : ~(0|G06|G04|G05);
// Gate A12-U207A
assign #0.2  A12U206Pad8 = rst ? 0 : ~(0|CYR_|T12A);
// Gate A12-U139B
assign #0.2  A12U137Pad2 = rst ? 0 : ~(0|G06);
// Gate A12-U138B
assign #0.2  A12U137Pad3 = rst ? 0 : ~(0|G05);
// Gate A12-U137A
...
// Gate A12-U123A
assign #0.2  PC15 = rst ? 0 : ~(0|A12U123Pad2|A12U123Pad3);
// Gate A12-U122B
assign #0.2  MGP_ = rst ? 1 : ~(0|PC15);
// Gate A12-U218A
assign #0.2  A12U214Pad8 = rst ? 1 : ~(0|A12U216Pad8|CSG);
// Gate A12-U150B
assign #0.2  A12U149Pad3 = rst ? 0 : ~(0|G11);
// Gate A12-U238A
...
// Gate A12-U218B
assign #0.2  A12U216Pad8 = rst ? 0 : ~(0|A12U214Pad8|A12U218Pad8);
// Gate A12-U121A
assign #0.2  A12U119Pad2 = rst ? 1 : ~(0|SAP|MONPAR|A12U119Pad8);
// Gate A12-U222B
assign #0.2  G03ED = rst ? 0 : ~(0|WL10_|WEDOPG_);
// Gate A12-U253A
assign #0.2  A12U252Pad2 = rst ? 1 : ~(0|CSG|A12U252Pad1);
// Gate A12-U103A
assign #0.2  GEQZRO_ = rst ? 1 : ~(0|A12U102Pad9);
// Gate A12-U211A A12-U216A A12-U214A
assign #0.2  T12A = rst ? 1 : ~(0|T12_);
// Gate A12-U258B
...
// Gate A12-U149A
assign #0.2  A12U149Pad1 = rst ? 1 : ~(0|A12U149Pad2|A12U149Pad3|G10);
// Gate A12-U121B
assign #0.2  A12U119Pad8 = rst ? 0 : ~(0|CGG|A12U119Pad2);
// Gate A12-U153B
assign #0.2  A12U149Pad2 = rst ? 0 : ~(0|G12);
// Gate A12-U112B
...
// Gate A12-U119B
assign #0.2  A12U118Pad4 = rst ? 1 : ~(0|PC15|A12U119Pad8);
// Gate A12-U160A
...
// Gate A12-U136B
assign #0.2  A12U136Pad9 = rst ? 0 : ~(0|G04);
// Gate A12-U204A
...
// Gate A12-U252A
assign #0.2  A12U252Pad1 = rst ? 0 : ~(0|A12U252Pad2|A12U247Pad1);
// Gate A12-U256B
...
// Gate A12-U243A
assign #0.2  A12U243Pad1 = rst ? 0 : ~(0|A12U243Pad2|CSG);
// Gate A12-U131A
assign #0.2  A12U131Pad1 = rst ? 0 : ~(0|G02|G03|G01);
// Gate A12-U110B
...
// Gate A12-U243B
assign #0.2  A12U243Pad2 = rst ? 1 : ~(0|A12U238Pad9|A12U243Pad1);
// Gate A12-U128A A12-U127A
assign #0.2  PB09 = rst ? 1 : ~(0|A12U128Pad2|A12U128Pad3|A12U127Pad2|A12U127Pad3);
// Gate A12-U220B
...
// Gate A12-U108A
assign #0.2  A12U102Pad3 = rst ? 1 : ~(0|GNZRO);
// Gate A12-U109A
assign #0.2  A12U108Pad7 = rst ? 0 : ~(0|A12U109Pad4);
// Gate A12-U208A
assign #0.2  SR_ = rst ? 1 : ~(0|A12U208Pad2|A12U206Pad1);
// Gate A12-U104B A12-U102B
assign #0.2  A12U102Pad9 = rst ? 0 : ~(0|A12U102Pad3|G02|G01|G03);
// Gate A12-U227B
...
// Gate A12-U148B
assign #0.2  A12U148Pad9 = rst ? 1 : ~(0|A12U137Pad9);
...
// Gate A12-U148A
assign #0.2  A12U148Pad1 = rst ? 0 : ~(0|G12|G10|G11);
// Gate A12-U246B
assign #0.2  RL06_ = rst ? 0 : ~(0|CAD6|RPTAD6);
// Gate A12-U215A
assign #0.2  G05ED = rst ? 0 : ~(0|WEDOPG_|WL12_);
// Gate A12-U259A
assign #0.2  A12U259Pad1 = rst ? 1 : ~(0|L15_);
// Gate A12-U210A
assign #0.2  S12_ = rst ? 0 : ~(0|A12U210Pad2);
// Gate A12-U231A
assign #0.2  A12U231Pad1 = rst ? 0 : ~(0|WL02_|WSG_);
// Gate A12-U259B
assign #0.2  L15A_ = rst ? 0 : ~(0|A12U259Pad1);
// Gate A12-U233A
assign #0.2  A12U231Pad8 = rst ? 1 : ~(0|A12U233Pad2|A12U232Pad1);
// Gate A12-U156A
assign #0.2  A12U156Pad1 = rst ? 1 : ~(0|G16A_|A12U155Pad1|G13);
// Gate A12-U132A
assign #0.2  A12U109Pad4 = rst ? 1 : ~(0|A12G03_|A12G02_|G01);
// Gate A12-U156B
...
// Gate A12-U155B
assign #0.2  A12U155Pad9 = rst ? 0 : ~(0|G16|G13|G14);
// Gate A12-U144A
assign #0.2  A12U144Pad1 = rst ? 0 : ~(0|A12U143Pad7|A12U142Pad1|G08);
// Gate A12-U155A
assign #0.2  A12U155Pad1 = rst ? 0 : ~(0|G14);
// Gate A12-U142A
assign #0.2  A12U142Pad1 = rst ? 0 : ~(0|G07);
...
// Gate A12-U142B
assign #0.2  A12U142Pad9 = rst ? 0 : ~(0|G07|G09|G08);
// Gate A12-U111A
...
// Gate A12-U214B
assign #0.2  S11_ = rst ? 0 : ~(0|A12U214Pad8);
// Gate A12-U230B
