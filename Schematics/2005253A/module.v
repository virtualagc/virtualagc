...
// Gate A12-U134A
pullup(A12G03_);
assign #GATE_DELAY A12G03_ = rst ? 1'bz : ((0|G03) ? 1'b0 : 1'bz);
// Gate A12-U219A
pullup(S10);
...
// Gate A12-U206A
pullup(g34351);
assign #GATE_DELAY g34351 = rst ? 1'bz : ((0|SR_|T12A) ? 1'b0 : 1'bz);
// Gate A12-U145B
pullup(g34128);
...
// Gate A12-U207A
pullup(g34349);
assign #GATE_DELAY g34349 = rst ? 1'bz : ((0|T12A|CYR_) ? 1'b0 : 1'bz);
// Gate A12-U139B
pullup(g34113);
...
// Gate A12-U132B
pullup(A12G02_);
assign #GATE_DELAY A12G02_ = rst ? 1'bz : ((0|G02) ? 1'b0 : 1'bz);
// Gate A12-U134B
pullup(g34107);
...
pullup(g34357);
assign #GATE_DELAY g34357 = rst ? 0 : ((0|g34351|g34349|g34353|g34355) ? 1'b0 : 1'bz);
// Gate A12-U140A
pullup(PA06_);
...
// Gate A12-U110B
pullup(g34219);
assign #GATE_DELAY g34219 = rst ? 1'bz : ((0|EB9|S10_) ? 1'b0 : 1'bz);
// Gate A12-U131B
pullup(G01A_);
...
// Gate A12-U208A
pullup(SR_);
assign #GATE_DELAY SR_ = rst ? 0 : ((0|g34351|g34345) ? 1'b0 : 1'bz);
...
// Gate A12-U207B
pullup(CYR_);
assign #GATE_DELAY CYR_ = rst ? 0 : ((0|g34349|g34344) ? 1'b0 : 1'bz);
// Gate A12-U124B
pullup(g34239);
...
// Gate A12-U201B
pullup(SHIFT);
assign #GATE_DELAY SHIFT = rst ? 1'bz : ((0|SHIFT_) ? 1'b0 : 1'bz);
// Gate A12-U205A
pullup(g34361);
...
// Gate A12-U204B
pullup(GINH);
assign #GATE_DELAY GINH = rst ? 1'bz : ((0|g34357) ? 1'b0 : 1'bz);
// Gate A12-U155B
pullup(g34147);
...
// Gate A12-U210B
pullup(SHIFT_);
assign #GATE_DELAY SHIFT_ = rst ? 0 : ((0|SHANC|SHINC) ? 1'b0 : 1'bz);
// Gate A12-U151A
pullup(g34139);
