...
initial $display("Gate delay (A12) will be %f ns.", GATE_DELAY);

// Gate A12-U150A A12-U152B
pullup(PA12);
assign #GATE_DELAY PA12 = rst ? 1'bz : ((0|g34137|g34136|g34138|g34139) ? 1'b0 : 1'bz);
// Gate A12-U150B
pullup(g34134);
...
// Gate A12-U160B A12-U159B A12-U135A
pullup(GNZRO);
assign #GATE_DELAY GNZRO = rst ? 0 : ((0|g34142|g34154|g34121|g34132|G15) ? 1'b0 : 1'bz);
// Gate A12-U159A A12-U157B
pullup(PA15);
assign #GATE_DELAY PA15 = rst ? 1'bz : ((0|g34149|g34150|g34147|g34148) ? 1'b0 : 1'bz);
// Gate A12-U147A
pullup(PA09_);
...
// Gate A12-U148A
pullup(g34136);
assign #GATE_DELAY g34136 = rst ? 0 : ((0|G11|G10|G12) ? 1'b0 : 1'bz);
// Gate A12-U148B
pullup(g34121);
...
// Gate A12-U144B A12-U146B
pullup(PA09);
assign #GATE_DELAY PA09 = rst ? 1'bz : ((0|g34126|g34125|g34127|g34128) ? 1'b0 : 1'bz);
// Gate A12-U146A
pullup(WG_);
...
// Gate A12-U106A A12-U107A
pullup(RELPLS);
assign #GATE_DELAY RELPLS = rst ? 0 : ((0|G01A_|g34204|g34202|G03|_A12_1_G02_) ? 1'b0 : 1'bz);
...
// Gate A12-U133A A12-U135B
pullup(PA03);
assign #GATE_DELAY PA03 = rst ? 1'bz : ((0|g34105|g34104|g34107|g34106) ? 1'b0 : 1'bz);
// Gate A12-U133B
pullup(g34106);
...
pullup(PA06);
assign #GATE_DELAY PA06 = rst ? 1'bz : ((0|g34115|g34114|g34116|g34117) ? 1'b0 : 1'bz);
// Gate A12-U139B
pullup(g34113);
assign #GATE_DELAY g34113 = rst ? 0 : ((0|G06) ? 1'b0 : 1'bz);
// Gate A12-U131A
pullup(g34104);
assign #GATE_DELAY g34104 = rst ? 0 : ((0|G01|G03|G02) ? 1'b0 : 1'bz);
// Gate A12-U131B
pullup(G01A_);
...
// Gate A12-U132B
pullup(_A12_1_G02_);
assign #GATE_DELAY _A12_1_G02_ = rst ? 0 : ((0|G02) ? 1'b0 : 1'bz);
// Gate A12-U141A
pullup(RSC_);
...
// Gate A12-U123A
pullup(PC15);
assign #GATE_DELAY PC15 = rst ? 0 : ((0|g34239|g34238) ? 1'b0 : 1'bz);
// Gate A12-U123B
pullup(PC15_);
...
// Gate A12-U116A A12-U118A
pullup(PALE);
assign #GATE_DELAY PALE = rst ? 0 : ((0|d8XP5|g34247|TPARG_|g34248|GOJAM|SCAD) ? 1'b0 : 1'bz);
// Gate A12-U117B
pullup(MPAL_);
...
// Gate A12-U127A A12-U128A
pullup(PB09);
assign #GATE_DELAY PB09 = rst ? 1'bz : ((0|g34228|g34227|g34230|g34229) ? 1'b0 : 1'bz);
// Gate A12-U127B
pullup(PB09_);
assign #GATE_DELAY PB09_ = rst ? 0 : ((0|PB09) ? 1'b0 : 1'bz);
// Gate A12-U124A
pullup(g34238);
assign #GATE_DELAY g34238 = rst ? 1'bz : ((0|PB09_|PB15) ? 1'b0 : 1'bz);
// Gate A12-U124B
pullup(g34239);
...
// Gate A12-U126A
pullup(g34234);
assign #GATE_DELAY g34234 = rst ? 0 : ((0|PA15|PA12) ? 1'b0 : 1'bz);
// Gate A12-U126B
pullup(g34235);
assign #GATE_DELAY g34235 = rst ? 1'bz : ((0|PA15_|PA12_) ? 1'b0 : 1'bz);
// Gate A12-U130A
pullup(g34227);
assign #GATE_DELAY g34227 = rst ? 0 : ((0|PA09|PA06|PA03) ? 1'b0 : 1'bz);
// Gate A12-U130B
pullup(g34228);
...
// Gate A12-U252A
pullup(g34437);
assign #GATE_DELAY g34437 = rst ? 0 : ((0|g34436|g34438) ? 1'b0 : 1'bz);
// Gate A12-U252B
pullup(g34467);
...
// Gate A12-U253A
pullup(g34438);
assign #GATE_DELAY g34438 = rst ? 1'bz : ((0|g34437|CSG) ? 1'b0 : 1'bz);
...
// Gate A12-U243A
pullup(g34424);
assign #GATE_DELAY g34424 = rst ? 1'bz : ((0|CSG|g34423) ? 1'b0 : 1'bz);
// Gate A12-U243B
pullup(g34423);
...
// Gate A12-U211A A12-U214A A12-U216A
pullup(T12A);
...
// Gate A12-U213A
pullup(g34336);
assign #GATE_DELAY g34336 = rst ? 1'bz : ((0|g34335|CSG) ? 1'b0 : 1'bz);
// Gate A12-U213B
pullup(g34334);
...
// Gate A12-U233A
pullup(g34402);
assign #GATE_DELAY g34402 = rst ? 0 : ((0|g34401|g34403) ? 1'b0 : 1'bz);
// Gate A12-U233B A12-U234B
pullup(S01_);
assign #GATE_DELAY S01_ = rst ? 0 : ((0|g34403) ? 1'b0 : 1'bz);
// Gate A12-U234A
pullup(g34403);
assign #GATE_DELAY g34403 = rst ? 1'bz : ((0|g34402|CSG) ? 1'b0 : 1'bz);
// Gate A12-U240A
pullup(g34416);
...
// Gate A12-U236A
pullup(g34409);
assign #GATE_DELAY g34409 = rst ? 0 : ((0|g34408|g34410) ? 1'b0 : 1'bz);
// Gate A12-U236B A12-U237B
pullup(S02);
assign #GATE_DELAY S02 = rst ? 1'bz : ((0|g34409) ? 1'b0 : 1'bz);
// Gate A12-U237A
pullup(g34410);
assign #GATE_DELAY g34410 = rst ? 1'bz : ((0|g34409|CSG) ? 1'b0 : 1'bz);
// Gate A12-U239A A12-U239B
pullup(S02_);
assign #GATE_DELAY S02_ = rst ? 0 : ((0|g34410) ? 1'b0 : 1'bz);
// Gate A12-U230A
pullup(G01ED);
...
// Gate A12-U225A
pullup(g34311);
assign #GATE_DELAY g34311 = rst ? 0 : ((0|g34312|g34310) ? 1'b0 : 1'bz);
// Gate A12-U225B
pullup(g34312);
...
// Gate A12-U257A
pullup(g34444);
assign #GATE_DELAY g34444 = rst ? 0 : ((0|g34443|g34445) ? 1'b0 : 1'bz);
// Gate A12-U257B
pullup(S07);
assign #GATE_DELAY S07 = rst ? 1'bz : ((0|g34444) ? 1'b0 : 1'bz);
// Gate A12-U258A
pullup(g34445);
assign #GATE_DELAY g34445 = rst ? 1'bz : ((0|g34444|CSG) ? 1'b0 : 1'bz);
// Gate A12-U258B
pullup(S07_);
