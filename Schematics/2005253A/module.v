...
pullup(RELPLS);
assign #GATE_DELAY RELPLS = rst ? 0 : ((0|G03|A12G02_|G01A_|g34204|g34202) ? 1'b0 : 1'bz);
// Gate A12-U213A
pullup(g34336);
...
// Gate A12-U218A
pullup(g34328);
assign #GATE_DELAY g34328 = rst ? 0 : ((0|CSG|g34327) ? 1'b0 : 1'bz);
// Gate A12-U150B
pullup(g34134);
...
// Gate A12-U228A
pullup(g34303);
assign #GATE_DELAY g34303 = rst ? 0 : ((0|g34304|g34302) ? 1'b0 : 1'bz);
// Gate A12-U247B
pullup(g34429);
...
// Gate A12-U132A
pullup(g34105);
assign #GATE_DELAY g34105 = rst ? 0 : ((0|G01|A12G02_|A12G03_) ? 1'b0 : 1'bz);
// Gate A12-U156B
pullup(g34149);
...
pullup(INHPLS);
assign #GATE_DELAY INHPLS = rst ? 0 : ((0|G02|A12G03_|G01|g34204|g34202) ? 1'b0 : 1'bz);
// Gate A12-U151B
pullup(g34138);
