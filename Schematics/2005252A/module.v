...
// Gate A7-U202A
assign #0.2  CIFF = rst ? 0 : !(0|g33458|CUG);
...
// Gate A7-U224B
assign #0.2  YT1 = rst ? 1 : !(0|EAD09_|EAD10|EAD11);
// Gate A7-U237B
...
// Gate A7-U160B
assign #0.2  g33125 = rst ? 0 : !(0|PIFL_|L15_);
...
// Gate A7-U203A
assign #0.2  g33458 = rst ? 1 : !(0|CI|CIFF);
// Gate A7-U142B
