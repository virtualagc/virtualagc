...
// Gate A7-U160B
pullup(g33125);
assign #GATE_DELAY g33125 = rst ? 1'bz : ((0|PIFL_|L15_) ? 1'b0 : 1'bz);
...
pullup(g33114);
assign #GATE_DELAY g33114 = rst ? 1'bz : ((0|g33108|g33122) ? 1'b0 : 1'bz);
// Gate A7-U147A
pullup(WG2G_);
...
// Gate A7-U231A
pullup(CI01_);
assign #GATE_DELAY CI01_ = rst ? 0 : ((0|CIFF|CINORM) ? 1'b0 : 1'bz);
// Gate A7-U231B
pullup(g33359);
...
// Gate A7-U204A
pullup(CINORM);
assign #GATE_DELAY CINORM = rst ? 1'bz : ((0|EAC_|NEAC) ? 1'b0 : 1'bz);
// Gate A7-U204B
pullup(g33429);
...
// Gate A7-U203A
pullup(g33458);
assign #GATE_DELAY g33458 = rst ? 0 : ((0|CIFF|CI) ? 1'b0 : 1'bz);
// Gate A7-U202A
pullup(CIFF);
assign #GATE_DELAY CIFF = rst ? 1'bz : ((0|CUG|g33458) ? 1'b0 : 1'bz);
// Gate A7-U254A
pullup(MRAG);
