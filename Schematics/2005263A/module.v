...
// Gate A6-U137A
pullup(IL02_);
assign #GATE_DELAY IL02_ = rst ? 1'bz : ((0|S02_) ? 1'b0 : 1'bz);
// Gate A6-U137B
pullup(IL06);
...
// Gate A6-U138B
pullup(IL02);
assign #GATE_DELAY IL02 = rst ? 0 : ((0|S02) ? 1'b0 : 1'bz);
// Gate A6-U143A
pullup(CGMC);
...
// Gate A6-U121A A6-U120A
pullup(RG_);
assign #GATE_DELAY RG_ = rst ? 1'bz : ((0|g40138|d5XP28|RADRG|d5XP4) ? 1'b0 : 1'bz);
// Gate A6-U121B
pullup(g40142);
assign #GATE_DELAY g40142 = rst ? 0 : ((0|T09|T12|T06) ? 1'b0 : 1'bz);
// Gate A6-U128A
pullup(g40150);
assign #GATE_DELAY g40150 = rst ? 0 : ((0|g40148|MP1_) ? 1'b0 : 1'bz);
// Gate A6-U128B
pullup(ZAP_);
...
// Gate A6-U123B A6-U120B
pullup(g40148);
assign #GATE_DELAY g40148 = rst ? 1'bz : ((0|T06|T04|T02|T08|T10) ? 1'b0 : 1'bz);
// Gate A6-U117A
pullup(RCH_);
...
// Gate A6-U126A A6-U125B
pullup(WB_);
assign #GATE_DELAY WB_ = rst ? 1'bz : ((0|d2XP3|d5XP28|d1XP10|g40145) ? 1'b0 : 1'bz);
// Gate A6-U126B A6-U129A A6-U223B A6-U204A
pullup(RU_);
assign #GATE_DELAY RU_ = rst ? 1'bz : ((0|d6XP5|d5XP12|g40145|ZAP|g40338|g40438|g40354|RDBANK) ? 1'b0 : 1'bz);
// Gate A6-U127A
pullup(MCRO_);
...
// Gate A6-U147A
pullup(g40250);
assign #GATE_DELAY g40250 = rst ? 0 : ((0|g40249|STRT2) ? 1'b0 : 1'bz);
// Gate A6-U147B A6-U148A
pullup(g40249);
assign #GATE_DELAY g40249 = rst ? 0 : ((0|P04|P05_|g40246|STOP_) ? 1'b0 : 1'bz);
...
// Gate A6-U215B A6-U241A
pullup(WA_);
assign #GATE_DELAY WA_ = rst ? 1'bz : ((0|_A6_2_7XP7|g40326|g40354|d2XP5|g40408|g40438) ? 1'b0 : 1'bz);
// Gate A6-U248A
pullup(ST2);
...
// Gate A6-U207A A6-U205A
pullup(g40309);
assign #GATE_DELAY g40309 = rst ? 1'bz : ((0|g40314|g40312|g40313|MINC|MCDU) ? 1'b0 : 1'bz);
// Gate A6-U205B
pullup(g40307);
assign #GATE_DELAY g40307 = rst ? 0 : ((0|DINC_|BR12B_) ? 1'b0 : 1'bz);
// Gate A6-U204B A6-U202A
pullup(g40304);
assign #GATE_DELAY g40304 = rst ? 1'bz : ((0|g40307|PINC|g40302|INCR0|g40303) ? 1'b0 : 1'bz);
// Gate A6-U202B
pullup(g40303);
...
// Gate A6-U203B
pullup(_A6_2_6XP10);
assign #GATE_DELAY _A6_2_6XP10 = rst ? 0 : ((0|g40304|T06_) ? 1'b0 : 1'bz);
// Gate A6-U206A
pullup(g40310);
assign #GATE_DELAY g40310 = rst ? 0 : ((0|g40309|T06_) ? 1'b0 : 1'bz);
// Gate A6-U206B
pullup(MONEX_);
