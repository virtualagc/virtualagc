...
initial $display("Gate delay (A24) will be %f ns.", GATE_DELAY);
...
// Gate A24-U157B A24-U156A A24-U156B
pullup(RCHBT_);
...
// Gate A24-U137A
pullup(g49216);
assign #GATE_DELAY g49216 = rst ? 0 : ((0|F02B) ? 1'b0 : 1'bz);
// Gate A24-U137B
pullup(d12KPPS);
assign #GATE_DELAY d12KPPS = rst ? 1'bz : ((0|FS03|g49216|SB0_) ? 1'b0 : 1'bz);
// Gate A24-U134A
pullup(d25KPPS);
...
// Gate A24-U109A
pullup(g49120);
assign #GATE_DELAY g49120 = rst ? 1'bz : ((0|DKCTR4|DKCTR5) ? 1'b0 : 1'bz);
// Gate A24-U109B
pullup(WATCH);
...
// Gate A24-U112A
pullup(g49123);
assign #GATE_DELAY g49123 = rst ? 0 : ((0|DKCTR5|DKCTR4_) ? 1'b0 : 1'bz);
// Gate A24-U112B
pullup(g49126);
...
// Gate A24-U146A
pullup(g49222);
assign #GATE_DELAY g49222 = rst ? 0 : ((0|F01A) ? 1'b0 : 1'bz);
// Gate A24-U146B
pullup(CDUCLK);
assign #GATE_DELAY CDUCLK = rst ? 1'bz : ((0|SB0_|g49222) ? 1'b0 : 1'bz);
...
// Gate A24-U105A
pullup(g49111);
assign #GATE_DELAY g49111 = rst ? 0 : ((0|g49112|g49110) ? 1'b0 : 1'bz);
// Gate A24-U105B
pullup(OVNHRP);
...
// Gate A24-U103B
pullup(g49105);
assign #GATE_DELAY g49105 = rst ? 0 : ((0|g49103|g49104) ? 1'b0 : 1'bz);
// Gate A24-U102A
pullup(g49103);
assign #GATE_DELAY g49103 = rst ? 0 : ((0|A15_|g49101) ? 1'b0 : 1'bz);
// Gate A24-U102B
pullup(g49104);
assign #GATE_DELAY g49104 = rst ? 1'bz : ((0|A16_|g49102) ? 1'b0 : 1'bz);
// Gate A24-U106A
pullup(g49112);
assign #GATE_DELAY g49112 = rst ? 1'bz : ((0|F17B|g49111) ? 1'b0 : 1'bz);
// Gate A24-U106B
pullup(g49110);
...
// Gate A24-U236B A24-U234A A24-U234B A24-U235A A24-U235B
pullup(GOJAM);
assign #GATE_DELAY GOJAM = rst ? 1'bz : ((0|GOJAM_) ? 1'b0 : 1'bz);
// Gate A24-U246A A24-U246B A24-U245A A24-U245B
pullup(PHS3_);
...
// Gate A24-U229A
pullup(NOZM);
assign #GATE_DELAY NOZM = rst ? 0 : ((0|g49304|PIPGZm) ? 1'b0 : 1'bz);
// Gate A24-U229B
pullup(g49355);
...
// Gate A24-U201A A24-U202B
pullup(GTONE);
assign #GATE_DELAY GTONE = rst ? 0 : ((0|FS08|FS09|F05B_|FS06|FS07A) ? 1'b0 : 1'bz);
// Gate A24-U201B
pullup(OUTCOM);
...
// Gate A24-U228A
pullup(g49304);
assign #GATE_DELAY g49304 = rst ? 1'bz : ((0|F18AX|NOZM) ? 1'b0 : 1'bz);
// Gate A24-U228B
pullup(g49356);
...
// Gate A24-U256A A24-U256B A24-U254B A24-U252A A24-U252B A24-U249A A24-U249B A24-U260A A24-U260B
pullup(CTPLS_);
assign #GATE_DELAY CTPLS_ = rst ? 1'bz : ((0|PIPYP|PIPYM|PIPZP|SHAFTM|PIPXP|PIPXM|TRNP|TRNM|SHAFTP|CDUYM|CDUZP|CDUZM|CDUXP|CDUXM|CDUYP|T5P|T6P|T4P|T1P|T2P|T3P|PIPZM|BMAGXP|BMAGXM|BMAGYP|BMAGYM|BMAGZP) ? 1'b0 : 1'bz);
// Gate A24-U237A
pullup(g49412);
assign #GATE_DELAY g49412 = rst ? 0 : ((0|T08|CDUSTB_) ? 1'b0 : 1'bz);
// Gate A24-U237B
pullup(CDUSTB_);
