...
// Gate A24-U244A
pullup(T01);
assign #0.2  T01 = rst ? 1'bz : ((0|ODDSET_|T01DC_) ? 1'b0 : 1'bz);
// Gate A24-U247A
pullup(F04B_);
...
// Gate A24-U205A
pullup(g49341);
assign #0.2  g49341 = rst ? 1'bz : ((0|FS08_|FS07_|FS09_) ? 1'b0 : 1'bz);
// Gate A24-U250A
pullup(MRCH);
...
// Gate A24-U104B
pullup(g49108);
assign #0.2  g49108 = rst ? 1'bz : ((0|g49106|OVNHRP) ? 1'b0 : 1'bz);
// Gate A24-U228A
pullup(g49304);
...
// Gate A24-U253A
pullup(CNTRSB_);
assign #0.2  CNTRSB_ = rst ? 0 : ((0|SB2) ? 1'b0 : 1'bz);
// Gate A24-U154A
pullup(ELSNCN);
assign #0.2  ELSNCN = rst ? 1'bz : ((0|g49248) ? 1'b0 : 1'bz);
// Gate A24-U154B
pullup(ELSNCM);
assign #0.2  ELSNCM = rst ? 1'bz : ((0|g49248) ? 1'b0 : 1'bz);
// Gate A24-U147B
pullup(d800SET);
assign #0.2  d800SET = rst ? 0 : ((0|SB1_|F07A_) ? 1'b0 : 1'bz);
// Gate A24-U135A
pullup(MON800);
assign #0.2  MON800 = rst ? 0 : ((0|FS07A) ? 1'b0 : 1'bz);
// Gate A24-U224B
pullup(g49359);
...
// Gate A24-U153B
pullup(g49201);
assign #0.2  g49201 = rst ? 0 : ((0|FS04) ? 1'b0 : 1'bz);
// Gate A24-U125A A24-U125B
pullup(CHWL04_);
assign #0.2  CHWL04_ = rst ? 1'bz : ((0|WL04) ? 1'b0 : 1'bz);
// Gate A24-U111B
pullup(MWATCH_);
assign #0.2  MWATCH_ = rst ? 1'bz : ((0|WATCH) ? 1'b0 : 1'bz);
...
// Gate A24-U236A
pullup(IC11_);
assign #0.2  IC11_ = rst ? 0 : ((0|IC11) ? 1'b0 : 1'bz);
// Gate A24-U134A
pullup(d25KPPS);
assign #0.2  d25KPPS = rst ? 0 : ((0|FS02|SB0_|g49221) ? 1'b0 : 1'bz);
// Gate A24-U224A
pullup(MISSZ);
...
pullup(PHS3_);
assign #0.2  PHS3_ = rst ? 0 : ((0|CT) ? 1'b0 : 1'bz);
// Gate A24-U242A A24-U242B
pullup(CHWL14_);
assign #0.2  CHWL14_ = rst ? 1'bz : ((0|WL14) ? 1'b0 : 1'bz);
// Gate A24-U152B
pullup(FS05_);
assign #0.2  FS05_ = rst ? 0 : ((0|FS05) ? 1'b0 : 1'bz);
...
// Gate A24-U106A
pullup(g49112);
assign #0.2  g49112 = rst ? 0 : ((0|g49111|F17B) ? 1'b0 : 1'bz);
// Gate A24-U145A A24-U145B
pullup(F05A_);
assign #0.2  F05A_ = rst ? 1'bz : ((0|F05A) ? 1'b0 : 1'bz);
// Gate A24-U105A
pullup(g49111);
assign #0.2  g49111 = rst ? 1'bz : ((0|g49110|g49112) ? 1'b0 : 1'bz);
// Gate A24-U225B
pullup(F7CSB1_);
...
pullup(SB0_);
assign #0.2  SB0_ = rst ? 1'bz : ((0|SB0) ? 1'b0 : 1'bz);
// Gate A24-U212B
pullup(F5ASB0_);
...
// Gate A24-U216A
pullup(g49316);
assign #0.2  g49316 = rst ? 0 : ((0|g49317|g49314) ? 1'b0 : 1'bz);
// Gate A24-U108A
pullup(g49115);
...
// Gate A24-U111A
pullup(g49119);
assign #0.2  g49119 = rst ? 1'bz : ((0) ? 1'b0 : 1'bz);
// Gate A24-U202A
pullup(FS09_);
assign #0.2  FS09_ = rst ? 0 : ((0|FS09) ? 1'b0 : 1'bz);
...
// Gate A24-U233B
pullup(FLASH);
assign #0.2  FLASH = rst ? 0 : ((0|FS17|FS16) ? 1'b0 : 1'bz);
// Gate A24-U227B
pullup(F07C_);
...
// Gate A24-U155B
pullup(g49251);
assign #0.2  g49251 = rst ? 1'bz : ((0) ? 1'b0 : 1'bz);
// Gate A24-U155A
pullup(g49248);
assign #0.2  g49248 = rst ? 0 : ((0|FS07A) ? 1'b0 : 1'bz);
// Gate A24-U219B
pullup(g49311);
...
// Gate A24-U233A
pullup(FLASH_);
assign #0.2  FLASH_ = rst ? 1'bz : ((0|FLASH) ? 1'b0 : 1'bz);
...
pullup(SB2_);
assign #0.2  SB2_ = rst ? 0 : ((0|SB2) ? 1'b0 : 1'bz);
...
// Gate A24-U108B
pullup(WATCH_);
assign #0.2  WATCH_ = rst ? 1'bz : ((0|WATCHP|WATCH) ? 1'b0 : 1'bz);
// Gate A24-U231A A24-U231B A24-U232B
pullup(F5ASB2_);
assign #0.2  F5ASB2_ = rst ? 1'bz : ((0|F5ASB2) ? 1'b0 : 1'bz);
// Gate A24-U105B
pullup(OVNHRP);
assign #0.2  OVNHRP = rst ? 0 : ((0|g49107|g49108|MP3) ? 1'b0 : 1'bz);
// Gate A24-U206A
pullup(g49351);
assign #0.2  g49351 = rst ? 0 : ((0|F08B_) ? 1'b0 : 1'bz);
// Gate A24-U205B
pullup(g49342);
assign #0.2  g49342 = rst ? 0 : ((0|g49341) ? 1'b0 : 1'bz);
// Gate A24-U107A
pullup(WATCHP);
assign #0.2  WATCHP = rst ? 0 : ((0|g49113|SB2_|g49112) ? 1'b0 : 1'bz);
// Gate A24-U232A
pullup(ONE);
assign #0.2  ONE = rst ? 1'bz : ((0) ? 1'b0 : 1'bz);
// Gate A24-U136B
pullup(NISQ);
assign #0.2  NISQ = rst ? 0 : ((0|NISQ_) ? 1'b0 : 1'bz);
// Gate A24-U216B
pullup(g49317);
assign #0.2  g49317 = rst ? 1'bz : ((0|g49315|g49316) ? 1'b0 : 1'bz);
...
// Gate A24-U206B
pullup(F09D);
assign #0.2  F09D = rst ? 1'bz : ((0|g49351|FS09_) ? 1'b0 : 1'bz);
// Gate A24-U219A
pullup(g49310);
...
// Gate A24-U109B
pullup(WATCH);
assign #0.2  WATCH = rst ? 0 : ((0|WATCH_|g49115) ? 1'b0 : 1'bz);
// Gate A24-U109A
pullup(g49120);
...
// Gate A24-U134B
pullup(g49221);
assign #0.2  g49221 = rst ? 1'bz : ((0|F01B) ? 1'b0 : 1'bz);
// End of NOR gates
