...
// Gate A19-U117B A19-U138B
pullup(T2P);
assign #GATE_DELAY T2P = rst ? 0 : ((0|XB5_|CA2_|OVF_|WOVR_) ? 1'b0 : 1'bz);
// Gate A19-U116A
pullup(g46127);
...
// Gate A19-U235A
pullup(g46333);
assign #GATE_DELAY g46333 = rst ? 1'bz : ((0|g46332|g46334) ? 1'b0 : 1'bz);
// Gate A19-U235B
pullup(g46334);
assign #GATE_DELAY g46334 = rst ? 0 : ((0|g46333|g46351) ? 1'b0 : 1'bz);
// Gate A19-U231A
pullup(BMAGXP);
...
// Gate A19-U250A
pullup(g46352);
assign #GATE_DELAY g46352 = rst ? 1'bz : ((0|g46350|g46353) ? 1'b0 : 1'bz);
// Gate A19-U250B
pullup(g46353);
assign #GATE_DELAY g46353 = rst ? 0 : ((0|g46351|g46352) ? 1'b0 : 1'bz);
// Gate A19-U251A
pullup(g46350);
