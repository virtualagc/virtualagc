...
// Gate A99-U120B
pullup(A99NOROPE);
assign #GATE_DELAY A99NOROPE = rst ? 0 : ((0|ROPER|ROPES|ROPET) ? 1'b0 : 1'bz);
// Gate A99-U216A
pullup(g99231);
assign #GATE_DELAY g99231 = rst ? 0 : ((0|g99230|A99RADDR7) ? 1'b0 : 1'bz);
// Gate A99-U214B
pullup(g99228);
assign #GATE_DELAY g99228 = rst ? 1'bz : ((0|A99ES06_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U218B
pullup(g99236);
assign #GATE_DELAY g99236 = rst ? 0 : ((0|A99ES08_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U124A
pullup(g99147);
assign #GATE_DELAY g99147 = rst ? 1'bz : ((0|g99145|A99QUARTERB) ? 1'b0 : 1'bz);
// Gate A99-U117A
pullup(g99133);
...
pullup(A99ES03_);
assign #GATE_DELAY A99ES03_ = rst ? 1'bz : ((0|XB4E|XB5E|XB6E|XB7E) ? 1'b0 : 1'bz);
// Gate A99-U131B
pullup(g99162);
...
// Gate A99-U222B
pullup(A99RADDR9);
assign #GATE_DELAY A99RADDR9 = rst ? 1'bz : ((0|g99242|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U220A
pullup(A99RADDR8);
assign #GATE_DELAY A99RADDR8 = rst ? 1'bz : ((0|g99237|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U222A
pullup(A99RADDR3);
assign #GATE_DELAY A99RADDR3 = rst ? 1'bz : ((0|g99240|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U201A A99-U201B
pullup(A99ES01_);
assign #GATE_DELAY A99ES01_ = rst ? 1'bz : ((0|XB1E|XB3E|XB5E|XB7E) ? 1'b0 : 1'bz);
// Gate A99-U221B
pullup(g99242);
assign #GATE_DELAY g99242 = rst ? 0 : ((0|g99241|A99RADDR9) ? 1'b0 : 1'bz);
// Gate A99-U217A
pullup(A99RADDR7);
assign #GATE_DELAY A99RADDR7 = rst ? 1'bz : ((0|g99231|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U229B
pullup(A99RADDR6);
assign #GATE_DELAY A99RADDR6 = rst ? 1'bz : ((0|g99257|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U228A
pullup(A99RADDR5);
assign #GATE_DELAY A99RADDR5 = rst ? 1'bz : ((0|g99252|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U225A
pullup(A99RADDR4);
assign #GATE_DELAY A99RADDR4 = rst ? 1'bz : ((0|g99245|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U211A A99-U211B
pullup(A99ES09_);
assign #GATE_DELAY A99ES09_ = rst ? 1'bz : ((0|YT1E|YT3E|YT5E|YT7E) ? 1'b0 : 1'bz);
// Gate A99-U132B
pullup(g99164);
assign #GATE_DELAY g99164 = rst ? 1'bz : ((0|g99163) ? 1'b0 : 1'bz);
// Gate A99-U209A
pullup(g99217);
assign #GATE_DELAY g99217 = rst ? 0 : ((0|A99ES03_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U132A
pullup(g99163);
...
// Gate A99-U223B
pullup(g99246);
assign #GATE_DELAY g99246 = rst ? 1'bz : ((0|A99ES10_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U135B
pullup(g99170);
...
// Gate A99-U223A
pullup(g99245);
assign #GATE_DELAY g99245 = rst ? 0 : ((0|g99219|A99RADDR4) ? 1'b0 : 1'bz);
// Gate A99-U135A
pullup(g99169);
assign #GATE_DELAY g99169 = rst ? 0 : ((0|g99168) ? 1'b0 : 1'bz);
// Gate A99-U203A A99-U203B
pullup(A99ES02_);
assign #GATE_DELAY A99ES02_ = rst ? 1'bz : ((0|XB2E|XB3E|XB6E|XB7E) ? 1'b0 : 1'bz);
// Gate A99-U112B
pullup(g99124);
...
// Gate A99-U224A
pullup(g99247);
assign #GATE_DELAY g99247 = rst ? 0 : ((0|g99246|A99RADDR10) ? 1'b0 : 1'bz);
// Gate A99-U108A
pullup(g99115);
...
// Gate A99-U210A
pullup(g99219);
assign #GATE_DELAY g99219 = rst ? 0 : ((0|A99ES04_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U212A A99-U212B
pullup(A99ES10_);
assign #GATE_DELAY A99ES10_ = rst ? 0 : ((0|YT2E|YT3E|YT6E|YT7E) ? 1'b0 : 1'bz);
// Gate A99-U133A
pullup(g99165);
assign #GATE_DELAY g99165 = rst ? 1'bz : ((0|g99166) ? 1'b0 : 1'bz);
// Gate A99-U119B
pullup(g99138);
assign #GATE_DELAY g99138 = rst ? 1'bz : ((0|g99137|A99NOROPE) ? 1'b0 : 1'bz);
// Gate A99-U119A
pullup(g99137);
assign #GATE_DELAY g99137 = rst ? 0 : ((0|SBF) ? 1'b0 : 1'bz);
// Gate A99-U229A
pullup(g99257);
assign #GATE_DELAY g99257 = rst ? 0 : ((0|g99228|A99RADDR6) ? 1'b0 : 1'bz);
// Gate A99-U141B
pullup(A99FADDR2);
assign #GATE_DELAY A99FADDR2 = rst ? 0 : ((0|IL02) ? 1'b0 : 1'bz);
// Gate A99-U128B
pullup(g99156);
assign #GATE_DELAY g99156 = rst ? 0 : ((0|g99128|RESETA) ? 1'b0 : 1'bz);
// Gate A99-U114B
pullup(g99128);
assign #GATE_DELAY g99128 = rst ? 1'bz : ((0|g99127|g99156) ? 1'b0 : 1'bz);
// Gate A99-U114A
pullup(g99127);
assign #GATE_DELAY g99127 = rst ? 0 : ((0|RESETA|g99159) ? 1'b0 : 1'bz);
// Gate A99-U130A
pullup(g99159);
assign #GATE_DELAY g99159 = rst ? 0 : ((0|g99160) ? 1'b0 : 1'bz);
// Gate A99-U215B
pullup(g99230);
assign #GATE_DELAY g99230 = rst ? 0 : ((0|A99ES07_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U221A
pullup(g99241);
assign #GATE_DELAY g99241 = rst ? 0 : ((0|A99ES09_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U215A
pullup(g99229);
assign #GATE_DELAY g99229 = rst ? 0 : ((0|g99204|A99RADDR1) ? 1'b0 : 1'bz);
// Gate A99-U121B
pullup(g99142);
...
// Gate A99-U122A
pullup(g99143);
assign #GATE_DELAY g99143 = rst ? 1'bz : ((0|g99122|A99QUARTERA) ? 1'b0 : 1'bz);
// Gate A99-U217B
pullup(g99234);
...
// Gate A99-U213A
pullup(g99225);
assign #GATE_DELAY g99225 = rst ? 1'bz : ((0|A99ES05_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U230A
pullup(g99259);
assign #GATE_DELAY g99259 = rst ? 1'bz : ((0|REX|REY) ? 1'b0 : 1'bz);
// Gate A99-U219B
pullup(A99RADDR2);
assign #GATE_DELAY A99RADDR2 = rst ? 1'bz : ((0|g99235|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U233A
pullup(g99265);
assign #GATE_DELAY g99265 = rst ? 1'bz : ((0|g99264|A99EDESTROY) ? 1'b0 : 1'bz);
// Gate A99-U216B
pullup(A99RADDR1);
assign #GATE_DELAY A99RADDR1 = rst ? 1'bz : ((0|g99229|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U210B
pullup(A99ES08_);
assign #GATE_DELAY A99ES08_ = rst ? 1'bz : ((0|YB2E|YB3E) ? 1'b0 : 1'bz);
// Gate A99-U202B
pullup(g99204);
...
// Gate A99-U202A
pullup(g99203);
assign #GATE_DELAY g99203 = rst ? 0 : ((0|SETEK) ? 1'b0 : 1'bz);
// Gate A99-U208A A99-U208B
pullup(A99ES06_);
assign #GATE_DELAY A99ES06_ = rst ? 0 : ((0|XT4E|XT5E|XT6E|XT7E) ? 1'b0 : 1'bz);
// Gate A99-U228B
pullup(A99RADDR11);
assign #GATE_DELAY A99RADDR11 = rst ? 1'bz : ((0|g99254|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U225B
pullup(A99RADDR10);
assign #GATE_DELAY A99RADDR10 = rst ? 1'bz : ((0|g99247|A99RESETK) ? 1'b0 : 1'bz);
// Gate A99-U129A
pullup(g99157);
assign #GATE_DELAY g99157 = rst ? 1'bz : ((0|g99156) ? 1'b0 : 1'bz);
// Gate A99-U138A
pullup(A99FADDR9);
assign #GATE_DELAY A99FADDR9 = rst ? 1'bz : ((0|A99QUARTERB|A99QUARTERA) ? 1'b0 : 1'bz);
// Gate A99-U138B
pullup(A99FADDR8);
assign #GATE_DELAY A99FADDR8 = rst ? 1'bz : ((0|A99QUARTERA|A99QUARTERC) ? 1'b0 : 1'bz);
// Gate A99-U139A
pullup(A99FADDR7);
assign #GATE_DELAY A99FADDR7 = rst ? 0 : ((0|IL07) ? 1'b0 : 1'bz);
// Gate A99-U139B
pullup(A99FADDR6);
...
// Gate A99-U140B
pullup(A99FADDR4);
assign #GATE_DELAY A99FADDR4 = rst ? 0 : ((0|IL04) ? 1'b0 : 1'bz);
// Gate A99-U141A
pullup(A99FADDR3);
assign #GATE_DELAY A99FADDR3 = rst ? 0 : ((0|IL03) ? 1'b0 : 1'bz);
// Gate A99-U129B
pullup(g99158);
assign #GATE_DELAY g99158 = rst ? 0 : ((0|g99157) ? 1'b0 : 1'bz);
// Gate A99-U142A
pullup(A99FADDR1);
assign #GATE_DELAY A99FADDR1 = rst ? 0 : ((0|IL01) ? 1'b0 : 1'bz);
// Gate A99-U104A
pullup(g99107);
...
pullup(A99ES11_);
assign #GATE_DELAY A99ES11_ = rst ? 1'bz : ((0|YT6E|YT7E|YT4E|YT5E) ? 1'b0 : 1'bz);
// Gate A99-U101A
pullup(A99FADDR16);
assign #GATE_DELAY A99FADDR16 = rst ? 0 : ((0|g99106|LOMOD|STR14) ? 1'b0 : 1'bz);
// Gate A99-U102B
pullup(A99FADDR15);
assign #GATE_DELAY A99FADDR15 = rst ? 0 : ((0|ROPER|g99105|g99107) ? 1'b0 : 1'bz);
// Gate A99-U105A A99-U104B
pullup(A99FADDR14);
assign #GATE_DELAY A99FADDR14 = rst ? 0 : ((0|g99113|g99114|g99110|g99111) ? 1'b0 : 1'bz);
// Gate A99-U109A A99-U109B
pullup(A99FADDR13);
assign #GATE_DELAY A99FADDR13 = rst ? 0 : ((0|g99116|g99119|g99120|g99121) ? 1'b0 : 1'bz);
// Gate A99-U122B
pullup(A99QUARTERA);
assign #GATE_DELAY A99QUARTERA = rst ? 0 : ((0|g99143|A99CQA) ? 1'b0 : 1'bz);
// Gate A99-U137A
pullup(A99FADDR11);
assign #GATE_DELAY A99FADDR11 = rst ? 1'bz : ((0|STR210|STR19) ? 1'b0 : 1'bz);
// Gate A99-U127A
pullup(A99QUARTERC);
assign #GATE_DELAY A99QUARTERC = rst ? 0 : ((0|g99152|A99CQC) ? 1'b0 : 1'bz);
// Gate A99-U233B
pullup(g99266);
...
// Gate A99-U120A
pullup(g99139);
assign #GATE_DELAY g99139 = rst ? 0 : ((0|g99138) ? 1'b0 : 1'bz);
// Gate A99-U204B
pullup(g99208);
assign #GATE_DELAY g99208 = rst ? 0 : ((0|A99ES02_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U209B
pullup(A99ES07_);
assign #GATE_DELAY A99ES07_ = rst ? 1'bz : ((0|YB1E|YB3E) ? 1'b0 : 1'bz);
// Gate A99-U235A
pullup(g99269);
...
// Gate A99-U123B
pullup(g99146);
assign #GATE_DELAY g99146 = rst ? 0 : ((0|RESETA) ? 1'b0 : 1'bz);
// Gate A99-U235B
pullup(g99270);
...
// Gate A99-U220B
pullup(g99240);
assign #GATE_DELAY g99240 = rst ? 0 : ((0|g99217|A99RADDR3) ? 1'b0 : 1'bz);
// Gate A99-U112A
pullup(A99FADDR12);
assign #GATE_DELAY A99FADDR12 = rst ? 1'bz : ((0|g99124|g99126) ? 1'b0 : 1'bz);
// Gate A99-U226B
pullup(g99252);
assign #GATE_DELAY g99252 = rst ? 0 : ((0|g99225|A99RADDR5) ? 1'b0 : 1'bz);
// Gate A99-U103B
pullup(g99106);
...
// Gate A99-U227B
pullup(g99254);
assign #GATE_DELAY g99254 = rst ? 0 : ((0|g99253|A99RADDR11) ? 1'b0 : 1'bz);
// Gate A99-U227A
pullup(g99253);
assign #GATE_DELAY g99253 = rst ? 0 : ((0|A99ES11_|g99203) ? 1'b0 : 1'bz);
// Gate A99-U236A
pullup(g99271);
assign #GATE_DELAY g99271 = rst ? 1'bz : ((0|g99272) ? 1'b0 : 1'bz);
// Gate A99-U218A
pullup(g99235);
assign #GATE_DELAY g99235 = rst ? 0 : ((0|g99208|A99RADDR2) ? 1'b0 : 1'bz);
// Gate A99-U231A
pullup(A99EDESTROY);
assign #GATE_DELAY A99EDESTROY = rst ? 0 : ((0|g99260|g99271) ? 1'b0 : 1'bz);
// Gate A99-U117B
pullup(g99134);
...
pullup(A99ES04_);
assign #GATE_DELAY A99ES04_ = rst ? 1'bz : ((0|XT1E|XT3E|XT5E|XT7E) ? 1'b0 : 1'bz);
// Gate A99-U136A
pullup(g99171);
...
// Gate A99-U204A
pullup(A99RESETK);
assign #GATE_DELAY A99RESETK = rst ? 0 : ((0|RSTKX_|RSTKY_|ZID) ? 1'b0 : 1'bz);
// Gate A99-U127B
pullup(g99154);
...
// Gate A99-U130B
pullup(g99160);
assign #GATE_DELAY g99160 = rst ? 1'bz : ((0|g99158) ? 1'b0 : 1'bz);
// Gate A99-U111A
pullup(g99121);
...
pullup(A99ES05_);
assign #GATE_DELAY A99ES05_ = rst ? 0 : ((0|XT2E|XT3E|XT6E|XT7E) ? 1'b0 : 1'bz);
// Gate A99-U136B
pullup(g99172);
...
// Gate A99-U219A
pullup(g99237);
assign #GATE_DELAY g99237 = rst ? 0 : ((0|g99236|A99RADDR8) ? 1'b0 : 1'bz);
// Gate A99-U236B
pullup(g99272);
