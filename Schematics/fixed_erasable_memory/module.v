...
module A99 ( 
  ...
  STR412, WEX, WEY, XB1E, XB2E, XB3E, XB4E, XB5E, XT1E, XT2E, XT4E, XT5E,
  XT6E, YB1E, YB2E, YT1E, YT2E, YT4E, YT6E, CLROPE, HIMOD, LOMOD, RESETA,
  RESETB, RESETC, ROPER, ROPES, ROPET, SA01, SA02, SA03, SA04, SA05, SA06,
  SA07, SA08, SA09, SA10, SA11, SA12, SA13, SA14, SA16, SAP, STR14, STR19,
  STR210, STR311, STR58, STR912, XB6E, XB7E, XT3E, XT7E, YB3E, YT3E, YT5E,
  YT7E, ZID
);
...
input wire rst, GEM01, GEM02, GEM03, GEM04, GEM05, GEM06, GEM07, GEM08, GEM09,
  ...
  SETEK, STR412, WEX, WEY, XB1E, XB2E, XB3E, XB4E, XB5E, XT1E, XT2E, XT4E,
  XT5E, XT6E, YB1E, YB2E, YT1E, YT2E, YT4E, YT6E;

inout wire CLROPE, HIMOD, LOMOD, RESETA, RESETB, RESETC, ROPER, ROPES, ROPET,
  STR14, STR19, STR210, STR311, STR58, STR912, XB6E, XB7E, XT3E, XT7E, YB3E,
  YT3E, YT5E, YT7E, ZID;
...
assign #GATE_DELAY _A99_1_FADDR2 = rst ? 1'bz : ((0|IL02) ? 1'b0 : 1'bz);
// Gate A99-U142A
...
assign #GATE_DELAY _A99_1_FADDR4 = rst ? 1'bz : ((0|IL04) ? 1'b0 : 1'bz);
// Gate A99-U137A
...
assign #GATE_DELAY _A99_1_NOROPE = rst ? 1'bz : ((0|ROPER|ROPES|ROPET) ? 1'b0 : 1'bz);
// Gate A99-U121A
pullup(g99141);
...
assign #GATE_DELAY _A99_2_RADDR2 = rst ? 1'bz : ((0|g99235|_A99_2_RESETK) ? 1'b0 : 1'bz);
// Gate A99-U220A
...
// Gate A99-U226B
pullup(g99252);
assign #GATE_DELAY g99252 = rst ? 1'bz : ((0|g99225|_A99_2_RADDR5) ? 1'b0 : 1'bz);
// Gate A99-U233A
pullup(g99265);
...
assign #GATE_DELAY _A99_2_RADDR5 = rst ? 0 : ((0|g99252|_A99_2_RESETK) ? 1'b0 : 1'bz);
// Gate A99-U228B
pullup(_A99_2_RADDR11);
assign #GATE_DELAY _A99_2_RADDR11 = rst ? 0 : ((0|g99254|_A99_2_RESETK) ? 1'b0 : 1'bz);
// Gate A99-U211A A99-U211B
pullup(_A99_2_ES09_);
assign #GATE_DELAY _A99_2_ES09_ = rst ? 0 : ((0|YT1E|YT3E|YT5E|YT7E) ? 1'b0 : 1'bz);
// Gate A99-U208A A99-U208B
pullup(_A99_2_ES06_);
assign #GATE_DELAY _A99_2_ES06_ = rst ? 0 : ((0|XT4E|XT5E|XT6E|XT7E) ? 1'b0 : 1'bz);
// Gate A99-U214A A99-U213B
pullup(_A99_2_ES11_);
assign #GATE_DELAY _A99_2_ES11_ = rst ? 1'bz : ((0|YT4E|YT5E|YT6E|YT7E) ? 1'b0 : 1'bz);
// Gate A99-U214B
pullup(g99228);
...
// Gate A99-U229A
pullup(g99257);
assign #GATE_DELAY g99257 = rst ? 1'bz : ((0|g99228|_A99_2_RADDR6) ? 1'b0 : 1'bz);
// Gate A99-U229B
pullup(_A99_2_RADDR6);
assign #GATE_DELAY _A99_2_RADDR6 = rst ? 0 : ((0|g99257|_A99_2_RESETK) ? 1'b0 : 1'bz);
