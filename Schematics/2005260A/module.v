...
// Gate A2-U158B A2-U159A A2-U159B A2-U160A
pullup(EVNSET_);
...
// Gate A2-U152B A2-U151B A2-U153B
pullup(ODDSET_);
...
// Gate A2-U213A
pullup(g37231);
assign #GATE_DELAY g37231 = rst ? 1'bz : ((0|T12DC_|EVNSET_|GOSET_) ? 1'b0 : 1'bz);
// Gate A2-U213B
pullup(g37233);
...
// Gate A2-U223A
pullup(P04);
assign #GATE_DELAY P04 = rst ? 1'bz : ((0|P04_|g37213) ? 1'b0 : 1'bz);
// Gate A2-U223B
pullup(P04_);
...
// Gate A2-U202A A2-U202B A2-U201A A2-U204A A2-U204B A2-U205A A2-U205B A2-U206A A2-U206B
pullup(GOJAM);
...
// Gate A2-U210A
pullup(g37237);
assign #GATE_DELAY g37237 = rst ? 1'bz : ((0|MSTP|EVNSET_) ? 1'b0 : 1'bz);
// Gate A2-U210B
pullup(g37239);
...
// Gate A2-U218A
pullup(F01A);
assign #GATE_DELAY F01A = rst ? 1'bz : ((0|P01_|F01B|F01C) ? 1'b0 : 1'bz);
// Gate A2-U118B
pullup(F01C);
...
// Gate A2-U358A A2-U359A A2-U359B
pullup(T12_);
assign #GATE_DELAY T12_ = rst ? 0 : ((0|T12) ? 1'b0 : 1'bz);
// Gate A2-U358B A2-U306A
pullup(T10);
...
// Gate A2-U350A A2-U350B A2-U351A
pullup(T04_);
...
// Gate A2-U320A A2-U320B A2-U303A A2-U326A
pullup(T12SET);
assign #GATE_DELAY T12SET = rst ? 1'bz : ((0|g37314|g37322|g37318|g37327|g37331|g37335|g37339|g37343|EVNSET_|g37310|g37306) ? 1'b0 : 1'bz);
// Gate A2-U304A
pullup(g37346);
assign #GATE_DELAY g37346 = rst ? 1'bz : ((0|EVNSET_|g37343) ? 1'b0 : 1'bz);
// Gate A2-U304B
pullup(T11);
...
// Gate A2-U329A
pullup(T12);
assign #GATE_DELAY T12 = rst ? 1'bz : ((0|EVNSET_|T12DC_) ? 1'b0 : 1'bz);
// Gate A2-U329B
pullup(g37304);
...
// Gate A2-U344A A2-U344B A2-U345A A2-U345B
pullup(T06_);
...
// Gate A2-U337A A2-U337B A2-U336A A2-U336B
pullup(T09_);
