...
// Gate A2-U230A
pullup(g37201);
assign #GATE_DELAY g37201 = rst ? 1'bz : ((0|RINGB_|P04_|P05_) ? 1'b0 : 1'bz);
// Gate A2-U230B
pullup(g37202);
...
// Gate A2-U220B
pullup(SB1);
assign #GATE_DELAY SB1 = rst ? 1'bz : ((0|P03_|P05_) ? 1'b0 : 1'bz);
// Gate A2-U212A
pullup(STOPA);
...
// Gate A2-U118B
pullup(F01C);
assign #GATE_DELAY F01C = rst ? 1'bz : ((0|FS01|F01A) ? 1'b0 : 1'bz);
// Gate A2-U217A
pullup(FS01_);
