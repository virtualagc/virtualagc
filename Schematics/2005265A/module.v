...
// Gate A15-U159A
pullup(g35248);
assign #GATE_DELAY g35248 = rst ? 0 : ((0|g35247|INCSET_) ? 1'b0 : 1'bz);
// Gate A15-U159B A15-U157B
pullup(g35247);
assign #GATE_DELAY g35247 = rst ? 1'bz : ((0|C32M|C33M|C34M|C35M|C36M) ? 1'b0 : 1'bz);
// Gate A15-U158A
pullup(g35243);
...
// Gate A15-U149A
pullup(g35238);
assign #GATE_DELAY g35238 = rst ? 0 : ((0|INCSET_|g35237) ? 1'b0 : 1'bz);
// Gate A15-U149B A15-U150B
pullup(g35237);
assign #GATE_DELAY g35237 = rst ? 1'bz : ((0|C37M|C40M|C41M|C42M|C44M|C43M) ? 1'b0 : 1'bz);
...
// Gate A15-U116B A15-U126A
pullup(EB11_);
assign #GATE_DELAY EB11_ = rst ? 1'bz : ((0|g35128|g35129|EB11|g35156) ? 1'b0 : 1'bz);
// Gate A15-U112B
pullup(RL11_);
...
// Gate A15-U102A A15-U103A
pullup(FB16_);
assign #GATE_DELAY FB16_ = rst ? 0 : ((0|g35151|FB16|g35101) ? 1'b0 : 1'bz);
// Gate A15-U102B
pullup(g35101);
...
// Gate A15-U103B
pullup(FB16);
assign #GATE_DELAY FB16 = rst ? 1'bz : ((0|CFBG|FB16_) ? 1'b0 : 1'bz);
// Gate A15-U101B
pullup(RL13_);
...
// Gate A15-U227A
pullup(g35456);
assign #GATE_DELAY g35456 = rst ? 1'bz : ((0|_A15_2_147L|_A15_2_2510H) ? 1'b0 : 1'bz);
// Gate A15-U227B
pullup(g35435);
...
// Gate A15-U228A
pullup(STR912);
assign #GATE_DELAY STR912 = rst ? 0 : ((0|g35456) ? 1'b0 : 1'bz);
// Gate A15-U228B
pullup(ROPET);
...
// Gate A15-U236A
pullup(RPTAD3);
assign #GATE_DELAY RPTAD3 = rst ? 0 : ((0|g35350|RRPA1_) ? 1'b0 : 1'bz);
// Gate A15-U236B
pullup(PRPOR2);
...
// Gate A15-U233A A15-U234B
pullup(g35353);
assign #GATE_DELAY g35353 = rst ? 1'bz : ((0|g35342|PRPOR4|g35336|g35319|g35314) ? 1'b0 : 1'bz);
// Gate A15-U233B
pullup(RPTAD4);
assign #GATE_DELAY RPTAD4 = rst ? 0 : ((0|RRPA1_|g35353) ? 1'b0 : 1'bz);
// Gate A15-U254A
pullup(g35315);
...
// Gate A15-U235B A15-U234A
pullup(g35350);
assign #GATE_DELAY g35350 = rst ? 1'bz : ((0|g35330|g35342|PRPOR3|g35319|g35309) ? 1'b0 : 1'bz);
