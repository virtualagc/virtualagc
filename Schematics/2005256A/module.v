...
// Gate A9-U258A
pullup(g52336);
assign #GATE_DELAY g52336 = rst ? 1'bz : ((0|Z08_|CZG) ? 1'b0 : 1'bz);
// Gate A9-U133A
pullup(g52136);
...
// Gate A9-U147A
pullup(g52140);
assign #GATE_DELAY g52140 = rst ? 0 : ((0|g52139|CBG) ? 1'b0 : 1'bz);
// Gate A9-U210A
pullup(g52427);
...
// Gate A9-U203A
pullup(A07_);
assign #GATE_DELAY A07_ = rst ? 1'bz : ((0|g52421|g52419|g52418) ? 1'b0 : 1'bz);
...
// Gate A9-U259A
pullup(Z08_);
assign #GATE_DELAY Z08_ = rst ? 0 : ((0|g52336|g52334) ? 1'b0 : 1'bz);
// Gate A9-U139A
pullup(g52151);
...
// Gate A9-U157A
pullup(g52121);
assign #GATE_DELAY g52121 = rst ? 0 : ((0|A05_|CAG) ? 1'b0 : 1'bz);
// Gate A9-U109A
pullup(g52251);
...
// Gate A9-U158A
pullup(A05_);
assign #GATE_DELAY A05_ = rst ? 1'bz : ((0|g52121|g52118|g52119) ? 1'b0 : 1'bz);
// Gate A9-U229A
pullup(Z07_);
...
// Gate A9-U148A
pullup(g52139);
assign #GATE_DELAY g52139 = rst ? 1'bz : ((0|g52140|g52138) ? 1'b0 : 1'bz);
// Gate A9-U107B
pullup(g52245);
...
// Gate A9-U204A
pullup(g52421);
assign #GATE_DELAY g52421 = rst ? 0 : ((0|CAG|A07_) ? 1'b0 : 1'bz);
// Gate A9-U124A
pullup(g52224);
