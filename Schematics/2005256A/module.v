...
initial $display("Gate delay (A9) will be %f ns.", GATE_DELAY);

// Gate A9-U104A A9-U143B A9-U114A A9-U125A
pullup(RL06_);
assign #GATE_DELAY RL06_ = rst ? 1'bz : ((0|g52228|g52232|g52237|MDT06|R1C|g52251|g52242|g52241|g52217|g52222|CH06) ? 1'b0 : 1'bz);
// Gate A9-U104B
pullup(MWL06);
...
// Gate A9-U110B A9-U109B
pullup(G06_);
assign #GATE_DELAY G06_ = rst ? 0 : ((0|g52244|g52243|SA06|g52246|g52245|G06) ? 1'b0 : 1'bz);
// Gate A9-U115A
pullup(g52242);
...
// Gate A9-U102A
pullup(Z06_);
assign #GATE_DELAY Z06_ = rst ? 0 : ((0|g52234|g52236) ? 1'b0 : 1'bz);
// Gate A9-U102B A9-U103B A9-U101B
pullup(WL06_);
assign #GATE_DELAY WL06_ = rst ? 1'bz : ((0|WL06) ? 1'b0 : 1'bz);
// Gate A9-U103A
pullup(g52236);
assign #GATE_DELAY g52236 = rst ? 1'bz : ((0|CZG|Z06_) ? 1'b0 : 1'bz);
// Gate A9-U101A
pullup(g52234);
...
// Gate A9-U137A
pullup(g52131);
assign #GATE_DELAY g52131 = rst ? 0 : ((0|g52130|CQG) ? 1'b0 : 1'bz);
// Gate A9-U137B
pullup(g52145);
...
// Gate A9-U138A
pullup(g52130);
assign #GATE_DELAY g52130 = rst ? 1'bz : ((0|g52131|g52129) ? 1'b0 : 1'bz);
// Gate A9-U138B
pullup(G05);
...
// Gate A9-U151A
pullup(g52127);
assign #GATE_DELAY g52127 = rst ? 1'bz : ((0|L05_|CLG1G) ? 1'b0 : 1'bz);
// Gate A9-U151B
pullup(g52108);
...
// Gate A9-U152A
pullup(L05_);
assign #GATE_DELAY L05_ = rst ? 0 : ((0|g52127|g52124|g52125) ? 1'b0 : 1'bz);
// Gate A9-U152B
pullup(g52106);
...
// Gate A9-U127A
pullup(g52221);
assign #GATE_DELAY g52221 = rst ? 1'bz : ((0|A06_|CAG) ? 1'b0 : 1'bz);
// Gate A9-U127B
pullup(XUY06_);
...
// Gate A9-U128A
pullup(A06_);
assign #GATE_DELAY A06_ = rst ? 0 : ((0|g52221|g52218|g52219) ? 1'b0 : 1'bz);
// Gate A9-U128B
pullup(g52204);
...
// Gate A9-U156A A9-U221B A9-U222B
pullup(G07_);
assign #GATE_DELAY G07_ = rst ? 0 : ((0|G07ED|g52444|SA07|g52443|g52445|G07|g52446) ? 1'b0 : 1'bz);
// Gate A9-U156B A9-U113B A9-U144A A9-U134A
pullup(RL05_);
assign #GATE_DELAY RL05_ = rst ? 1'bz : ((0|g52117|g52122|CH05|MDT05|R1C|g52151|g52141|g52142|g52132|g52137|g52128) ? 1'b0 : 1'bz);
// Gate A9-U148A
pullup(g52139);
...
// Gate A9-U254A
pullup(g52331);
assign #GATE_DELAY g52331 = rst ? 1'bz : ((0|CQG|g52330) ? 1'b0 : 1'bz);
// Gate A9-U254B
pullup(g52345);
...
// Gate A9-U218B A9-U247A A9-U257A A9-U236A
pullup(RL08_);
assign #GATE_DELAY RL08_ = rst ? 1'bz : ((0|R1C|MDT08|g52351|g52342|g52341|g52328|g52337|g52332|g52317|CH08|g52322) ? 1'b0 : 1'bz);
// Gate A9-U247B
pullup(g52317);
...
// Gate A9-U258B A9-U260B A9-U259B
pullup(WL08_);
assign #GATE_DELAY WL08_ = rst ? 1'bz : ((0|WL08) ? 1'b0 : 1'bz);
// Gate A9-U243A
pullup(g52339);
assign #GATE_DELAY g52339 = rst ? 1'bz : ((0|g52338|g52340) ? 1'b0 : 1'bz);
// Gate A9-U243B
pullup(g52313);
...
// Gate A9-U208B
pullup(g52407);
assign #GATE_DELAY g52407 = rst ? 1'bz : ((0|g52406|g52405|g52408) ? 1'b0 : 1'bz);
// Gate A9-U207A
pullup(g52424);
...
// Gate A9-U239A
pullup(L08_);
assign #GATE_DELAY L08_ = rst ? 1'bz : ((0|g52324|g52325|g52327) ? 1'b0 : 1'bz);
// Gate A9-U239B
pullup(g52306);
...
// Gate A9-U215B
pullup(CI08_);
assign #GATE_DELAY CI08_ = rst ? 1'bz : ((0|SUMA07_|g52409) ? 1'b0 : 1'bz);
// Gate A9-U217A A9-U227A A9-U248B A9-U205A
pullup(RL07_);
assign #GATE_DELAY RL07_ = rst ? 1'bz : ((0|g52442|g52451|g52441|g52428|g52437|g52432|R1C|MDT07|g52417|CH07|g52422) ? 1'b0 : 1'bz);
// Gate A9-U217B
pullup(g52417);
...
// Gate A9-U214A
pullup(g52440);
assign #GATE_DELAY g52440 = rst ? 0 : ((0|CBG|g52439) ? 1'b0 : 1'bz);
// Gate A9-U214B
pullup(g52411);
assign #GATE_DELAY g52411 = rst ? 0 : ((0|CI07_) ? 1'b0 : 1'bz);
// Gate A9-U213A
pullup(g52439);
assign #GATE_DELAY g52439 = rst ? 1'bz : ((0|g52438|g52440) ? 1'b0 : 1'bz);
// Gate A9-U213B
pullup(g52413);
...
// Gate A9-U206B A9-U236B
pullup(CO10);
assign #GATE_DELAY CO10 = rst ? 0 : ((0|CI07_|XUY09_|XUY07_|XUY10_|XUY08_) ? 1'b0 : 1'bz);
// Gate A9-U212A
pullup(g52438);
...
// Gate A9-U210A
pullup(g52427);
assign #GATE_DELAY g52427 = rst ? 1'bz : ((0|L07_|CLG1G) ? 1'b0 : 1'bz);
// Gate A9-U210B
pullup(g52408);
assign #GATE_DELAY g52408 = rst ? 0 : ((0|CUG|g52407) ? 1'b0 : 1'bz);
// Gate A9-U209A
pullup(L07_);
assign #GATE_DELAY L07_ = rst ? 0 : ((0|g52427|g52425|g52424) ? 1'b0 : 1'bz);
// Gate A9-U209B
pullup(g52406);
...
// Gate A9-U230B A9-U229B A9-U228B
pullup(WL07_);
assign #GATE_DELAY WL07_ = rst ? 1'bz : ((0|WL07) ? 1'b0 : 1'bz);
// Gate A9-U229A
pullup(Z07_);
assign #GATE_DELAY Z07_ = rst ? 0 : ((0|g52436|g52434) ? 1'b0 : 1'bz);
// Gate A9-U228A
pullup(g52436);
assign #GATE_DELAY g52436 = rst ? 1'bz : ((0|Z07_|CZG) ? 1'b0 : 1'bz);
// Gate A9-U220A
pullup(g52429);
...
// Gate A9-U244A
pullup(g52340);
assign #GATE_DELAY g52340 = rst ? 0 : ((0|CBG|g52339) ? 1'b0 : 1'bz);
// Gate A9-U244B
pullup(g52311);
assign #GATE_DELAY g52311 = rst ? 0 : ((0|CI08_) ? 1'b0 : 1'bz);
// Gate A9-U234A
pullup(g52321);
assign #GATE_DELAY g52321 = rst ? 0 : ((0|CAG|A08_) ? 1'b0 : 1'bz);
// Gate A9-U234B
pullup(XUY08_);
...
// Gate A9-U246B
pullup(SUMB08_);
assign #GATE_DELAY SUMB08_ = rst ? 1'bz : ((0|g52311|g52313) ? 1'b0 : 1'bz);
// Gate A9-U253A
pullup(g52330);
assign #GATE_DELAY g52330 = rst ? 0 : ((0|g52329|g52331) ? 1'b0 : 1'bz);
// Gate A9-U253B
pullup(G08);
assign #GATE_DELAY G08 = rst ? 1'bz : ((0|CGG|G08_) ? 1'b0 : 1'bz);
// Gate A9-U240A
pullup(g52327);
assign #GATE_DELAY g52327 = rst ? 0 : ((0|L08_|CLG1G) ? 1'b0 : 1'bz);
// Gate A9-U240B
pullup(g52308);
assign #GATE_DELAY g52308 = rst ? 1'bz : ((0|CUG|g52307) ? 1'b0 : 1'bz);
// Gate A9-U233A
pullup(A08_);
assign #GATE_DELAY A08_ = rst ? 1'bz : ((0|g52321|g52319|g52318) ? 1'b0 : 1'bz);
// Gate A9-U233B
pullup(g52304);
...
// Gate A9-U252B A9-U251B
pullup(G08_);
assign #GATE_DELAY G08_ = rst ? 0 : ((0|g52345|G08|g52346|g52344|SA08|g52343) ? 1'b0 : 1'bz);
// Gate A9-U251A
pullup(GEM08);
