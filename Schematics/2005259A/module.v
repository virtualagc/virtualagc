...
// Gate A1-U217A
assign #0.2  g38334 = rst ? 1 : ~(0|FS21|g38333);
// Gate A1-U205A
...
// Gate A1-U219A
assign #0.2  g38335 = rst ? 1 : ~(0|F21B|F20A|g38333);
// Gate A1-U227B
...
// Gate A1-U237A
assign #0.2  g38414 = rst ? 0 : ~(0|FS27|g38413);
// Gate A1-U160B
...
// Gate A1-U159B
assign #0.2  g38174 = rst ? 1 : ~(0|FS17|g38173);
// Gate A1-U237B
assign #0.2  FS27 = rst ? 1 : ~(0|g38415|g38414);
// Gate A1-U233B
...
// Gate A1-U236A
assign #0.2  g38413 = rst ? 1 : ~(0|F27A|F26A|g38415);
// Gate A1-U221A
assign #0.2  g38324 = rst ? 1 : ~(0|FS20|g38323);
// Gate A1-U114A
assign #0.2  g38243 = rst ? 1 : ~(0|F05A|F06A|g38245);
// Gate A1-U158A
assign #0.2  g38175 = rst ? 1 : ~(0|g38173|F17B|F16A);
// Gate A1-U234B
...
// Gate A1-U235A
assign #0.2  g38415 = rst ? 0 : ~(0|F27B|F26A|g38413);
// Gate A1-U141B
...
// Gate A1-U138B
assign #0.2  FS11 = rst ? 0 : ~(0|g38115|g38114);
// Gate A1-U156A
assign #0.2  FS16 = rst ? 1 : ~(0|g38165|g38164);
// Gate A1-U159A
assign #0.2  FS17 = rst ? 0 : ~(0|g38174|g38175);
// Gate A1-U149A
...
// Gate A1-U157A
assign #0.2  g38173 = rst ? 0 : ~(0|F17A|g38175|F16A);
// Gate A1-U106A
...
// Gate A1-U218A
assign #0.2  g38333 = rst ? 0 : ~(0|g38335|F20A|F21A);
// Gate A1-U233A
...
// Gate A1-U137A
assign #0.2  g38115 = rst ? 1 : ~(0|g38113|F11B|F10A);
// Gate A1-U138A
assign #0.2  g38114 = rst ? 1 : ~(0|FS11|g38113);
// Gate A1-U137B
assign #0.2  g38113 = rst ? 0 : ~(0|F11A|F10A|g38115);
// Gate A1-U250B
...
// Gate A1-U154A
assign #0.2  g38163 = rst ? 1 : ~(0|F16A|F15A|g38165);
// Gate A1-U153A
assign #0.2  g38165 = rst ? 0 : ~(0|F16B|g38163|F15A);
// Gate A1-U152A
...
// Gate A1-U155A
assign #0.2  g38164 = rst ? 0 : ~(0|FS16|g38163);
// Gate A1-U214A
...
// Gate A1-U217B
assign #0.2  FS21 = rst ? 0 : ~(0|g38334|g38335);
// Gate A1-U230A
