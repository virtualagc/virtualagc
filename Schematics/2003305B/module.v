...
pullup(g98015);
assign #GATE_DELAY g98015 = rst ? 0 : ((0|g98014|g98013) ? 1'b0 : 1'bz);
// Gate A52-U107A
pullup(g98014);
...
// Gate A52-U106B
pullup(g98013);
assign #GATE_DELAY g98013 = rst ? 0 : ((0|g98012|g98003) ? 1'b0 : 1'bz);
// Gate A52-U120A
pullup(g98040);
assign #GATE_DELAY g98040 = rst ? 0 : ((0|MSCDBL_) ? 1'b0 : 1'bz);
// Gate A52-U120B
pullup(g98041);
assign #GATE_DELAY g98041 = rst ? 0 : ((0|g98040|g98059) ? 1'b0 : 1'bz);
// Gate A52-U109A A52-U109B
pullup(g98018);
assign #GATE_DELAY g98018 = rst ? 0 : ((0|g98017) ? 1'b0 : 1'bz);
// Gate A52-U128A
pullup(MDT08);
...
// Gate A52-U108B
pullup(g98017);
assign #GATE_DELAY g98017 = rst ? 0 : ((0|g98016|g98013) ? 1'b0 : 1'bz);
// Gate A52-U119A
pullup(g98038);
assign #GATE_DELAY g98038 = rst ? 0 : ((0|MSCAFL_) ? 1'b0 : 1'bz);
// Gate A52-U119B
pullup(g98039);
...
// Gate A52-U117A
pullup(g98034);
assign #GATE_DELAY g98034 = rst ? 0 : ((0|MVFAIL_) ? 1'b0 : 1'bz);
// Gate A52-U117B
pullup(g98035);
...
// Gate A52-U118A
pullup(g98036);
assign #GATE_DELAY g98036 = rst ? 0 : ((0|MCTRAL_) ? 1'b0 : 1'bz);
// Gate A52-U118B
pullup(g98037);
...
// Gate A52-U104A
pullup(g98008);
assign #GATE_DELAY g98008 = rst ? 0 : ((0|MWL06) ? 1'b0 : 1'bz);
// Gate A52-U104B
pullup(g98009);
assign #GATE_DELAY g98009 = rst ? 0 : ((0|MT01) ? 1'b0 : 1'bz);
// Gate A52-U110A A52-U110B A52-U101B
pullup(g98003);
assign #GATE_DELAY g98003 = rst ? 0 : ((0|g98008|g98006|g98007|g98009|g98010|g98005|g98004|g98002) ? 1'b0 : 1'bz);
// Gate A52-U112A
pullup(g98024);
...
// Gate A52-U114A
pullup(g98028);
assign #GATE_DELAY g98028 = rst ? 0 : ((0|MTCAL_) ? 1'b0 : 1'bz);
// Gate A52-U114B
pullup(g98029);
assign #GATE_DELAY g98029 = rst ? 0 : ((0|g98028|g98047) ? 1'b0 : 1'bz);
// Gate A52-U111A
pullup(g98022);
assign #GATE_DELAY g98022 = rst ? 0 : ((0|MPAL_) ? 1'b0 : 1'bz);
// Gate A52-U111B
pullup(g98023);
assign #GATE_DELAY g98023 = rst ? 0 : ((0|g98022|g98043) ? 1'b0 : 1'bz);
// Gate A52-U113A
pullup(g98026);
assign #GATE_DELAY g98026 = rst ? 0 : ((0|MPAL_|g98024) ? 1'b0 : 1'bz);
// Gate A52-U113B
pullup(g98027);
assign #GATE_DELAY g98027 = rst ? 0 : ((0|g98026|g98045) ? 1'b0 : 1'bz);
// Gate A52-U102A
pullup(g98004);
assign #GATE_DELAY g98004 = rst ? 0 : ((0|MWL02) ? 1'b0 : 1'bz);
// Gate A52-U102B
pullup(g98005);
assign #GATE_DELAY g98005 = rst ? 0 : ((0|MWL03) ? 1'b0 : 1'bz);
// Gate A52-U101A
pullup(g98002);
assign #GATE_DELAY g98002 = rst ? 0 : ((0|MWL01) ? 1'b0 : 1'bz);
// Gate A52-U103A
pullup(g98006);
assign #GATE_DELAY g98006 = rst ? 0 : ((0|MWL04) ? 1'b0 : 1'bz);
// Gate A52-U103B
pullup(g98007);
assign #GATE_DELAY g98007 = rst ? 0 : ((0|MWL05) ? 1'b0 : 1'bz);
// End of NOR gates
