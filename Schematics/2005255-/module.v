...
initial $display("Gate delay (A8) will be %f ns.", GATE_DELAY);

// Gate A8-U101A
pullup(g51234);
assign #GATE_DELAY g51234 = rst ? 0 : ((0|WZG_|WL02_) ? 1'b0 : 1'bz);
// Gate A8-U101B A8-U102B A8-U103B
pullup(WL02_);
assign #GATE_DELAY WL02_ = rst ? 1'bz : ((0|WL02) ? 1'b0 : 1'bz);
// Gate A8-U102A
pullup(Z02_);
assign #GATE_DELAY Z02_ = rst ? 0 : ((0|g51234|g51236) ? 1'b0 : 1'bz);
// Gate A8-U143A A8-U221B A8-U222B
pullup(G03_);
assign #GATE_DELAY G03_ = rst ? 1'bz : ((0|G03ED|g51444|SA03|g51443|g51445|G03|g51446) ? 1'b0 : 1'bz);
// Gate A8-U143B A8-U114A A8-U104A A8-U125A
pullup(RL02_);
assign #GATE_DELAY RL02_ = rst ? 1'bz : ((0|RB2|MDT02|R1C|g51251|g51242|g51241|g51228|g51232|g51237|g51217|g51222|CH02) ? 1'b0 : 1'bz);
// Gate A8-U114B
pullup(g51217);
...
// Gate A8-U158A
pullup(A01_);
assign #GATE_DELAY A01_ = rst ? 1'bz : ((0|g51121|g51118|g51119) ? 1'b0 : 1'bz);
// Gate A8-U158B
pullup(g51104);
assign #GATE_DELAY g51104 = rst ? 0 : ((0|CUG|g51103|CLXC) ? 1'b0 : 1'bz);
// Gate A8-U157A
pullup(g51121);
assign #GATE_DELAY g51121 = rst ? 0 : ((0|A01_|CAG) ? 1'b0 : 1'bz);
// Gate A8-U157B
pullup(XUY01_);
...
// Gate A8-U107A
pullup(g51231);
assign #GATE_DELAY g51231 = rst ? 0 : ((0|g51230|CQG) ? 1'b0 : 1'bz);
// Gate A8-U107B
pullup(g51245);
...
// Gate A8-U121A
pullup(g51227);
assign #GATE_DELAY g51227 = rst ? 1'bz : ((0|CLG1G|L02_) ? 1'b0 : 1'bz);
// Gate A8-U121B
pullup(g51208);
assign #GATE_DELAY g51208 = rst ? 1'bz : ((0|g51207|CUG) ? 1'b0 : 1'bz);
// Gate A8-U122A
pullup(L02_);
assign #GATE_DELAY L02_ = rst ? 0 : ((0|g51227|g51224|g51225) ? 1'b0 : 1'bz);
// Gate A8-U122B
pullup(g51206);
assign #GATE_DELAY g51206 = rst ? 0 : ((0|WYDG_|WL01_) ? 1'b0 : 1'bz);
// Gate A8-U108A
pullup(g51230);
assign #GATE_DELAY g51230 = rst ? 1'bz : ((0|g51231|g51229) ? 1'b0 : 1'bz);
// Gate A8-U108B
pullup(G02);
...
// Gate A8-U132B A8-U133B A8-U131B
pullup(WL01_);
...
// Gate A8-U148A
pullup(g51139);
assign #GATE_DELAY g51139 = rst ? 1'bz : ((0|g51140|g51138) ? 1'b0 : 1'bz);
// Gate A8-U148B
pullup(g51113);
...
// Gate A8-U113A A8-U139B A8-U140B
pullup(G01_);
assign #GATE_DELAY G01_ = rst ? 1'bz : ((0|G01ED|g51145|g51146|G01|g51144|g51143|SA01) ? 1'b0 : 1'bz);
// Gate A8-U113B A8-U134A A8-U156B A8-U144A
pullup(RL01_);
assign #GATE_DELAY RL01_ = rst ? 1'bz : ((0|R15|MDT01|RB1|g51132|g51137|g51128|g51117|g51122|CH01|g51151|g51141|g51142) ? 1'b0 : 1'bz);
// Gate A8-U135A
pullup(g51137);
...
// Gate A8-U156A A8-U109B A8-U110B
pullup(G02_);
assign #GATE_DELAY G02_ = rst ? 0 : ((0|G02ED|g51246|g51245|G02|g51244|g51243|SA02) ? 1'b0 : 1'bz);
// Gate A8-U109A
pullup(g51251);
...
// Gate A8-U155B A8-U125B
pullup(CO04);
assign #GATE_DELAY CO04 = rst ? 0 : ((0|CI01_|XUY01_|XUY03_|XUY02_|XUY04_) ? 1'b0 : 1'bz);
// Gate A8-U144B
pullup(g51117);
...
// Gate A8-U147A
pullup(g51140);
assign #GATE_DELAY g51140 = rst ? 0 : ((0|g51139|CBG) ? 1'b0 : 1'bz);
// Gate A8-U147B
pullup(g51111);
...
// Gate A8-U209A
pullup(L03_);
assign #GATE_DELAY L03_ = rst ? 0 : ((0|g51427|g51425|g51424) ? 1'b0 : 1'bz);
// Gate A8-U209B
pullup(g51406);
...
// Gate A8-U210A
pullup(g51427);
assign #GATE_DELAY g51427 = rst ? 1'bz : ((0|L03_|CLG1G) ? 1'b0 : 1'bz);
// Gate A8-U210B
pullup(g51408);
...
// Gate A8-U206B A8-U236B
pullup(CO06);
assign #GATE_DELAY CO06 = rst ? 0 : ((0|CI03_|XUY05_|XUY03_|XUY06_|XUY04_) ? 1'b0 : 1'bz);
// Gate A8-U214A
pullup(g51440);
...
// Gate A8-U212B
pullup(SUMA03_);
assign #GATE_DELAY SUMA03_ = rst ? 1'bz : ((0|g51409|XUY03_|CI03_) ? 1'b0 : 1'bz);
// Gate A8-U217A A8-U205A A8-U248B A8-U227A
pullup(RL03_);
assign #GATE_DELAY RL03_ = rst ? 1'bz : ((0|g51442|g51451|g51441|g51417|CH03|g51422|R15|R1C|MDT03|g51428|g51437|g51432) ? 1'b0 : 1'bz);
// Gate A8-U217B
pullup(g51417);
...
// Gate A8-U205B A8-U252B A8-U251B
pullup(G04_);
assign #GATE_DELAY G04_ = rst ? 0 : ((0|G04ED|g51345|G04|g51346|g51344|SA04|g51343) ? 1'b0 : 1'bz);
// Gate A8-U247A A8-U236A A8-U257A A8-U218B
pullup(RL04_);
assign #GATE_DELAY RL04_ = rst ? 1'bz : ((0|g51351|g51342|g51341|g51317|CH04|g51322|g51328|g51337|g51332|R15|R1C|MDT04) ? 1'b0 : 1'bz);
// Gate A8-U247B
pullup(g51317);
...
// Gate A8-U240A
pullup(g51327);
assign #GATE_DELAY g51327 = rst ? 0 : ((0|L04_|CLG1G) ? 1'b0 : 1'bz);
// Gate A8-U240B
pullup(g51308);
assign #GATE_DELAY g51308 = rst ? 1'bz : ((0|CUG|g51307) ? 1'b0 : 1'bz);
// Gate A8-U239A
pullup(L04_);
assign #GATE_DELAY L04_ = rst ? 1'bz : ((0|g51324|g51325|g51327) ? 1'b0 : 1'bz);
// Gate A8-U239B
pullup(g51306);
assign #GATE_DELAY g51306 = rst ? 0 : ((0|WL03_|WYDG_) ? 1'b0 : 1'bz);
// Gate A8-U234A
pullup(g51321);
assign #GATE_DELAY g51321 = rst ? 0 : ((0|CAG|A04_) ? 1'b0 : 1'bz);
// Gate A8-U234B
pullup(XUY04_);
...
// Gate A8-U233A
pullup(A04_);
assign #GATE_DELAY A04_ = rst ? 1'bz : ((0|g51321|g51319|g51318) ? 1'b0 : 1'bz);
// Gate A8-U233B
pullup(g51304);
...
// Gate A8-U242B
pullup(SUMA04_);
assign #GATE_DELAY SUMA04_ = rst ? 1'bz : ((0|g51309|XUY04_|CI04_) ? 1'b0 : 1'bz);
// Gate A8-U243A
pullup(g51339);
...
// Gate A8-U228B A8-U229B A8-U230B
pullup(WL03_);
...
// Gate A8-U223A
pullup(g51430);
assign #GATE_DELAY g51430 = rst ? 1'bz : ((0|g51429|g51431) ? 1'b0 : 1'bz);
// Gate A8-U223B
pullup(G03);
...
// Gate A8-U224A
pullup(g51431);
assign #GATE_DELAY g51431 = rst ? 0 : ((0|CQG|g51430) ? 1'b0 : 1'bz);
// Gate A8-U224B
pullup(g51445);
...
// Gate A8-U253A
pullup(g51330);
assign #GATE_DELAY g51330 = rst ? 0 : ((0|g51329|g51331) ? 1'b0 : 1'bz);
// Gate A8-U253B
pullup(G04);
assign #GATE_DELAY G04 = rst ? 1'bz : ((0|CGG|G04_) ? 1'b0 : 1'bz);
// Gate A8-U258A
pullup(g51336);
assign #GATE_DELAY g51336 = rst ? 0 : ((0|Z04_|CZG) ? 1'b0 : 1'bz);
// Gate A8-U258B A8-U259B A8-U260B
pullup(WL04_);
...
// Gate A8-U259A
pullup(Z04_);
assign #GATE_DELAY Z04_ = rst ? 1'bz : ((0|g51336|g51334) ? 1'b0 : 1'bz);
// Gate A8-U260A
pullup(g51334);
...
// Gate A8-U254A
pullup(g51331);
assign #GATE_DELAY g51331 = rst ? 1'bz : ((0|CQG|g51330) ? 1'b0 : 1'bz);
// Gate A8-U254B
pullup(g51345);
