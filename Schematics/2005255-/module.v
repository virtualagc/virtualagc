...
// Gate A8-U223A
assign #0.2  A8U223Pad1 = rst ? 0 : ~(0|A8U223Pad2|A8U220Pad1);
// Gate A8-U218B A8-U236A A8-U257A A8-U247A
assign #0.2  RL04_ = rst ? 1 : ~(0|R15|R1C|MDT04|A8U235Pad1|CH04|A8U236Pad4|A8U255Pad1|A8U256Pad1|A8J3Pad340|A8U245Pad1|A8U246Pad1|A8U247Pad4);
// Gate A8-U147A
assign #0.2  A8U145Pad2 = rst ? 0 : ~(0|CBG|A8U146Pad3);
// Gate A8-U152B
assign #0.2  A8U152Pad9 = rst ? 0 : ~(0|WYDLOG_|WL16_);
// Gate A8-U148B
assign #0.2  A8U145Pad7 = rst ? 1 : ~(0|A8U146Pad8|XUY01_);
// Gate A8-U232A
...
// Gate A8-U240A
assign #0.2  A8U239Pad2 = rst ? 1 : ~(0|CLG1G|L04_);
// Gate A8-U225B
...
assign #0.2  G02_ = rst ? 0 : ~(0|A8U106Pad9|A8U107Pad9|G02|G02ED|A8U110Pad6|A8U110Pad7|SA02);
// Gate A8-U145A
assign #0.2  A8U144Pad2 = rst ? 0 : ~(0|A8U145Pad2|RCG_);
// Gate A8-U115B
assign #0.2  SUMB02_ = rst ? 0 : ~(0|A8U115Pad7|A8U115Pad8);
// Gate A8-U241B
assign #0.2  A8U241Pad9 = rst ? 1 : ~(0|A8U238Pad9|A8U231Pad9);
// Gate A8-U144B
...
// Gate A8-U203A
assign #0.2  A03_ = rst ? 1 : ~(0|A8U201Pad1|A8U202Pad1|A8U203Pad4);
// Gate A8-U153B
assign #0.2  A8U150Pad8 = rst ? 1 : ~(0|A8U152Pad9|A8U151Pad9|A8U153Pad8);
// Gate A8-U250A
...
// Gate A8-U210B
assign #0.2  A8U204Pad8 = rst ? 1 : ~(0|CUG|A8U208Pad9);
// Gate A8-U259A
assign #0.2  Z04_ = rst ? 0 : ~(0|A8U259Pad2|A8U258Pad1);
// Gate A8-U160A
...
// Gate A8-U208B
assign #0.2  A8U208Pad9 = rst ? 0 : ~(0|A8U208Pad6|A8U207Pad9|A8U204Pad8);
// Gate A8-U129A
...
// Gate A8-U118A
assign #0.2  A8U116Pad3 = rst ? 1 : ~(0|A8U118Pad2|A8U115Pad2);
// Gate A8-U115A
...
// Gate A8-U214A
assign #0.2  A8U213Pad2 = rst ? 1 : ~(0|A8U213Pad1|CBG);
// Gate A8-U253A
...
// Gate A8-U203B
assign #0.2  A8U201Pad8 = rst ? 1 : ~(0|A8U201Pad9|CLXC|CUG);
// Gate A8-U139A
...
// Gate A8-U117A
assign #0.2  A8U115Pad2 = rst ? 0 : ~(0|CBG|A8U116Pad3);
// Gate A8-U224A
assign #0.2  A8U223Pad2 = rst ? 1 : ~(0|A8U223Pad1|CQG);
// Gate A8-U128B
...
// Gate A8-U102A
assign #0.2  Z02_ = rst ? 0 : ~(0|A8U102Pad2|A8U101Pad1);
// Gate A8-U138A
...
// Gate A8-U244B
assign #0.2  A8U244Pad9 = rst ? 1 : ~(0|CI04_);
// Gate A8-U128A
assign #0.2  A02_ = rst ? 1 : ~(0|A8U128Pad2|A8U128Pad3|A8U127Pad1);
// Gate A8-U148A
assign #0.2  A8U146Pad3 = rst ? 1 : ~(0|A8U148Pad2|A8U145Pad2);
// Gate A8-U207B
assign #0.2  A8U207Pad9 = rst ? 0 : ~(0|WL03_|WYLOG_);
// Gate A8-U150B
assign #0.2  A8U146Pad8 = rst ? 0 : ~(0|A8U150Pad7|A8U150Pad8);
...
// Gate A8-U152A
assign #0.2  L01_ = rst ? 0 : ~(0|A8U152Pad2|A8U152Pad3|A8U151Pad1);
// Gate A8-U142A
assign #0.2  CLEARA = rst ? 0 : ~(0|S08A_|SETAB_);
// Gate A8-U204B
assign #0.2  XUY03_ = rst ? 0 : ~(0|A8U201Pad8|A8U204Pad8);
// Gate A8-U219A
assign #0.2  CLEARD = rst ? 0 : ~(0|S08A|SETCD_);
// Gate A8-U133A
assign #0.2  A8U132Pad2 = rst ? 1 : ~(0|Z01_|CZG);
// Gate A8-U209A
assign #0.2  L03_ = rst ? 0 : ~(0|A8U207Pad1|A8U208Pad1|A8U209Pad4);
// Gate A8-U149B
assign #0.2  SUMA01_ = rst ? 1 : ~(0|A8U146Pad8|XUY01_|CI01_);
// Gate A8-U230A
...
// Gate A8-U145B
assign #0.2  SUMB01_ = rst ? 0 : ~(0|A8U145Pad7|A8U145Pad8);
// Gate A8-U256A
...
assign #0.2  G04_ = rst ? 0 : ~(0|A8U250Pad9|SA04|A8U249Pad9|G04ED|A8U252Pad6|G04|A8U252Pad8);
// Gate A8-U254A
...
// Gate A8-U201B
assign #0.2  A8U201Pad9 = rst ? 0 : ~(0|A8U201Pad6|MONEX|A8U201Pad8);
// Gate A8-U150A
...
assign #0.2  G03_ = rst ? 0 : ~(0|G03ED|A8U222Pad6|G03|A8U222Pad8|A8U220Pad9|SA03|A8U219Pad9);
// Gate A8-U253B
...
// Gate A8-U107A
assign #0.2  A8U107Pad1 = rst ? 0 : ~(0|CQG|A8U106Pad2);
// Gate A8-U138B
...
// Gate A8-U239A
assign #0.2  L04_ = rst ? 0 : ~(0|A8U239Pad2|A8U238Pad1|A8U237Pad1);
// Gate A8-U233B
assign #0.2  A8U231Pad8 = rst ? 1 : ~(0|A8U231Pad9|CLXC|CUG);
// Gate A8-U243A
...
// Gate A8-U258A
assign #0.2  A8U258Pad1 = rst ? 1 : ~(0|CZG|Z04_);
// Gate A8-U238B
...
// Gate A8-U215B
assign #0.2  CI04_ = rst ? 0 : ~(0|SUMA03_|A8U211Pad9);
// Gate A8-U242A
...
// Gate A8-U211B
assign #0.2  A8U211Pad9 = rst ? 1 : ~(0|A8U208Pad9|A8U201Pad9);
// Gate A8-U146A
assign #0.2  A8U144Pad3 = rst ? 0 : ~(0|RBLG_|A8U146Pad3);
// Gate A8-U231B
assign #0.2  A8U231Pad9 = rst ? 0 : ~(0|A8U231Pad6|MONEX|A8U231Pad8);
// Gate A8-U106A
...
// Gate A8-U108A
assign #0.2  A8U106Pad2 = rst ? 1 : ~(0|A8U108Pad2|A8U107Pad1);
// Gate A8-U120A
