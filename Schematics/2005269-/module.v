...
// Gate A13-U138A
pullup(g41237);
assign #GATE_DELAY g41237 = rst ? 0 : ((0|g41238|GOJAM) ? 1'b0 : 1'bz);
// Gate A13-U115B
pullup(g41130);
...
// Gate A13-U115A
pullup(g41129);
assign #GATE_DELAY g41129 = rst ? 0 : ((0|G16A_|G01A) ? 1'b0 : 1'bz);
// Gate A13-U160B
pullup(g41201);
...
// Gate A13-U160A
pullup(g41202);
assign #GATE_DELAY g41202 = rst ? 0 : ((0|g41201|F05B_) ? 1'b0 : 1'bz);
// Gate A13-U134B
pullup(SCADBL);
assign #GATE_DELAY SCADBL = rst ? 0 : ((0|d2FSFAL|CON3) ? 1'b0 : 1'bz);
// Gate A13-U154A
pullup(g41213);
assign #GATE_DELAY g41213 = rst ? 0 : ((0|SB0_|g41209|g41211) ? 1'b0 : 1'bz);
// Gate A13-U124B
pullup(g41109);
assign #GATE_DELAY g41109 = rst ? 0 : ((0|IIP_|g41110) ? 1'b0 : 1'bz);
// Gate A13-U157A A13-U155A
pullup(g41211);
assign #GATE_DELAY g41211 = rst ? 0 : ((0|DOFILT|g41206|SCADBL|ALTEST|g41212) ? 1'b0 : 1'bz);
// Gate A13-U130B
pullup(MSTRTP);
...
// Gate A13-U153A
pullup(g41247);
assign #GATE_DELAY g41247 = rst ? 1'bz : ((0|g41205|STRT1) ? 1'b0 : 1'bz);
// Gate A13-U130A
pullup(g41104);
assign #GATE_DELAY g41104 = rst ? 0 : ((0|g41103|g41101) ? 1'b0 : 1'bz);
// Gate A13-U129A
pullup(g41103);
...
pullup(CKTAL_);
assign #GATE_DELAY CKTAL_ = rst ? 1'bz : ((0|g41113|g41112|PALE|WATCHP|g41125|g41126) ? 1'b0 : 1'bz);
// Gate A13-U121A A13-U121B
pullup(MTCAL_);
assign #GATE_DELAY MTCAL_ = rst ? 1'bz : ((0|g41126|g41125) ? 1'b0 : 1'bz);
// Gate A13-U159A
pullup(g41203);
assign #GATE_DELAY g41203 = rst ? 1'bz : ((0|g41204|g41202) ? 1'b0 : 1'bz);
// Gate A13-U146A
pullup(g41225);
assign #GATE_DELAY g41225 = rst ? 1'bz : ((0|SCAFAL|FLTOUT|AGCWAR) ? 1'b0 : 1'bz);
// Gate A13-U149A
pullup(SYNC14_);
assign #GATE_DELAY SYNC14_ = rst ? 1'bz : ((0|g41220) ? 1'b0 : 1'bz);
// Gate A13-U125A
pullup(g41112);
assign #GATE_DELAY g41112 = rst ? 0 : ((0|g41111|g41108) ? 1'b0 : 1'bz);
// Gate A13-U125B
pullup(g41113);
...
// Gate A13-U117A
pullup(G16SW_);
assign #GATE_DELAY G16SW_ = rst ? 0 : ((0|g41129|g41130) ? 1'b0 : 1'bz);
// Gate A13-U141B
pullup(OSCALM);
...
// Gate A13-U106A
pullup(g41142);
assign #GATE_DELAY g41142 = rst ? 0 : ((0|INKL|g41141) ? 1'b0 : 1'bz);
// Gate A13-U158A
pullup(g41205);
assign #GATE_DELAY g41205 = rst ? 0 : ((0|NHVFAL|g41203|F05A_) ? 1'b0 : 1'bz);
...
pullup(MRPTAL_);
assign #GATE_DELAY MRPTAL_ = rst ? 1'bz : ((0|g41112|g41113) ? 1'b0 : 1'bz);
// Gate A13-U134A
pullup(F08B_);
...
// Gate A13-U141A
pullup(g41232);
assign #GATE_DELAY g41232 = rst ? 0 : ((0|STRT2|OSCALM) ? 1'b0 : 1'bz);
// Gate A13-U106B
pullup(g41150);
...
pullup(CTPLS_);
assign #GATE_DELAY CTPLS_ = rst ? 1'bz : ((0|CDUXD|CDUYD|CDUZD|SHAFTD|TRUND|THRSTD|ALTM|OTLNKM|EMSD|RNRADM|GYROD|RNRADP|INLNKM|BMAGZM|INLNKP) ? 1'b0 : 1'bz);
// Gate A13-U111B
pullup(g41138);
...
// Gate A13-U120A
pullup(g41125);
assign #GATE_DELAY g41125 = rst ? 0 : ((0|g41122|F10A_) ? 1'b0 : 1'bz);
// Gate A13-U103A
pullup(g41153);
assign #GATE_DELAY g41153 = rst ? 0 : ((0|g41152|GOJAM|DRPRST) ? 1'b0 : 1'bz);
// Gate A13-U102A
pullup(g41152);
assign #GATE_DELAY g41152 = rst ? 1'bz : ((0|DLKRPT|g41153) ? 1'b0 : 1'bz);
// Gate A13-U105A
pullup(g41143);
assign #GATE_DELAY g41143 = rst ? 0 : ((0|g41141|T03_) ? 1'b0 : 1'bz);
...
// Gate A13-U139A
pullup(g41235);
assign #GATE_DELAY g41235 = rst ? 1'bz : ((0|g41234|T10) ? 1'b0 : 1'bz);
// Gate A13-U124A
pullup(g41110);
assign #GATE_DELAY g41110 = rst ? 1'bz : ((0|g41109|F14B) ? 1'b0 : 1'bz);
// Gate A13-U157B
pullup(MVFAIL_);
...
// Gate A13-U109A
pullup(g41140);
assign #GATE_DELAY g41140 = rst ? 0 : ((0|T09_|g41138|NOTEST) ? 1'b0 : 1'bz);
// Gate A13-U138B
pullup(g41238);
assign #GATE_DELAY g41238 = rst ? 0 : ((0|ERRST|g41237|SBYEXT) ? 1'b0 : 1'bz);
// Gate A13-U137A
pullup(g41239);
assign #GATE_DELAY g41239 = rst ? 1'bz : ((0|g41238|ALTEST) ? 1'b0 : 1'bz);
// Gate A13-U152A
pullup(STRT1);
assign #GATE_DELAY STRT1 = rst ? 0 : ((0|g41245|g41247) ? 1'b0 : 1'bz);
// Gate A13-U111A
pullup(g41139);
assign #GATE_DELAY g41139 = rst ? 0 : ((0|g41138|INKL) ? 1'b0 : 1'bz);
// Gate A13-U147A
pullup(MSCAFL_);
...
pullup(g41218);
assign #GATE_DELAY g41218 = rst ? 0 : ((0|P02|FS01|P03_|CT_) ? 1'b0 : 1'bz);
// Gate A13-U145B
pullup(AGCWAR);
...
// Gate A13-U140A
pullup(g41234);
assign #GATE_DELAY g41234 = rst ? 0 : ((0|g41235|SBY) ? 1'b0 : 1'bz);
// Gate A13-U119A
pullup(g41122);
assign #GATE_DELAY g41122 = rst ? 1'bz : ((0|g41121|F10B) ? 1'b0 : 1'bz);
// Gate A13-U118A
pullup(g41121);
assign #GATE_DELAY g41121 = rst ? 0 : ((0|g41122|TCF0|TC0) ? 1'b0 : 1'bz);
// Gate A13-U137B
pullup(RESTRT);
...
// Gate A13-U128A
pullup(g41102);
assign #GATE_DELAY g41102 = rst ? 0 : ((0|F05B_|g41101) ? 1'b0 : 1'bz);
// Gate A13-U118B
pullup(g41123);
