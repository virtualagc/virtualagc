...
initial $display("Gate delay (A13) will be %f ns.", GATE_DELAY);
...
// Gate A13-U119A
pullup(g41122);
assign #GATE_DELAY g41122 = rst ? 0 : ((0|F10B|g41121) ? 1'b0 : 1'bz);
// Gate A13-U119B
pullup(g41124);
assign #GATE_DELAY g41124 = rst ? 1'bz : ((0|F10B|g41123) ? 1'b0 : 1'bz);
// Gate A13-U118A
pullup(g41121);
assign #GATE_DELAY g41121 = rst ? 1'bz : ((0|TC0|TCF0|g41122) ? 1'b0 : 1'bz);
// Gate A13-U118B
pullup(g41123);
assign #GATE_DELAY g41123 = rst ? 0 : ((0|g41119|g41124) ? 1'b0 : 1'bz);
// Gate A13-U110A
pullup(g41137);
...
// Gate A13-U122A A13-U127A
pullup(CKTAL_);
assign #GATE_DELAY CKTAL_ = rst ? 1'bz : ((0|g41126|g41125|WATCHP|PALE|g41112|g41113) ? 1'b0 : 1'bz);
// Gate A13-U122B
pullup(g41111);
...
// Gate A13-U116B A13-U117B
pullup(g41119);
assign #GATE_DELAY g41119 = rst ? 0 : ((0|T04_|INKL|TC0|TCF0) ? 1'b0 : 1'bz);
// Gate A13-U117A
pullup(G16SW_);
assign #GATE_DELAY G16SW_ = rst ? 0 : ((0|g41130|g41129) ? 1'b0 : 1'bz);
// Gate A13-U108A A13-U108B A13-U113A A13-U113B A13-U103B
pullup(CTPLS_);
assign #GATE_DELAY CTPLS_ = rst ? 1'bz : ((0|RNRADP|GYROD|RNRADM|INLNKM|BMAGZM|INLNKP|THRSTD|TRUND|SHAFTD|ALTM|OTLNKM|EMSD|CDUXD|CDUYD|CDUZD) ? 1'b0 : 1'bz);
// Gate A13-U103A
pullup(g41153);
...
// Gate A13-U138B
pullup(g41238);
assign #GATE_DELAY g41238 = rst ? 1'bz : ((0|ERRST|g41237|SBYEXT) ? 1'b0 : 1'bz);
// Gate A13-U139A
pullup(g41235);
assign #GATE_DELAY g41235 = rst ? 0 : ((0|T10|g41234) ? 1'b0 : 1'bz);
// Gate A13-U139B
pullup(SBYEXT);
assign #GATE_DELAY SBYEXT = rst ? 0 : ((0|g41234) ? 1'b0 : 1'bz);
// Gate A13-U144A
pullup(CGCWAR);
...
// Gate A13-U137A
pullup(g41239);
assign #GATE_DELAY g41239 = rst ? 0 : ((0|ALTEST|g41238) ? 1'b0 : 1'bz);
// Gate A13-U137B
pullup(RESTRT);
assign #GATE_DELAY RESTRT = rst ? 1'bz : ((0|g41239) ? 1'b0 : 1'bz);
// Gate A13-U141A
pullup(g41232);
...
// Gate A13-U115A
pullup(g41129);
assign #GATE_DELAY g41129 = rst ? 1'bz : ((0|G01A|G16A_) ? 1'b0 : 1'bz);
// Gate A13-U115B
pullup(g41130);
assign #GATE_DELAY g41130 = rst ? 0 : ((0|SUMA16_|G01A_|SUMB16_) ? 1'b0 : 1'bz);
...
// Gate A13-U140A
pullup(g41234);
assign #GATE_DELAY g41234 = rst ? 1'bz : ((0|SBY|g41235) ? 1'b0 : 1'bz);
// Gate A13-U123A
pullup(g41108);
...
// Gate A13-U150A A13-U151A
pullup(g41217);
assign #GATE_DELAY g41217 = rst ? 0 : ((0|CT_|P03_|FS01|P02) ? 1'b0 : 1'bz);
// Gate A13-U150B
pullup(SYNC4_);
assign #GATE_DELAY SYNC4_ = rst ? 1'bz : ((0|g41217) ? 1'b0 : 1'bz);
// Gate A13-U156A
pullup(g41209);
