...
## Page 303
                BANK            11
                EBANK=          STBUFF
# THE UPDATE PROGRAM PROCESSES COMMANDS AND DATA INSERATIONS REQUSTED BY THE GROUND VIA UPLINK
...
#  V75E3EXXXXXE... FOR APS2,ENTER MSB,LSB OF RCSTM(TA)0, RCSM(TA)1,
#                  RCSM(TA)2,TA,RD,TIME IN CSEC X 2(28)
#                  POSITION IN METERS X 2(-24)
#  V75E4EXXXXXE... FOR APS3, ENTER ALL BUT RD ABOVE
#  V76EXXXXXE...  STATE VECTOR MSB,LSB OF X,Y,ZXVEL,YVEL,ZVEL,TIME.
#                  TIME IN CSEC X 2(28)
