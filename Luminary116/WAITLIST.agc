...
TWIDDLE         INHINT
                ...
                ROR             SUPERBNK
                XCH             L
## Note: The above thre statements are marked in black ink with a right open brace to the left of the statements.
...
## Note: The above statement (opcode to the end of operand) is undelined with red ink
##       The generated address (01,3466) and the generated octal code (6 3522) including parity (1) are circled in red (single "circle")
