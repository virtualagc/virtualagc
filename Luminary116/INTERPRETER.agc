...
##              2021-05-30 ABS  Added IRT0 location symbol to match scans.
##                              B5TOBB -> B5TOB8
...
BUFNORM         EXTEND                                          # ADD -1 TO AUGMENT SHIFT COUNT AND SHIFT
                ...
                DCA             BUF
                DAS             BUF
## Note: For the three previous statements operator and operand are circled with red ink (single "circle".)
...
## Note: The above statement (operator and operand) have a single red underline in red
