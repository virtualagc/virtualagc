...
# ORS ARE CALCULATED AS 1) ESTIMATED RATES (FOLLOWING) IF NEEDLFLG = 1, OTHERWISE AS 2) DAP FOLLOWING ERRORS FOR
# NEEDLFLG = 0 AND 3) TOTAL ATTITUDE ERRORS FOR NEEDFLG = 1.
...
#              3) IF NEEDLFLG = 1, INPUT OMEGAP, OMEGAQ, AND OMEGAR.
