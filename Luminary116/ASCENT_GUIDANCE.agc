...
## Page 839
                ...
                STCALL          TGO                             # THIS WILL BE USED ON NEXT CYCLE
                                RPCOMP1                         # COMPUTE NEW RR FOR NEXT CYCLE.
                GOTO
                                ASCTERM2
...
RPCOMP1         DLOAD                                           # FLRCS = 1 (TRIM MODE)
                ...
                STORE           PRATE                           #     RF = R + RDOT TGO
RPCOMP2         DLOAD           DMP                             # FLRCS =C (GUIDANCE MODE)
                                PRATE                           # LEAVE FCONS AND PRATE ALONE SO THAT
                                TGO                             #     RF = R + RDOT TGO + (FCONS*TGC**2)/
...
ZDOTCOMP        STQ             CALL                            # COMPUTE CETRAL ANGLE                (0)
                                ASCSAVE
                                THETCOMP
                DMP             DAD
                                KPARM
