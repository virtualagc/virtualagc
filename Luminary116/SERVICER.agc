...
R12             CS              FLGWRD11
                ...
                MASK            NO511BIT
                EXTEND
                BZF             UPDATCHK                        # IF N0511BIT SET,DO NOT CHECK OR POSITION
...
##       the markers "START" and "END" above.
...
##       the appearance of a small "face with ears".
##       At the bottom of the rectangle between the ends of the opening is another small "face" drawing as above withou the "ears".
##
...
## Note: Under the last statement of this page in the generated address column the name "Frank Krall" is written
##       diagonally (from bottom left to top right) in black ink.
## Page 878
                TC              INTPRET
                ABS             DSU
...
## Note: In the generated listing the assigned bank relative address (3571) of the above statement
##       is circled in red
                CADR            LRALT
...
## Note: In the generated listing the assigned bank relative address (3577) of the above statement
##       is circled in red
