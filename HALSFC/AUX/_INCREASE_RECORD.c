/*
  File _INCREASE_RECORD.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
_INCREASE_RECORD (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (550)
  {
  ...
  // NEWNRECS=_DOPE_ALLOC(DOPE)+NRECSMORE; (551)
  {
  ...
  // NEWNBYTES=_SPACE_ROUND(NEWNRECS*_DOPE_WIDTH(DOPE)); (552)
  {
  ...
  // OLDNBYTES=_RECORD#BYTES(DOPE); (553)
  {
    int32_t numberRHS = (int32_t)((
        putFIXED (
            m_SPACE_ROUNDxBYTES,
  ...
  // NBYTESMORE=NEWNBYTES-OLDNBYTES; (554)
  {
    int32_t numberRHS
  ...
  // IF NBYTESMORE > FREEBYTES THEN (555)
  if (1
      & (xGT (getFIXED (m_INCREASE_RECORDxNBYTESMORE), getFIXED (mFREEBYTES))))
    // CALL _STEAL(NBYTESMORE-FREEBYTES); (556)
    {
  ...
  _SQUASH_RECORDS (0);
  // CALL _MOVE_RECS(DOPE,NBYTESMORE); (558)
  {
