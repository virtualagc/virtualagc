/*
  File _UNUSED_BYTES.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
_UNUSED_BYTES (int reset)
{
  ...
  while (1 & (xGT (getFIXED (m_UNUSED_BYTESxCUR), 0)))
    {
      // IF ~_IS_REC_CONSTANT(CUR) THEN (138)
      if (1
          & (xNOT (
              xNEQ (xAND (COREWORD (xadd (getFIXED (m_UNUSED_BYTESxCUR), 20)),
                    ...
                    0))))
        // ANS=ANS+ ( 4294967288 &
        // (_DOPE_WIDTH(CUR)*(_DOPE_ALLOC(CUR)-_DOPE_USED(CUR)))); (139)
        {
