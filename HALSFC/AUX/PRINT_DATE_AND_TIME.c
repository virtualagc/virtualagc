/*
  File PRINT_DATE_AND_TIME.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
PRINT_DATE_AND_TIME (int reset)
{
  ...
  // CALL PRINT_TIME(MESSAGE || MONTH(M - 1) || BLANK || DAY - DAYS(M - 1) ||
  // ', ' || YEAR || '.  CLOCK TIME = ', T); (691)
  {
    putCHARACTERp (
        mPRINT_TIMExMESSAGE,
        xsCAT (
