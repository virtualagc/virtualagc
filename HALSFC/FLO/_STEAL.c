/*
  File _STEAL.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
...
_STEAL (int reset)
{
  ...
  // IF FREELIMIT-FREEPOINT < NBYTES THEN (490)
  if (1
      & (xLT (xsubtract (FREELIMIT (), FREEPOINT ()),
              getFIXED (m_STEALxNBYTES))))
    // DO; (491)
  ...
  // _OLDFREELIMIT,FREELIMIT=FREELIMIT-NBYTES; (494)
  {
    int32_t numberRHS
