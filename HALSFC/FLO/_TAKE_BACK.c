/*
  File _TAKE_BACK.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
...
_TAKE_BACK (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (331)
  {
  ...
  while (1
                  ...
                  xGT (getFIXED (m_TAKE_BACKxLEFTBYTES), 0))))
    {
      ...
      if (1
        ...
        {
        rs1s1:;
          // DIF_RECS,RET_RECS=_DOPE_ALLOC(CUR)-_DOPE_USED(CUR); (342)
          {
          ...
          // IF RET_RECS > 0 THEN (343)
          if (1 & (xGT (getFIXED (m_TAKE_BACKxRET_RECS), 0)))
            // DO; (344)
            {
            rs1s1s1:;
              // RET_RECS=(NBYTES*RET_RECS)/POSSIBLE + 1; (345)
              {
              ...
              // LEFTBYTES=LEFTBYTES-(FREEBYTES-PREV_FREEBYTES); (352)
              {
                int32_t numberRHS = (int32_t)(xsubtract (
                    getFIXED (m_TAKE_BACKxLEFTBYTES),
