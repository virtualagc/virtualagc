/*
  File COMPACTIFYxADD_DESC.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
...
COMPACTIFYxADD_DESC (int reset)
{
  ...
  // IF (L >= LOWER_BOUND) & (L <= UPPER_BOUND) THEN (476)
  if (1
    ...
    rs1:;
      ...
      // IF ND = ACTUAL_DX_TOTAL THEN (479)
      if (1
        ...
        rs1s1:;
          ...
          // INSUFFICIENT SORT AREA. JOB ABANDONED.'; (481)
          {
