/*
  File _FREEBLOCK_CHECKxBLKPROC.c generated by XCOM-I, 2024-08-09 12:38:39.
*/
    ...
    rs1:;
      ...
      if (1
        ...
        rs1s2:;
          ...
          // BPNTR='||BPNTR||',UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (120)
          {
            putCHARACTERp (
                m_SPMANERRxMSG,
      ...
      // BPNTR=_FREEBLOCK_NEXT(BPNTR); (122)
      {
        int32_t numberRHS
      ...
      if (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
        ...
        if (1
          ...
          {
          rs1s3:;
            // CALL _SPMANERR('2 CONSECUTIVE BLOCKS.'); (126)
            {
