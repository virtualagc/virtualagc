/*
  File _FREEBLOCK_CHECK.c generated by XCOM-I, 2024-08-09 12:38:39.
*/
...
_FREEBLOCK_CHECK (int reset)
{
  ...
  // CALL _CHECK_FOR_THEFT; (56)
  _CHECK_FOR_THEFT (0);
  // FBYTES,RBYTES,BLKNO,RECNO=0; (57)
  {
  ...
  // IF FREEPRINT THEN (62)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (63)
    {
    rs1:;
      // IF ^ _IN_COMPACTIFY THEN (64)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (65)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // FIRSTBLOCK ^ = 0 ) * ( FIRSTBLOCK - FREEBASE - 3 ) ) ; (66)
          {
  ...
  while (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxRDOPE), 0)))
    {
      ...
      if (1
        ...
        rs2s1:;
          ...
          // IF FREEPRINT THEN (74)
          if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
            // IF ~ _IN_COMPACTIFY THEN (75)
            if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
              // IF FREELIMIT > FREEPOINT + 650 THEN (76)
              if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // CALL ADDRESS_CHECK(_DOPE_POINTER(RDOPE)); (78)
          {
          ...
          if (1
            ...
            rs2s1s1:;
              ...
              // SIZE,UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (81)
              {
                putCHARACTERp (
                    m_SPMANERRxMSG,
                    xsCAT (
  ...
  if (1 & (xNEQ (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
    ...
    {
    rs3:;
      // CALL _SPMANERR('CONSECUTIVE FREEBLOCKS.'); (89)
      {
  ...
  if (1
    ...
    rs4:;
      ...
      // UPLIM='||UPLIM||',DOWNLIM='||DOWNLIM); (92)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
  ...
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    ...
    {
    rs5:;
      // IF ^ _IN_COMPACTIFY THEN (95)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (96)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          // OUTPUT = FBYTES || ' BYTES OF FREEBYTES, ' || RBYTES || '
          // ALLOCATED, TOTAL OF ' || RBYTES + FBYTES ; (97)
          {
            descriptor_t *stringRHS;
            stringRHS = xsCAT (
  ...
  // CALL _CHECK_FOR_THEFT; (98)
  _CHECK_FOR_THEFT (0);
  // IF (FBYTES~=FREEBYTES) | (RBYTES~=RECBYTES) THEN (99)
  if (1
      & (xOR (
    ...
    rs6:;
      ...
      // RBYTES='||RBYTES||', RECBYTES='||RECBYTES); (101)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
            xsCAT (
