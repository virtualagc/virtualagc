/*
  File DISP.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
...
DISP (int reset)
{
  ...
  // TEMP = VMEM_PAD_DISP(VMEM_OLD_NDX); (860)
  {
    descriptor_t *bitRHS
  ...
  if (1 & (xNEQ (xAND (BYTE0 (mDISPxFLAGS), BYTE0 (mRESV)), 0)))
    ...
    rs1:;
      ...
      // VMEM_RESV_CNT = VMEM_RESV_CNT + 1; (866)
      {
  ...
  // ELSE (867)
    ...
    if (1 & (xNEQ (xAND (BYTE0 (mDISPxFLAGS), BYTE0 (mRELS)), 0)))
      ...
      rs2:;
        ...
        // VMEM_RESV_CNT = VMEM_RESV_CNT - 1; (871)
        {
          int32_t numberRHS
  ...
  // VMEM_PAD_DISP(VMEM_OLD_NDX) = TEMP; (872)
  {
