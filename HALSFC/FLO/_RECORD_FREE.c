/*
  File _RECORD_FREE.c generated by XCOM-I, 2024-08-09 12:38:39.
*/
...
_RECORD_FREE (int reset)
{
  ...
  // CALL _CHECK_FOR_THEFT; (279)
  _CHECK_FOR_THEFT (0);
  // IF _DOPE_ALLOC(DOPE) <= 0 THEN (280)
  if (1 & (xLE (COREWORD (xadd (getFIXED (m_RECORD_FREExDOPE), 8)), 0)))
    ...
    rs1:;
      ...
      {
      rs1s1:;
        // CALL _SPMANERR('IN RECORD_FREE, NOT ALLOCATED: '||DOPE); (283)
        {
          putCHARACTERp (
              m_SPMANERRxMSG,
