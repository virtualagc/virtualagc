/*
  File ZERO_CORE.c generated by XCOM-I, 2024-08-09 12:38:39.
*/
...
ZERO_CORE (int reset)
{
  ...
  // DO WHILE COUNT ~= 0; (851)
  while (1 & (xNEQ (getFIXED (mZERO_CORExCOUNT), 0)))
    {
      // IF COUNT > 256 THEN (852)
      ...
      // CALL ZERO_256(CORE_ADDR,#BYTES); (856)
      {
