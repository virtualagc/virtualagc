/*
  File _GET_SPACE.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
...
_GET_SPACE (int reset)
{
  ...
  // IF (NBYTES& 7) ~= 0 THEN (558)
  if (1 & (xNEQ (xAND (getFIXED (m_GET_SPACExNBYTES), 7), 0)))
    // CALL _SPMANERR( 'IN _GET_SPACE, NBYTES='||NBYTES); (559)
    {
  ...
  // FREEB=_FIND_FREE(NBYTES,UNMOVEABLE); (560)
  {
  ...
  // CALL _REDUCE_BLOCK(FREEB,NBYTES,_TRUE); (562)
  {
