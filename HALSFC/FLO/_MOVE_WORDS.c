/*
  File _MOVE_WORDS.c generated by XCOM-I, 2024-08-08 04:31:35.
*/
  ...
  if (1 & (xGT (getFIXED (m_MOVE_WORDSxDEST), getFIXED (m_MOVE_WORDSxSOURCE))))
    // DO I=0 TO NUMBYTES-4 BY 4; (135)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from2); getFIXED (m_MOVE_WORDSxI) <= to2;
        ...
        {
          // COREWORD(DEST-I) = COREWORD(SOURCE-I); (136)
          {
  ...
  // ELSE (137)
    ...
    // DO I=0 TO NUMBYTES -4 BY 4; (138)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from3); getFIXED (m_MOVE_WORDSxI) <= to3;
        ...
        {
          // COREWORD(DEST+I)=COREWORD(SOURCE+I); (139)
          {
