/*
  File SCANxBUILD_COMMENT.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
SCANxBUILD_COMMENT (int reset)
{
  ...
  // IF NEXT_CHAR ~= BYTE(X1) THEN (6867)
  ...
  // DO BLANK_COUNT = 0 TO BLANK_COUNT; (6869)
  {
    ...
    for (putBIT (16, mBLANK_COUNT, fixedToBit (16, from107));
      ...
      {
        // COMMENT_COUNT = COMMENT_COUNT + 1; (6870)
        {
          int32_t numberRHS
        ...
        // BYTE(SAVE_COMMENT, COMMENT_PTR) = NEXT_CHAR; (6875)
        {
