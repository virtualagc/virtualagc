/*
  File DUMPIT.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
DUMPIT (int reset)
{
  ...
  // OUTPUT = '       OPTIONAL TABLE SIZES'; (9800)
  {
  ...
  // OUTPUT(1) = '0NAME       REQUESTED    USED'; (9801)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT(1) = '+____       _________    ____'; (9802)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = FORM_UP('LITSTRINGS',LIT_CHAR_SIZE,LIT_CHAR_USED); (9804)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = FORM_UP('SYMBOLS   ', SYTSIZE, NDECSY); (9805)
  {
    descriptor_t *stringRHS;
    stringRHS = (putCHARACTERp (mDUMPITxFORM_UPxMSG,
  ...
  // OUTPUT = FORM_UP('MACROSIZE ', MACRO_TEXT_LIM, FIRST_FREE); (9806)
  {
    descriptor_t *stringRHS;
    stringRHS = (putCHARACTERp (mDUMPITxFORM_UPxMSG,
  ...
  // OUTPUT = FORM_UP('XREFSIZE  ', XREF_LIM, XREF_INDEX); (9807)
  {
    descriptor_t *stringRHS;
    stringRHS = (putCHARACTERp (mDUMPITxFORM_UPxMSG,
  ...
  // OUTPUT = FORM_UP('BLOCKSUM  ', OUTER_REF_LIM, OUTER_REF_MAX); (9808)
  {
    descriptor_t *stringRHS;
    stringRHS
  ...
  // OUTPUT = 'CALLS TO SCAN        = ' || SCAN_COUNT; (9810)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'CALLS TO IDENTIFY    = ' || IDENT_COUNT; (9811)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'NUMBER OF REDUCTIONS = ' || REDUCTIONS; (9812)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'MAX STACK SIZE       = ' || MAXSP; (9813)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'MAX IND. STACK SIZE  = ' || MAX_PTR_TOP; (9814)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'END IND. STACK SIZE  = ' || PTR_TOP; (9815)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'END ARRAY STACK SIZE = ' || AS_PTR; (9816)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'MAX EXT_ARRAY INDEX  = ' || EXT_ARRAY_PTR; (9817)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'STATEMENT COUNT      = '||STMT_NUM-1; (9818)
  {
    descriptor_t *stringRHS;
    stringRHS
  ...
  // OUTPUT = 'MINOR COMPACTIFIES   = ' || COMPACTIFIES; (9819)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'MAJOR COMPACTIFIES   = ' || COMPACTIFIES(1); (9820)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'REALLOCATIONS        = '|| REALLOCATIONS; (9821)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'MAX NESTING DEPTH    = ' || MAXNEST; (9822)
  {
    descriptor_t *stringRHS;
  ...
  // OUTPUT = 'FREE STRING AREA     = ' || FREELIMIT - FREEBASE; (9823)
  {
    descriptor_t *stringRHS;
    stringRHS
