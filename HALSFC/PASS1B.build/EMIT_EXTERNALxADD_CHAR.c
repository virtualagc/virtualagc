/*
  File EMIT_EXTERNALxADD_CHAR.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
EMIT_EXTERNALxADD_CHAR (int reset)
{
  ...
  if (1
    ...
    rs1:;
      ...
      // CALL BLANK(NEWBUFF, 0, TPL_LRECL); (7003)
      {
