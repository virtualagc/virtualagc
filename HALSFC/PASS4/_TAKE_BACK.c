/*
  File _TAKE_BACK.c generated by XCOM-I, 2024-08-08 04:33:20.
*/
...
_TAKE_BACK (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (324)
  {
  ...
  while (1
                  ...
                  xGT (getFIXED (m_TAKE_BACKxLEFTBYTES), 0))))
    {
      ...
      if (1
        ...
        {
        rs1s1:;
          // DIF_RECS,RET_RECS=_DOPE_ALLOC(CUR)-_DOPE_USED(CUR); (335)
          {
          ...
          // IF RET_RECS > 0 THEN (336)
          if (1 & (xGT (getFIXED (m_TAKE_BACKxRET_RECS), 0)))
            // DO; (337)
            {
            rs1s1s1:;
              // RET_RECS=(NBYTES*RET_RECS)/POSSIBLE + 1; (338)
              {
              ...
              // LEFTBYTES=LEFTBYTES-(FREEBYTES-PREV_FREEBYTES); (345)
              {
                int32_t numberRHS = (int32_t)(xsubtract (
                    getFIXED (m_TAKE_BACKxLEFTBYTES),
