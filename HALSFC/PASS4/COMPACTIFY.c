/*
  File COMPACTIFY.c generated by XCOM-I, 2024-08-08 04:33:20.
*/
...
COMPACTIFY (int reset)
{
  ...
  // IF LOWER_BOUND = 0 THEN (348)
  if (1 & (xEQ (getFIXED (mCOMPACTIFYxLOWER_BOUND), 0)))
    // LOWER_BOUND = FREEBASE; (349)
    {
...
if (1 & (xNEQ (getFIXED (m_DX_TOTAL), getFIXED (m_PREV_DX_TOTAL))))
  ...
  rs1:;
    ...
    if (1
      ...
      {
      rs1s1:;
        // OUTPUT='BI006 SEVERITY 3  BUG IN COMPACTIFY***  ABORTING'; (367)
        {
...
// DO TRIED = 0 TO 1; (370)
{
  ...
  for (putBIT (1, mCOMPACTIFYxTRIED, fixedToBit (1, from4));
    ...
    {
      // IF FORCE_MAJOR THEN (371)
      if (1 & (bitToFixed (getBIT (1, mFORCE_MAJOR))))
        // DO; (372)
        {
        rs2s1:;
          // FORCE_MAJOR=_FALSE; (373)
          {
      ...
      // COMPACTIFIES(TRIED) = COMPACTIFIES(TRIED) + 1; (376)
      {
              ...
              rs2s3s1:;
                ...
                // DO J=DP TO DP+DW*(_DOPE_USED(L)-1) BY DW; (389)
                {
                  ...
                  for (putFIXED (mCOMPACTIFYxJ, from7);
                    ...
                    {
                      // DO K=J TO J+4*(_DOPE_#DESCRIPTORS(L)-1) BY 4; (390)
                      {
        ...
        rs2s4:;
                 ...
                 putFIXED (mCOMPACTIFYxI, getFIXED (mCOMPACTIFYxI) + by10))
              {
                ...
                if (1
                  ...
                  rs2s4s2s1:;
                    ...
                    if (1 & (xGT (getFIXED (mCOMPACTIFYxDELTA), 0)))
                      // DO K = BC TO TC; (415)
                      {
                        ...
                        for (putFIXED (mCOMPACTIFYxK, from11);
                          ...
                          {
                            // COREBYTE(K-DELTA) = COREBYTE(K); (416)
                            {
                    ...
                    // FREEPOINT = FREEPOINT + TC - BC + 1; (417)
                    {
                      int32_t numberRHS = (int32_t)(xadd (
                          xsubtract (
          ...
          // DO K = BC TO TC; (424)
          {
            ...
            for (putFIXED (mCOMPACTIFYxK, from12);
              ...
              {
                // COREBYTE(K-DELTA) = COREBYTE(K); (425)
                {
                  int32_t numberRHS
          ...
          // FREEPOINT = FREEPOINT + TC - BC + 1; (426)
          {
            int32_t numberRHS = (int32_t)(xadd (
      ...
      if (1 & (getFIXED (mCOMPACTIFYxMODE)))
        ...
        {
        rs2s5:;
          // IF ACTUAL_DX_TOTAL>0 THEN (429)
          if (1 & (xGT (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 0)))
            // CALL MONITOR(7, ADDR(DX), SHL(ACTUAL_DX_TOTAL , 2)); (430)
            MONITOR7 (ADDR ("DX", 0x80000000, NULL, 0),
                      SHL (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 2));
          // I = ADDR(DESCRIPTOR_DESCRIPTOR); (431)
          {
            int32_t numberRHS
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (440)
{
...
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_TRIGGER THEN (448)
if (1
  ...
  rs3:;
    ...
    // K=_SPACE_ROUND(FREESTRING_TARGET - _LAST_COMPACTIFY_FOUND); (451)
    {
...
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_MIN THEN (463)
if (1 & (xLT (getFIXED (m_LAST_COMPACTIFY_FOUND), getFIXED (mFREESTRING_MIN))))
  ...
  rs4:;
    ...
    // MEMORY FOR STRING STORAGE. JOB ABANDONED.'; (465)
    {
      descriptor_t *stringRHS;
      stringRHS = cToDescriptor (
