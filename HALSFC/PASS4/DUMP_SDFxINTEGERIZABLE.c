/*
  File DUMP_SDFxINTEGERIZABLE.c generated by XCOM-I, 2024-08-09 12:40:27.
*/
...
DUMP_SDFxINTEGERIZABLE (int reset)
{
  ...
  reentryGuard = guardReentry (reentryGuard, "DUMP_SDFxINTEGERIZABLE");
...
p17_4:;
  // (18)          CALL INLINE("68", 0, 0, 1, 0);              /* LE 0,0(0,1)
  // */
...
// TEMP = ADDR(NO_INTEGER); (2016)
{
  int32_t numberRHS = (int32_t)(-2);
  putFIXED (mDUMP_SDFxINTEGERIZABLExTEMP, numberRHS);
}
// TEMP1 = ADDR(LIT_NEGMAX); (2017)
{
  int32_t numberRHS = (int32_t)(-1);
  putFIXED (mDUMP_SDFxINTEGERIZABLExTEMP1, numberRHS);
}
...
// Type RX, p. 9-10:		LE
// 4,mDUMP_SDFxINTEGERIZABLExFLT_NEGMAX(0,0)
...
// NEGLIT = SHR(DW(2), 31); (2037)
{
  int32_t numberRHS = (int32_t)(SHR (
      getFIXED (getFIXED (mFOR_DW) + 4 * (2) + 0 + 4 * (0)), 31));
  descriptor_t *bitRHS;
  bitRHS = fixedToBit (32, (int32_t)(numberRHS));
  putBIT (8, mDUMP_SDFxINTEGERIZABLExNEGLIT, bitRHS);
  bitRHS->inUse = 0;
}
// IF NEGLIT THEN (2038)
if (1 & (bitToFixed (getBIT (8, mDUMP_SDFxINTEGERIZABLExNEGLIT))))
  // DO; (2039)
  {
  rs2:;
    // IF DW(3) ~= NEGMAX THEN (2040)
    if (1
        & (xNEQ (getFIXED (getFIXED (mFOR_DW) + 4 * (3) + 0 + 4 * (0)),
                 getFIXED (mDUMP_SDFxINTEGERIZABLExNEGMAX))))
      // DW(3) = -DW(3); (2041)
      {
