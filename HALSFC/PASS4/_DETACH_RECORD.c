/*
  File _DETACH_RECORD.c generated by XCOM-I, 2024-08-08 04:33:20.
*/
...
_DETACH_RECORD (int reset)
{
  ...
  if (1 & (xEQ (getFIXED (m_DETACH_RECORDxPREV), 0)))
    // FIRSTRECORD=_DOPE_NEXT(DOPE); (228)
    {
      int32_t numberRHS
  ...
  // ELSE (229)
    ...
    // _DOPE_NEXT(PREV)=_DOPE_NEXT(DOPE); (230)
    {
      int32_t numberRHS
          = (int32_t)(COREWORD (xadd (getFIXED (m_DETACH_RECORDxDOPE), 16)));
