/*
  File COMPACTIFYxADD_DESC.c generated by XCOM-I, 2024-08-09 12:40:27.
*/
...
COMPACTIFYxADD_DESC (int reset)
{
  ...
  // IF (L >= LOWER_BOUND) & (L <= UPPER_BOUND) THEN (469)
  if (1
    ...
    rs1:;
      ...
      // IF ND = ACTUAL_DX_TOTAL THEN (472)
      if (1
        ...
        rs1s1:;
          ...
          // INSUFFICIENT SORT AREA. JOB ABANDONED.'; (474)
          {
