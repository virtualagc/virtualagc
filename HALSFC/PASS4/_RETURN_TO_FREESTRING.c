/*
  File _RETURN_TO_FREESTRING.c generated by XCOM-I, 2024-08-08 04:33:20.
*/
...
_RETURN_TO_FREESTRING (int reset)
{
  ...
  // ELSE (263)
    ...
    {
    rs2:;
      // CALL _SQUASH_RECORDS; (265)
      _SQUASH_RECORDS (0);
      // IF FIRSTBLOCK <= 0 THEN (266)
      if (1 & (xLE (getFIXED (mFIRSTBLOCK), 0)))
        // DO; (267)
        {
        rs2s1:;
          // CALL _SPMANERR('IN RETURN_TO_FREESTRING,
          // FIRSTBLOCK='||FIRSTBLOCK); (268)
          {
            putCHARACTERp (
                m_SPMANERRxMSG,
      ...
      // CALL _REDUCE_BLOCK(FIRSTBLOCK,NBYTES,_FALSE); (269)
      {
      ...
      // _OLDFREELIMIT,FREELIMIT=FREELIMIT+NBYTES; (270)
      {
      ...
      // FREEBYTES=FREEBYTES-NBYTES; (271)
      {
