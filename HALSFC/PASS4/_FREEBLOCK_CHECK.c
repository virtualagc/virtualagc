/*
  File _FREEBLOCK_CHECK.c generated by XCOM-I, 2024-08-09 12:40:27.
*/
...
_FREEBLOCK_CHECK (int reset)
{
  ...
  // CALL _CHECK_FOR_THEFT; (49)
  _CHECK_FOR_THEFT (0);
  // FBYTES,RBYTES,BLKNO,RECNO=0; (50)
  {
  ...
  // IF FREEPRINT THEN (55)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (56)
    {
    rs1:;
      // IF ^ _IN_COMPACTIFY THEN (57)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (58)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // FIRSTBLOCK ^ = 0 ) * ( FIRSTBLOCK - FREEBASE - 3 ) ) ; (59)
          {
  ...
  while (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxRDOPE), 0)))
    {
      ...
      if (1
        ...
        rs2s1:;
          ...
          // IF FREEPRINT THEN (67)
          if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
            // IF ~ _IN_COMPACTIFY THEN (68)
            if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
              // IF FREELIMIT > FREEPOINT + 650 THEN (69)
              if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // CALL ADDRESS_CHECK(_DOPE_POINTER(RDOPE)); (71)
          {
          ...
          if (1
            ...
            rs2s1s1:;
              ...
              // SIZE,UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (74)
              {
                putCHARACTERp (
                    m_SPMANERRxMSG,
                    xsCAT (
  ...
  if (1 & (xNEQ (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
    ...
    {
    rs3:;
      // CALL _SPMANERR('CONSECUTIVE FREEBLOCKS.'); (82)
      {
  ...
  if (1
    ...
    rs4:;
      ...
      // UPLIM='||UPLIM||',DOWNLIM='||DOWNLIM); (85)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
  ...
  // IF FREEPRINT THEN (86)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (87)
    {
    rs5:;
      // IF ^ _IN_COMPACTIFY THEN (88)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (89)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          // OUTPUT = FBYTES || ' BYTES OF FREEBYTES, ' || RBYTES || '
          // ALLOCATED, TOTAL OF ' || RBYTES + FBYTES ; (90)
          {
            descriptor_t *stringRHS;
            stringRHS = xsCAT (
  ...
  // CALL _CHECK_FOR_THEFT; (91)
  _CHECK_FOR_THEFT (0);
  // IF (FBYTES~=FREEBYTES) | (RBYTES~=RECBYTES) THEN (92)
  if (1
      & (xOR (
    ...
    rs6:;
      ...
      // RBYTES='||RBYTES||', RECBYTES='||RECBYTES); (94)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
            xsCAT (
