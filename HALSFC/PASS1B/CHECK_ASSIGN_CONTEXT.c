/*
  File CHECK_ASSIGN_CONTEXT.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
CHECK_ASSIGN_CONTEXT (int reset)
{
  ...
  // IF CONTEXT>0 THEN (7347)
  if (1 & (xGT (getFIXED (mCONTEXT), 0)))
    // DO; (7348)
    {
    rs1:;
      // CALL SET_XREF_RORS(LOC); (7349)
      {
  ...
  // IF (SYT_FLAGS(FIX) & INP_OR_CONST) ~= 0 THEN (7356)
  if (1
      & (xNEQ (xAND (getFIXED (getFIXED (mSYM_TAB)
                     ...
                     5120),
               0)))
    // CALL ERROR(CLASS_A,1,VAR(LOC)); (7357)
    {
  ...
  // IF (SYT_FLAGS(FIX) & ACCESS_FLAG) ~= 0 THEN (7358)
  if (1
      & (xNEQ (xAND (getFIXED (getFIXED (mSYM_TAB)
                               + 34 * (getFIXED (mCHECK_ASSIGN_CONTEXTxFIX))
                               + 8 + 4 * (0)),
                     65536),
               0)))
    // CALL ERROR(CLASS_PS, 8, VAR(LOC)); (7359)
    {
  ...
  // IF SHR(T,5) THEN (7363)
  if (1 & (SHR (COREHALFWORD (mCHECK_ASSIGN_CONTEXTxT), 5)))
    // CALL HALMAT_FIX_PIPTAGS(INX(PTR(LOC)),0,1); (7364)
    {
      putFIXED (
  ...
  // IF SHR(T,6) THEN (7365)
  if (1 & (SHR (COREHALFWORD (mCHECK_ASSIGN_CONTEXTxT), 6)))
    // CALL ERROR(CLASS_SQ,3,VAR(LOC)); (7366)
    {
  ...
  // IF DELAY_CONTEXT_CHECK THEN (7367)
