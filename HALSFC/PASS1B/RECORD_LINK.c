/*
  File RECORD_LINK.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
RECORD_LINK (int reset)
{
  ...
  while (1 & (xGT (getFIXED (mRECORD_LINKxCUR), 0)))
    {
      // IF ~_IS_COMMON(CUR) THEN (633)
      if (1 & (xNOT (xLT (getFIXED (mRECORD_LINKxCUR), 4196))))
        // CALL _SPMANERR( 'NON COMMON RECORD AT LINK, DOPE='||CUR); (634)
        {
          putCHARACTERp (
              m_SPMANERRxMSG,
  ...
  // CALL _RETURN_TO_FREESTRING(FREEBYTES); (638)
  {
