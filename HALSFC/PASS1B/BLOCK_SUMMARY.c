/*
  File BLOCK_SUMMARY.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
BLOCK_SUMMARY (int reset)
{
  ...
  // CALL COMPRESS_OUTER_REF; (4725)
  COMPRESS_OUTER_REF (0);
  // FIRST_TIME = TRUE; (4726)
  {
  ...
  // DO I = 0 TO MAX_SUM; (4727)
  {
    ...
    for (putBIT (16, mBLOCK_SUMMARYxI, fixedToBit (16, from85));
                                     ...
                                     + by85)))
      {
        ...
        // CALL OUT_BLOCK_SUMMARY; (4731)
        BLOCK_SUMMARYxOUT_BLOCK_SUMMARY (0);
        // IF LENGTH(C) ~= 0 THEN (4732)
  ...
  // IF (SYT_FLAGS(BLOCK_SYTREF(NEST)) & EXTERNAL_FLAG) = 0 THEN (4734)
  if (1
