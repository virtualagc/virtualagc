/*
  File HALMAT.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
HALMAT (int reset)
{
  ...
  // IF CONTROL(0) THEN (7212)
  if (1 & (bitToFixed (getBIT (1, mCONTROL + 1 * 0))))
    // CALL HALMAT_BLAB(CURRENT_ATOM,NEXT_ATOM#); (7213)
    {
  ...
  if (1 & (bitToFixed (getBIT (1, mHALMAT_OK))))
    ...
    {
    rs1:;
      // IF NEXT_ATOM# = ATOM#_LIM THEN (7216)
      if (1 & (xEQ (getFIXED (mNEXT_ATOMp), 1799)))
        // CALL HALMAT_OUT; (7217)
        HALMAT_OUT (0);
      // IF NEXT_ATOM#=(ATOM#_FAULT - 1) THEN (7218)
      if (1
      ...
      // ELSE (7223)
        ...
        {
        rs1s2:;
          // ATOMS(NEXT_ATOM#)=CURRENT_ATOM; (7225)
          {
