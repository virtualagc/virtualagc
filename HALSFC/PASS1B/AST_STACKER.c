/*
  File AST_STACKER.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
AST_STACKER (int reset)
{
  ...
  // IF INX(INX)>0 THEN (8401)
  if (1 & (xGT (COREHALFWORD (mINX + 2 * COREHALFWORD (mINX)), 0)))
    // CALL ERROR(CLASS_SS,1,VAR(MP)); (8402)
    {
  ...
  // DO NUM=1 TO NUM; (8403)
  {
    ...
    for (putBIT (16, mAST_STACKERxNUM, fixedToBit (16, from130));
                                     ...
                                     + by130)))
      {
        ...
        // PSEUDO_LENGTH(IND_LINK),IND_LINK=I; (8409)
        {
