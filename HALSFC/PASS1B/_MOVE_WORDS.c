/*
  File _MOVE_WORDS.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
  ...
  if (1 & (xGT (getFIXED (m_MOVE_WORDSxDEST), getFIXED (m_MOVE_WORDSxSOURCE))))
    // DO I=0 TO NUMBYTES-4 BY 4; (144)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from2); getFIXED (m_MOVE_WORDSxI) <= to2;
        ...
        {
          // COREWORD(DEST-I) = COREWORD(SOURCE-I); (145)
          {
  ...
  // ELSE (146)
    ...
    // DO I=0 TO NUMBYTES -4 BY 4; (147)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from3); getFIXED (m_MOVE_WORDSxI) <= to3;
        ...
        {
          // COREWORD(DEST+I)=COREWORD(SOURCE+I); (148)
          {
