/*
  File SCANxBUILD_INTERNAL_BCD.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
SCANxBUILD_INTERNAL_BCD (int reset)
{
  ...
  // IF LENGTH(INTERNAL_BCD) > 0 THEN (6629)
  if (1 & (xGT (LENGTH (getCHARACTER (mSCANxINTERNAL_BCD)), 0)))
    // INTERNAL_BCD = INTERNAL_BCD || X1; (6630)
    {
  ...
  // ELSE (6631)
    ...
    // INTERNAL_BCD = SUBSTR(X1 || X1, 1); (6632)
    {
      descriptor_t *stringRHS;
  ...
  // COREBYTE(FREEPOINT - 1) = NEXT_CHAR; (6633)
  {
