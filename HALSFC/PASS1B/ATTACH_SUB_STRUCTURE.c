/*
  File ATTACH_SUB_STRUCTURE.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
ATTACH_SUB_STRUCTURE (int reset)
{
  ...
  // IF SYT_ARRAY(FIXV(MP))=0 THEN (8517)
  if (1
    ...
    STRUC_SLIP:
      ...
      if (1 & (xGT (COREHALFWORD (mATTACH_SUB_STRUCTURExSUBp), 0)))
        ...
        {
        rs1s1:;
          // CALL ERROR(CLASS_SC,1,VAR(MP)); (8523)
          {
  ...
  // ELSE (8525)
    ...
    // ELSE (8528)
      ...
      {
      rs2:;
        // CALL REDUCE_SUBSCRIPT( 8,VAR_ARRAYNESS(1)); (8530)
        {
