/*
  File HALMAT_RELOCATE.c generated by XCOM-I, 2024-08-08 04:33:34.
*/
...
HALMAT_RELOCATE (int reset)
{
  ...
  // HALMAT_RELOCATE_FLAG=FALSE; (7156)
  {
  ...
  // IF ATOM#_FAULT=ATOM#_LIM THEN (7159)
  ...
  while (1
    ...
    {
      // CALL MOVE_BLOCK(D4,NEXT_ATOM#,D1); (7168)
      {
      ...
      // CALL MOVE_BLOCK(ATOM#_FAULT,ATOM#_FAULT+D1,D3); (7169)
      {
        putBITp (16, mHALMAT_RELOCATExMOVE_BLOCKxSTART,
  ...
  // CALL MOVE_BLOCK(D4,NEXT_ATOM#,D2); (7174)
  {
    putBITp (16, mHALMAT_RELOCATExMOVE_BLOCKxSTART,
             getBIT (16, mHALMAT_RELOCATExD4));
    putBITp (16, mHALMAT_RELOCATExMOVE_BLOCKxSTOP,
  ...
  // CALL MOVE_BLOCK(ATOM#_FAULT,ATOM#_LIM,D3); (7175)
  {
    putBITp (16, mHALMAT_RELOCATExMOVE_BLOCKxSTART,
             fixedToBit (32, (int32_t)(getFIXED (mATOMp_FAULT))));
    putBITp (16, mHALMAT_RELOCATExMOVE_BLOCKxSTOP,
  ...
  // D2 = SHL(D2 + D4 - ATOM#_FAULT,16); (7179)
  {
    int32_t numberRHS
