/*
  File ARITH_TO_CHAR.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
ARITH_TO_CHAR (int reset)
{
  ...
  // TEMP=SCALAR_TYPE; (7716)
  {
    int32_t numberRHS = (int32_t)(5);
    putFIXED (mTEMP, numberRHS);
  }
  // DO CASE PSEUDO_TYPE(PTR(I))-MAT_TYPE; (7717)
  {
  rs1:
    switch (xsubtract (
        BYTE0 (
  ...
  // CALL HALMAT_TUPLE(XBTOC(TEMP-BIT_TYPE),0,I,0,0); (7722)
  {
  ...
  // CALL SETUP_VAC(I,CHAR_TYPE); (7723)
  {
