/*
  File ADD_AND_SUBTRACT.c generated by XCOM-I, 2024-08-09 12:40:41.
*/
...
ADD_AND_SUBTRACT (int reset)
{
  ...
  // IF ARITH_LITERAL(MP,SP) THEN (7586)
  if (1
    ...
    {
    rs1:;
      // IF MONITOR(9,MODE+1) THEN (7588)
      if (1 & (MONITOR9 (xadd (COREHALFWORD (mADD_AND_SUBTRACTxMODE), 1))))
        // DO; (7589)
        {
        rs1s1:;
          // CALL ERROR(CLASS_VA,MODE+1); (7590)
          {
      ...
      // LOC_P(PTR(MP))=SAVE_LITERAL(1,DW_AD); (7592)
      {
      ...
      // PSEUDO_TYPE(PTR(MP))=LIT_RESULT_TYPE(MP,SP); (7593)
      {
        int32_t numberRHS
  ...
  // ELSE (7594)
    ...
    AS_FAIL:
      ...
      // CALL HALMAT_TUPLE(MODE,0,MP,SP,0); (7602)
      {
