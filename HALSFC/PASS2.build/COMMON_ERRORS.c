/*
  File COMMON_ERRORS.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
// AGAIN: (1292)
AGAIN:
  // C=SUBSTR(ERROR_CLASSES,SHL(CLASS-1,1),2); (1293)
  {
    descriptor_t *stringRHS;
    stringRHS = SUBSTR (
  ...
  // DO WHILE FOUND = 0 & DOWN_COUNT < = RECORD_TOP(DOWN_INFO); (1306)
  while (1
         & (xAND (
                             ...
                             1)))))
    {
      ...
      if (1
        ...
        {
        rs2s1:;
          // IF TEMP_STMT = DWN_STMT(DOWN_COUNT) THEN (1309)
          if (1
            ...
            rs2s1s1:;
              ...
              // ELSE (1317)
                ...
                rs2s1s1s2:;
                  ...
                  // DOWNGRADE DIRECTIVE AND RECOMPILE ' || AST; (1319)
                  {
                    descriptor_t *stringRHS;
                    stringRHS = xsCAT (
                        xsCAT (
          ...
          if (1 & (xGE (COREHALFWORD (mCOMMON_ERRORSxK), 0)))
            ...
            rs3s1s1:;
              ...
              // ELSE (1336)
                ...
                // S = SUBSTR(S,0,K) || TEXT || SUBSTR(S,K+2); (1337)
                {
                  descriptor_t *stringRHS;
                  stringRHS = xsCAT (
  ...
  // IF SEVERITY = 1 THEN (1342)
  if (1 & (xEQ (COREHALFWORD (mCOMMON_ERRORSxSEVERITY), 1)))
    // DO; (1343)
    {
    rs4:;
      // SEVERITY_ONE = TRUE; (1344)
      {
        int32_t numberRHS = (int32_t)(1);
        descriptor_t *bitRHS;
        bitRHS = fixedToBit (32, (int32_t)(numberRHS));
