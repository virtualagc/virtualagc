/*
  File _ACTIVE_DESCRIPTORS.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
_ACTIVE_DESCRIPTORS (int reset)
{
  ...
  // IF (_DOPE_USED(DOPE) = 0) | (_DOPE_#DESCRIPTORS(DOPE)=0) THEN (59)
  if (1
      & (xOR (
  ...
  // DND=SHL(_DOPE_#DESCRIPTORS(DOPE),2); (62)
  {
