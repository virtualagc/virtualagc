/*
  File GENERATExEMIT_ARRAY_DO.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
GENERATExEMIT_ARRAY_DO (int reset)
{
  ...
  // DO SUBOP = 1 TO DOCOPY(LEVEL); (6131)
  {
    ...
    for (putBIT (16, mGENERATExSUBOP, fixedToBit (16, from79));
                                     ...
                                     + by79)))
      {
        ...
        // DOFLAG(ADOPTR) = SHR(TAG3(2), 2); (6137)
        {
