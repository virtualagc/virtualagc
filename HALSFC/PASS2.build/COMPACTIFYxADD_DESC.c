/*
  File COMPACTIFYxADD_DESC.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
COMPACTIFYxADD_DESC (int reset)
{
  ...
  // IF (L >= LOWER_BOUND) & (L <= UPPER_BOUND) THEN (495)
  if (1
    ...
    rs1:;
      ...
      // IF ND = ACTUAL_DX_TOTAL THEN (498)
      if (1
        ...
        rs1s1:;
          ...
          // INSUFFICIENT SORT AREA. JOB ABANDONED.'; (500)
          {
