/*
  File GENERATExCOPY_STACK_ENTRY.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
GENERATExCOPY_STACK_ENTRY (int reset)
{
  ...
  // AIA_ADJUSTED(PTR2)=AIA_ADJUSTED(PTR); (3566)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // BACKUP_REG(PTR2) = BACKUP_REG(PTR); (3579)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // NEXT_USE(PTR2) = NEXT_USE(PTR); (3580)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // INX_NEXT_USE(PTR2) = INX_NEXT_USE(PTR); (3581)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // IND_STACK(PTR2).I_CSE_USE = IND_STACK(PTR).I_CSE_USE; (3582)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // IND_STACK(PTR2).I_DSUBBED = IND_STACK(PTR).I_DSUBBED; (3583)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // INX_SHIFT(PTR2) = INX_SHIFT(PTR); (3587)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // STRUCT_INX(PTR2) = STRUCT_INX(PTR); (3590)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // STRUCT_CON(PTR2) = STRUCT_CON(PTR); (3591)
  {
    int32_t numberRHS = (int32_t)(getFIXED (
        getFIXED (mIND_STACK)
  ...
  // NR_DEREF(PTR2) = NR_DEREF(PTR); (3594)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // NR_DELTA(PTR2) = NR_DELTA(PTR); (3595)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // NR_STACK(PTR2) = NR_STACK(PTR); (3596)
  {
    descriptor_t *bitRHS = getBIT (
        16, getFIXED (mIND_STACK)
  ...
  // LIVES_REMOTE(PTR2) = LIVES_REMOTE(PTR); (3597)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // POINTS_REMOTE(PTR2) = POINTS_REMOTE(PTR); (3598)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // NAME_VAR(PTR2) = NAME_VAR(PTR); (3599)
  {
    descriptor_t *bitRHS
        = getBIT (8, getFIXED (mIND_STACK)
                         + 73 * (COREHALFWORD (mGENERATExCOPY_STACK_ENTRYxPTR))
  ...
  // NR_DEREF_TMP(PTR2) = NR_DEREF_TMP(PTR); (3601)
  {
    descriptor_t *bitRHS
  ...
  // DO CASE PACKFORM(FORM(PTR2)); (3603)
  {
  rs1:
    switch (BYTE0 (
        mPACKFORM
        ...
        rs1s2:;
          ...
          if (1
              & (xEQ (
                  COREHALFWORD (
                      ...
                      + 32 + 2 * (0)),
                  BYTE0 (mWORK))))
            // WORK_USAGE(LOC(PTR2)) = WORK_USAGE(LOC(PTR2)) + 1; (3608)
            {
          ...
          // ELSE (3609)
            ...
            rs1s2s1:;
              ...
              // IF BASE(PTR2) ~= TEMPBASE THEN (3612)
              if (1
                  & (xNEQ (
                      COREHALFWORD (getFIXED (mIND_STACK)
                                    ...
                                    + 22 + 2 * (0)),
                      BYTE0 (mTEMPBASE))))
                // CALL INCR_USAGE(BASE(PTR2)); (3613)
                {
                  putBITp (
                      16, mGENERATExINCR_USAGExR,
                      getBIT (16,
