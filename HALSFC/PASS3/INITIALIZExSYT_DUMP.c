/*
  File INITIALIZExSYT_DUMP.c generated by XCOM-I, 2024-08-09 12:40:16.
*/
...
INITIALIZExSYT_DUMP (int reset)
{
  ...
  // LNK1  LNK2  DIMS  XREF  ARRA    FLAGS    ADDR     LK'; (2365)
  {
    descriptor_t *stringRHS;
    ...
    for (putBIT (16, mOP1, fixedToBit (16, from75));
             ...
             16, mOP1, fixedToBit (16, bitToFixed (getBIT (16, mOP1)) + by75)))
      {
        ...
        if (1 & (xLT (getFIXED (mTMP), 32)))
          // S1 = S1||SUBSTR(X72,0,32-TMP); (2375)
          {
            descriptor_t *stringRHS;
        ...
        // TS = S2||X2||S1||X2||S3||X2||S4||X2; (2379)
        {
          descriptor_t *stringRHS;
          stringRHS = xsCAT (
              xsCAT (
        ...
        // S1 = FORMAT(SYT_SCOPE(OP1),3); (2380)
        {
          descriptor_t *stringRHS;
          stringRHS
        ...
        // S4 = FORMAT(SYT_LINK1(OP1),4); (2383)
        {
          descriptor_t *stringRHS;
          stringRHS = (putFIXED (mFORMATxIVAL,
                                 COREHALFWORD (getFIXED (mSYM_TAB)
        ...
        // TS = TS||S1||X2||S2||X2||S3||X2||S4||X2; (2384)
        {
          descriptor_t *stringRHS;
          stringRHS = xsCAT (
              xsCAT (
        ...
        // S1 = FORMAT(SYT_LINK2(OP1),4); (2385)
        {
          descriptor_t *stringRHS;
          stringRHS = (putFIXED (mFORMATxIVAL,
                                 COREHALFWORD (getFIXED (mSYM_TAB)
        ...
        // S4 = FORMAT(SYT_ARRAY(OP1),4); (2388)
        {
          descriptor_t *stringRHS;
          stringRHS = (putFIXED (mFORMATxIVAL,
                                 COREHALFWORD (getFIXED (mSYM_TAB)
        ...
        // TS = TS||S1||X2||S2||X2||S3||X2||S4||X2; (2389)
        {
          descriptor_t *stringRHS;
          stringRHS = xsCAT (
              xsCAT (
