/*
  File INITIALIZExDPRINT.c generated by XCOM-I, 2024-08-08 04:33:10.
*/
...
INITIALIZExDPRINT (int reset)
{
  ...
  if (1 & (bitToFixed (getBIT (1, mDLIST))))
    ...
    {
    rs1:;
      // S1 = FORMAT((#DEL_SYMBOLS + 1),4); (2584)
      {
      ...
      // OUTPUT = X2||'#: '||S1||X2||'REASON: '||S2||X4||S3||X4||S4; (2591)
      {
        descriptor_t *stringRHS;
        stringRHS = xsCAT (
            xsCAT (
  ...
  // ELSE (2592)
    ...
    // IF (REASON#=0)|(REASON#=3) THEN (2593)
    if (1
      ...
      rs2:;
        ...
        if (1 & (xNOT (BYTE0 (mINITIALIZExDPRINTxHDR_FLAG))))
          ...
          rs2s1:;
            ...
            // BUT MAY NOT HAVE BEEN USED ***'; (2599)
            {
              descriptor_t *stringRHS;
