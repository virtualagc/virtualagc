/*
  File BUILD_SDFxGET_SDF_CELL.c generated by XCOM-I, 2024-08-08 04:33:10.
*/
...
BUILD_SDFxGET_SDF_CELL (int reset)
{
  ...
  // PTR_TYPE = SHR(VMEM_PTR,30) & 3; (3773)
  {
  ...
  // CALL LOCATE(VMEM_PTR &  1073741823,ADDR(NODE_H),0); (3774)
  {
  ...
  // CALL MOVE(NODE_H(0),VMEM_LOC_ADDR,LOC_ADDR); (3776)
  {
  ...
  if (1 & (xGT (COREHALFWORD (mBUILD_SDFxPTR_INX), 400)))
    ...
    rs1:;
      ...
      // OUTPUT = P3ERR || 'CELL PTR STACK OVERFLOW ***'; (3781)
      {
        descriptor_t *stringRHS;
        stringRHS
