...
BUILD_SDF_LITTABxSDF_CHAR_LIT (int reset)
{
  ...
  // IF LITCHR_INDEX + CHAR_LEN(INDEX) > PAGE_SIZE THEN (1346)
  if (1
      & (xGT (
  ...
  // LITCHR_INDEX = LITCHR_INDEX+CHAR_LEN(INDEX) + 1; (1353)
  {
  ...
  // CHARS_LEFT = CHARS_LEFT-(CHAR_LEN(INDEX)+1); (1354)
  {
  ...
  // NODE_F(LIT_TAB_INDEX+1) = LITCHR_TAB+OFFSET; (1355)
  {
    int32_t numberRHS = (int32_t)(xadd (
  ...
  // NODE_F(LIT_TAB_INDEX+2) = CHAR_LEN(INDEX); (1356)
  {
