...
BUILD_SDFxMOVE_CELL_TREExDO_EXP_VARS_CELL (int reset)
{
  ...
  // CALL P3_LOCATE(PTR,ADDR(NODE_H),MODF|RESV); (3830)
  {
  ...
  // DO J = SHR(NODE_H(1) + 3,1) TO SHR(NODE_H(0),2) - 1; (3835)
  {
         ...
         putBIT (16, mBUILD_SDFxMOVE_CELL_TREExJ,
                 fixedToBit (
                     16, bitToFixed (getBIT (16, mBUILD_SDFxMOVE_CELL_TREExJ))
                             + by107)))
      {
        // IF (NODE_F(J) &  3221225472) ~=  3221225472 THEN (3836)
        if (1
            & (xNEQ (
                xAND (getFIXED (
                      ...
                      3221225472),
                3221225472)))
          // NODE_F(J) = GET_SDF_CELL(NODE_F(J)); (3837)
          {
  ...
  // CALL P3_PTR_LOCATE(PTR,RELS); (3838)
  {
