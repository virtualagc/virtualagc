/*
  File PAGING_STRATEGY.c generated by XCOM-I, 2024-08-09 12:40:16.
*/
...
PAGING_STRATEGY (int reset)
{
    ...
    for (putBIT (16, mPAGING_STRATEGYxI, fixedToBit (16, from27));
         ...
         putBIT (16, mPAGING_STRATEGYxI,
                 fixedToBit (16, bitToFixed (getBIT (16, mPAGING_STRATEGYxI))
                                     + by27)))
      {
        // IF (PAD_DISP(I) &  16383) = 0 THEN (1117)
        if (1
            & (xEQ (
            ...
            if (1 & (xEQ (COREHALFWORD (mPAGING_STRATEGYxLRECp), -1)))
              ...
              rs1s1s1:;
                ...
                // ELSE (1127)
                  ...
                  // IF PAD_CNT(I) < PREV_CNT1 THEN (1128)
                  if (1
                      & (xLT (COREHALFWORD (
                                  mPAD_CNT
                                  + 2 * COREHALFWORD (mPAGING_STRATEGYxI)),
            ...
            // ELSE (1132)
              ...
              rs1s1s2:;
                ...
                // ELSE (1138)
                  ...
                  // IF PAD_CNT(I) < PREV_CNT2 THEN (1139)
                  if (1
                      & (xLT (COREHALFWORD (
                                  mPAD_CNT
                                  + 2 * COREHALFWORD (mPAGING_STRATEGYxI)),
  ...
  // IF (PAD_DISP(NEW_NDX) &  16384) ~= 0 THEN (1149)
  if (1
      & (xNEQ (
    ...
    rs2:;
      ...
      if (1 & (xEQ (COREHALFWORD (mPAGING_STRATEGYxLRECp), -1)))
        ...
        rs2s1:;
          ...
          // PAGE_TO_LREC(PAGE) = LAST_LREC; (1156)
          {
      ...
      // COREWORD(ADDR(PAGE_TEMP)) = PAD_ADDR(NEW_NDX); (1158)
      {
        int32_t numberRHS
