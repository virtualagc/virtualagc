/*
  File REFORMAT_HALMAT.c generated by XCOM-I, 2024-08-09 12:40:16.
*/
...
REFORMAT_HALMAT (int reset)
{
  ...
  // CALL LOCATE(HLOC,ADDR(HMAT_PTR),RESV); (1382)
  {
  ...
  while (1 & (xGT (COREHALFWORD (mREFORMAT_HALMATxSIZE), 0)))
    {
      ...
      // SLOC = GET_DATA_CELL(HMAT_BLK_SZ,ADDR(SDF_PTR),RESV|MODF); (1388)
      {
      ...
      // ELSE (1393)
        ...
        {
        rs1s2:;
          // COREWORD(LINKCELL) = SLOC; (1395)
          {
            int32_t numberRHS = (int32_t)(getFIXED (mREFORMAT_HALMATxSLOC));
            COREWORD2 (getFIXED (mREFORMAT_HALMATxLINKCELL), numberRHS);
          }
          // CALL P3_PTR_LOCATE(TMP_LOC,RELS); (1396)
          {
      ...
      // LIMIT = WORDS_IN_BLK-LINK_SPACE; (1397)
      {
      ...
      // DO I = START TO LIMIT-1; (1399)
      {
        ...
        for (putBIT (16, mREFORMAT_HALMATxI, fixedToBit (16, from34));
                                     ...
                                     + by34)))
          {
            ...
            // IF HMAT_PTR(HCELL) = XREC_WORD THEN (1401)
            if (1
              ...
              rs1s3s1:;
                ...
                // CALL PTR_LOCATE(TMP_LOC,RELS); (1405)
                {
                ...
                // CALL LOCATE(HLOC,ADDR(HMAT_PTR),RESV); (1406)
                {
                  putFIXED (mLOCATExPTR, getFIXED (mREFORMAT_HALMATxHLOC));
      ...
      if (1 & (xGT (COREHALFWORD (mREFORMAT_HALMATxSIZE), 0)))
        ...
        rs1s4:;
          ...
          // LINKCELL = ADDR(SDF_PTR(I+1)); (1413)
          {
  ...
  // CALL P3_PTR_LOCATE(SLOC,RELS); (1414)
  {
    putFIXED (mP3_PTR_LOCATExPTR, getFIXED (mREFORMAT_HALMATxSLOC));
    putBITp (8, mP3_PTR_LOCATExFLAGS, getBIT (8, mRELS));
    P3_PTR_LOCATE (0);
  }
  // CALL PTR_LOCATE(HLOC,RELS); (1415)
  {
