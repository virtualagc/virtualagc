/*
  File BUILD_SDFxSEARCH_AND_ENQUEUE.c generated by XCOM-I, 2024-08-09 12:40:16.
*/
...
BUILD_SDFxSEARCH_AND_ENQUEUE (int reset)
{
  ...
  // PTR_TEMP = SYMB_TO_PTR(SUBJ_SYMB); (3743)
  {
  ...
  // SUBJ_PTR = EXTRACT4(PTR_TEMP,8,0) - 2; (3744)
  {
  ...
  // CALL P3_LOCATE(PREV_PTR,ADDR(NODE_H),0); (3751)
  {
  ...
  while (1
         & (xNEQ (COREHALFWORD (mBUILD_SDFxSEARCH_AND_ENQUEUExNEXT_SYMB), 0)))
    {
      ...
      // NEXT_PTR = EXTRACT4(PTR_TEMP,8,0) - 2; (3755)
      {
        int32_t numberRHS = (int32_t)(xsubtract (
            (putFIXED (mEXTRACT4xPTR, getFIXED (mBUILD_SDFxPTR_TEMP)),
             putBITp (16, mEXTRACT4xOFFSET, fixedToBit (32, (int32_t)(8))),
      ...
      // CALL P3_LOCATE(NEXT_PTR+2,ADDR(NODE_F),0); (3756)
      {
      ...
      if (1
        ...
        {
        rs2s1:;
          // IF NODE_H(10) > REL_ADDR THEN (3760)
          if (1
      ...
      // ELSE (3762)
        ...
        // IF (NODE_F(3) &  16777215) > REL_ADDR THEN (3763)
        if (1
      ...
      // PREV_PTR = NEXT_PTR; (3766)
      {
        int32_t numberRHS = (int32_t)(getFIXED (mBUILD_SDFxNEXT_PTR));
        putFIXED (mBUILD_SDFxPREV_PTR, numberRHS);
      }
    } // End of DO WHILE block
  // IF (CMPL_FLAG=FALSE)&((TYPE=0)|(TYPE=1)) THEN (3767)
  if (1
...
// INSERT: (3769)
INSERT:
  // CALL PUTN(PREV_PTR,0,ADDR(SUBJ_SYMB),2,0); (3770)
  {
  ...
  // IF (TYPE = 4) | (NEXT_SYMB ~= 0) THEN (3771)
  if (1
      & (xOR (
          xEQ (getFIXED (mBUILD_SDFxSEARCH_AND_ENQUEUExTYPE), 4),
          xNEQ (COREHALFWORD (mBUILD_SDFxSEARCH_AND_ENQUEUExNEXT_SYMB), 0))))
    // CALL PUTN(SUBJ_PTR,0,ADDR(NEXT_SYMB),2,0); (3772)
    {
