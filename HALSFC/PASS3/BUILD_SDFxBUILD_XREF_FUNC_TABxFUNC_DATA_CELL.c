...
BUILD_SDFxBUILD_XREF_FUNC_TABxFUNC_DATA_CELL (int reset)
{
         ...
         putBIT (
             ...
             fixedToBit (
                 16, bitToFixed (getBIT (
                         ...
                         + by112)))
      {
        // IF (INDEX = NEXT_TO_LAST) & (I < (NODE_H(0)-3)) THEN (3932)
        if (1
            & (xAND (
                xEQ (COREHALFWORD (
          ...
          {
          rs1s1:;
            // NODE_H(INDEX) = POINTER_PREFIX; (3934)
            {
              int32_t numberRHS = (int32_t)(-1);
              descriptor_t *bitRHS;
              bitRHS = fixedToBit (32, (int32_t)(numberRHS));
            ...
            // CALL P3_PTR_LOCATE(CELL,RELS); (3936)
            {
              putFIXED (
                  mP3_PTR_LOCATExPTR,
                  getFIXED (
        ...
        // NODE_H(INDEX) = (XREF(PTR) &  65535); (3939)
        {
  ...
  // CALL P3_PTR_LOCATE(CELL,RELS); (3942)
  {
