/*
  File _INCREASE_RECORD.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
_INCREASE_RECORD (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (561)
  {
  ...
  // NEWNRECS=_DOPE_ALLOC(DOPE)+NRECSMORE; (562)
  {
  ...
  // NEWNBYTES=_SPACE_ROUND(NEWNRECS*_DOPE_WIDTH(DOPE)); (563)
  {
  ...
  // OLDNBYTES=_RECORD#BYTES(DOPE); (564)
  {
    int32_t numberRHS = (int32_t)((
        putFIXED (
            m_SPACE_ROUNDxBYTES,
  ...
  // NBYTESMORE=NEWNBYTES-OLDNBYTES; (565)
  {
    int32_t numberRHS
  ...
  // IF NBYTESMORE > FREEBYTES THEN (566)
  if (1
      & (xGT (getFIXED (m_INCREASE_RECORDxNBYTESMORE), getFIXED (mFREEBYTES))))
    // CALL _STEAL(NBYTESMORE-FREEBYTES); (567)
    {
  ...
  // CALL _SQUASH_RECORDS; (568)
  _SQUASH_RECORDS (0);
  // CALL _MOVE_RECS(DOPE,NBYTESMORE); (569)
  {
