/*
  File GENERATExGEN_CLASS0xDEFINE_LABEL.c generated by XCOM-I, 2024-08-08
  04:32:26.
*/
...
GENERATExGEN_CLASS0xDEFINE_LABEL (int reset)
{
  ...
  if (1
      & (xEQ (COREHALFWORD (
                  ...
                  + 32 + 2 * (0)),
              BYTE0 (mLBL))))
    // IF SYT_TYPE(LOC(PTR)) = STMT_LABEL THEN (10960)
    if (1
        & (xEQ (
            BYTE0 (getFIXED (mSYM_TAB)
                   ...
                   + 32 + 1 * (0)),
            BYTE0 (mSTMT_LABEL))))
      // FLAG = SYT_DIMS(LOC(PTR)) > 3 | SYT_DIMS(LOC(PTR)) < 1; (10961)
      {
  ...
  // CALL SET_LABEL(VAL(PTR), FLAG, 1); (10962)
  {
    putBITp (
  ...
  if (1 & (bitToFixed (getBIT (1, mASSEMBLER_CODE))))
    ...
    rs1:;
      ...
      // OUTPUT = HEX_LOCCTR||CHARSTRING||' EQU *'; (10970)
      {
        descriptor_t *stringRHS;
