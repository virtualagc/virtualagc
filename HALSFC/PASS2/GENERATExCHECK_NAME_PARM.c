/*
  File GENERATExCHECK_NAME_PARM.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExCHECK_NAME_PARM (int reset)
{
  ...
  // ELSE (8101)
            ...
            xNOT (
                xAND (BYTE0 (getFIXED (mIND_STACK)
                      ...
                      xEQ (COREHALFWORD (getFIXED (mIND_STACK)
                                         ...
                                         + 2 * (0)),
                           BYTE0 (mWORK)))))))
      // CALL ERRORS(CLASS_FT,104,''||ARGNO); (8103)
      {
    ...
    // ELSE (8104)
      ...
      // IF ARGTYPE = STRUCTURE THEN (8105)
      if (1 & (xEQ (COREHALFWORD (mARGTYPE), BYTE0 (mSTRUCTURE))))
        // CALL CHECK_STRUCTURE_PARM(TAG); (8106)
        {
      ...
      // ELSE (8107)
        ...
        {
        rs2:;
          // IF SYT_TYPE(LOC2(RIGHTOP)) >= ANY_LABEL THEN (8109)
          if (1
              & (xGE (BYTE0 (getFIXED (mSYM_TAB)
                             ...
                             + 32 + 1 * (0)),
                      BYTE0 (mANY_LABEL))))
            // TYPE(RIGHTOP) = SYT_TYPE(LOC2(RIGHTOP)); (8110)
            {
          ...
          // CALL CHECK_ASSIGN_PARM(TAG); (8111)
          {
