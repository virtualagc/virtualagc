/*
  File COMPACTIFY.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
COMPACTIFY (int reset)
{
  ...
  // IF LOWER_BOUND = 0 THEN (374)
  if (1 & (xEQ (getFIXED (mCOMPACTIFYxLOWER_BOUND), 0)))
    // LOWER_BOUND = FREEBASE; (375)
    {
...
if (1 & (xNEQ (getFIXED (m_DX_TOTAL), getFIXED (m_PREV_DX_TOTAL))))
  ...
  rs1:;
    ...
    if (1
      ...
      {
      rs1s1:;
        // OUTPUT='BI006 SEVERITY 3  BUG IN COMPACTIFY***  ABORTING'; (393)
        {
...
// DO TRIED = 0 TO 1; (396)
{
  ...
  for (putBIT (1, mCOMPACTIFYxTRIED, fixedToBit (1, from4));
    ...
    {
      // IF FORCE_MAJOR THEN (397)
      if (1 & (bitToFixed (getBIT (1, mFORCE_MAJOR))))
        // DO; (398)
        {
        rs2s1:;
          // FORCE_MAJOR=_FALSE; (399)
          {
      ...
      // COMPACTIFIES(TRIED) = COMPACTIFIES(TRIED) + 1; (402)
      {
              ...
              rs2s3s1:;
                ...
                // DO J=DP TO DP+DW*(_DOPE_USED(L)-1) BY DW; (415)
                {
                  ...
                  for (putFIXED (mCOMPACTIFYxJ, from7);
                    ...
                    {
                      // DO K=J TO J+4*(_DOPE_#DESCRIPTORS(L)-1) BY 4; (416)
                      {
        ...
        rs2s4:;
                 ...
                 putFIXED (mCOMPACTIFYxI, getFIXED (mCOMPACTIFYxI) + by10))
              {
                ...
                if (1
                  ...
                  rs2s4s2s1:;
                    ...
                    if (1 & (xGT (getFIXED (mCOMPACTIFYxDELTA), 0)))
                      // DO K = BC TO TC; (441)
                      {
                        ...
                        for (putFIXED (mCOMPACTIFYxK, from11);
                          ...
                          {
                            // COREBYTE(K-DELTA) = COREBYTE(K); (442)
                            {
                    ...
                    // FREEPOINT = FREEPOINT + TC - BC + 1; (443)
                    {
                      int32_t numberRHS = (int32_t)(xadd (
                          xsubtract (
          ...
          // DO K = BC TO TC; (450)
          {
            ...
            for (putFIXED (mCOMPACTIFYxK, from12);
              ...
              {
                // COREBYTE(K-DELTA) = COREBYTE(K); (451)
                {
                  int32_t numberRHS
          ...
          // FREEPOINT = FREEPOINT + TC - BC + 1; (452)
          {
            int32_t numberRHS = (int32_t)(xadd (
      ...
      if (1 & (getFIXED (mCOMPACTIFYxMODE)))
        ...
        {
        rs2s5:;
          // IF ACTUAL_DX_TOTAL>0 THEN (455)
          if (1 & (xGT (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 0)))
            // CALL MONITOR(7, ADDR(DX), SHL(ACTUAL_DX_TOTAL , 2)); (456)
            MONITOR7 (ADDR ("DX", 0x80000000, NULL, 0),
                      SHL (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 2));
          // I = ADDR(DESCRIPTOR_DESCRIPTOR); (457)
          {
            int32_t numberRHS
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (466)
{
...
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_TRIGGER THEN (474)
if (1
  ...
  rs3:;
    ...
    // K=_SPACE_ROUND(FREESTRING_TARGET - _LAST_COMPACTIFY_FOUND); (477)
    {
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (488)
{
  int32_t numberRHS = (int32_t)(xsubtract (FREELIMIT (), FREEPOINT ()));
  putFIXED (m_LAST_COMPACTIFY_FOUND, numberRHS);
}
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_MIN THEN (489)
if (1 & (xLT (getFIXED (m_LAST_COMPACTIFY_FOUND), getFIXED (mFREESTRING_MIN))))
  ...
  rs4:;
    ...
    // MEMORY FOR STRING STORAGE. JOB ABANDONED.'; (491)
    {
      descriptor_t *stringRHS;
      stringRHS = cToDescriptor (
