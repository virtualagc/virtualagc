/*
  File GENERATExEMITEVENTADDR.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExEMITEVENTADDR (int reset)
{
  ...
  // ELSE (3342)
    ...
    rs1:;
      ...
      // SYT_ADDR(SY)+SYT_CONST(SY)+INX_CON(OP), HADDR); (3344)
      {
        putBITp (
            16, mEMITADDRxCTR,
            getBIT (16,
