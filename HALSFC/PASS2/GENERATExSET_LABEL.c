/*
  File GENERATExSET_LABEL.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExSET_LABEL (int reset)
{
  ...
  if (1 & (xNOT (BYTE0 (mGENERATExSET_LABELxFLAG1))))
    // CALL CLEAR_REGS; (3359)
    CLEAR_REGS (0);
  // STOPPERFLAG = FALSE; (3360)
  {
  ...
  rs1:;
    ...
    if (1
      ...
      // CALL _NEEDMORE_SPACE ( ADDR ( LAB_LOC )  ) ; (3364)
      {
  ...
  // LOCATION(STMTNO) = LOCCTR(INDEXNEST); (3366)
  {
    int32_t numberRHS
  ...
  // LOCATION_LINK(STMTNO) = LASTLABEL(INDEXNEST); (3367)
  {
    descriptor_t *bitRHS
  ...
  if (1 & (xNOT (BYTE0 (mGENERATExSET_LABELxFLAG2))))
    ...
    {
    rs2:;
      // IF ASSEMBLER_CODE THEN (3373)
      if (1 & (bitToFixed (getBIT (1, mASSEMBLER_CODE))))
        // OUTPUT = HEX_LOCCTR||'P#'||STMTNO||' EQU *'; (3374)
        {
