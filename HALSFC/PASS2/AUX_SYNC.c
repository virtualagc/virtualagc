/*
  File AUX_SYNC.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
AUX_SYNC (int reset)
{
  ...
  // DO WHILE AUX(GET_AUX(AUX_CTR)); (1011)
  while (1
         & (getFIXED (
             mAUX
             + 4
