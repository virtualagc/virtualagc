/*
  File OBJECT_GENERATORxLEFTHEX.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
OBJECT_GENERATORxLEFTHEX (int reset)
{
  ...
  while (1 & (xGT (COREHALFWORD (mOBJECT_GENERATORxLEFTHEXxN), 0)))
    {
      // B=BYTE(HEXCODES,SHR(F,SHIFTCOUNT)&FONE); (15414)
      {
  ...
  // RETURN BLANK||SUBSTR(SS,0,K); (15419)
  {
    reentryGuard = 0;
