/*
  File GENERATExGEN_CLASS0xDOFORSETUP.c generated by XCOM-I, 2024-08-09
  12:39:31.
*/
...
GENERATExGEN_CLASS0xDOFORSETUP (int reset)
{
  ...
  // ELSE (12280)
    ...
    {
    rs1:;
      // CALL FORCE_BY_MODE(PTR, OPTYPE); (12282)
      {
      ...
      // TEMP = GETFREESPACE(OPTYPE, 1); (12283)
      {
      ...
      // CALL EMIT_BY_MODE(STORE, REG(PTR), TEMP, OPTYPE); (12284)
      {
      ...
      // CALL DROP_REG(PTR); (12285)
      {
        putBITp (16, mGENERATExDROP_REGxOP,
                 getBIT (16, mGENERATExGEN_CLASS0xDOFORSETUPxPTR));
        GENERATExDROP_REG (0);
      }
      // CALL RETURN_STACK_ENTRY(PTR); (12286)
      {
