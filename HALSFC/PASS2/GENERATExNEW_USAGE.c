/*
  File GENERATExNEW_USAGE.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
                    ...
                    rs1s1s1s1:;
                      ...
                      if (1
                        ...
                        if (1
                          ...
                          // INX_CON(OP)=R_INX_CON(I)+2)  THEN (3417)
                          if (1
                              & (xOR (
                                  xOR (
                                      xOR (
                                    ...
                                    COREHALFWORD (
                                        ...
                                        + 73
                                              * (COREHALFWORD (
                                                  mGENERATExNEW_USAGExOP))
                                        + 40 + 2 * (0)))))
                          // IF FLAG | R_XCON(I) = INX_CON(OP) THEN (3421)
                          if (1
                              & (xOR (
