/*
  File GENERATExGET_CSIZ.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExGET_CSIZ (int reset)
{
  ...
  // ELSE (8225)
    ...
    rs1:;
      ...
      // PTR = GET_OPERAND(SUBOP, 0, BY_NAME_FALSE, 1); (8228)
      {
