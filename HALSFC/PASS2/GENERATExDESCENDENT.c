/*
  File GENERATExDESCENDENT.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
GENERATExDESCENDENT (int reset)
{
  ...
  // IF SYT_TYPE(XLOC) = STRUCTURE THEN (7798)
  if (1
    ...
    {
    rs1:;
      // IF (SYT_FLAGS(XLOC) & EVIL_FLAGS) = EVIL_FLAGS THEN (7800)
      if (1
          & (xEQ (
      ...
      // STRUCT_MOD(REF) = STRUCT_MOD(REF) + SYT_ADDR(XLOC); (7811)
      {
