/*
  File OBJECT_GENERATORxZERO_INIT_VAL.c generated by XCOM-I, 2024-08-09
  12:39:31.
*/
...
OBJECT_GENERATORxZERO_INIT_VAL (int reset)
{
  ...
  // DO FOR IDX = FIRST TO LAST; (15373)
  {
    int32_t from151, to151, by151;
    from151 = getFIXED (mOBJECT_GENERATORxZERO_INIT_VALxFIRST);
    to151 = getFIXED (mOBJECT_GENERATORxZERO_INIT_VALxLAST);
    by151 = 1;
    for (putFIXED (mOBJECT_GENERATORxZERO_INIT_VALxIDX, from151);
         getFIXED (mOBJECT_GENERATORxZERO_INIT_VALxIDX) <= to151;
         putFIXED (mOBJECT_GENERATORxZERO_INIT_VALxIDX,
                   getFIXED (mOBJECT_GENERATORxZERO_INIT_VALxIDX) + by151))
      {
        // DO ; (15374)
        {
        rs1s1:;
          // IF COREWORD ( ADDR ( INIT_TAB ) + 12 ) >= COREWORD ( ADDR (
          // INIT_TAB ) + 8 ) THEN (15375)
          if (1
              & (xGE (
                  COREWORD (xadd (ADDR ("INIT_TAB", 0x80000000, NULL, 0), 12)),
                  COREWORD (
                      xadd (ADDR ("INIT_TAB", 0x80000000, NULL, 0), 8)))))
            // CALL _NEEDMORE_SPACE ( ADDR ( INIT_TAB )  ) ; (15376)
            {
