/*
  File GENERATExSTRUCTURE_DECODE.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
GENERATExSTRUCTURE_DECODE (int reset)
{
  ...
  // IF SYT_DIMS(LOC(PTR)) = LOC2(PTR) THEN (6260)
  if (1
      & (xEQ (
          COREHALFWORD (
              getFIXED (mSYM_TAB)
  ...
  // STRUCT_CON(PTR) = STRUCT_CON(PTR) + SYT_ADDR(OP1); (6264)
  {
              ...
              & (xAND (
                  ...
                  bitToFixed (
                      (putBITp (16, mGENERATExDEREFxOP,
                       ...
                       GENERATExDEREF (0))))))
            // CALL STRUCTURE_DEREF; (6270)
            GENERATExSTRUCTURE_DECODExSTRUCTURE_DEREF (0);
          // ELSE (6271)
          else
            // CALL STRUCTURE_LOAD_NAME; (6272)
            GENERATExSTRUCTURE_DECODExSTRUCTURE_LOAD_NAME (0);
        es1:;
        } // End of DO block
  // IF (SYT_FLAGS(OP1) & NAME_FLAG) ~= 0 THEN (6273)
  if (1
