/*
  File GENERATExFINDAC.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExFINDAC (int reset)
{
  ...
  // CALL CHECKPOINT_REG(R,SAVE); (4140)
  {
  ...
  if (1
    ...
    rs1:;
      ...
      if (1 & (xLT (COREHALFWORD (mGENERATExFINDACxR), BYTE0 (mFR0))))
        ...
        {
        rs1s1:;
          // R_TYPE(R), R_TYPE(R+1) = DINTEGER; (4153)
          {
