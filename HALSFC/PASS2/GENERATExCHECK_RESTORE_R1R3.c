/*
  File GENERATExCHECK_RESTORE_R1R3.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExCHECK_RESTORE_R1R3 (int reset)
{
  ...
  if (1
    ...
    {
    rs1:;
      // CALL RESTORE_R1R3(INST, 1, NEW_GLOBAL_BASE, COND); (3026)
      {
      ...
      // D_R1_CHANGE = SHR(D_R1_CHANGE,1); (3027)
      {
  ...
  if (1
    ...
    {
    rs2:;
      // CALL RESTORE_R1R3(INST, 3, NEW_LOCAL_BASE, COND); (3031)
      {
        putBITp (16, mGENERATExRESTORE_R1R3xINST,
                 getBIT (16, mGENERATExCHECK_RESTORE_R1R3xINST));
        putBITp (16, mGENERATExRESTORE_R1R3xXREG,
      ...
      // D_R3_CHANGE = SHR(D_R3_CHANGE,1); (3032)
      {
  ...
  // IF D_R1_CHANGE & (FLAG=CSYM) & (XBASE=1) THEN (3034)
  if (1
  ...
  // IF D_R3_CHANGE & (((FLAG=CSYM) & (XBASE=3)) | (INST=MVH)) THEN (3036)
  if (1
      & (xAND (
          BYTE0 (mD_R3_CHANGE),
          xOR (xAND (
