/*
  File GENERATExGET_RECVR_INFO.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExGET_RECVR_INFO (int reset)
{
  ...
  // PART_SIZE=START_OFF + ROW(RECVR) * COLUMN(RECVR) * DATA_WIDTH; (8848)
  {
  ...
  // PART_SIZE=PART_SIZE + (ROW(RECVR) - 1) * DEL(RECVR); (8849)
  {
    int32_t numberRHS = (int32_t)(xadd (
  ...
  // ASSIGN_PARM_FLAG = (SYT_FLAGS(RECVR_SYMPTR) & ASSIGN_FLAG) ~= 0; (8852)
  {
  ...
  // RECVR_NEST_LEVEL = SYT_NEST(RECVR_SYMPTR); (8853)
  {
    descriptor_t *bitRHS = getBIT (
  ...
  // RECVR_STRUCT = SYT_TYPE(RECVR_SYMPTR) = STRUCTURE; (8854)
  {
    int32_t numberRHS = (int32_t)(xEQ (
