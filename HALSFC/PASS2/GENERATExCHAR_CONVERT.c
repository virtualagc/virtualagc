/*
  File GENERATExCHAR_CONVERT.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExCHAR_CONVERT (int reset)
{
  ...
  // PTR = GETFREESPACE(CHAR, SIZE(OP) + 2); (7596)
  {
  ...
  // CALL CHAR_CALL(XXASN, PTR, OP, 0); (7597)
  {
  ...
  // CALL DROPSAVE(OP); (7599)
  {
    putBITp (16, mGENERATExDROPSAVExENTRY,
             getBIT (16, mGENERATExCHAR_CONVERTxOP));
    GENERATExDROPSAVE (0);
  }
  // CALL RETURN_STACK_ENTRY(OP); (7600)
  {
