/*
  File _SPMANERR.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
_SPMANERR (int reset)
{
  ...
  // IF ~ _IN_COMPACTIFY THEN (43)
  if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
    // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (44)
    ...
    // ELSE (48)
      ...
      {
      rs2:;
        // OUTPUT='BI003 SEVERITY 3  BUG IN SPACE MANAGEMENT SYSTEM'; (50)
        {
          descriptor_t *stringRHS;
  ...
  // IF NUMERRORS > MAX_NUM_ERRORS THEN (53)
