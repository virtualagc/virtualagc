/*
  File GENERATExGENSVCADDR.c generated by XCOM-I, 2024-08-08 04:32:26.
*/
...
GENERATExGENSVCADDR (int reset)
{
  ...
  // CALL FORCE_ADDRESS(PTRARG1, PTR, 0, FOR_NAME_TRUE); (8666)
  {
  ...
  // CALL EMITOP(STH, PTRARG1, STK); (8668)
  {
