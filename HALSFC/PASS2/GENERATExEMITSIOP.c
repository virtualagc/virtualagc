/*
  File GENERATExEMITSIOP.c generated by XCOM-I, 2024-08-09 12:39:31.
*/
...
GENERATExEMITSIOP (int reset)
{
  ...
  // CALL EMITDELTA(INX_CON(OP)); (3288)
  {
  ...
  rs1:
    switch (BYTE0 (
      ...
      {
      case 0:
        // CALL EMITSP(INST, FORM(OP), LOC(OP), VALUE); (3291)
        {
      ...
      case 1:
        ...
        {
        rs1s1:;
          // CALL EMITSI(INST, BASE(OP), DISP(OP), VALUE); (3292)
          {
