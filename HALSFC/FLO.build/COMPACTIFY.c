/*
  File COMPACTIFY.c generated by XCOM-I, 2024-08-09 12:38:39.
*/
...
COMPACTIFY (int reset)
{
  ...
  // IF LOWER_BOUND = 0 THEN (355)
  if (1 & (xEQ (getFIXED (mCOMPACTIFYxLOWER_BOUND), 0)))
    // LOWER_BOUND = FREEBASE; (356)
    {
...
if (1 & (xNEQ (getFIXED (m_DX_TOTAL), getFIXED (m_PREV_DX_TOTAL))))
  ...
  rs1:;
    ...
    if (1
      ...
      {
      rs1s1:;
        // OUTPUT='BI006 SEVERITY 3  BUG IN COMPACTIFY***  ABORTING'; (374)
        {
...
// DO TRIED = 0 TO 1; (377)
{
  ...
  for (putBIT (1, mCOMPACTIFYxTRIED, fixedToBit (1, from4));
    ...
    {
      // IF FORCE_MAJOR THEN (378)
      if (1 & (bitToFixed (getBIT (1, mFORCE_MAJOR))))
        // DO; (379)
        {
        rs2s1:;
          // FORCE_MAJOR=_FALSE; (380)
          {
      ...
      // COMPACTIFIES(TRIED) = COMPACTIFIES(TRIED) + 1; (383)
      {
              ...
              rs2s3s1:;
                ...
                // DO J=DP TO DP+DW*(_DOPE_USED(L)-1) BY DW; (396)
                {
                  ...
                  for (putFIXED (mCOMPACTIFYxJ, from7);
                    ...
                    {
                      // DO K=J TO J+4*(_DOPE_#DESCRIPTORS(L)-1) BY 4; (397)
                      {
        ...
        rs2s4:;
                 ...
                 putFIXED (mCOMPACTIFYxI, getFIXED (mCOMPACTIFYxI) + by10))
              {
                ...
                if (1
                  ...
                  rs2s4s2s1:;
                    ...
                    if (1 & (xGT (getFIXED (mCOMPACTIFYxDELTA), 0)))
                      // DO K = BC TO TC; (422)
                      {
                        ...
                        for (putFIXED (mCOMPACTIFYxK, from11);
                          ...
                          {
                            // COREBYTE(K-DELTA) = COREBYTE(K); (423)
                            {
                    ...
                    // FREEPOINT = FREEPOINT + TC - BC + 1; (424)
                    {
                      int32_t numberRHS = (int32_t)(xadd (
                          xsubtract (
          ...
          // DO K = BC TO TC; (431)
          {
            ...
            for (putFIXED (mCOMPACTIFYxK, from12);
              ...
              {
                // COREBYTE(K-DELTA) = COREBYTE(K); (432)
                {
                  int32_t numberRHS
          ...
          // FREEPOINT = FREEPOINT + TC - BC + 1; (433)
          {
            int32_t numberRHS = (int32_t)(xadd (
      ...
      if (1 & (getFIXED (mCOMPACTIFYxMODE)))
        ...
        {
        rs2s5:;
          // IF ACTUAL_DX_TOTAL>0 THEN (436)
          if (1 & (xGT (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 0)))
            // CALL MONITOR(7, ADDR(DX), SHL(ACTUAL_DX_TOTAL , 2)); (437)
            MONITOR7 (ADDR ("DX", 0x80000000, NULL, 0),
                      SHL (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 2));
          // I = ADDR(DESCRIPTOR_DESCRIPTOR); (438)
          {
            int32_t numberRHS
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (447)
{
...
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_TRIGGER THEN (455)
if (1
  ...
  rs3:;
    ...
    // K=_SPACE_ROUND(FREESTRING_TARGET - _LAST_COMPACTIFY_FOUND); (458)
    {
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (469)
{
  int32_t numberRHS = (int32_t)(xsubtract (FREELIMIT (), FREEPOINT ()));
  putFIXED (m_LAST_COMPACTIFY_FOUND, numberRHS);
}
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_MIN THEN (470)
if (1 & (xLT (getFIXED (m_LAST_COMPACTIFY_FOUND), getFIXED (mFREESTRING_MIN))))
  ...
  rs4:;
    ...
    // MEMORY FOR STRING STORAGE. JOB ABANDONED.'; (472)
    {
      descriptor_t *stringRHS;
      stringRHS = cToDescriptor (
