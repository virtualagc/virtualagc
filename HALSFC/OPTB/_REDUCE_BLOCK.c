/*
  File _REDUCE_BLOCK.c generated by XCOM-I, 2024-08-09 12:41:07.
*/
...
_REDUCE_BLOCK (int reset)
{
  ...
  // IF ~TOP & (REMBYTES < OLDNBYTES) THEN (260)
  if (1
      & (xAND (xNOT (BYTE0 (m_REDUCE_BLOCKxTOP)),
               xLT (getFIXED (m_REDUCE_BLOCKxREMBYTES),
                    getFIXED (m_REDUCE_BLOCKxOLDNBYTES)))))
    // _FREEBLOCK_SIZE(BLOCK)=OLDNBYTES-REMBYTES; (261)
    {
      int32_t numberRHS
  ...
  // ELSE (262)
    ...
    {
    rs2:;
      // PREV=_PREV_FREEBLOCK(BLOCK); (264)
      {
      ...
      // IF REMBYTES=OLDNBYTES THEN (265)
      if (1
        ...
        rs2s1:;
          ...
          if (1 & (xEQ (getFIXED (m_REDUCE_BLOCKxPREV), 0)))
            // FIRSTBLOCK=_FREEBLOCK_NEXT(BLOCK); (268)
            {
              int32_t numberRHS
          ...
          // ELSE (269)
            ...
            // _FREEBLOCK_NEXT(PREV)=_FREEBLOCK_NEXT(BLOCK); (270)
            {
              int32_t numberRHS
                  = (int32_t)(COREWORD (getFIXED (m_REDUCE_BLOCKxBLOCK)));
      ...
      // ELSE (271)
        ...
        rs2s2:;
          ...
          // _FREEBLOCK_NEXT(NEWBLOCK)=_FREEBLOCK_NEXT(BLOCK); (274)
          {
            int32_t numberRHS
                = (int32_t)(COREWORD (getFIXED (m_REDUCE_BLOCKxBLOCK)));
            COREWORD2 (getFIXED (m_REDUCE_BLOCKxNEWBLOCK), numberRHS);
          }
          // _FREEBLOCK_SIZE(NEWBLOCK)=OLDNBYTES-REMBYTES; (275)
          {
            int32_t numberRHS
                = (int32_t)(xsubtract (getFIXED (m_REDUCE_BLOCKxOLDNBYTES),
                                       getFIXED (m_REDUCE_BLOCKxREMBYTES)));
          ...
          // ELSE (278)
            ...
            // _FREEBLOCK_NEXT(PREV)=NEWBLOCK; (279)
            {
              int32_t numberRHS
                  = (int32_t)(getFIXED (m_REDUCE_BLOCKxNEWBLOCK));
              COREWORD2 (getFIXED (m_REDUCE_BLOCKxPREV), numberRHS);
