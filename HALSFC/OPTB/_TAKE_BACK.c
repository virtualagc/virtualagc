/*
  File _TAKE_BACK.c generated by XCOM-I, 2024-08-08 04:34:00.
*/
...
_TAKE_BACK (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (346)
  {
  ...
  while (1
                  ...
                  xGT (getFIXED (m_TAKE_BACKxLEFTBYTES), 0))))
    {
      ...
      if (1
        ...
        {
        rs1s1:;
          // DIF_RECS,RET_RECS=_DOPE_ALLOC(CUR)-_DOPE_USED(CUR); (357)
          {
          ...
          // IF RET_RECS > 0 THEN (358)
          if (1 & (xGT (getFIXED (m_TAKE_BACKxRET_RECS), 0)))
            // DO; (359)
            {
            rs1s1s1:;
              // RET_RECS=(NBYTES*RET_RECS)/POSSIBLE + 1; (360)
              {
              ...
              // LEFTBYTES=LEFTBYTES-(FREEBYTES-PREV_FREEBYTES); (367)
              {
                int32_t numberRHS = (int32_t)(xsubtract (
                    getFIXED (m_TAKE_BACKxLEFTBYTES),
