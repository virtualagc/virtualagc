/*
  File _MOVE_WORDS.c generated by XCOM-I, 2024-08-09 12:41:07.
*/
  ...
  if (1 & (xGT (getFIXED (m_MOVE_WORDSxDEST), getFIXED (m_MOVE_WORDSxSOURCE))))
    // DO I=0 TO NUMBYTES-4 BY 4; (150)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from2); getFIXED (m_MOVE_WORDSxI) <= to2;
        ...
        {
          // COREWORD(DEST-I) = COREWORD(SOURCE-I); (151)
          {
  ...
  // ELSE (152)
    ...
    // DO I=0 TO NUMBYTES -4 BY 4; (153)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from3); getFIXED (m_MOVE_WORDSxI) <= to3;
        ...
        {
          // COREWORD(DEST+I)=COREWORD(SOURCE+I); (154)
          {
