/*
  File _FREEBLOCK_CHECKxADDRESS_CHECK.c generated by XCOM-I, 2024-08-08
  04:34:00.
*/
...
_FREEBLOCK_CHECKxADDRESS_CHECK (int reset)
{
  ...
  rs1:;
    ...
    // ADDRESS='||((ADDRESS^=0)*(ADDRESS-FREEBASE-3))); (121)
    {
      putCHARACTERp (
          m_SPMANERRxMSG,
          xsCAT (
