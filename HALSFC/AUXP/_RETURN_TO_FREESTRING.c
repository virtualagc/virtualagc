/*
  File _RETURN_TO_FREESTRING.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
_RETURN_TO_FREESTRING (int reset)
{
  ...
  // ELSE (278)
    ...
    {
    rs2:;
      // CALL _SQUASH_RECORDS; (280)
      _SQUASH_RECORDS (0);
      // IF FIRSTBLOCK <= 0 THEN (281)
      if (1 & (xLE (getFIXED (mFIRSTBLOCK), 0)))
        // DO; (282)
        {
        rs2s1:;
          // CALL _SPMANERR('IN RETURN_TO_FREESTRING,
          // FIRSTBLOCK='||FIRSTBLOCK); (283)
          {
            putCHARACTERp (
                m_SPMANERRxMSG,
      ...
      // CALL _REDUCE_BLOCK(FIRSTBLOCK,NBYTES,_FALSE); (284)
      {
      ...
      // _OLDFREELIMIT,FREELIMIT=FREELIMIT+NBYTES; (285)
      {
      ...
      // FREEBYTES=FREEBYTES-NBYTES; (286)
      {
