/*
  File _STEAL.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
_STEAL (int reset)
{
  ...
  // IF FREELIMIT-FREEPOINT < NBYTES THEN (498)
  if (1
      & (xLT (xsubtract (FREELIMIT (), FREEPOINT ()),
              getFIXED (m_STEALxNBYTES))))
    // DO; (499)
  ...
  // _OLDFREELIMIT,FREELIMIT=FREELIMIT-NBYTES; (502)
  {
    int32_t numberRHS
