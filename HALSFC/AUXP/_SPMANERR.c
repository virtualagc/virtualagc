/*
  File _SPMANERR.c generated by XCOM-I, 2024-08-09 12:39:13.
*/
...
_SPMANERR (int reset)
{
  ...
  // IF ~ _IN_COMPACTIFY THEN (32)
  if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
    // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (33)
    ...
    // ELSE (37)
      ...
      {
      rs2:;
        // OUTPUT='BI003 SEVERITY 3  BUG IN SPACE MANAGEMENT SYSTEM'; (39)
        {
          descriptor_t *stringRHS;
  ...
  // IF NUMERRORS > MAX_NUM_ERRORS THEN (42)
