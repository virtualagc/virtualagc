/*
  File _FREEBLOCK_CHECKxBLKPROC.c generated by XCOM-I, 2024-08-08 04:32:08.
*/
...
_FREEBLOCK_CHECKxBLKPROC (int reset)
{
  ...
  if (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
    ...
    rs1:;
      ...
      // IF FREEPRINT THEN (120)
      if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
        // DO ; (121)
        {
        rs1s1:;
          // IF ^ _IN_COMPACTIFY THEN (122)
          if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
            // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (123)
      ...
      if (1
        ...
        rs1s2:;
          ...
          // BPNTR='||BPNTR||',UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (128)
          {
            putCHARACTERp (
                m_SPMANERRxMSG,
      ...
      // BPNTR=_FREEBLOCK_NEXT(BPNTR); (130)
      {
        int32_t numberRHS
      ...
      if (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
        ...
        if (1
          ...
          {
          rs1s3:;
            // CALL _SPMANERR('2 CONSECUTIVE BLOCKS.'); (134)
            {
