/*
  File CLEAR_REGS.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
CLEAR_REGS (int reset)
{
  ...
  // DO I = 0 TO REG_NUM; (1041)
  {
    ...
    for (putBIT (16, mCLEAR_REGSxI, fixedToBit (16, from23));
      ...
      {
        // IF ASSEMBLER_CODE THEN (1042)
        if (1 & (bitToFixed (getBIT (1, mASSEMBLER_CODE))))
          // IF (USAGE(I)&(~TRUE)) ~= 0 THEN (1043)
          if (1
