/*
  File GENERATExVECMAT_CONVERT.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExVECMAT_CONVERT (int reset)
{
  ...
  // TEMPSPACE = ROW(OP) * COLUMN(OP); (7202)
  {
  ...
  // IF PREC_SPEC > 0 THEN (7203)
  if (1 & (xGT (COREHALFWORD (mGENERATExVECMAT_CONVERTxPREC_SPEC), 0)))
    // OPTYPE = PREC_SPEC&8 | TYPE(OP)& 247; (7204)
    {
  ...
  // PTR = GET_VM_TEMP(OP, OPTYPE); (7207)
  {
    descriptor_t *bitRHS
  ...
  // CALL VECMAT_ASSIGN(PTR, OP); (7208)
  {
  ...
  // CALL DROPSAVE(OP); (7209)
  {
    putBITp (16, mGENERATExDROPSAVExENTRY,
             getBIT (16, mGENERATExVECMAT_CONVERTxOP));
    GENERATExDROPSAVE (0);
  }
  // CALL RETURN_STACK_ENTRY(OP); (7210)
  {
