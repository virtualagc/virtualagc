/*
  File _INCREASE_RECORD.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
_INCREASE_RECORD (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (559)
  {
  ...
  // NEWNRECS=_DOPE_ALLOC(DOPE)+NRECSMORE; (560)
  {
  ...
  // NEWNBYTES=_SPACE_ROUND(NEWNRECS*_DOPE_WIDTH(DOPE)); (561)
  {
  ...
  // OLDNBYTES=_RECORD#BYTES(DOPE); (562)
  {
    int32_t numberRHS = (int32_t)((
        putFIXED (
            m_SPACE_ROUNDxBYTES,
  ...
  // NBYTESMORE=NEWNBYTES-OLDNBYTES; (563)
  {
    int32_t numberRHS
  ...
  // IF NBYTESMORE > FREEBYTES THEN (564)
  if (1
      & (xGT (getFIXED (m_INCREASE_RECORDxNBYTESMORE), getFIXED (mFREEBYTES))))
    // CALL _STEAL(NBYTESMORE-FREEBYTES); (565)
    {
  ...
  // CALL _SQUASH_RECORDS; (566)
  _SQUASH_RECORDS (0);
  // CALL _MOVE_RECS(DOPE,NBYTESMORE); (567)
  {
