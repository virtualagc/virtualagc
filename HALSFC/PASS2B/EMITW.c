/*
  File EMITW.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
EMITW (int reset)
{
  ...
  // CODE(GET_CODE(CODE_LINE)) = DATA; (1073)
  {
  ...
  // IF BINARY_CODE THEN (1074)
  if (1 & (bitToFixed (getBIT (1, mBINARY_CODE))))
    // DO; (1075)
    {
    rs1:;
      // OUTPUT = HEX_LOCCTR || X3 || HEX(DATA, 8); (1076)
      {
  ...
  // IF ~MODIFIER THEN (1077)
  if (1 & (xNOT (BYTE0 (mEMITWxMODIFIER))))
    // LOCCTR(INDEXNEST) = LOCCTR(INDEXNEST) + 2; (1078)
    {
