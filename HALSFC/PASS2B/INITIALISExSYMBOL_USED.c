/*
  File INITIALISExSYMBOL_USED.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
INITIALISExSYMBOL_USED (int reset)
{
  ...
  // IF SELFNAMELOC > 0 THEN (2131)
  if (1 & (xGT (COREHALFWORD (mSELFNAMELOC), 0)))
    // IF PTR >= SELFNAMELOC THEN (2132)
    if (1
  ...
  while (1 & (xGT (COREHALFWORD (mINITIALISExSYMBOL_USEDxPTR), 0)))
    {
      ...
      if (1
          & (xNEQ (xAND (getFIXED (
                         ...
                         57344),
                   0)))
        // IF (XREF(PTR) &  8191) > FIRSTSTMT# THEN (2139)
        if (1
            & (xGT (
                xAND (getFIXED (
                          getFIXED (mCROSS_REF)
