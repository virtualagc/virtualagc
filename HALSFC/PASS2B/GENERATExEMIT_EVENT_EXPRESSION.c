/*
  File GENERATExEMIT_EVENT_EXPRESSION.c generated by XCOM-I, 2024-08-09
  12:41:32.
*/
...
GENERATExEMIT_EVENT_EXPRESSION (int reset)
{
    ...
    for (putBIT (16, mGENERATExEMIT_EVENT_EXPRESSIONxI,
         ...
         putBIT (16, mGENERATExEMIT_EVENT_EXPRESSIONxI,
                 fixedToBit (16, bitToFixed (getBIT (
                                     ...
                                     + by93)))
      {
        // EXPRESS = SHL(EV_EXP(I), 28-SHL(I,1)) | EXPRESS; (8638)
        {
  ...
  // IF STATIC_BLOCK THEN (8651)
  if (1 & (GENERATExSTATIC_BLOCK (0)))
    // DO; (8652)
    {
    rs2:;
      // LEFTOP = GET_STACK_ENTRY; (8653)
      {
        ...
        for (putBIT (16, mGENERATExEMIT_EVENT_EXPRESSIONxI,
             ...
             putBIT (
                 ...
                 fixedToBit (16, bitToFixed (getBIT (
                                     ...
                                     + by94)))
          {
            // CALL GENEVENTADDR(EV_OP(I)); (8661)
            {
              putBITp (
      ...
      // PROGDATA=LOCCTR(DATABASE); (8662)
      {
        int32_t numberRHS
            = (int32_t)(getFIXED (mLOCCTR + 4 * COREHALFWORD (mDATABASE)));
        putFIXED (mPROGDATA, numberRHS);
      }
      // CALL RESUME_LOCCTR(NARGINDEX); (8663)
      {
  ...
  // ELSE (8664)
    ...
    {
    rs3:;
      // LEFTOP = GETFREESPACE(DINTEGER, SHR(EV_PTR+3, 1)); (8666)
      {
        ...
        for (putBIT (16, mGENERATExEMIT_EVENT_EXPRESSIONxI,
             ...
             putBIT (
                 ...
                 fixedToBit (16, bitToFixed (getBIT (
                                     ...
                                     + by95)))
          {
            // CALL GENSVCADDR(EV_OP(I), LEFTOP, I+1); (8668)
            {
              putBITp (
      ...
      // CALL FORCE_NUM(PTRARG1, SHL(EV_EXPTR-1, 28) + EXPRESS, 8); (8670)
      {
      ...
      // CALL EMITOP(ST, PTRARG1, LEFTOP); (8671)
      {
