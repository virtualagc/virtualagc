/*
  File GENERATExCHECK_AGGREGATE_ASSIGN.c generated by XCOM-I, 2024-08-09
  12:41:32.
*/
...
GENERATExCHECK_AGGREGATE_ASSIGN (int reset)
{
  ...
  // CALL GUARANTEE_ADDRESSABLE(OP, LA); (7819)
  {
  ...
  rs1:
    switch (BYTE0 (
      ...
      {
      case 0:
        // IF FORM(OP) = CSYM | INX(OP) ~= 0 THEN (7822)
        if (1
      ...
      case 1:
        ...
        break;
      case 2:
        // IF FORM(OP) = CSYM | INX(OP) ~= 0 | COLUMN(OP) > 0 THEN (7825)
        if (1
            & (xOR (
                xOR (xEQ (COREHALFWORD (
                              getFIXED (mIND_STACK)
