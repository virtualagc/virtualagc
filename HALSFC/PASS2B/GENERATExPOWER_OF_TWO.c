/*
  File GENERATExPOWER_OF_TWO.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExPOWER_OF_TWO (int reset)
{
  ...
  while (1 & (xNOT (getFIXED (mGENERATExPOWER_OF_TWOxTEST))))
    {
      // INX_SHIFT(0) = INX_SHIFT(0) + 1; (5552)
      {
