/*
  File GENERATExCHAR_CALL.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExCHAR_CALL (int reset)
{
  ...
  // REMOTE_ADDRS = CHECK_REMOTE(OP0); (7298)
  {
  ...
  // REMOTE_ADDRS = CHECK_REMOTE(OP1) | REMOTE_ADDRS; (7299)
  {
  ...
  // ((OP1>0) & (CSECT_TYPE(LOC(OP1),OP1)=LOCAL#D)) ) THEN (7300)
  if (1
      & (xAND (
          BYTE0 (mDATA_REMOTE),
          xOR (
  ...
  if (1 & (xGT (COREHALFWORD (mGENERATExCHAR_CALLxOP3), 0)))
    ...
    {
    rs1:;
      // TARGET_REGISTER = SYSARG2(INTCALL); (7308)
      {
        descriptor_t *bitRHS
      ...
      // CALL FORCE_ACCUMULATOR(OP3, FULLBIT); (7309)
      {
  ...
  if (1 & (xGT (COREHALFWORD (mGENERATExCHAR_CALLxOP2), 0)))
    // CALL STACK_REG_PARM(FORCE_ADDRESS(SYSARG2(INTCALL), OP2, 1)); (7316)
    {
      putBITp (
  ...
  // CALL STACK_REG_PARM(FORCE_ADDRESS(SYSARG1(INTCALL), OP1, 1)); (7317)
  {
    putBITp (
        16, mGENERATExSTACK_REG_PARMxR,
        fixedToBit (
  ...
  if (1 & (xGT (COREHALFWORD (mGENERATExCHAR_CALLxOP0), 0)))
    ...
    if (1
      ...
      {
      rs2:;
        // IF (FORM(OP0)=WORK) & ~CHAR_ASNMNT THEN (7321)
        if (1
        ...
        // CALL STACK_REG_PARM(FORCE_ADDRESS(SYSARG0(INTCALL), OP0, 1)); (7323)
        {
          putBITp (
              16, mGENERATExSTACK_REG_PARMxR,
              fixedToBit (
  ...
  if (1
    ...
    {
    rs3:;
      // CALL SET_CHAR_DESC(OP1, FIXARG1, FIXARG2); (7326)
      {
      ...
      if (1
        ...
        {
        rs3s1:;
          // IF OLD_LINKAGE & OP3 = 0 THEN (7329)
          if (1
              & (xAND (BYTE0 (mOLD_LINKAGE),
                       xEQ (COREHALFWORD (mGENERATExCHAR_CALLxOP3), 0))))
            // CALL SET_CHAR_DESC(OP0, SYSARG2, FIXARG3); (7330)
            {
              putBITp (16, mGENERATExSET_CHAR_DESCxOP,
                       getBIT (16, mGENERATExCHAR_CALLxOP0));
          ...
          // ELSE (7331)
            ...
            rs3s1s1:;
              ...
              if (1
                ...
                rs3s1s1s1:;
                  ...
                  if (1
                    ...
                    // SHL(VAL(COLUMN(OP0)),16)+VAL(DEL(OP0)), 8); (7336)
                    {
                  ...
                  // ELSE (7337)
                    ...
                    {
                    rs3s1s1s1s1:;
                      // TARGET_REGISTER = FIXARG3; (7339)
                      {
                        descriptor_t *bitRHS = getBIT (8, mFIXARG3);
                        putBIT (16, mTARGET_REGISTER, bitRHS);
                        bitRHS->inUse = 0;
                      }
                      // CALL FORCE_ACCUMULATOR(DEL(OP0)); (7340)
                      {
                        putBITp (
                      ...
                      // CALL EMITP(SRL, FIXARG3, 0, SHCOUNT, 16); (7341)
                      {
              ...
              // ELSE (7344)
                ...
                {
                rs3s1s1s2:;
                  // IF FORM(COLUMN(OP0)) = LIT THEN (7346)
                  if (1
                      & (xEQ (COREHALFWORD (
                                  getFIXED (mIND_STACK)
                                  + 73
                              ...
                              BYTE0 (mLIT))))
                    // CALL FORCE_NUM(FIXARG3,
                    // SHL(VAL(COLUMN(OP0)),16)+VAL(COLUMN(OP0)), 8); (7347)
                    {
                      putBITp (16, mGENERATExFORCE_NUMxR,
                               getBIT (8, mFIXARG3));
                      putFIXED (
                  ...
                  // ELSE (7348)
                    ...
                    {
                    rs3s1s1s2s1:;
                      // TARGET_REGISTER = FIXARG3; (7350)
                      {
                        descriptor_t *bitRHS = getBIT (8, mFIXARG3);
                        putBIT (16, mTARGET_REGISTER, bitRHS);
                        bitRHS->inUse = 0;
                      }
                      // CALL FORCE_ACCUMULATOR(COLUMN(OP0)); (7351)
                      {
                        putBITp (
                            16, mGENERATExFORCE_ACCUMULATORxOP,
                            getBIT (16, getFIXED (mIND_STACK)
                      ...
                      // CALL OFF_TARGET(COLUMN(OP0)); (7352)
                      {
                        putBITp (
                            16, mGENERATExOFF_TARGETxOP,
                            getBIT (16, getFIXED (mIND_STACK)
              ...
              // CALL RETURN_STACK_ENTRIES(COLUMN(OP0), DEL(OP0)); (7353)
              {
                putBITp (
  ...
  // ELSE (7354)
    ...
    if (1
      ...
      {
      rs4:;
        // CALL SET_CHAR_DESC(OP0, FIXARG1, FIXARG2); (7357)
        {
          putBITp (16, mGENERATExSET_CHAR_DESCxOP,
                   getBIT (16, mGENERATExCHAR_CALLxOP0));
          putBITp (16, mGENERATExSET_CHAR_DESCxR1, getBIT (8, mFIXARG1));
  ...
  if (1 & (xGT (COREHALFWORD (mGENERATExCHAR_CALLxOP3), 0)))
    ...
    {
    rs5:;
      // CALL CHECK_VAC(OP3, SYSARG2(INTCALL)); (7361)
      {
  ...
  // IF REMOTE_ADDRS THEN (7363)
  if (1 & (bitToFixed (getBIT (1, mREMOTE_ADDRS))))
    // IF OPCODE = XXASN THEN (7364)
  ...
  // CALL GENLIBCALL(FORM_CHARNAME(OPCODE, CPART, VACOP)); (7366)
  {
  ...
  // LASTRESULT, OP3, REMOTE_ADDRS, CHAR_ASNMNT = 0; (7367)
  {
    int32_t numberRHS = (int32_t)(0);
    descriptor_t *bitRHS;
    bitRHS = fixedToBit (32, (int32_t)(numberRHS));
