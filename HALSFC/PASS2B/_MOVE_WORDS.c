/*
  File _MOVE_WORDS.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
  ...
  if (1 & (xGT (getFIXED (m_MOVE_WORDSxDEST), getFIXED (m_MOVE_WORDSxSOURCE))))
    // DO I=0 TO NUMBYTES-4 BY 4; (152)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from2); getFIXED (m_MOVE_WORDSxI) <= to2;
        ...
        {
          // COREWORD(DEST-I) = COREWORD(SOURCE-I); (153)
          {
  ...
  // ELSE (154)
    ...
    // DO I=0 TO NUMBYTES -4 BY 4; (155)
    {
      ...
      for (putFIXED (m_MOVE_WORDSxI, from3); getFIXED (m_MOVE_WORDSxI) <= to3;
        ...
        {
          // COREWORD(DEST+I)=COREWORD(SOURCE+I); (156)
          {
