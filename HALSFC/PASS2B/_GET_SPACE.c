/*
  File _GET_SPACE.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
_GET_SPACE (int reset)
{
  ...
  // IF (NBYTES& 7) ~= 0 THEN (575)
  if (1 & (xNEQ (xAND (getFIXED (m_GET_SPACExNBYTES), 7), 0)))
    // CALL _SPMANERR( 'IN _GET_SPACE, NBYTES='||NBYTES); (576)
    {
  ...
  // FREEB=_FIND_FREE(NBYTES,UNMOVEABLE); (577)
  {
  ...
  // CALL _REDUCE_BLOCK(FREEB,NBYTES,_TRUE); (579)
  {
