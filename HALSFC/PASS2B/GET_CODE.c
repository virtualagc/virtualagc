/*
  File GET_CODE.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GET_CODE (int reset)
{
  ...
  // ELSE (1024)
    ...
    rs1:;
      ...
      // DO CODE_MAX = CODE_MAX + 1 TO CODE_BLK - 1; (1028)
      {
        ...
        for (putFIXED (mCODE_MAX, from21); getFIXED (mCODE_MAX) <= to21;
          ...
          {
            // FILE(CODE_FILE, CODE_MAX) = CODE; (1029)
            {
