/*
  File INITIALISExCONSTERM.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
INITIALISExCONSTERM (int reset)
{
    ...
    rs1:;
      ...
      if (1
        ...
        rs1s1:;
          ...
          // RETURN -(EXTENT(K) + SYT_DISP(K)); (2098)
          {
            reentryGuard = 0;
            return xminus (xadd (
  ...
  // ELSE (2101)
    ...
    rs2:;
            ...
            for (putBIT (16, mINITIALISExCONSTERMxI, fixedToBit (16, from33));
                 ...
                 putBIT (16, mINITIALISExCONSTERMxI,
                         fixedToBit (16, bitToFixed (getBIT (
                                             ...
                                             + by33)))
              {
                // TERM1 = TERM1 * GETARRAYDIM(I, OP) - 1; (2107)
                {
          ...
          if (1 & (xEQ (COREHALFWORD (mINITIALISExCONSTERMxJ), 1)))
            ...
            if (1
                & (xGT (COREHALFWORD (
                            ...
                            + 18 + 2 * (0)),
                        0)))
              // TERM1 = TERM1 * CS(SYT_DIMS(OP)+2); (2113)
              {
        ...
        if (1 & (xEQ (COREHALFWORD (mINITIALISExCONSTERMxT), BYTE0 (mMATRIX))))
          ...
          rs2s3:;
            ...
            if (1 & (xEQ (COREHALFWORD (mINITIALISExCONSTERMxJ), 1)))
              ...
              {
              rs2s3s1:;
                // TERM1 = SHR(SYT_DIMS(OP), 8) * TERM1; (2119)
                {
                  int32_t numberRHS = (int32_t)(xmultiply (
                      SHR (COREHALFWORD (
                               getFIXED (mSYM_TAB)
                ...
                // TERM1 = (SYT_DIMS(OP) &  255) * TERM1 - 1; (2120)
                {
                  int32_t numberRHS = (int32_t)(xsubtract (
        ...
        // ELSE (2122)
          ...
          if (1
            ...
            rs2s4:;
              // IF J = 1 THEN (2125)
              if (1 & (xEQ (COREHALFWORD (mINITIALISExCONSTERMxJ), 1)))
                // TERM1 = TERM1 * (SYT_DIMS(OP)& 255) - 1; (2126)
                {
                  int32_t numberRHS = (int32_t)(xsubtract (
      ...
      // RETURN TERM1 * BIGHTS(SYT_TYPE(OP)); (2130)
      {
        reentryGuard = 0;
        return xmultiply (
            getFIXED (mINITIALISExCONSTERMxTERM1),
