...
GENERATExGEN_CLASS0xSINGLE_3VECTOR_OPERATION (int reset)
{
  ...
  // IF NUMOP = 1 THEN (12357)
  if (1 & (xEQ (COREHALFWORD (mNUMOP), 1)))
    // DO; (12358)
    {
    rs1:;
      // CALL DECODEPIP(1); (12359)
      {
      ...
      if (1 & (xEQ (COREHALFWORD (mOP1), 3)))
        ...
        rs1s1:;
          ...
          // IF (OPR(SKIP_NOP(PTR)) &  65529) = XVDLE THEN (12363)
          if (1
              & (xEQ (
                  xAND (
                      getFIXED (
          ...
          // ELSE (12365)
            ...
            // IF (SHR(OPR(PTR),1)& 4) = 0 THEN (12366)
            if (1
                & (xEQ (
                    xAND (
                        SHR (
                ...
                if (1
                    & (xGT (
                        COREHALFWORD (
                            mGENERATExGEN_CLASS0xSINGLE_3VECTOR_OPERATIONxPTR),
                        0)))
                  // IF (OPR(SKIP_NOP(PTR)) &  65529) = XVDLE THEN (12370)
                  if (1
                      & (xEQ (
                          xAND (
                              getFIXED (
