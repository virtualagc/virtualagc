/*
  File EMITSTRING.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
while (1 & (xGT (COREHALFWORD (mEMITSTRINGxLEN), 0)))
  {
    ...
    // ELSE (1099)
      ...
      rs2s1:;
        ...
        // LOCCTR(INDEXNEST) = LOCCTR(INDEXNEST) + CS(LEN); (1102)
        {
