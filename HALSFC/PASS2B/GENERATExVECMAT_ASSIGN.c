/*
  File GENERATExVECMAT_ASSIGN.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
GENERATExVECMAT_ASSIGN (int reset)
{
  ...
  // IF (TYPE(OP0)&8) ~= (TYPE(OP1)&8) THEN (7189)
  if (1
