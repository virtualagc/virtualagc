/*
  File GENERATExCHAR_SUBSCRIPT.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
  ...
  rs1:
    switch (COREHALFWORD (mTAG3))
      ...
      case 1:
        ...
        {
        rs1s1:;
          // COLUMN(ALCOP) = SET_CINDEX(RIGHTOP); (8304)
          {
      ...
      case 2:
        ...
        rs1s2:;
              ...
              & (xAND (
                  ...
                  xEQ (xOR (COREHALFWORD (getFIXED (mIND_STACK)
                            ...
                            COREHALFWORD (
                                ...
                                + 2 * (0))),
                       1))))
            // SIZE(ALCOP) = VAL(EXTOP) - VAL(RIGHTOP) + 1; (8309)
            {
          ...
          // COLUMN(ALCOP) = SET_CINDEX(RIGHTOP); (8310)
          {
            descriptor_t *bitRHS = (putBITp (16, mGENERATExSET_CINDEXxOP,
                                             getBIT (16, mRIGHTOP)),
                                    GENERATExSET_CINDEX (0));
          ...
          // DEL(ALCOP) = SET_CINDEX(EXTOP, 1); (8311)
          {
            descriptor_t *bitRHS = (putBITp (16, mGENERATExSET_CINDEXxOP,
      ...
      case 3:
        ...
        rs1s3:;
          ...
          // EXTOP, COLUMN(ALCOP) = SET_CINDEX(EXTOP); (8315)
          {
            descriptor_t *bitRHS = (putBITp (16, mGENERATExSET_CINDEXxOP,
                                             getBIT (16, mGENERATExEXTOP)),
                                    GENERATExSET_CINDEX (0));
          ...
          if (1
            ...
            rs1s3s1:;
              ...
              if (1
                ...
                {
                rs1s3s1s1:;
                  // VAL(RIGHTOP) = VAL(EXTOP) + VAL(RIGHTOP) - 1; (8320)
                  {
              ...
              // ELSE (8322)
                ...
                // VAL(RIGHTOP) = VAL(RIGHTOP) - 1; (8323)
                {
                  int32_t numberRHS = (int32_t)(xsubtract (
                      getFIXED (getFIXED (mIND_STACK)
                                + 73 * (COREHALFWORD (mRIGHTOP)) + 12
          ...
          // ELSE (8324)
            ...
            // CONST(RIGHTOP) = CONST(RIGHTOP) - 1; (8325)
            {
              int32_t numberRHS = (int32_t)(xsubtract (
                  getFIXED (getFIXED (mIND_STACK)
          ...
          // DEL(ALCOP) = SET_CINDEX(RIGHTOP, TAG3-1); (8326)
          {
            descriptor_t *bitRHS
