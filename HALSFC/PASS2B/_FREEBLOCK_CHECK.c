/*
  File _FREEBLOCK_CHECK.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
_FREEBLOCK_CHECK (int reset)
{
  ...
  // CALL _CHECK_FOR_THEFT; (73)
  _CHECK_FOR_THEFT (0);
  // FBYTES,RBYTES,BLKNO,RECNO=0; (74)
  {
  ...
  // IF FREEPRINT THEN (79)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (80)
    {
    rs1:;
      // IF ^ _IN_COMPACTIFY THEN (81)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (82)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // FIRSTBLOCK ^ = 0 ) * ( FIRSTBLOCK - FREEBASE - 3 ) ) ; (83)
          {
  ...
  while (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxRDOPE), 0)))
    {
      ...
      if (1
        ...
        rs2s1:;
          ...
          // IF FREEPRINT THEN (91)
          if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
            // IF ~ _IN_COMPACTIFY THEN (92)
            if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
              // IF FREELIMIT > FREEPOINT + 650 THEN (93)
              if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // CALL ADDRESS_CHECK(_DOPE_POINTER(RDOPE)); (95)
          {
          ...
          if (1
            ...
            rs2s1s1:;
              ...
              // SIZE,UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (98)
              {
                putCHARACTERp (
                    m_SPMANERRxMSG,
                    xsCAT (
  ...
  if (1 & (xNEQ (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
    ...
    {
    rs3:;
      // CALL _SPMANERR('CONSECUTIVE FREEBLOCKS.'); (106)
      {
  ...
  if (1
    ...
    rs4:;
      ...
      // UPLIM='||UPLIM||',DOWNLIM='||DOWNLIM); (109)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
  ...
  // IF FREEPRINT THEN (110)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (111)
    {
    rs5:;
      // IF ^ _IN_COMPACTIFY THEN (112)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (113)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          // OUTPUT = FBYTES || ' BYTES OF FREEBYTES, ' || RBYTES || '
          // ALLOCATED, TOTAL OF ' || RBYTES + FBYTES ; (114)
          {
            descriptor_t *stringRHS;
            stringRHS = xsCAT (
  ...
  // CALL _CHECK_FOR_THEFT; (115)
  _CHECK_FOR_THEFT (0);
  // IF (FBYTES~=FREEBYTES) | (RBYTES~=RECBYTES) THEN (116)
  if (1
      & (xOR (
    ...
    rs6:;
      ...
      // RBYTES='||RBYTES||', RECBYTES='||RECBYTES); (118)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
            xsCAT (
