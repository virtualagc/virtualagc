/*
  File LIB_LOOK.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
LIB_LOOK (int reset)
{
  ...
  // LIB_POINTER = LIB_START(HASH(NAME)); (1378)
  {
  ...
  // DO WHILE LIB_POINTER ~= 0; (1379)
  while (1 & (xNEQ (COREHALFWORD (mLIB_POINTER), 0)))
    {
      // IF NAME = DESC(LIB_NAME_INDEX(ABS(LIB_POINTER))) THEN (1380)
      if (1
        ...
        {
        rs1s1:;
          // IF EMIT_LDM_TABLE(ABS(LIB_POINTER))= 0 THEN (1382)
          if (1
      ...
      // LIB_POINTER = LIB_LINK(ABS(LIB_POINTER)); (1387)
      {
        descriptor_t *bitRHS
