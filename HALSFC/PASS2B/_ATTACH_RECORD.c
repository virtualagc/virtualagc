/*
  File _ATTACH_RECORD.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
_ATTACH_RECORD (int reset)
{
  ...
  // IF FIRSTRECORD = 0 THEN (231)
  if (1 & (xEQ (getFIXED (mFIRSTRECORD), 0)))
    // FIRSTRECORD=DOPE; (232)
    {
  ...
  // ELSE (233)
    ...
    rs1:;
      ...
      do
        {
          // IF _DOPE_POINTER(CUR) < LOC THEN (239)
          if (1
