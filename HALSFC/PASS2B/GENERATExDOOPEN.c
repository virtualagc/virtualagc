/*
  File GENERATExDOOPEN.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExDOOPEN (int reset)
{
  ...
  // TMP, BACKUP_REG(PTR) = REG(PTR); (5849)
  {
  ...
  if (1 & (xLT (getFIXED (mGENERATExDOOPENxSTOP), 0)))
    // DORANGE(ADOPTR) = SET_ARRAY_SIZE(-STOP); (5851)
    {
      descriptor_t *bitRHS
  ...
  // ELSE (5852)
    ...
    // DORANGE(ADOPTR) = GET_INTEGER_LITERAL(STOP); (5853)
    {
  ...
  // IF STEP = 1 & NEW_INSTRUCTIONS THEN (5854)
  if (1
    ...
    rs1:;
      ...
      if (1 & (xLT (getFIXED (mGENERATExDOOPENxSTOP), 0)))
        ...
        {
        rs1s1:;
          // CALL LOAD_NUM(TMP, START, 1); (5860)
          {
          ...
          // CALL CHECK_ADDR_NEST(-1, DORANGE(ADOPTR)); (5861)
          {
          ...
          // CALL EMITOP(IHL, TMP, DORANGE(ADOPTR)); (5862)
          {
      ...
      // ELSE (5865)
        ...
        // CALL LOAD_NUM(TMP, SHL(START,16) + STOP - 1, 9); (5866)
        {
          putBITp (16, mGENERATExLOAD_NUMxR,
                   fixedToBit (32, (int32_t)(getFIXED (mTMP))));
          putFIXED (
  ...
  // ELSE (5868)
    ...
    // CALL LOAD_NUM(TMP, START, 1); (5869)
    {
      putBITp (16, mGENERATExLOAD_NUMxR,
               fixedToBit (32, (int32_t)(getFIXED (mTMP))));
  ...
  // CALL SET_LABEL(DOLABEL(ADOPTR), 1); (5870)
  {
    putBITp (
  ...
  // CALL SET_USAGE(TMP, AIDX, PTR); (5871)
  {
