/*
  File COMPACTIFY.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
COMPACTIFY (int reset)
{
  ...
  // IF LOWER_BOUND = 0 THEN (372)
  if (1 & (xEQ (getFIXED (mCOMPACTIFYxLOWER_BOUND), 0)))
    // LOWER_BOUND = FREEBASE; (373)
    {
...
if (1 & (xNEQ (getFIXED (m_DX_TOTAL), getFIXED (m_PREV_DX_TOTAL))))
  ...
  rs1:;
    ...
    if (1
      ...
      {
      rs1s1:;
        // OUTPUT='BI006 SEVERITY 3  BUG IN COMPACTIFY***  ABORTING'; (391)
        {
...
// DO TRIED = 0 TO 1; (394)
{
  ...
  for (putBIT (1, mCOMPACTIFYxTRIED, fixedToBit (1, from4));
    ...
    {
      // IF FORCE_MAJOR THEN (395)
      if (1 & (bitToFixed (getBIT (1, mFORCE_MAJOR))))
        // DO; (396)
        {
        rs2s1:;
          // FORCE_MAJOR=_FALSE; (397)
          {
      ...
      // COMPACTIFIES(TRIED) = COMPACTIFIES(TRIED) + 1; (400)
      {
              ...
              rs2s3s1:;
                ...
                // DO J=DP TO DP+DW*(_DOPE_USED(L)-1) BY DW; (413)
                {
                  ...
                  for (putFIXED (mCOMPACTIFYxJ, from7);
                    ...
                    {
                      // DO K=J TO J+4*(_DOPE_#DESCRIPTORS(L)-1) BY 4; (414)
                      {
        ...
        rs2s4:;
          ...
          // DO K = BC TO TC; (448)
          {
            ...
            for (putFIXED (mCOMPACTIFYxK, from12);
              ...
              {
                // COREBYTE(K-DELTA) = COREBYTE(K); (449)
                {
                  int32_t numberRHS
          ...
          // FREEPOINT = FREEPOINT + TC - BC + 1; (450)
          {
            int32_t numberRHS = (int32_t)(xadd (
      ...
      if (1 & (getFIXED (mCOMPACTIFYxMODE)))
        ...
        {
        rs2s5:;
          // IF ACTUAL_DX_TOTAL>0 THEN (453)
          if (1 & (xGT (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 0)))
            // CALL MONITOR(7, ADDR(DX), SHL(ACTUAL_DX_TOTAL , 2)); (454)
            MONITOR7 (ADDR ("DX", 0x80000000, NULL, 0),
                      SHL (getFIXED (mCOMPACTIFYxACTUAL_DX_TOTAL), 2));
          // I = ADDR(DESCRIPTOR_DESCRIPTOR); (455)
          {
            int32_t numberRHS
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (464)
{
...
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_TRIGGER THEN (472)
if (1
  ...
  rs3:;
    ...
    // K=_SPACE_ROUND(FREESTRING_TARGET - _LAST_COMPACTIFY_FOUND); (475)
    {
...
// _LAST_COMPACTIFY_FOUND=FREELIMIT-FREEPOINT; (486)
{
  int32_t numberRHS = (int32_t)(xsubtract (FREELIMIT (), FREEPOINT ()));
  putFIXED (m_LAST_COMPACTIFY_FOUND, numberRHS);
}
// IF _LAST_COMPACTIFY_FOUND < FREESTRING_MIN THEN (487)
if (1 & (xLT (getFIXED (m_LAST_COMPACTIFY_FOUND), getFIXED (mFREESTRING_MIN))))
  ...
  rs4:;
    ...
    // MEMORY FOR STRING STORAGE. JOB ABANDONED.'; (489)
    {
      descriptor_t *stringRHS;
      stringRHS = cToDescriptor (
