/*
  File GENERATExCTON.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExCTON (int reset)
{
  ...
  // IF CHECK_REMOTE(OP) | COLUMN(OP) > 0 THEN (7687)
  if (1
  ...
  // IF DATA_REMOTE & (CSECT_TYPE(LOC(OP),OP)=LOCAL#D) THEN (7689)
  if (1
      & (xAND (
          BYTE0 (mDATA_REMOTE),
          xEQ (
  ...
  // CALL GENLIBCALL('CTO' || TYPES(CHARTYPE(OPTYPE)+TAG)); (7693)
  {
    putCHARACTERp (
  ...
  // CALL SET_RESULT_REG(PTR, OPTYPE); (7696)
  {
