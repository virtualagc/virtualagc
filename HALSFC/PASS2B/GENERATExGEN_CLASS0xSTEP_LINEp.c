/*
  File GENERATExGEN_CLASS0xSTEP_LINEp.c generated by XCOM-I, 2024-08-09
  12:41:32.
*/
...
GENERATExGEN_CLASS0xSTEP_LINEp (int reset)
{
  ...
  // DO WHILE OPRTR ~= XSMRK & OPRTR ~= XIMRK; (12020)
  while (1
         & (xAND (xNEQ (COREHALFWORD (mGENERATExGEN_CLASS0xSTEP_LINEpxOPRTR),
                  ...
                  xNEQ (COREHALFWORD (mGENERATExGEN_CLASS0xSTEP_LINEpxOPRTR),
                        COREHALFWORD (mXIMRK)))))
    {
      // IMRK_CTR = IMRK_CTR + OPNUM + 1; (12021)
      {
        int32_t numberRHS = (int32_t)(xadd (
  ...
  // LINE# = SHR(OPR(IMRK_CTR+1), 16); (12023)
  {
  ...
  // IF ASSEMBLER_CODE THEN (12024)
  if (1 & (bitToFixed (getBIT (1, mASSEMBLER_CODE))))
    // OUTPUT = '*** HAL/S STATEMENT ' || LINE#; (12025)
    {
