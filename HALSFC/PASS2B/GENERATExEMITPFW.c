/*
  File GENERATExEMITPFW.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExEMITPFW (int reset)
{
  ...
  // DIFF = LOCCTR(INDEXNEST)+1 - DEST; (3262)
  {
  ...
  // IF (INST=BC|INST=BCT) & DEST~=0 & DIFF>=0 & DIFF<=55 THEN (3263)
  if (1
    ...
    // CALL EMITP(INST+ 64, XREG, 0, FORM(PTR), LOC(PTR), SRSTYPE); (3264)
    {
      putBITp (
  ...
  // ELSE (3265)
    ...
    // CALL EMITP(INST, XREG, 0, FORM(PTR), LOC(PTR)); (3266)
    {
  ...
  // CALL RETURN_STACK_ENTRY(PTR); (3267)
  {
