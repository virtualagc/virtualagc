...
GENERATExGEN_CLASS0xMOVE_STRUCTURExUSE_MSTRUC (int reset)
{
  ...
  // OPCODE, REMOTE_ADDRS = CHECK_REMOTE(RIGHTOP) | REMOTE_ADDRS; (11107)
  {
  ...
  // INTCALL = 2 + INTRINSIC(MSTRUC(OPCODE)); (11108)
  {
  ...
  // CALL STACK_REG_PARM(FORCE_ADDRESS(SYSARG1(INTCALL), RIGHTOP, 1)); (11109)
  {
    putBITp (
  ...
  // TARGET_REGISTER = FIXARG1; (11110)
  {
    descriptor_t *bitRHS = getBIT (8, mFIXARG1);
    putBIT (16, mTARGET_REGISTER, bitRHS);
    bitRHS->inUse = 0;
  }
  // CALL FORCE_ACCUMULATOR(EXTOP, INTEGER); (11111)
  {
  ...
  // CALL STACK_TARGET(EXTOP); (11112)
  {
    putBITp (16, mGENERATExSTACK_TARGETxOP,
             getBIT (16, mGENERATExGEN_CLASS0xMOVE_STRUCTURExEXTOP));
    GENERATExSTACK_TARGET (0);
  }
  // CALL FORCE_ADDRESS(SYSARG0(INTCALL),LEFTOP); (11113)
  {
  ...
  // CALL DROP_PARM_STACK; (11114)
  GENERATExDROP_PARM_STACK (0);
  // CALL GENLIBCALL(MSTRUC(OPCODE)); (11115)
  {
