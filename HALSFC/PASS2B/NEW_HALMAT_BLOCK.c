/*
  File NEW_HALMAT_BLOCK.c generated by XCOM-I, 2024-08-08 04:34:25.
*/
...
NEW_HALMAT_BLOCK (int reset)
{
  ...
  // OPR(0)=FILE(CODEFILE,CURCBLK); (976)
  {
    rFILE (ADDR ("FOR_ATOMS", 0, "CONST_ATOMS", 0), BYTE0 (mCODEFILE),
           BYTE0 (mCURCBLK));
  }
  // CURCBLK=CURCBLK+1; (977)
  {
  ...
  // OFF_PAGE_CTR(OFF_PAGE_NEXT) = 0; (981)
  {
    int32_t numberRHS = (int32_t)(0);
    descriptor_t *bitRHS;
    bitRHS = fixedToBit (32, (int32_t)(numberRHS));
