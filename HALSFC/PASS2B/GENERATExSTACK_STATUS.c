/*
  File GENERATExSTACK_STATUS.c generated by XCOM-I, 2024-08-09 12:41:32.
*/
...
GENERATExSTACK_STATUS (int reset)
{
  ...
  // IF STACK_DUMP THEN (2775)
  if (1 & (bitToFixed (getBIT (1, mSTACK_DUMP))))
    // DO I = 1 TO STACK_MAX; (2776)
    {
