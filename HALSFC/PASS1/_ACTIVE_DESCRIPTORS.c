/*
  File _ACTIVE_DESCRIPTORS.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
_ACTIVE_DESCRIPTORS (int reset)
{
  ...
  // IF (_DOPE_USED(DOPE) = 0) | (_DOPE_#DESCRIPTORS(DOPE)=0) THEN (49)
  if (1
      & (xOR (
  ...
  // DND=SHL(_DOPE_#DESCRIPTORS(DOPE),2); (52)
  {
