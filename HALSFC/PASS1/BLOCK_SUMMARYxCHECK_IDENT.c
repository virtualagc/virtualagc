/*
  File BLOCK_SUMMARYxCHECK_IDENT.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
BLOCK_SUMMARYxCHECK_IDENT (int reset)
{
  ...
  // IF SYT_NEST(PTR) ~< NEST THEN (4775)
  if (1
  ...
  // CALL OUTPUT_IDENT(TEMP1&6); (4785)
  {
