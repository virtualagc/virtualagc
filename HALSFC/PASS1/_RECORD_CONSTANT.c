/*
  File _RECORD_CONSTANT.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
_RECORD_CONSTANT (int reset)
{
  ...
  // _DOPE_USED(DOPE) = _DOPE_ALLOC(DOPE); (621)
  {
    int32_t numberRHS
