/*
  File STREAMxSCAN_CARD.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
STREAMxSCAN_CARD (int reset)
{
  ...
  // DO CP = 1 TO TEXT_LIMIT; (4500)
  {
    ...
    for (putBIT (16, mSTREAMxCP, fixedToBit (16, from78));
      ...
      {
        // IF BYTE(CURRENT_CARD, CP) ~= BYTE(X1) THEN (4501)
        if (1
            & (xNEQ (
          ...
          {
          rs1s1:;
            // IF BYTE(E_LINE(TYPE), CP) ~= BYTE(X1) THEN (4503)
            if (1
            ...
            // E_INDICATOR(CP + POINT) = E_COUNT(TYPE); (4509)
            {
            ...
            // FILL = BYTE(CURRENT_CARD, CP); (4510)
            {
