/*
  File GET_ARRAYNESS.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
GET_ARRAYNESS (int reset)
{
  ...
  // IF SYT_ARRAY(FIXV(MP))~=0 THEN (7711)
  if (1
    ...
    rs1:;
      ...
      // VAR_ARRAYNESS(1)=SYT_ARRAY(FIXV(MP)); (7714)
      {
        descriptor_t *bitRHS
  ...
  if (1 & (xGT (COREHALFWORD (mGET_ARRAYNESSxI), 0)))
    ...
    rs2:;
        ...
        for (putBIT (16, mGET_ARRAYNESSxJ, fixedToBit (16, from123));
             ...
             putBIT (16, mGET_ARRAYNESSxJ,
                     fixedToBit (16, bitToFixed (getBIT (16, mGET_ARRAYNESSxJ))
                                         + by123)))
          {
            // VAR_ARRAYNESS(VAR_ARRAYNESS+J)=EXT_ARRAY(I+J); (7722)
            {
              descriptor_t *bitRHS = getBIT (
                  16, mEXT_ARRAY
                          + 2
      ...
      // VAR_ARRAYNESS=VAR_ARRAYNESS+EXT_ARRAY(I); (7723)
      {
  ...
  // IF (SYT_FLAGS(I)&NAME_FLAG)~=0 THEN (7726)
  if (1
  ...
  // VAL_P(PTR(MP))=VAL_P(PTR(MP))|K; (7728)
  {
