/*
  File HALMAT_OUT.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
HALMAT_OUT (int reset)
{
  ...
  // IF ATOM#_FAULT<0 THEN (7178)
  if (1 & (xLT (getFIXED (mATOMp_FAULT), 0)))
    // ATOM#_FAULT=NEXT_ATOM#-1; (7179)
    {
  ...
  // ELSE (7180)
    ...
    rs1:;
      ...
      // IF HALMAT_RELOCATE_FLAG THEN (7183)
      ...
      // SAVE_ATOM=ATOMS(ATOM#_FAULT); (7185)
      {
      ...
      // ATOMS(ATOM#_FAULT)=SHL(XXREC,4); (7186)
      {
  ...
  if (1 & (bitToFixed (getBIT (1, mCONTROL + 1 * 11))))
    ...
    rs2:;
      ...
      // OUTPUT='         *** HALMAT BLOCK '||HALMAT_BLOCK||' ***'; (7191)
      {
        descriptor_t *stringRHS;
        stringRHS
        ...
        for (putBIT (16, mHALMAT_OUTxI, fixedToBit (16, from117));
             ...
             putBIT (16, mHALMAT_OUTxI,
                     fixedToBit (16, bitToFixed (getBIT (16, mHALMAT_OUTxI))
                                         + by117)))
          {
            // CALL HALMAT_BLAB(ATOMS(I),I); (7194)
            {
  ...
  // FILE(HALMAT_FILE,HALMAT_BLOCK) = ATOMS(0); (7195)
  {
    lFILE (1, COREHALFWORD (mHALMAT_BLOCK),
           ADDR ("FOR_ATOMS", 0, "CONST_ATOMS", 0));
  }
  // HALMAT_BLOCK=HALMAT_BLOCK+1; (7196)
  {
  ...
  // ATOMS(ATOM#_FAULT)=SAVE_ATOM; (7197)
  {
  ...
  // HALMAT_RELOCATE_FLAG=TRUE; (7198)
  {
