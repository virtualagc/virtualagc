/*
  File REDUCE_SUBSCRIPT.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
  ...
  rs1:
    switch (REDUCE_SUBSCRIPTxSTEPPER (0))
      ...
      case 1:
        ...
        {
        rs1s1:;
          // CALL CHECK_SUBSCRIPT(MODE,SIZE,0); (8310)
          {
      ...
      case 2:
        ...
        {
        rs1s2:;
          // T1=CHECK_SUBSCRIPT(MODE,SIZE,0); (8313)
          {
            int32_t numberRHS
          ...
          // T2=CHECK_SUBSCRIPT(MODE,SIZE,0); (8316)
          {
            int32_t numberRHS
                = (int32_t)((putBITp (16, mCHECK_SUBSCRIPTxMODE,
                                      getBIT (16, mREDUCE_SUBSCRIPTxMODE)),
          ...
          if (1 & (xNOT (BYTE0 (mREDUCE_SUBSCRIPTxFLAG))))
            ...
            rs1s2s1:;
              ...
              if (1
                ...
                // SR_ERR1: (8321)
                SR_ERR1:
                  // CALL ERROR(CLASS_SR,1,VAR(MP)); (8322)
                  {
              ...
              // ELSE (8324)
                ...
                if (1
                  ...
                  rs1s2s1s2:;
                    ...
                    // VAL_P(IND_LINK),PSEUDO_LENGTH(IND_LINK)=0; (8331)
                    {
                ...
                // ELSE (8333)
                  ...
                  if (1
                    ...
                    // SR_ERR2: (8336)
                    SR_ERR2:
                      // CALL ERROR(CLASS_SR,2,VAR(MP)); (8337)
                      {
                        putBITp (16, mERRORxCLASS, getBIT (16, mCLASS_SR));
      ...
      case 3:
        ...
        {
        rs1s3:;
          // T1=CHECK_SUBSCRIPT(MODE,SIZE,1); (8345)
          {
            int32_t numberRHS
                = (int32_t)((putBITp (16, mCHECK_SUBSCRIPTxMODE,
                                      getBIT (16, mREDUCE_SUBSCRIPTxMODE)),
          ...
          // CALL STEPPER; (8347)
          REDUCE_SUBSCRIPTxSTEPPER (0);
          // T2=CHECK_SUBSCRIPT(MODE,SIZE,0); (8348)
          {
            int32_t numberRHS
                = (int32_t)((putBITp (16, mCHECK_SUBSCRIPTxMODE,
                                      getBIT (16, mREDUCE_SUBSCRIPTxMODE)),
          ...
          if (1 & (xNOT (BYTE0 (mREDUCE_SUBSCRIPTxFLAG))))
            ...
            rs1s3s1:;
              ...
              // IF (T2>SIZE&SIZE>0)|T1=0 THEN (8357)
              if (1
                  & (xOR (
              ...
              if (1 & (xEQ (COREHALFWORD (mREDUCE_SUBSCRIPTxT1), 1)))
                ...
                rs1s3s1s1:;
                  ...
                  // PSEUDO_LENGTH(IND_LINK_SAVE)=NEXT_SUB; (8364)
                  {
