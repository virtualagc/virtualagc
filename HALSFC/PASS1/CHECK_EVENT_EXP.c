/*
  File CHECK_EVENT_EXP.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
CHECK_EVENT_EXP (int reset)
{
  ...
  // IF PSEUDO_FORM(PTR(LOC))=XVAC THEN (7327)
  if (1
      & (xEQ (
          BYTE0 (mPSEUDO_FORM
                 + 1
          ...
          BYTE0 (mXVAC))))
    // CALL HALMAT_FIX_POPTAG(LOC_P(PTR(LOC)),5); (7328)
    {
      putFIXED (
  ...
  // RETURN CHECK_ARRAYNESS|(INX(PTR(LOC))=0); (7329)
  {
    reentryGuard = 0;
    return xOR (
        CHECK_ARRAYNESS (0),
