/*
  File EMIT_SUBSCRIPT.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
                 ...
                 BYTE0 (mEMIT_SUBSCRIPTxMODE))))
    {
      ...
      if (1
        ...
        rs1s1:;
          ...
          // CALL HALMAT_PIP(LOC_P(I),PSEUDO_FORM(I),0,0); (8607)
          {
            putBITp (
                16, mHALMAT_PIPxOPERAND,
      ...
      // ELSE (8609)
        ...
        // CALL HALMAT_PIP(LOC_P(I),PSEUDO_FORM(I),INX(I),VAL_P(I)); (8610)
        {
