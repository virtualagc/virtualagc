/*
  File SYT_DUMPxENTER_SORT.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
SYT_DUMPxENTER_SORT (int reset)
{
  ...
  // IF LENGTH(SYT_NAME(LOC)) > MAX_LENGTH THEN (5897)
  if (1
      & (xGT (
          LENGTH (getCHARACTER (
              getFIXED (mSYM_TAB)
    ...
    // MAX_LENGTH = LENGTH(SYT_NAME(LOC)); (5898)
    {
