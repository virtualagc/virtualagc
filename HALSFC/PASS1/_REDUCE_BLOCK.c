/*
  File _REDUCE_BLOCK.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
_REDUCE_BLOCK (int reset)
{
  ...
  // IF ~TOP & (REMBYTES < OLDNBYTES) THEN (254)
  if (1
      & (xAND (xNOT (BYTE0 (m_REDUCE_BLOCKxTOP)),
               xLT (getFIXED (m_REDUCE_BLOCKxREMBYTES),
                    getFIXED (m_REDUCE_BLOCKxOLDNBYTES)))))
    // _FREEBLOCK_SIZE(BLOCK)=OLDNBYTES-REMBYTES; (255)
    {
      int32_t numberRHS
  ...
  // ELSE (256)
    ...
    {
    rs2:;
      // PREV=_PREV_FREEBLOCK(BLOCK); (258)
      {
      ...
      if (1
        ...
        rs2s1:;
          ...
          if (1 & (xEQ (getFIXED (m_REDUCE_BLOCKxPREV), 0)))
            // FIRSTBLOCK=_FREEBLOCK_NEXT(BLOCK); (262)
            {
              int32_t numberRHS
          ...
          // ELSE (263)
            ...
            // _FREEBLOCK_NEXT(PREV)=_FREEBLOCK_NEXT(BLOCK); (264)
            {
              int32_t numberRHS
                  = (int32_t)(COREWORD (getFIXED (m_REDUCE_BLOCKxBLOCK)));
      ...
      // ELSE (265)
        ...
        rs2s2:;
          ...
          // _FREEBLOCK_NEXT(NEWBLOCK)=_FREEBLOCK_NEXT(BLOCK); (268)
          {
            int32_t numberRHS
                = (int32_t)(COREWORD (getFIXED (m_REDUCE_BLOCKxBLOCK)));
            COREWORD2 (getFIXED (m_REDUCE_BLOCKxNEWBLOCK), numberRHS);
          }
          // _FREEBLOCK_SIZE(NEWBLOCK)=OLDNBYTES-REMBYTES; (269)
          {
            int32_t numberRHS
                = (int32_t)(xsubtract (getFIXED (m_REDUCE_BLOCKxOLDNBYTES),
                                       getFIXED (m_REDUCE_BLOCKxREMBYTES)));
          ...
          // ELSE (272)
            ...
            // _FREEBLOCK_NEXT(PREV)=NEWBLOCK; (273)
            {
              int32_t numberRHS
                  = (int32_t)(getFIXED (m_REDUCE_BLOCKxNEWBLOCK));
              COREWORD2 (getFIXED (m_REDUCE_BLOCKxPREV), numberRHS);
