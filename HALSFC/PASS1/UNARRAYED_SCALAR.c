/*
  File UNARRAYED_SCALAR.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
UNARRAYED_SCALAR (int reset)
{
  ...
  // IF PSEUDO_TYPE(PTR(LOC))=INT_TYPE THEN (7320)
  if (1
      & (xEQ (
          BYTE0 (mPSEUDO_TYPE
                 + 1
    ...
    {
    rs1:;
      // CALL HALMAT_TUPLE(XITOS,0,LOC,0,0); (7322)
      {
      ...
      // CALL SETUP_VAC(LOC,SCALAR_TYPE); (7323)
      {
  ...
  // RETURN CHECK_ARRAYNESS|(PSEUDO_TYPE(PTR(LOC))~=SCALAR_TYPE); (7324)
  {
    reentryGuard = 0;
    return xOR (
        CHECK_ARRAYNESS (0),
