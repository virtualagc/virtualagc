/*
  File ICQ_ARRAYNESS_OUTPUT.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
ICQ_ARRAYNESS_OUTPUT (int reset)
{
  ...
  // IF SYT_ARRAY(ID_LOC)~=0 THEN (8934)
  if (1
    ...
    {
    rs1:;
      // IF (SYT_FLAGS(ID_LOC)&AUTO_FLAG)~=0 THEN (8936)
      if (1
      ...
      // CALL HALMAT_POP(I,0,XCO_D,0); (8940)
      {
      ...
      // IF SYT_TYPE(ID_LOC)=MAJ_STRUC THEN (8941)
      if (1
        ...
        rs1s1:;
          ...
          // CALL HALMAT_PIP(SYT_ARRAY(ID_LOC),XIMD,0,0); (8944)
          {
      ...
      // ELSE (8945)
        ...
        // DO I=1 TO EXT_ARRAY(SYT_ARRAY(ID_LOC)); (8946)
        {
      ...
      // CALL HALMAT_FIX_PIP#(LAST_POP#,I-1); (8948)
      {
      ...
      // CALL HALMAT_POP(XDLPE,0,XCO_N,0); (8949)
      {
