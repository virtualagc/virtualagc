/*
  File EMIT_EXTERNALxEX_WRITE.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
  ...
  rs1:
    switch (COREHALFWORD (mTPL_FLAG))
      ...
      case 1:
        ...
        {
        rs1s1:;
          // IF NEWBUFF~=SUBSTR(OLDBUFF,0,TPL_LRECL) THEN (6979)
          if (1
