/*
  File UPDATE_BLOCK_CHECK.c generated by XCOM-I, 2024-08-08 04:31:11.
*/
...
UPDATE_BLOCK_CHECK (int reset)
{
  ...
  // IF UPDATE_BLOCK_LEVEL>0 THEN (7499)
  if (1 & (xGT (COREHALFWORD (mUPDATE_BLOCK_LEVEL), 0)))
    // IF SYT_NEST(FIXL(LOC))<NEST THEN (7500)
    if (1
        & (xLT (BYTE0 (getFIXED (mSYM_TAB)
                       ...
                       + 28 + 1 * (0)),
                getFIXED (mNEST))))
      // CALL ERROR(CLASS_PU,3,VAR(LOC)); (7501)
      {
