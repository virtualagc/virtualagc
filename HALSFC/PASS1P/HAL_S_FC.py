...
History:    2023-08-24 RSB  Began porting from ##DRIVER.xpl, segregating global
            ...
            2024-08-08 RSB  As part of a reorganization of the modern version
                            of HAL/S-FC for easier dissemination, the original
                            development folder (yaShuttle/ported/PASS1.PROCS/)
                            has been moved here and renamed.  The original 
                            concept of a Python port for all passes of HAL/S-FC
                            was abandoned after PASS1 was ported.
