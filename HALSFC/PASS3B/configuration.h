...
#define APP_NAME "PASS3B"
#define XCOM_I_START_TIME 4573300
...
#define FREE_BASE 0x008980
#define FREE_POINT 0x008C47 // Initial value for `freepoint`
#define PHYSICAL_MEMORY_LIMIT 0xFFB8F0
#define PRIVATE_MEMORY_SIZE 0x002710
#define FREE_LIMIT 0xFFB2F0
#define NUM_SYMBOLS 895
...
#define MAX_LENGTH_MANGLED 48
#define NUM_MANGLED 30
#define MAX_TYPE1 64
#define MAX_TYPE2 64
#define USER_MEMORY 4196
#define PRIVATE_MEMORY 4224
#define NUM_INITIALIZED 35912
