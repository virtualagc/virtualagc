...
BUILD_SDFxMOVE_CELL_TREExDO_PF_INV_CELL (int reset)
{
  ...
  // CALL P3_LOCATE(PTR,ADDR(NODE_H),MODF|RESV); (3820)
  {
  ...
  if (1
    ...
    rs1:;
      ...
      // NODE_H(0) = SHL(NODE_H(1)+2,2); (3825)
      {
  ...
  // NODE_H(3) = SYT_SORT1(NODE_H(3)); (3828)
  {
    ...
    for (putBIT (16, mBUILD_SDFxMOVE_CELL_TREExJ, fixedToBit (16, from104));
                             ...
                             + by104)))
      {
        ...
        if (1
          ...
          {
          rs2s1:;
            // IF (NODE_F(J) &  3221225472) =  3221225472 THEN (3832)
            if (1
                & (xEQ (
                    xAND (
                        getFIXED (
                        ...
                        3221225472),
                    3221225472)))
              // NODE_H(J+J+1) = SYT_SORT1(NODE_H(J+J+1)); (3833)
              {
                descriptor_t *bitRHS = getBIT (
                    16,
                    getFIXED (mSORTING)
            ...
            // ELSE (3834)
              ...
              // NODE_F(J) = GET_SDF_CELL(NODE_F(J)); (3835)
              {
      ...
      for (putBIT (16, mBUILD_SDFxMOVE_CELL_TREExJ, fixedToBit (16, from105));
           ...
           putBIT (16, mBUILD_SDFxMOVE_CELL_TREExJ,
                   fixedToBit (16, bitToFixed (getBIT (
                                       ...
                                       + by105)))
        {
          // NODE_H(J) = SYT_SORT1(NODE_H(J)); (3838)
          {
            descriptor_t *bitRHS = getBIT (
                16, getFIXED (mSORTING)
                        + 12
  ...
  // CALL P3_PTR_LOCATE(PTR,RELS); (3839)
  {
