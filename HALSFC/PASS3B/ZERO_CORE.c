/*
  File ZERO_CORE.c generated by XCOM-I, 2024-08-08 04:35:09.
*/
...
ZERO_CORE (int reset)
{
  ...
  // DO WHILE COUNT ~= 0; (814)
  while (1 & (xNEQ (getFIXED (mZERO_CORExCOUNT), 0)))
    {
      // IF COUNT > 256 THEN (815)
      ...
      // CALL ZERO_256(CORE_ADDR,#BYTES); (819)
      {
