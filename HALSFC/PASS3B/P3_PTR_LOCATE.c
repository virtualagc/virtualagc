/*
  File P3_PTR_LOCATE.c generated by XCOM-I, 2024-08-09 12:42:16.
*/
...
P3_PTR_LOCATE (int reset)
{
  ...
  if (1
    ...
    rs2:;
      ...
      // ELSE (1185)
        ...
        {
        rs2s2:;
          // CUR_NDX = NEW_NDX; (1187)
          {
            descriptor_t *bitRHS = getBIT (16, mNEW_NDX);
            putBIT (16, mP3_PTR_LOCATExCUR_NDX, bitRHS);
            bitRHS->inUse = 0;
          }
          // PAGE_TO_NDX(PAD_PAGE(CUR_NDX)) = -1; (1188)
          {
      ...
      // PAD_PAGE(CUR_NDX) = LAST_PAGE; (1190)
      {
        descriptor_t *bitRHS = getBIT (16, mLAST_PAGE);
      ...
      // CALL ZERO_CORE(PAD_ADDR(CUR_NDX),PAGE_SIZE); (1194)
      {
        putFIXED (
      ...
      // COREWORD(ADDR(PAGE_TEMP1)) = PAD_ADDR(CUR_NDX); (1195)
      {
  ...
  // ELSE (1198)
    ...
    rs3:;
      ...
      // IF CUR_NDX = -1 THEN (1201)
      if (1 & (xEQ (COREHALFWORD (mP3_PTR_LOCATExCUR_NDX), -1)))
        // DO; (1202)
        {
        rs3s1:;
          // CUR_NDX = NEW_NDX; (1203)
          {
            descriptor_t *bitRHS = getBIT (16, mNEW_NDX);
            putBIT (16, mP3_PTR_LOCATExCUR_NDX, bitRHS);
            bitRHS->inUse = 0;
          }
          // PAGE_TO_NDX(PAD_PAGE(CUR_NDX)) = -1; (1204)
          {
            int32_t numberRHS = (int32_t)(-1);
            descriptor_t *bitRHS;
            bitRHS = fixedToBit (32, (int32_t)(numberRHS));
          ...
          // COREWORD(ADDR(PAGE_TEMP)) = PAD_ADDR(CUR_NDX); (1207)
          {
            int32_t numberRHS = (int32_t)(getFIXED (
                mPAD_ADDR + 4 * COREHALFWORD (mP3_PTR_LOCATExCUR_NDX)));
  ...
  // PAD_DISP(CUR_NDX) = PAD_DISP(CUR_NDX) + 1; (1213)
  {
  ...
  // LOC_ADDR = PAD_ADDR(CUR_NDX) + OFFSET; (1216)
  {
    int32_t numberRHS = (int32_t)(xadd (
        getFIXED (mPAD_ADDR + 4 * COREHALFWORD (mP3_PTR_LOCATExCUR_NDX)),
