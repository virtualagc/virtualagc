/*
  File OUTPUT_SDF.c generated by XCOM-I, 2024-08-08 04:35:09.
*/
...
OUTPUT_SDF (int reset)
{
  ...
  // CALL P3_LOCATE(0,ADDR(NODE_F),MODF); (1554)
  {
  ...
  while (1 & (xNEQ (getFIXED (mOUTPUT_SDFxPTR), 0)))
    {
      // CALL P3_LOCATE(PTR,ADDR(NODE_F),0); (1560)
      {
      ...
      // DIR_FREE_SPACE = DIR_FREE_SPACE + NODE_F(0); (1561)
      {
  ...
  // CALL P3_LOCATE(FREE_CHAIN,ADDR(NODE_F),0); (1566)
  {
  ...
  while (1 & (xNEQ (getFIXED (mOUTPUT_SDFxPTR), getFIXED (mOUTPUT_SDFxTEMP))))
    {
      ...
      // DATA_FREE_SPACE = DATA_FREE_SPACE + NODE_F(0); (1571)
      {
        int32_t numberRHS = (int32_t)(xadd (
  ...
  // CALL P3_DISP(MODF); (1574)
  {
    putBITp (8, mP3_DISPxFLAGS, getBIT (8, mMODF));
    P3_DISP (0);
  }
  // CALL P3_LOCATE(ROOT_PTR,ADDR(NODE_F),MODF); (1575)
  {
  ...
  // COREWORD(ADDR(NODE_H)) = LOC_ADDR; (1576)
  {
    int32_t numberRHS = (int32_t)(getFIXED (mLOC_ADDR));
    COREWORD2 (ADDR ("OUTPUT_SDFxNODE_H", 0x80000000, NULL, 0), numberRHS);
  }
  // IF OVERFLOW_FLAG THEN (1577)
  if (1 & (bitToFixed (getBIT (1, mOVERFLOW_FLAG))))
    // NODE_H(0) = NODE_H(0)| 2048; (1578)
    {
  ...
  // IF SRN_FLAG1 THEN (1579)
  if (1 & (bitToFixed (getBIT (1, mSRN_FLAG1))))
    // NODE_H(0) = NODE_H(0)| 1024; (1580)
    {
      int32_t numberRHS = (int32_t)(xOR (
  ...
  // IF SRN_FLAG2 THEN (1581)
  if (1 & (bitToFixed (getBIT (1, mSRN_FLAG2))))
    // NODE_H(0) = NODE_H(0)| 512; (1582)
    {
      int32_t numberRHS = (int32_t)(xOR (
  ...
  // NODE_H(58) = DIR_FREE_SPACE + DATA_FREE_SPACE; (1590)
  {
  ...
  // IF MONITOR(14, 8, NAME) THEN (1600)
  if (1 & (MONITOR14 (8, getFIXED (mOUTPUT_SDFxNAME))))
    // CHAR_STRING = 'REPLACED'; (1601)
    {
      descriptor_t *stringRHS;
