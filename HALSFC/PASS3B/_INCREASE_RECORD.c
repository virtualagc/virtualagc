/*
  File _INCREASE_RECORD.c generated by XCOM-I, 2024-08-09 12:42:16.
*/
...
_INCREASE_RECORD (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (619)
  {
  ...
  // NEWNRECS=_DOPE_ALLOC(DOPE)+NRECSMORE; (620)
  {
  ...
  // NEWNBYTES=_SPACE_ROUND(NEWNRECS*_DOPE_WIDTH(DOPE)); (621)
  {
  ...
  // OLDNBYTES=_RECORD#BYTES(DOPE); (622)
  {
    int32_t numberRHS = (int32_t)((
        putFIXED (
            m_SPACE_ROUNDxBYTES,
  ...
  // NBYTESMORE=NEWNBYTES-OLDNBYTES; (623)
  {
    int32_t numberRHS
  ...
  // IF NBYTESMORE > FREEBYTES THEN (624)
  if (1
      & (xGT (getFIXED (m_INCREASE_RECORDxNBYTESMORE), getFIXED (mFREEBYTES))))
    // CALL _STEAL(NBYTESMORE-FREEBYTES); (625)
    {
  ...
  // CALL _SQUASH_RECORDS; (626)
  _SQUASH_RECORDS (0);
  // CALL _MOVE_RECS(DOPE,NBYTESMORE); (627)
  {
  ...
  // BY 4; (628)
  {
    ...
    from18 = xadd (COREWORD (getFIXED (m_INCREASE_RECORDxDOPE)),
                   getFIXED (m_INCREASE_RECORDxOLDNBYTES));
    to18 = xsubtract (xadd (COREWORD (getFIXED (m_INCREASE_RECORDxDOPE)),
                            getFIXED (m_INCREASE_RECORDxNEWNBYTES)),
                      4);
    by18 = 4;
    for (putFIXED (m_INCREASE_RECORDxI, from18);
         getFIXED (m_INCREASE_RECORDxI) <= to18;
         putFIXED (m_INCREASE_RECORDxI, getFIXED (m_INCREASE_RECORDxI) + by18))
      {
        // COREWORD(I)=0; (629)
        {
