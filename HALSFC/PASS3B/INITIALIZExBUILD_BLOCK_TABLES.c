/*
  File INITIALIZExBUILD_BLOCK_TABLES.c generated by XCOM-I, 2024-08-08
  04:35:09.
*/
...
INITIALIZExBUILD_BLOCK_TABLES (int reset)
{
  ...
  // #SYMBOLS, #PROCS, #COMPOOLS, #EXTERNALS = 0; (2493)
  {
          ...
          switch (BYTE0 (getFIXED (mSYM_TAB) + 34 * (COREHALFWORD (mOP1)) + 30
                  ...
                  switch (xAND (BYTE0 (getFIXED (mSYM_TAB)
                    ...
                    case 10:
                      ...
                      rs1s1s3s1s11:;
                        // CALL BLOCK_SUB; (2527)
                        INITIALIZExBLOCK_SUB (0);
                        // IF (SYT_FLAGS(OP1)&EXTERNAL_FLAG)~=0 THEN (2528)
                        if (1
                            & (xNEQ (
            ...
            case 6:
              ...
              rs1s1s7:;
                // CALL SYMB_SUB; (2540)
                INITIALIZExSYMB_SUB (0);
                // IF FIRST_CALL THEN (2541)
                if (1
                    & (bitToFixed (getBIT (
                        16, mINITIALIZExBUILD_BLOCK_TABLESxFIRST_CALL))))
                  // IF (VAR_EXTENT(OP1) &  2147483648) ~= 0 THEN (2542)
                  if (1
                    ...
                    if (1
                      ...
                      {
                      rs1s1s7s1:;
                        // PTR_TEMP = VAR_EXTENT(OP1) &  2147483647; (2545)
                        {
                        ...
                        // IF SYT_CLASS(I) = REPL_ARG_CLASS THEN (2547)
                        if (1
                            & (xEQ (
                          ...
                          rs1s1s7s1s1:;
                            ...
                            // CALL PTR_LOCATE(PTR_TEMP,RESV); (2551)
                            {
                            ...
                            // PTR = GET_CELL(CELLSIZE,ADDR(NODE_F),0); (2557)
                            {
                            ...
                            // CALL MOVE(8,ADDR_TEMP,VMEM_LOC_ADDR); (2558)
                            {
                            ...
                            // COREWORD(ADDR(NODE_H)) = VMEM_LOC_ADDR; (2566)
                            {
                              int32_t numberRHS
                                  = (int32_t)(getFIXED (mVMEM_LOC_ADDR));
                            ...
                            // CALL PTR_LOCATE(PTR_TEMP,RELS); (2568)
                            {
                              putFIXED (mPTR_LOCATExPTR,
                                        getFIXED (mINITIALIZExPTR_TEMP));
                              putBITp (8, mPTR_LOCATExFLAGS,
                            ...
                            // VAR_EXTENT(OP1) = PTR |  2147483648; (2569)
                            {
                              int32_t numberRHS = (int32_t)(xOR (
