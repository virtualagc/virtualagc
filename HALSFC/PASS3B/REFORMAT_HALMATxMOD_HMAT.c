/*
  File REFORMAT_HALMATxMOD_HMAT.c generated by XCOM-I, 2024-08-09 12:42:16.
*/
  ...
  if (1
      & (xAND (
          ...
          xEQ (xAND (SHR (getFIXED (
                     ...
                     15),
               1))))
    // RETURN SUB_OPRND(SYT_SORT1(OPERAND_FIELD(CELL))); (1424)
    {
      reentryGuard = 0;
      return xOR (
          SHL (
