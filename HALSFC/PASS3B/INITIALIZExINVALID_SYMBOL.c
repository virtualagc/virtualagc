/*
  File INITIALIZExINVALID_SYMBOL.c generated by XCOM-I, 2024-08-08 04:35:09.
*/
...
INITIALIZExINVALID_SYMBOL (int reset)
{
  ...
  // #DEL_SYMBOLS = #DEL_SYMBOLS + 1; (2419)
  {
  ...
  // PROC_TAB3(PROCPOINT) = PROC_TAB3(PROCPOINT) - 1; (2421)
  {
