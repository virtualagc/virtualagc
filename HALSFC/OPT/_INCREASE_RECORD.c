/*
  File _INCREASE_RECORD.c generated by XCOM-I, 2024-08-08 04:31:49.
*/
...
_INCREASE_RECORD (int reset)
{
  ...
  // REALLOCATIONS=REALLOCATIONS+1; (557)
  {
  ...
  // NEWNRECS=_DOPE_ALLOC(DOPE)+NRECSMORE; (558)
  {
  ...
  // NEWNBYTES=_SPACE_ROUND(NEWNRECS*_DOPE_WIDTH(DOPE)); (559)
  {
  ...
  // OLDNBYTES=_RECORD#BYTES(DOPE); (560)
  {
    int32_t numberRHS = (int32_t)((
        putFIXED (
            m_SPACE_ROUNDxBYTES,
  ...
  // NBYTESMORE=NEWNBYTES-OLDNBYTES; (561)
  {
    int32_t numberRHS
  ...
  // IF NBYTESMORE > FREEBYTES THEN (562)
  if (1
      & (xGT (getFIXED (m_INCREASE_RECORDxNBYTESMORE), getFIXED (mFREEBYTES))))
    // CALL _STEAL(NBYTESMORE-FREEBYTES); (563)
    {
  ...
  // CALL _SQUASH_RECORDS; (564)
  _SQUASH_RECORDS (0);
  // CALL _MOVE_RECS(DOPE,NBYTESMORE); (565)
  {
