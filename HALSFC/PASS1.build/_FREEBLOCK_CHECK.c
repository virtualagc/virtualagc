/*
  File _FREEBLOCK_CHECK.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
_FREEBLOCK_CHECK (int reset)
{
  ...
  // CALL _CHECK_FOR_THEFT; (65)
  _CHECK_FOR_THEFT (0);
  // FBYTES,RBYTES,BLKNO,RECNO=0; (66)
  {
  ...
  // IF FREEPRINT THEN (71)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (72)
    {
    rs1:;
      // IF ^ _IN_COMPACTIFY THEN (73)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (74)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // FIRSTBLOCK ^ = 0 ) * ( FIRSTBLOCK - FREEBASE - 3 ) ) ; (75)
          {
  ...
  while (1 & (xGT (getFIXED (m_FREEBLOCK_CHECKxRDOPE), 0)))
    {
      ...
      if (1
        ...
        rs2s1:;
          ...
          // IF FREEPRINT THEN (83)
          if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
            // IF ~ _IN_COMPACTIFY THEN (84)
            if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
              // IF FREELIMIT > FREEPOINT + 650 THEN (85)
              if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          ...
          // CALL ADDRESS_CHECK(_DOPE_POINTER(RDOPE)); (87)
          {
          ...
          if (1
            ...
            rs2s1s1:;
              ...
              // SIZE,UPLIM='||((UPLIM^=0)*(UPLIM-FREEBASE-3))); (90)
              {
                putCHARACTERp (
                    m_SPMANERRxMSG,
                    xsCAT (
  ...
  if (1 & (xNEQ (getFIXED (m_FREEBLOCK_CHECKxBPNTR), 0)))
    ...
    {
    rs3:;
      // CALL _SPMANERR('CONSECUTIVE FREEBLOCKS.'); (98)
      {
  ...
  if (1
    ...
    rs4:;
      ...
      // UPLIM='||UPLIM||',DOWNLIM='||DOWNLIM); (101)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
  ...
  // IF FREEPRINT THEN (102)
  if (1 & (bitToFixed (getBIT (1, mFREEPRINT))))
    // DO ; (103)
    {
    rs5:;
      // IF ^ _IN_COMPACTIFY THEN (104)
      if (1 & (xNOT (BYTE0 (m_IN_COMPACTIFY))))
        // IF ( FREELIMIT > FREEPOINT + 650 ) THEN (105)
        if (1 & (xGT (FREELIMIT (), xadd (FREEPOINT (), 650))))
          // OUTPUT = FBYTES || ' BYTES OF FREEBYTES, ' || RBYTES || '
          // ALLOCATED, TOTAL OF ' || RBYTES + FBYTES ; (106)
          {
            descriptor_t *stringRHS;
            stringRHS = xsCAT (
  ...
  // CALL _CHECK_FOR_THEFT; (107)
  _CHECK_FOR_THEFT (0);
  // IF (FBYTES~=FREEBYTES) | (RBYTES~=RECBYTES) THEN (108)
  if (1
      & (xOR (
    ...
    rs6:;
      ...
      // RBYTES='||RBYTES||', RECBYTES='||RECBYTES); (110)
      {
        putCHARACTERp (
            m_SPMANERRxMSG,
            xsCAT (
