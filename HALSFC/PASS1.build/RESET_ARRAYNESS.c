/*
  File RESET_ARRAYNESS.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
RESET_ARRAYNESS (int reset)
{
  ...
  // IF ARRAYNESS_STACK(AS_PTR)>0 THEN (7678)
  if (1
    ...
    rs1:;
            ...
            // DO I=1 TO CURRENT_ARRAYNESS; (7683)
            {
              ...
              for (putBIT (16, mRESET_ARRAYNESSxI, fixedToBit (16, from121));
                                       ...
                                       + by121)))
                {
                  ...
                  // IF CURRENT_ARRAYNESS(I)>0 THEN (7685)
                  if (1
                      & (xGT (COREHALFWORD (
                                  mCURRENT_ARRAYNESS
                                  + 2 * COREHALFWORD (mRESET_ARRAYNESSxI)),
                              0)))
                    // IF ARRAYNESS_STACK(J)>0 THEN (7686)
                    if (1
                        & (xGT (COREHALFWORD (
                                    mARRAYNESS_STACK
      ...
      // CURRENT_ARRAYNESS=ARRAYNESS_STACK(AS_PTR); (7693)
      {
        descriptor_t *bitRHS
      ...
      // DO I= 1 TO CURRENT_ARRAYNESS; (7694)
      {
        ...
        for (putBIT (16, mRESET_ARRAYNESSxI, fixedToBit (16, from122));
                                     ...
                                     + by122)))
          {
            ...
            // CURRENT_ARRAYNESS(I)=ARRAYNESS_STACK(J); (7696)
            {
              descriptor_t *bitRHS
      ...
      // AS_PTR=AS_PTR-CURRENT_ARRAYNESS; (7697)
      {
        int32_t numberRHS = (int32_t)(xsubtract (
  ...
  // ELSE (7698)
    ...
    // IF CURRENT_ARRAYNESS>0 THEN (7699)
    if (1 & (xGT (COREHALFWORD (mCURRENT_ARRAYNESS), 0)))
      // MISMATCH=4; (7700)
      {
