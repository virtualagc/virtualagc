/*
  File _ATTACH_BLOCKxJOIN.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
  ...
  if (1 & (xNEQ (getFIXED (m_ATTACH_BLOCKxJOINxB1), 0)))
    ...
    rs1:;
      ...
      if (1
        ...
        {
        rs1s1:;
          // _FREEBLOCK_NEXT(B1)=_FREEBLOCK_NEXT(B2); (221)
          {
            int32_t numberRHS
                = (int32_t)(COREWORD (getFIXED (m_ATTACH_BLOCKxJOINxB2)));
            COREWORD2 (getFIXED (m_ATTACH_BLOCKxJOINxB1), numberRHS);
          }
          // _FREEBLOCK_SIZE(B1)=_FREEBLOCK_SIZE(B1)+_FREEBLOCK_SIZE(B2); (222)
          {
