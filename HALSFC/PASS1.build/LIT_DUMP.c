/*
  File LIT_DUMP.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
LIT_DUMP (int reset)
{
  ...
  // OUTPUT(1) = '0L I T E R A L   T A B L E   D U M P:'; (5977)
  {
  ...
  // OUTPUT(1)='0 LOC  TYPE          LITERAL'; (5978)
  {
    descriptor_t *stringRHS;
  ...
  // DO I = 1 TO LIT_TOP; (5980)
  {
    ...
    for (putFIXED (mI, from99); getFIXED (mI) <= to99;
         putFIXED (mI, getFIXED (mI) + by99))
      {
          ...
          switch (xAND (getFIXED (getFIXED (mLIT_PG) + 1560 * (0) + 0
            ...
            case 0:
              ...
              rs1s1s1:;
                ...
                // IF LENGTH(S)>100 THEN (5985)
                if (1 & (xGT (LENGTH (getCHARACTER (mLIT_DUMPxS)), 100)))
                  // S=SUBSTR(S,0,100); (5986)
                  {
                    descriptor_t *stringRHS;
            ...
            case 1:
              ...
              rs1s1s2:;
                ...
                // IF LENGTH(S)<8 THEN (5989)
                if (1 & (xLT (LENGTH (getCHARACTER (mLIT_DUMPxS)), 8)))
                  // S=SUBSTR(ZEROS,LENGTH(S))||S; (5990)
                  {
                    descriptor_t *stringRHS;
                    stringRHS
                ...
                // IF LENGTH(S)<16 THEN (5992)
                if (1 & (xLT (LENGTH (getCHARACTER (mLIT_DUMPxS)), 16)))
                  // S=SUBSTR(ZEROS,LENGTH(S)-8)||S; (5993)
                  {
                    descriptor_t *stringRHS;
                    stringRHS = xsCAT (
            ...
            case 2:
              ...
              rs1s1s3:;
                ...
                // IF LENGTH(S)<8 THEN (5996)
                if (1 & (xLT (LENGTH (getCHARACTER (mLIT_DUMPxS)), 8)))
                  // S=SUBSTR(ZEROS,LENGTH(S))||S; (5997)
                  {
                    descriptor_t *stringRHS;
                    stringRHS
                        = xsCAT (SUBSTR2 (getCHARACTER (mLIT_DUMPxZEROS),
        ...
        // OUTPUT=I_FORMAT(I,4)||SUBSTR(T,SHL(LIT1(TEMP),3),8)||S; (5999)
        {
          descriptor_t *stringRHS;
          stringRHS = xsCAT (
