/*
  File MATCH_ARITH.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
MATCH_ARITH (int reset)
{
  ...
  // I=PSEUDO_TYPE(PTR(LOC1))-MAT_TYPE; (7553)
  {
  ...
  // IF (SHL(1,PSEUDO_TYPE(PTR(LOC2))-MAT_TYPE)&ARITH_VALID(I))=0 THEN (7554)
  if (1
      & (xEQ (
  ...
  // ELSE (7556)
    ...
    rs1:
      switch (COREHALFWORD (mMATCH_ARITHxI))
        {
        case 0:
          // CALL MATRIX_COMPARE(LOC1,LOC2,CLASS_EM,1); (7559)
          {
          ...
          break;
        case 1:
          // CALL VECTOR_COMPARE(LOC1,LOC2,CLASS_EV,1); (7560)
          {
          ...
          break;
        case 2:
          // CALL MATCH_SIMPLES(LOC1,LOC2); (7561)
          {
          ...
          break;
        case 3:
          // CALL MATCH_SIMPLES(LOC1,LOC2); (7562)
          {
            putBITp (16, mMATCH_SIMPLESxLOC1, getBIT (16, mMATCH_ARITHxLOC1));
            putBITp (16, mMATCH_SIMPLESxLOC2, getBIT (16, mMATCH_ARITHxLOC2));
            MATCH_SIMPLES (0);
