/*
  File LIT_RESULT_TYPE.c generated by XCOM-I, 2024-08-09 12:38:15.
*/
...
// IF PSEUDO_TYPE(PTR(LOC1))=INT_TYPE THEN (7568)
if (1
    & (xEQ (BYTE0 (mPSEUDO_TYPE
            ...
            6)))
  // IF PSEUDO_TYPE(PTR(LOC2))=INT_TYPE THEN (7569)
  if (1
      & (xEQ (
          BYTE0 (mPSEUDO_TYPE
                 + 1
    ...
    if (1 & (xLE (getFIXED (getFIXED (mFOR_DW) + 4 * (2) + 0 + 4 * (0)), 0)))
      // RETURN INT_TYPE; (7571)
      {
        reentryGuard = 0;
        return 6;
      }
// RETURN SCALAR_TYPE; (7572)
{
  reentryGuard = 0;
  return 5;
}
