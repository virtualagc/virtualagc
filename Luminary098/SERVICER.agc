...
## Mod history: 2019-07-28 MAS  Created from Luminary 99. Reverted the POSUPDAT
##                              code to match Luminary 69's implementation, to
##                              back out the doppler compensation code introduced
##                              in PCR 775.
