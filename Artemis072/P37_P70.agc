...
## Page 897
		...
		EBANK=	RTEDVD
		COUNT*	$$/P37		# GAP COUNT directive start ...smc
...
RTE625		BZE	GOTO		# Change from sub call in Comanche55 ..smc
			P37G
			RTEALRM
...
P37W		CLEAR	CLEAR
		...
		STOVL	TPASS4
			V2(T1)/
		VSU	EXIT		# block varies from comanche55...smc
			V(T1)/		#	
		CAF	EBANK4		#
		TS	EBANK		#
		TG	INTPRET		#
...
V6N60RTE	VN	0660
V6N81RTE	VN	0681
		SETLOC	RTE		# was BANK 32 in comanche55...smc
		BANK
		COUNT*	$$/P37		# COUNT directive change ...smc
...
P370ALRM	STQ	EXIT
		...
		TCF	GOTOPOOH
		TCF	-4
		TC	POSTJUMP	# was INTPRET in comanche55..smc
		CADR	P37
V5N09RTE	=	VN0509		# was V5N09RTE	VN 0509 in comanche55..smc
...
PREC170		DLOAD	DAD
		...
		BDDV	SL*
			00D
			0 -3,1		# 0 missing from scan on comanche55 ...smc
## Page 918
...
# DESIRED FINAL ANGLE HAS BEEN REACHED.
		...
		SETLOC	RTE
		BANK
		COUNT*	$$/P37		# page 906 to 919 388 ..smc
PREC225		DLOAD
			ZERORTE
PRECX		GOTO
			SPRTEX
...
#	T2		FINAL TIME						DP	B28	CS
		...
		SETLOC	RTE3
		BANK
		COUNT*	$$/P37		# COUNT directive start ..smc
RTENCK1		STQ	CALL
			RTENCKEX
			INTSTALL
		VLOAD	SET
...
RTENCK3D	STORE	TDEC1
		...
		SETLOC	RTE
		BANK
		COUNT*	$$/P37		# page 920 to 922 bank 4, 392 ...smc
...
V2TERROR	EXIT			#	OR IF LAMBDA LESS THAN ONE
		...
		OCT	20610		# different that comanche55...smc
...
1RTEB1		=	UNITX		# new constants for artemis72 ...smc
1RTEB2		=	DP1/4TH		#
1RTEB3		=	DP2(-3)		# 1 B-3		new for artemis72
1RTEB4		=	DP2(-4)		# 1 B-4		new for artemis72
1RTEB13		2DEC	1. B-13
1RTEB17		2DEC	1. B-17
1RTEB25		2DEC	1. B-25
#					* * B25 AND B28 MUST BE CONSECUTIVE * * 
1RTEB28		2DEC	1. B-28
ZERORTE		=	UNITZ		# new for artemis72 ...smc
...
2RTEB1		=	DPPOSMAX	# new for artemis72 ...smc
M9RTEB28	2DEC	-9
M8RTEB28	2DEC	-8
...
CSUBT		=	UNITX		# new for artemis72 ...smc
OCT605		OCT	00605
OCT612		OCT	00612
...
EPC10RTE	2DEC	.0001 B-7
		...
		SETLOC	RTECON1
		BANK
		COUNT*	$$/P37		# page 938 to 939 56 ..smc		
