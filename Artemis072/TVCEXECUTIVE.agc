...
# Page 951
		SETLOC	DAPROLL
		BANK
		EBANK=	CNTR		# new for artemis72 ...smc
		COUNT*	$$/TVCX
		
TVCEXEC		CS	FLAGWRD6	# CHECK FOR TERMINATION (BITS 15,14 READ
		MASK	DPCONIFG	#	10 FROM TVCDAPON TO RCSDAPON)
		EXTEND
...
ROLLPREP	CAE	CDUX		# UPDATE ROLL LADDERS (NO NEED TO RESTART-
		...
		TC	TWIDDLE		# new for artemis72 ...smc
		ADRES	ROLLDAP		
...
FCORFRAC	OCT	BIT13		# ONE-SHOT CORRECTION FRACTION	
