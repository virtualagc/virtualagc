...
#
#							 1/2	 17	 16
#	XKEPCSM(LEM)	- RDOT OF KEPLERS EQUATION	M	2	2
#			  0 IF TCCSM(LEM) = 0
#
...
A-PCHK		BOF	CALL
		...
		LXA,2			# SET X2 FOR MOON OR EARTH SCALING
			PBODY
ANDOUT		BOFCLR	EXIT
			STATEFLG
			RECTOUT
...
P00HCHK		DLOAD	ABS
		...
		DSU	BMN
			...
			A-PCHK
		BOFF	BON
			PCDFLAG		# IS BACKWARDS INTEGRATION INHIBITED
			TIMESTEP	# NO
...
# MIDTOAV2
#
# THIS ROUTINE INTEGRATES THE CSM STATE VECTOR TO THE CURRENT TIME PLUS
