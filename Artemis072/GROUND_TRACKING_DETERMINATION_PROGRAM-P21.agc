...
HOP29DSP	VLOAD	PDDL		# STORE UNIT NORTH(IN PLANETARY COORDS )
		...
		DOT	POVL		# PD=8D,MUSUBZ AT 0D, EXCHANGE	DOT-PRODUCT
			OD		#      WITH MUSUBN IN PUSHLIST
		SIGN	STADR		# PD=6D, PUT MUSUBN IN HEMI. OF MUSUBZ
		STOVL	MUSUBN
			P29BASER
HOPALOG		BOFF	VSR2		# MUST BE B+29 FOR LAT-LONG
			CMOONFLG
			+1
...
THETCOMP	DMP	BOV
		...
		SL1	POVL		# PD=2D, MAKE B+1 FOR ACOS, EXCHANGE
