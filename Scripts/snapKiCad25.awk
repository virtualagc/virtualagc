...
# in autoplaceKiCad.py that put them there.  But it can also happen if
# you just accidentally set the gridsize wrong and don't notice it 
# until too late.  At any rate, there doesn't
