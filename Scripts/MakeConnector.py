...
if partName == "ConnectorGeneric":
	...
	endingPinNumber = 769
	omitPins = [ ]
elif partName == "ConnectorB1-100":
	startingPinNumber = 101
	endingPinNumber = 124
	omitPins = [ ]
elif partName == "ConnectorB1-200":
	startingPinNumber = 201
	endingPinNumber = 224
	omitPins = [ ]
elif partName == "ConnectorB1-300":
	startingPinNumber = 301
	endingPinNumber = 324
	omitPins = [ ]
elif partName == "ConnectorB1-400":
	startingPinNumber = 401
	endingPinNumber = 424
	omitPins = [ ]
elif partName == "ConnectorB8-100":
	startingPinNumber = 101
	endingPinNumber = 169
	omitPins = [ ]
elif partName == "ConnectorB8-200":
	startingPinNumber = 201
	endingPinNumber = 269
	omitPins = [ ]
elif partName == "ConnectorB8-300":
	startingPinNumber = 301
	endingPinNumber = 369
	omitPins = [ ]
elif partName == "ConnectorB8-400":
	startingPinNumber = 401
	endingPinNumber = 469
	omitPins = [ ]
