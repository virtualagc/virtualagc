...
for pin in range(numPins):
	print("T 0 0 0 " + str(textSize) + " 0 " + str(pin+1) + " 0 " + str(pin+startingPinNumber) + " Normal 0 C C")
print("P 2 0 0 0 " + str(-lineWidth) + " " + str(-yRadius) + " " + str(lineWidth) + " " + str(-yRadius) + " N")
print("P 2 0 0 0 " + str(-lineWidth) + " " + str(yRadius) + " " + str(lineWidth) + " " + str(yRadius) + " N")
for pin in range(numPins):
	print("X " + str(pin+startingPinNumber) + " " + str(pin+startingPinNumber) + " " + str(xRadius) + " 0 0 L " + str(textSize) + " " + str(textSize) + " " + str(pin+1) + " 1 P")
for pin in range(numPins):
	print("X " + str(pin+startingPinNumber) + " " + str(pin+startingPinNumber) + " 0 " + str(yRadius) + " 0 D " + str(textSize) + " " + str(textSize) + " " + str(pin+1) + " 2 P")
print("ENDDRAW")
print("ENDDEF")
print("#")
print("#End Library")
