...
- `MEDS2.py` provides a simulation of a Multifunction Electronic Display (MED), i.e. a Shuttle display screen. The directories config/ and data/ belong also to this program.
