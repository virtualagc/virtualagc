...
*/              Space Shuttle development.
         ...
         TITLE 'STOWDMEM - DYNAMICALLY INSERTS MEMBER NAME ON DD CARD ' 00000100
*                                                                       00000200
...
SAMEDD   MVC   JFCB+44(8),8(2)    COPY MEMBER TO  JFCB                  00003000
         OPEN  (DCB,(OUTPUT)),TYPE=J                                    00003100
         CLOSE (DCB)                                                    00003200
         L     13,SAVE+4                                                00003300
         RETURN (14,12)                                                 00003400
BADESC   XPLABEND 30,'STOWDMEM: 1ST ARG MUST BE STRING, LENGTH 16'      00003500
NODD     XPLABEND 40,'STOWDMEM: REQUESTED DD CARD MISSING'              00003600
DCB      DCB   DSORG=PS,MACRF=W,BUFNO=0,EXLST=EXLST                     00003700
         ORG   DCB+40                                                   00003800
