...
*/              Space Shuttle development.
         ...
         TITLE 'IMIN--INTEGER MIN FUNCTION ,DP'                         00000100
*
* WHEN DATA_REMOTE IS IN EFFECT, THE LDM INSTRUCTIONS ARE NOT NEEDED
* AROUND THE CALL TO THIS RTL ROUTINE BECAUSE R1/R3 IS NOT USED AS
* A BASE REGISTER. (CR12620)
*
IMIN     AMAIN INTSIC=YES                                               00000200
*                                                                       00000300
...
ILOOP    C     R6,2(R2)       COMPARE  CURRMIN TO NEXT ELEMENT          00001600
         BNH   LOW            IF ^> THEN SKIP ASSIGNMENT                00001700
START    L     R6,2(R2)       RESET CURRMIN                             00001800
LOW      LA    R2,2(R2)       BUMP INPUT PTR TO NEXT ELEMENT            00001900
