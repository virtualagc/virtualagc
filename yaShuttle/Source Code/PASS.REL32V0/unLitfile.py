...
The memory file doesn't actually need to be compressed, but with a full memory
...
them and don't know what they represent. I think that 5 may have something
to do with arrays.)
