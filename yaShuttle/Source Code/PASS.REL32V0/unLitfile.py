...
Each record contains data for 130 literals.  

The 4-byte records on the first page are "types" of the literals:  big-endian 
integers with the values 
...
As for the other 2 pages, the data format in their 4-byte fields depends on
the type of literal:
