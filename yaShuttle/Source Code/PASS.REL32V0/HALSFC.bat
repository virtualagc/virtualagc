...
set FILES_LOCAL="%FILES_LOCAL:"=% pass1A.rpt COMMON0.out.bin.gz"
...
set FILES_PRESERVE="litfile.bin litfile0.bin litfile2.bin cards COMMON0.out COMMON0.gz COMMON2.out TEMPLIB.json TEMPLIB TEMPLIBB.json TEMPLIBB pass1.rpt pass1p.rpt opt.rpt pass2.rpt cards.bin listing2.txt optmat.bin halmat.bin
