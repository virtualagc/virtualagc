...
p92_0: ;
  ...
  detailedInlineBefore(92, "L	3,33700(0,0)");
...
p92_10: ;
  ...
  detailedInlineBefore(95, "L	1,2196(0,0)");
...
p92_18: ;
  ...
  detailedInlineBefore(97, "L	1,2192(0,0)");
  GR[1] = COREWORD(address360B);
  detailedInlineAfter();

p92_22: ;
  // (98)          CALL INLINE("58", 2, 0, PTR);             /* L    2,PTR              */
  address360B = (59980) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,59980(0,0)
  detailedInlineBefore(98, "L	2,59980(0,0)");
