...
p19_0: ;
  ...
  address360B = (56376) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	1,56376(0,0)
  detailedInlineBefore(19, "L	1,56376(0,0)");
...
p19_8: ;
  ...
  address360B = (56384) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	2,56384(0,0)
  detailedInlineBefore(21, "LH	2,56384(0,0)");
  GR[2] = COREHALFWORD(address360B);
  detailedInlineAfter();

p19_12: ;
  // (22)          CALL INLINE("58", 3, 0, MVCTEMP);    /* L   3,MVCTEMP                */
  address360B = (56380) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	3,56380(0,0)
  detailedInlineBefore(22, "L	3,56380(0,0)");
...
p19_16: ;
  ...
  detailedInlineBefore(23, "EX	2,0(0,3)");
    // Unsupported opcode EX.  The MVC instruction referenced by GR[3]
    // is patch24b.  Here's the necessary translation of it:
