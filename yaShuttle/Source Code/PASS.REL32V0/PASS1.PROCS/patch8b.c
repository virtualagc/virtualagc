...
p8_2: ;
  ...
  address360B = (56364) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,56364(0,0)
  detailedInlineBefore(9, "L	2,56364(0,0)");
  GR[2] = COREWORD(address360B);
  detailedInlineAfter();

p8_6: ;
  // (10)             CALL INLINE("58",3,0,FROM);      /* L   3,FROM                    */
  address360B = (56360) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	3,56360(0,0)
  detailedInlineBefore(10, "L	3,56360(0,0)");
  GR[3] = COREWORD(address360B);
  detailedInlineAfter();

p8_10: ;
  // (11)             CALL INLINE("48",1,0,LEGNTH);    /* LH 1,LEGNTH                   */
  address360B = (56372) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	1,56372(0,0)
  detailedInlineBefore(11, "LH	1,56372(0,0)");
...
p8_16: ;
  ...
  address360B = (56368) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	4,56368(0,0)
  detailedInlineBefore(13, "L	4,56368(0,0)");
...
p8_20: ;
  ...
  detailedInlineBefore(14, "EX	1,0(0,4)");
    // Unsupported opcode EX.  The MVC referenced by GR[4] is in
    // patch16b, and translates as follows:
