...
p19_6: ;
  ...
  address360B = (6524) & 0xFFFFFF;
  // Type RX, p. 9-10:		LE	4,6524(0,0)
  detailedInlineBefore(22, "LE	4,6524(0,0)");
  FR[4] = fromFloatIBM(COREWORD(address360B), 0);
  detailedInlineAfter();

p19_10: ;
  // (23)          CALL INLINE("58", 2, 0, TEMP1);             /* L 2,TEMP1   */          
  address360B = (6540) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,6540(0,0)
  detailedInlineBefore(23, "L	2,6540(0,0)");
...
p19_30: ;
  ...
  address360B = (6536) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,6536(0,0)
  detailedInlineBefore(29, "L	2,6536(0,0)");
  GR[2] = COREWORD(address360B);
  detailedInlineAfter();
