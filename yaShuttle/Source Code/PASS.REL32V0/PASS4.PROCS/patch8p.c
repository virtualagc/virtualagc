{
  ...
  //                            Fixed EX instruction, checked remainder,
  //                            renamed file.
...
p8_2: ;
  ...
  detailedInlineBefore(9, "L	2,6256(0,0)");
...
p8_6: ;
  ...
  detailedInlineBefore(10, "L	3,6252(0,0)");
  GR[3] = COREWORD(address360B);
  detailedInlineAfter();

p8_10: ;
  // (11)             CALL INLINE("48",1,0,LEGNTH);    /* LH 1,LEGNTH */                  
  address360B = (6264) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	1,6264(0,0)
  detailedInlineBefore(11, "LH	1,6264(0,0)");
...
p8_16: ;
  ...
  address360B = (6260) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	4,6260(0,0)
  detailedInlineBefore(13, "L	4,6260(0,0)");
...
p8_20: ;
  ...
  // Translation of the targeted MVC instruction.  See patch16p.c.
  mvc(GR[2], GR[3], GR[1]);
  detailedInlineAfter();
