 ...
 */
   ...
   /* EDIT LEVEL 002             23 AUGUST 1977         VERSION 1.1     */      00100100
                                                                                00100200
  /* PROCEDURE TO DUMP LAST ACCESSED POINTERS */                                00100210
DUMP_VMEM_STATUS:                                                               00100220
   PROCEDURE;                                                                   00100230
      DECLARE FLAGS(VMEM_LIM_PAGES) CHARACTER, I BIT(8);                        00100240
      DO I = 0 TO VMEM_LIM_PAGES;                                               00100250
         FLAGS(I) = '';                                                         00100260
         IF (VMEM_FLAGS_STATUS(I) & RESV) ^= 0                                  00100270
            THEN FLAGS(I) = ' RESV';                                            00100280
         IF (VMEM_FLAGS_STATUS(I) & MODF) ^= 0                                  00100290
            THEN FLAGS(I) = FLAGS(I) || ' MODF';                                00100300
         IF (VMEM_FLAGS_STATUS(I) & RELS) ^= 0                                  00100310
            THEN FLAGS(I) = FLAGS(I) || ' RELS';                                00100320
         IF FLAGS(I) = '' THEN FLAGS(I) = ' NO FLAGS';                          00100330
      END;                                                                      00100340
      OUTPUT = 'POINTERS IN CORE:     FLAGS:';                                  00100350
      DO I = 0 TO VMEM_LIM_PAGES;                                               00100360
         OUTPUT = '         '||HEX8(VMEM_PTR_STATUS(I))||'     '||FLAGS(I);     00100370
      END;                                                                      00100380
   END DUMP_VMEM_STATUS;                                                        00100390
                                                                                00100400
                                                                                00100410
MOVE:                                                                           00100420
...
BAD_PTR:                                                                        00114800
    PROCEDURE;                                                                  00114900
      OUTPUT = '*** BAD POINTER '||HEX8(PTR)||' DETECTED BY PTR_LOCATE ***';    00115000
      CALL DUMP_VMEM_STATUS;                                                    00115010
GO TO PHASE3_ERROR;                                                             00115020
      CALL EXIT;                                                                00115100
   ...
   PROCEDURE (CELL_SIZE,BVAR,FLAGS) FIXED;                                      00124000
      ...
      IF CELL_SIZE < VMEM_PAGE_SIZE THEN DO;                                    00124800
         IF VMEM_LOOK_AHEAD THEN DO;                                            00124900
            ...
            IF AVAIL_SIZE >= CELL_SIZE THEN GO TO SAVE_SPACE;                   00125200
