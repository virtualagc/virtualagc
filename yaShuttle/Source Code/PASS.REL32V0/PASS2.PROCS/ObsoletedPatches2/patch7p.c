{
  ...
  //                            Fixed EX instruction, did other checks,
  //                            renamed "guess" to "patch".

p7_0: ;
  // (7)          CALL INLINE("58", 1, 0, CORE_ADDR);  /* L   1,CORE_ADDR              */
  address360B = (61576) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	1,61576(0,0)
  detailedInlineBefore(7, "L	1,61576(0,0)");
...
p7_8: ;
  ...
  address360B = (61584) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	2,61584(0,0)
  detailedInlineBefore(9, "LH	2,61584(0,0)");
  GR[2] = COREHALFWORD(address360B);
  detailedInlineAfter();

p7_12: ;
  // (10)          CALL INLINE("58", 3, 0, MVCTEMP);    /* L   3,MVCTEMP                */
  address360B = (61580) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	3,61580(0,0)
  detailedInlineBefore(10, "L	3,61580(0,0)");
...
p7_16: ;
  ...
  // Here's the translated target instruction (MVC) of the EX instruction.
