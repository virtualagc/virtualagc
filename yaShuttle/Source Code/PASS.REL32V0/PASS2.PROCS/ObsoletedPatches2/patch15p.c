...
p15_0: ;
  ...
  address360B = (61848) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	1,61848(0,0)
  detailedInlineBefore(15, "L	1,61848(0,0)");
...
p15_4: ;
  ...
  // Type SS, p. 7-131:		TR	61854(255,0),0(1)
  detailedInlineBefore(16, "TR	61854(255,0),0(1)");
