...
p19_6: ;
  ...
  address360B = (67992) & 0xFFFFFF;
  // Type RX, p. 9-10:		LE	4,67992(0,0)
  detailedInlineBefore(22, "LE	4,67992(0,0)");
  FR[4] = fromFloatIBM(COREWORD(address360B), 0);
  detailedInlineAfter();

p19_10: ;
  // (23)          CALL INLINE("58", 2, 0, TEMP1);              /* L   2,TEMP1   */       
  address360B = (68000) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,68000(0,0)
  detailedInlineBefore(23, "L	2,68000(0,0)");
...
p19_18: ;
  ...
  detailedInlineBefore(26, "L	1,2196(0,0)");
...
p19_26: ;
  ...
  detailedInlineBefore(28, "L	1,2192(0,0)");
  GR[1] = COREWORD(address360B);
  detailedInlineAfter();

p19_30: ;
  // (29)          CALL INLINE("58", 2, 0, TEMP);               /* L    2,TEMP       */   
  address360B = (67996) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,67996(0,0)
  detailedInlineBefore(29, "L	2,67996(0,0)");
  GR[2] = COREWORD(address360B);
  detailedInlineAfter();
