...
MMWSNP  TITLE 'SINGLE PRECISION VECTOR/MATRIX OUTPUT INTERFACE'         00000100
*
...
HOLD7    DS    H                                                        00000500
         MEND                                                           00000600
MMWSNP   AMAIN ACALL=YES                                                00000700
* OUTPUT AN M*N SINGLE PRECISION VECTOR/MATRIX                          00000800
