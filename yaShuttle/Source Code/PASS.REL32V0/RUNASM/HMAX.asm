...
*/              Space Shuttle development.
         ...
         TITLE 'HMAX--INTEGER MAX FUNCTION ,SP'                         00000100
*
* WHEN DATA_REMOTE IS IN EFFECT, THE LDM INSTRUCTIONS ARE NOT NEEDED
* AROUND THE CALL TO THIS RTL ROUTINE BECAUSE R1/R3 IS NOT USED AS
* A BASE REGISTER. (CR12620)
*
HMAX     AMAIN INTSIC=YES                                               00000200
*                                                                       00000300
...
HLOOP    CH    R6,1(R2)       COMPARE CURRMAX TO NEXT ELEMENT           00001600
         BNL   HIGH           IF ^< THEN SKIP ASSIGNMENT                00001700
START    LH    R6,1(R2)       RESET CURRMAX                             00001800
HIGH     LA   R2,1(R2)        BUMP INPUT PTR TO NEXT ELEMENT            00001900
