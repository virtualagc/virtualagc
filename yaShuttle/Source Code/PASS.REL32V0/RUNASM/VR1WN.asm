...
*/              Space Shuttle development.
         ...
         TITLE 'REMOTE TO REMOTE VECTOR MOVE, SP TO DP'                 00000100
*
* WHEN DATA_REMOTE IS IN EFFECT, THE LDM INSTRUCTIONS ARE NOT NEEDED
* AROUND THE CALL TO THIS RTL ROUTINE BECAUSE R1/R3 IS NOT USED AS
* A BASE REGISTER. (CR12620)
*
VR1WN    AMAIN                                                          00000200
*                                                                       00000300
...
*        V1 IS A SINGLE PRECISION VECTOR,                               00000700
*        V2 IS A DOUBLE PRECISION VECTOR,                               00000800
*        AT LEAST ONE OF THE ABOVE IS REMOTE,                           00000900
*        M1 IS A SINGLE PRECISION MATRIX,                               00001000
*        M2 IS A DOUBLE PRECISION MATRIX,                               00001100
...
*                                                                       00002200
         SER   F1,F1                                                    00002300
         NOPR  R4             NOP TO ALIGN THE LE AND STED ON           00002400
*                             EVEN BOUNDARIES TO SAVE ON LOOP TIME      00002500
VR1WNX   LE@#  F0,ARG4(R5)                                              00002600
         STED@# F0,ARG2(R5)                                             00002700
         BCTB  R5,VR1WNX                                                00002800
         AEXIT                                                          00002900
         ACLOSE                                                         00003000
