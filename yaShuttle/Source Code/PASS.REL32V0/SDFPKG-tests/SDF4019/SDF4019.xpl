...
/*   THIS TEST CASE SHOULD GET A 4019 ABEND WHEN A GETMAIN     */               
/*   FAIL DURING THE INITIALIZATION OF THE SDFPKG.             */               
/*                                                             */               
...
DECLARE GETM LITERALLY '6';                                                     
BASED  ALLOC_MEM1 FIXED;                                                        
                                                                                
DECLARE (BLKS,SYMS) BIT(16);                                                    
DECLARE NAME CHARACTER INITIAL('##COPY1A');                                     
DECLARE NAMEADDR BIT(32);                                                       
                                                                                
/* DYNAMICALLY ALLOCATE A BIG CHUNK OF MEMORY */                                
 IF MONITOR(GETM,ADDR(ALLOC_MEM1),54000) =0                                     
    THEN OUTPUT='MEMORY ALLOCATED FOR MEM1';                                    
    ELSE OUTPUT='NOT ENOUGH MEMORY FOR MEM1';                                   
