...
/*   THIS TEST CASE SHOULD GET A 4020 ABEND WHEN A HAL BLOCK   */              
/*   WAS NOT SET PRIOR TO LOCATING A SYMBOL DATA CELL USING    */              
...
OUTPUT = ''; OUTPUT = '--- SDFPKG MODE 9  & 13 TEST ---';                      
   ...
   OUTPUT = 'SYM #5  NAME = '||NAME||' BLOCK # = '||BLKNO;                     
                                                                               
/* LOCATE SYMBOL DATA CELL USING SYMBOL NAME ONLY, BLOCK NO IS  */             
/* NOT SET PRIOR TO THE LOCATE REQUEST                          */             
