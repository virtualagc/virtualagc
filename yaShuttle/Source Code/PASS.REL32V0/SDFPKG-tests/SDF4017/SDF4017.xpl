...
/*   THIS TEST CASE SHOULD GET A 4017 ABEND WHEN MULTIPLE      */               
/*   CALLS WERE MADE TO INITIALIZE SDFPKG.                     */               
/*                                                             */               
...
OUTPUT = ' CRETURN = '||CRETURN;                                                
IF CRETURN ^= 0 THEN OUTPUT= 'INITIALIZATION FAIL';                             
