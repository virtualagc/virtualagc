...
/*   THIS TEST CASE SHOULD GET A 4004 ABEND WHEN TOO MANY      */               
/*   RELEASES WERE PERFORMED FOR ONE PAGE.                     */               
/*                                                             */               
...
DO I = FIRST_STMT TO LAST_STMT;                                                 
   ...
   CALL MONITOR(22,"20000006"); /* SET RLSE FLAG FOR LOCATED ITEM */            
  END;                                                                          
                                                                                
/* TOO MANY RELEASES WERE PERFORM ON ONE PAGE */                                
OUTPUT = ''; OUTPUT = '--- RESERVE COUNT UNDERFLOW ---';                        
  CALL MONITOR(22,"20000006"); /* RELEASE THE LOCATED ITEM */                   
