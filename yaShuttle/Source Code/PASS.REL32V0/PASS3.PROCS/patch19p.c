{
  ...
  //                            EX instruction fixed, other parts checked,
  //                            renamed from "guess" to "patch".

p19_0: ;
  // (19)          CALL INLINE("58", 1, 0, CORE_ADDR);  /* L   1,CORE_ADDR              */
  address360B = (30088) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	1,30088(0,0)
  detailedInlineBefore(19, "L	1,30088(0,0)");
...
p19_8: ;
  ...
  address360B = (30096) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	2,30096(0,0)
  detailedInlineBefore(21, "LH	2,30096(0,0)");
  GR[2] = COREHALFWORD(address360B);
  detailedInlineAfter();

p19_12: ;
  // (22)          CALL INLINE("58", 3, 0, MVCTEMP);    /* L   3,MVCTEMP                */
  address360B = (30092) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	3,30092(0,0)
  detailedInlineBefore(22, "L	3,30092(0,0)");
...
p19_16: ;
  ...
  // Translation of the targeted MVC instruction:
  mvc(GR[1] + 1, GR[1], GR[2]);
  detailedInlineAfter();
