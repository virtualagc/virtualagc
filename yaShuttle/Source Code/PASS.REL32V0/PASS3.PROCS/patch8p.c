...
p8_2: ;
  ...
  address360B = (30076) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	2,30076(0,0)
  detailedInlineBefore(9, "L	2,30076(0,0)");
  GR[2] = COREWORD(address360B);
  detailedInlineAfter();

p8_6: ;
  // (10)             CALL INLINE("58",3,0,FROM);      /* L   3,FROM                    */
  address360B = (30072) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	3,30072(0,0)
  detailedInlineBefore(10, "L	3,30072(0,0)");
  GR[3] = COREWORD(address360B);
  detailedInlineAfter();

p8_10: ;
  // (11)             CALL INLINE("48",1,0,LEGNTH);    /* LH 1,LEGNTH                   */
  address360B = (30084) & 0xFFFFFF;
  // Type RX, p. 7-80:		LH	1,30084(0,0)
  detailedInlineBefore(11, "LH	1,30084(0,0)");
...
p8_16: ;
  ...
  address360B = (30080) & 0xFFFFFF;
  // Type RX, p. 7-7:		L	4,30080(0,0)
  detailedInlineBefore(13, "L	4,30080(0,0)");
...
p8_20: ;
  ...
  // Translation of the targetd MVC instruction; see patch16p.c:
  mvc(GR[2], GR[3], GR[1]);
  detailedInlineAfter();
