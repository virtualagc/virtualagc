...
p27_6: ;
  // (30)       CALL INLINE("78", 4, 0, FLTuNEGMAX);        /* LE 4,FLTuNEGMAX */
...
p27_10: ;
  ...
  // Type RX, p. 7-77:		L	2,mINTEGERIZABLExTEMP1(0,0)
...
p27_18: ;
  // (34)       CALL INLINE("58", 1, 0, ADDRuROUNDER);      /* L 1,ADDRuROUNDER */
  address360B = (mADDRuROUNDER) & 0xFFFFFF;
  // Type RX, p. 7-77:		L	1,mADDRuROUNDER(0,0)
  detailedInlineBefore(34, "L	1,mADDRuROUNDER(0,0)");
...
p27_26: ;
  // (36)       CALL INLINE("58", 1, 0, ADDRuFIXEDuLIMIT);  /* L 1,ADDRuLIMIT */
  address360B = (mADDRuFIXEDuLIMIT) & 0xFFFFFF;
  // Type RX, p. 7-77:		L	1,mADDRuFIXEDuLIMIT(0,0)
  detailedInlineBefore(36, "L	1,mADDRuFIXEDuLIMIT(0,0)");
  GR[1] = COREWORD(address360B);
  detailedInlineAfter();
...
p27_30: ;
  ...
  // Type RX, p. 7-77:		L	2,mINTEGERIZABLExTEMP(0,0)
