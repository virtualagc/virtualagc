...
def SYNTHESIZE(PRODUCTION_NUMBER):
    ...
    '''
    The case statement below was not originally within a while-loop, but it is
    here in order to account for the massive spaghetti in the original code
    for which Python has no corresponding "goto" statement for implementation.
    '''
    # The following goto_XXXX's are looped.
    ...
    # The following goto_XXX's aren't looped.
    goto_EXITTING = False
    goto_REPEATING = False
    firstTry = True
    while firstTry or  \
            goto_COMBINE_SCALARS_AND_VECTORS or goto_CROSS_PRODUCTS or \
            goto_ARITH_LITS or goto_CLOSE_SCOPE or goto_FIX_NOLAB : 
        firstTry = False
        # Fake up production number for goto_XXXX.
        if goto_COMBINE_SCALARS_AND_VECTORS or goto_CROSS_PRODUCTS:
            PRODUCTION_NUMBER = 11
        elif goto_ARITH_LITS:
            PRODUCTION_NUMBER = 19
        elif goto_FIX_NOLAB:
            PRODUCTION_NUMBER = 47
        elif goto_CLOSE_SCOPE:
            PRODUCTION_NUMBER = 291
        ...
        if PRODUCTION_NUMBER == 0:
            ...
            #  <PRODUCT> ::= <FACTOR>
            if not (goto_COMBINE_SCALARS_AND_VECTORS or goto_CROSS_PRODUCTS):
                CROSS_COUNT = 0
                DOT_COUNT = 0
                SCALAR_COUNT = 0
                VECTOR_COUNT = 0
        ...
        # <BASIC STATEMENT>::= <WAIT KEY><ARITH EXP>;
            ...
            END;
        elif PRODUCTION_NUMBER == 247:
            # <AND> ::= &
            pass
        elif PRODUCTION_NUMBER == 248:
            # <AND> ::= AND
            pass
        elif PRODUCTION_NUMBER == 249:
            # <OR> ::= |
            pass
        elif PRODUCTION_NUMBER == 250:
            # <OR> ::= OR
            pass
        elif PRODUCTION_NUMBER == 251:
            # <NOT> ::= not 
            pass
        elif PRODUCTION_NUMBER == 252:
            # <NOT> ::= NOT
            pass
        elif PRODUCTION_NUMBER == 253:
            # <CAT> ::= +
            pass
        elif PRODUCTION_NUMBER == 254:
            # <CAT> ::= CAT
            pass
            ...
            #  <CONSTANT>  ::=  <CHAR CONST>
            pass;
        elif PRODUCTION_NUMBER == 426:
            #  <NUMBER> ::= <SIMPLE NUMBER>
            pass
        elif PRODUCTION_NUMBER == 427:
            #  <NUMBER> ::= <LEVEL>
            pass
            ...
            INX(REFER_LOC)=INX(REFER_LOC)|TEMP;
            END;
        elif PRODUCTION_NUMBER == 452:
            pass          #  INSURANCE
        elif PRODUCTION_NUMBER == 453:
            pass          #  INSURANCE
        elif PRODUCTION_NUMBER == 454:
            pass          #  INSURANCE
        elif PRODUCTION_NUMBER == 455:
            pass          #  INSURANCE
        elif PRODUCTION_NUMBER == 456:
            pass          #  INSURANCE
