...
def STAB_HDR():
    ...
    CELL_PTR = GET_CELL(CELLSIZE,ADDR(NODE_H),RESV+MODF);
    ...
    IF CELLSIZE > 0 THEN DO;
       NODE_F(2) = GET_CELL(SHL(CELLSIZE,1)+2,ADDR(NODE_H),MODF);
       NODE_H(0) = CELLSIZE;
    ...
    IF CELLSIZE > 0 THEN DO;
       NODE_F(3) = GET_CELL(SHL(CELLSIZE,1)+2,ADDR(NODE_H),MODF);
       NODE_H(0) = CELLSIZE;
