            ...
            # END
                ...
                if np:  # DO
                    ...
                    # END
                        ...
                        g.FIXL[0] = g.LOC_P[0];
                        g.CURRENT_ARRAYNESS[0] = h.EXT_ARRAY[g.SYT_ARRAY(g.LOC_P[0])];
                        for J in range(1, g.CURRENT_ARRAYNESS[0] + 1):
                            g.CURRENT_ARRAYNESS[J] = EXT_ARRAY(g.SYT_ARRAY(g.LOC_P[0]) + J);
                        # END
                    # END
                    ...
                    goto = "ARR_CHECKOUT";
                # END;
                if (not np and goto == None) or goto == "ARR_CHECKOUT":  # Was ELSE
                    if goto == None:
                        g.PSEUDO_LENGTH[0] = g.VAR_LENGTH(g.LOC_P[0]);
                    if (g.SYT_ARRAY(g.LOC_P[0]) == 0 and goto == None) \
                        ...
                        if RESET_ARRAYNESS(): ERROR(d.CLASS_FD, 4);
                        SAVE_ARRAYNESS();
                    # END
