...
int main(int argc, char **argv) {
    ...
    if (!yaHALMAT2_ops.initializer(&gpcA, program_path, NULL, 0.0, NULL, NULL, NULL, NULL, NULL)) {
        fprintf(stderr, "FAIL: gpcA initializer failed\n");
        return 1;
    }
    if (!yaHALMAT2_ops.initializer(&gpcB, program_path, NULL, 0.0, NULL, NULL, NULL, NULL, NULL)) {
