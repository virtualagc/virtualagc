...
# Filename:	PINBALL_NOUN_TABLES.s
...
#	00101			OPTICAL TRACKER AZIMUTH ANGLE (XXX.XX DEG)
# Page 309
#								USE ARITHDP1
...
# Page 314
		...
		OCT	04121			# 67	LRVX
						#	LRVY
						#	LRVZ
		OCT	64124			# 68	SLANT RANGE TO LANDING SITE
...
# Page 315
		...
		OCT	04231			# 91	ALTITUDE
						#	VELOCITY
						#	FLIGHT PATH ANGLE
		OCT	04234			# 92	PCT FTP (10.5 KLB) AT PRESENT THRUST
						#	ALTITUDE RATE
						#	COMPUTED ALTITUDE
...
# Page 317
		...
		OCT	10200			# 74	3COMP	MIN/SEC, DPDEG(360), DPDEG(360)
						#		(NO LOAD, DEC ONLY)
		OCT	00010			# 75	3COMP	POS, MIN/SEC, MIN/SEC
						#		(NO LOAD, DEC ONLY)
# Page 318
...
# Page 319
		...
		OCT	06500
		2DEC	.18125 E5 B-28		# FORWARD/LATERAL VELOCITY
...
SFOUTAB		OCT	05174			# WHOLE, DP TIME (SEC)
		...
		OCT	05531
		2DEC	5.517 E-5 B14		# FORWARD/LATERAL VELOCTY
