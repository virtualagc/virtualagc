...
# Mod history:	2009-10-03 	Adapted from corresponding Comanche 055 file.
...
#			FLASH DISPALY TIME V06N16. INITIAL CHOICE = 0 = PRESENT TIME.
...
NEXTLINE	STOVL	RONE		# RN AT (-29)M FOR EARTH OR MOON
		...
		BON	CALL
			...
			MOONGONA	# CALCULATIONS ARE TO BE PERFORMED.
...
MOONGON		SET	DLOAD
		...
		ABVAL	 
		SET	RVQ
			LUNAFLAG	# FOR LAT-LONG SUBROUTINE
