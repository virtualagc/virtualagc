...
#       MUCH, SHAREABLE WITH RCS/ENTRY, IN EBANK6 ONLY
                ...
                EBANK=  CNTR		# was BZERO in artemis055 ...smc
...
PITCHDAP        LXCH    BANKRUPT        # T5 ENTRY, NORMAL OR VIA DAPINIT
                ...
                CAE     T5TVCDT
                TS      TIME5
#					# STROKER tests removed, were in comanche055 ...smc
...
YAWDAP          LXCH    BANKRUPT        # T5 ENTRY, NORMAL
                ...
                CAE     T5TVCDT
                TS      TIME5
#					# STROKER test removed, were in comanche055 ...smc
YCDUOUTS	CAE	CDUY		# COMPUTE CDUYDOT	# YCDUOUTS section new for artemis072 ...smc
		XCH	YCDUYPST
		EXTEND
		MSU	YCDUYPST
		TCR	RLIMTEST	#	RATE TEST
...
DAPINIT         LXCH    BANKRUPT        # T5 RUPT ENTRY (CALLED BY TVCINT4)
		...
		TS	YCDUYPST	# not in comanche055 ....smc
                CAE     CDUZ
                TS      PCDUZPST
		TS	YCDUZPST	# not in comanche055 ....smc
...
2DAPCAS         CAE     DAP1    +1      # SECOND DAP CASCADE
                ...
                DCA     DAP2
# Page 976
		DDOUBL			# both DDOUBL missing from comanche055 ...smc
		DDOUBL
                DXCH    DAP3
                TCF     OPTVARK
...
OPTVARK         CS      DAP3    +1      # VARIABLE GAIN PACKAGE
                ...
                DXCH    CMDTMP          # FIX UP SCALING -- SCALED B+1 ASCREVS
                DDOUBL
                DXCH    CMDTMP          #                -- SCALED B+0 ASCREVS
                                        # NOTE -- THERE IS AN INHERENT GAIN OF
                                        # (B+1 ASCREVS/REV) ON THE OUTPUT DACS.
