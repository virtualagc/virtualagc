...
# XPREV   * +17 FOR EARTH*PRVIOUS VALUE OF X IN METERS-TO-THE-ONE-HALF FROM KEPPREP (DP)
#         * +16 FOR MOON *(DP)
#
...
# DP PARAMETERS - FPSILONT, DELX, DELT, RCNORM, XMODULO, PLUS PUSHLIST REGISTERS 0 THROUGH 39D.
...
# VTARGTAG*NONE          *A S.P. TAG TO BE SET TO ZERO IF LAMBERT IS TO COMUTE THE VELOCITY AT R2VEC AS WELL AS
#         *              *AT R1VEC.
#
...
BADX		DLOAD	SR1		# RECIPE EXCEEDED X BOUNDS - USE XMAX/1
			XMAX
		STORE	X
		GOTO
			DXCOMP
...
PARAM		STQ	CLEAR		# MPAC=V1VEC, 0D=R1VEC         PL AT 6
		...
		SSP	CALL
			...
			GEOM		# MPAC=SNGA (+1), 0D=CSGA (+I) PL AT 2
