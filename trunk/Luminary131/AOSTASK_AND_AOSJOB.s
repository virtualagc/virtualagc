...
# Reference:	pp. 1482-1503 of 1729.pdf.
...
# DETERMINE MASS OF THE LEM.
		...
		MASK	CSMDOCKD
		TS	DOCKTEMP	# STORE REDORD OF STATE IN TEMP (MPAC +3).
		CCS	A
...
# DEBRIS:	SCRATCHX,SCRATCHY,SCRATCHZ,A,L	(NOTE: SCRATX,Y,Z ARE EQUATED TO MPAC +4,+5, AND +6.)
...
GETAOSUV	INHINT
		...
		CCS	A
		CA	FLATVAL		# DRIFTING FLIGHT, STORE .8 INFLAT
...
BOTHAXES	TS	SIGNAOS		# CODING COMMON TO U,V AXES
		...
		TCF	+3		# AND LEAVE SIGNACS AT ZERO
