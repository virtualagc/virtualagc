...
# TOWARDS THE CENTER OF THE EARTH.  THIS ROUTINE IS SELECTED BY THE ASTRO-
...
CONV5		SETPD	UNIT		# UE = -UNIT(REM)(UEM)		MOON SPHERE
		...
		CALL
			*SMNB*
		STODL	RLM		# PRE-MULTIPLY RLM BY (NBSA) MATRIX(B0) (garbled)
			RLM +2
		PUSH	DSU
			RLM
		DMP
