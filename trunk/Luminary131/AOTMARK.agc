...
# Reference:	pp. 250-267 of 1729.pdf.
...
AVEIT		SLOAD	PDVL		# N(NUMBER OF VECS) IN 0-1
		...
		STORE	STARSAV2
		EXIT
		CCS	MARKCNTR	# SEE IF ANOTHER MARK PARI IN MKVAC
...
VACSTOR		CAF	LOW9
		...
		CA	MARKCNTR	# A X MARKCNTR FOR STORE INDEX
		EXTEND
		MP	SIX
...
# Page 265
		...
		RXOR	LCHAN
		CCS	A
		TCF	REMARK		# NOT A PAIR YET, DISPLAY MARK ACTION
...
SURFAGAN	CA	CURSOR
		INDEX	MKDEX		# HOLDS VAC ARREA POINTER FOR SURF MARKING
