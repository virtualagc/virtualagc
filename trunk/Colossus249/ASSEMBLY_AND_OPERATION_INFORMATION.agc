...
#
# -FF-
# TRIM DEGREES		XXX.XX DEG.		SP	LOW ORDER BIT = 65.41 SEC
#			(MAX 388.69)			OF ARC
#
# -GG-
...
#			(MAX 97733BB.)			NEWTON METER
#
# -JJ-
# POSITIONS		XXX.XX NAUT MI		DP	BIT 1 OF LOW REGISTER =
#							2 METERS
#
# -KK-									    16
...
#								IMU-2, R02, P51
# 00211		COARSE ALIGN ERROR - DRIVE DEL 2 DEGREES	IMU MODE SWITCH		ALARM
...
# 00404		TARGET OUT OF VIEW - TRUN ANGLE DEL 90 DEG	R52			PRIOLARM
# 00405		TWO STARS NOT AVAILABLE				P52,P54			ALARM
# 00406		REND NAVIGATION NOT OPERATING			P21,R23			ALARM
# 00407		AUTO OPTICS REQUEST TRUN ANGLE DEL 50 DEG.	R52			ALARM
# 00420		THIRD CALL TO ORBITAL INTEGRATION		ALL CALLS TO INTRO	(?)
# 00421		W-MATRIX OVERFLOW				INTEGRV			ALARM
# 00605		NUMBER OF ITERATIONS EXCEEDS LOOP MAXIMUM	P32,P72			VARALARM
...
# 01706		STAGE VERIFY DISCRETE DOES NOT AGREE 		R03			(?)
# 01707(?)	CHECKLIST 203 NOT PERFORMED			R61			(?)
# 03117(?)	ICDU FAIL CAUSED THE ISS WARNING		T4RUPT			VARALARM
# 04717(?)	ICDU, PIPA FAILS CAUSED THE ISS WARNING		T4RUPT			VARALARM
# 07777		IMU FAIL CAUSED THE ISS WARNING			T4RUPT			VARALARM
# 10777		IMU, PIPA FAILS CAUSED THE ISS WARNING		T4RUPT			VARALARM
# 13711(?)	IMU, ICDU FAILS CAUSED THE ISS WARNING		T4RUPT			VARALARM
# 14711(?)	IMU, ICDU, PIPA FAILS CAUSED THE ISS WARNING	T4RUPT			VARALARM
#
