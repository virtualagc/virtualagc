...
CHARIN		TC	+1		# BLOCK DISPLAY SYST BUT SAVE OLD
...
# OPDEGOUT USED TO TEST BIT 13 OF WASOPSET (1 = 90 DEG RANGE, 0 = 180).
...
MONIT1		TS	MPAC +1		# TEMP STORAGE
		...
		LOC	+1
		TC	+1		# GRABLOCK=2. +0 INTO DSPLOCK (BIT4 OF
...
IDADDTAB	CADR	OPTX 	+04000	# 01	   DEGREES		52
		...
		CADR	TIME2	+12000	# 11	   HOURS		655
		CADR	TIME2	+10000	# 11	   SECONDS		655
...
6K+3		OCT	6003		# TC PRENVBSY WAS DONE) -2 TO BE ENTERED.
		...
		SETLOC	PUTINLST +4
NVSUBSY1	TS	CADRTEM
		TC	+1		# TEST IF REALLY LOCKED OUT
		TC	+3		# STILL BUSY
