...
# DSPLOCK	=	STATE (BIT4)	KEYBOARD/SUBROUTINE CALL INTERLOCK FIXME
...
# THE LIST2 VERBFAN IS LOCATED IN BANK 05. FIXME
...
DSPDCEND	CAF	LDSPDCWD	# ALL SFOUT ROUTINES END HERE
		TC	SWCALL
		CCS	DECOUNT
		TC	+2
		TC	ENTEXIT
...
ARTOUTSF	XCH	SFTEMP2		# ASSUMES POINT AT LEFT OF DP SFCON.
		...
		XCH	MPAC
		TC	SHORTMP
SCOUTEND	CAF	LDSPDCND
		TC	BANKJUMP
LDSPDCND	CADR	DSPDCEND
...
LTPAGREE	CADR	TPAGREE
LDSP2DEC	CADR	DSP2DEC
...
LOADLV		CAF	ZERO
		...
		CAF	LRECLTST	# AFTER COMPLETED LOAD, GO TO RECALTST
		TC	BANKJUMP	# TO SEE IF THERE IS RECALL FROM ENDIDLE.

LRECLTST	CADR	RECALTST
...
OPDEGIN3	XCH	MPAC		# RANGE IS 90 DEG
...
MONIT1		TS	MPAC +1		# TEMP STORAGE
		...
		LOC	+1
		CAF	ZERO		# GRABLOCK=2. +0 INTO DSPLOCK (BIT4 OF FIXME
		TS	DSPLOCK		# STATE) AND LEAVE KEY RELEASE LIGHT ALONE
		INHINT
		CCS	MONSAVE
