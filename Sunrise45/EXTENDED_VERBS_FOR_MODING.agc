...
TESTCADR	CADR	ALM/END		# 0  ILLEGAL.
		CADR	      		# 1 GYRO DRIFT TEST.
		CADR	        	# 2  PIPA SCALE FACTOR DETERMINATION.
		CADR	       		# 3  IMU ALIGNMENT TEST
		CADR	      		# 4  IMU CHECK.
		CADR	        	# 5  GYRO TORQUING TEST.
		CADR	    		# 6  C RELAY CHECK.
		CADR	      		# 7  DSKY CHECK.
...
# THE FOLLOWING PROGRAM IMPLEMENTS MAJOR MODE 27 OF FLIGHT 501 - STATE VECTOR UPDATE.
		BANK	13
76UPDATE	TC	+1      	# TURN OFF UPDAOFLG TO ALLOW ANOTHER V76
		OCT	20000
