...
## The printout appears to say "IMUGOARSE" in the line below, but many other
## AGC versions have an identical card reading "IMUCOARSE", so I believe there
## is a smudge on the paper that merely makes the 'C' appear to be a 'G'
## &mdash; RSB 2017.
