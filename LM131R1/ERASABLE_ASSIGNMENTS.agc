...
## The following block of erasables, through DELQFIX, were added between Luminary 131
## and LM131 rev 1 to support automatic P66 and variable servicer avoidance. P65 erasables
## that used to occupy this space were deleted.
TAUHZ		EQUALS	HIGHCRIT +1	# P66 HORIZONTAL
QHZ		EQUALS	TAUHZ +1	#     VELOCITY NULLING
AHZLIM		EQUALS	QHZ +1		#       CONSTANTS
TOOFEW		EQUALS	AHZLIM +1	# B(1) TOO FEW THROTTLINGS PER OMISSION:
					#  ONE LESS THAN NO. THROTTLES REQUIRED
					#   BETWEEN SKIPPED THROTTLES
					#    1466 ALARM IF THROTTLINGS <= TOOFEW
HLROFF		EQUALS	TOOFEW +1	# I(2) TMP  NO LANDING RADAR UPDATES
2LATE466	EQUALS	HLROFF +2	# I(2) MIN ELAPSED TIME SINCE PIPTIME ERE
					# A P66(2 R/D) WILL BE OMITTED
DELQFIX		EQUALS	2LATE466 +2	# I(2) LR ALTITUDE DATA REASONABLE PARM.
...
## The following erasable was added for LM131 rev 1.
