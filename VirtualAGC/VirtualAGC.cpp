    ...
    - ID_FIRSTMISSION] =
	  ...
	  //
		...
		DISABLED, CM, BLOCK2, PERIPHERALS, "", "CM.ini" },
            { "Luminary 69 rev 0", "Luminary069/MAIN.agc.html",
	    ...
	    { "Luminary 99 Rev 0", "LMY99R0/MAIN.agc.html",
		"Click this to select Luminary 99 rev 0, a preliminary revision of the Apollo 11 LM software.",
	    ...
	    { "Luminary 99 rev 2", "LUM99R2/MAIN.agc.html",
		"Click this to select Luminary 99 rev 2, a hypthetical revision of the Apollo 11 LM software.",
		...
		DISABLED, CM, BLOCK2, PERIPHERALS, "", "CM.ini" },
            { "Luminary 130", "Luminary130/MAIN.agc.html",
		...
		| wxSYSTEM_MENU))
{
  ...
  sizer_1_copy_staticbox = new wxStaticBox (this, -1,
					    wxT ("Browse Source Code"));
  sizer_18_staticbox = new wxStaticBox (this, -1, wxT ("AGC Startup"));
  sizer_22_staticbox = new wxStaticBox (this, -1, wxT ("Interface styles"));
  sizer_38_staticbox = new wxStaticBox (this, -1,
					wxT ("Use AGC/AEA debugger?"));
  sizer_20_staticbox = new wxStaticBox (
      this, -1, wxT ("LM Abort Computer (AEA) software"));
  sizer_19_staticbox = new wxStaticBox (
      this, -1, wxT ("Guidance Computer (AGC) software"));
  if (!maximumSquish)
    {
      Patch1Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo1.png"), wxBITMAP_TYPE_ANY));
      Patch7Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo7.png"), wxBITMAP_TYPE_ANY));
      Patch8Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo8.png"), wxBITMAP_TYPE_ANY));
      Patch9Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo9.png"), wxBITMAP_TYPE_ANY));
      Patch10Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo10.png"), wxBITMAP_TYPE_ANY));
      Patch11Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo11.png"), wxBITMAP_TYPE_ANY));
      PatchBitmap = new wxStaticBitmap (
	  this, wxID_ANY,
	  wxBitmap (wxT ("ApolloPatch2.png"), wxBITMAP_TYPE_ANY));
      Patch12Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo12.png"), wxBITMAP_TYPE_ANY));
      Patch13Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo13.png"), wxBITMAP_TYPE_ANY));
      Patch14Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo14.png"), wxBITMAP_TYPE_ANY));
      Patch15Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo15.png"), wxBITMAP_TYPE_ANY));
      Patch16Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo16.png"), wxBITMAP_TYPE_ANY));
      Patch17Bitmap = new wxStaticBitmap (
	  this, wxID_ANY, wxBitmap (wxT ("apo17.png"), wxBITMAP_TYPE_ANY));
    }
  TopLine = new wxStaticLine (this, wxID_ANY);
  if (!maximumSquish)
    {
      SimTypeLabel = new wxStaticText (this, wxID_ANY,
				       wxT ("AGC Simulation Type"),
  ...
  for (int i = ID_FIRSTMISSION; i < ID_AGCCUSTOMBUTTON; i++)
	...
	missionRadioButtons[i - ID_FIRSTMISSION] = new wxRadioButton (
	    this, i,
  ...
  AgcCustomButton = new wxRadioButton (this, ID_AGCCUSTOMBUTTON,
				       wxT ("Custom:"));
  AgcCustomFilename = new wxTextCtrl (this, ID_AGCCUSTOMFILENAME,
				      wxEmptyString);
  ...
  JoystickConfigure = new wxButton (this, ID_JOYSTICKCONFIGURE,
				    wxT ("Handler"));
  ...
  DeviceCpumonCheckbox = new wxCheckBox (
      this, ID_DEVICECPUMONCHECKBOX, wxT ("AGC CPU Bus/Input/Output Monitor"));
  static_line_4 = new wxStaticLine (this, wxID_ANY, wxDefaultPosition,
				    wxDefaultSize, wxLI_VERTICAL);
  DeviceImuCheckbox = new wxCheckBox (
      this, ID_DEVICEIMUCHECKBOX,
  ...
  DevicePropulsionCheckbox = new wxCheckBox (
      this, ID_DEVICEPROPULSIONCHECKBOX,
  ...
  StartupWipeButton = new wxRadioButton (this, ID_STARTUPWIPEBUTTON,
					 wxT ("Restart program, wiping memory"),
					 wxDefaultPosition, wxDefaultSize,
					 wxRB_GROUP);
  StartupPreserveButton = new wxRadioButton (
      this, ID_STARTUPPRESERVEBUTTON,
      wxT ("Restart program, preserving memory"));
  StartupResumeButton = new wxRadioButton (
      this, ID_STARTUPRESUMEBUTTON,
  ...
  DskyLiteButton = new wxRadioButton (this, ID_DSKYLITEBUTTON,
				      wxT ("\"Lite\""));
  ...
  AeaDebugMonitorButton = new wxRadioButton (this, ID_AEADEBUGMONITORBUTTON,
					     wxT ("Debugger"));
  FlightProgram4Button = new wxRadioButton (
      this, ID_FLIGHTPROGRAM4BUTTON, wxT ("Apollo 9 (Flight Programs 3, 4)"),
      wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  FlightProgram5Button = new wxRadioButton (
      this, ID_FLIGHTPROGRAM5BUTTON, wxT ("Apollo 10 (Flight Program 5)"));
  FlightProgram6Button = new wxRadioButton (
      this, ID_FLIGHTPROGRAM6BUTTON, wxT ("Apollo 11 (Flight Program 6)"));
  FlightProgram7Button = new wxRadioButton (
      this, ID_FLIGHTPROGRAM7BUTTON, wxT ("Apollo 12-14? (Flight Program 7)"));
  FlightProgram8Button = new wxRadioButton (
      this, ID_FLIGHTPROGRAM8BUTTON, wxT ("Apollo 15-17 (Flight Program 8)"));
  if (!maximumSquish)
    {
      ...
      AeaCustomFilename = new wxTextCtrl (this, ID_AEACUSTOMFILENAME,
					  wxEmptyString);
      AeaFilenameBrowse = new wxButton (this, ID_AEAFILENAMEBROWSE,
					wxT ("..."));
    }
...
VirtualAGC::AgcFilenameBrowseEvent (wxCommandEvent &event)
{
  ...
  wxFileDialog *Dialog = new wxFileDialog (
      this, wxT ("Choose AGC executable-binary file"), AgcDirectory, wxT (""),
...
VirtualAGC::AeaFilenameBrowseEvent (wxCommandEvent &event)
{
  TEMPTRACE ("4");
  wxFileDialog *Dialog = new wxFileDialog (
      this, wxT ("Choose AEA/AGS executable-binary file"), AeaDirectory,
      wxT (""), wxT ("Source files (*.aea)|*.aea|Binary files (*.bin)|*.bin"),
      wxFD_DEFAULT_STYLE | wxFD_FILE_MUST_EXIST | wxFD_CHANGE_DIR);
  if (!maximumSquish)
    {
  ...
  if (wxID_OK == Dialog->ShowModal ())
      ...
      if (Extension.IsSameAs (wxT ("aea")))  // Source code!
	{
	  ...
	  Dummy += wxT (EOL);
	  BuildScript.Write (Dummy);
	  Dummy = MvCommand + wxT (" yaLEMAP.bin \"") + Filebase
	      + wxT (".bin\"");
	  Dummy += wxT (EOL);
	  BuildScript.Write (Dummy);
	  ...
	  Dummy += wxT (EOL);
	  BuildScript.Write (Dummy);
	  Dummy = MvCommand + wxT (" yaLEMAP.lst \"") + Filebase
	      + wxT (".lst\"");
	  Dummy += wxT (EOL);
	  BuildScript.Write (Dummy);
	  BuildScript.Close ();
...
VirtualAGC::CoreBrowseEvent (wxCommandEvent &event)
{
  ...
  wxFileDialog *Dialog = new wxFileDialog (
      this, wxT ("Choose core-dump file for resumption"), ScenarioDirectory,
      wxT (""), wxT ("Core-dump files (*.core)|*.core|All files (*)|*"),
      wxFD_DEFAULT_STYLE | wxFD_FILE_MUST_EXIST | wxFD_CHANGE_DIR);
  if (wxID_OK == Dialog->ShowModal ())
    {
      wxString Pathname = Dialog->GetPath ();
...
VirtualAGC::CoreSaveEvent (wxCommandEvent &event)
{
  ...
  if (Response == wxNO)
	...
	LastDirectory = HomeDirectory;
      wxFileDialog *DialogR = new wxFileDialog (
	  this, wxT ("Choose core-dump file to save"), LastDirectory, wxT (""),
    ...
    {
      wxFileDialog *DialogS = new wxFileDialog (
	  this,
	  wxT ("Save core-dump file as"),
	  ScenarioDirectory,
	  wxT (""),
	  wxT ("Core-dump files (*.core)|*.core|All files (*)|*"),
...
VirtualAGC::do_layout ()
{
  ...
  grid_sizer_1->Add (AeaDebugNormalButton, 0,
...
VirtualAGC::FormCommands (void)
{
  ...
  if (!AgcCustomButton->GetValue ())
    {
      CoreBin = wxT ("source/") + basename + wxT ("/") + basename
	  + wxT (".bin");
      CorePad = wxT ("source/") + basename + wxT ("/") + basename
	  + wxT (".pad");
      CoreLst = wxT ("source/") + basename + wxT ("/") + basename
	  + wxT (".lst");
      if (DebugMode)
	     ...
	     wxCAPTION | wxMINIMIZE_BOX | wxSTAY_ON_TOP | wxSYSTEM_MENU)
{
  ...
  UplinkPanel = new wxPanel (this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
			     wxNO_BORDER | wxTAB_TRAVERSAL);
  sizer_32_staticbox = new wxStaticBox (
      ScriptPanel, -1, wxT ("To do the same thing from a command line ..."));
  sizer_33_staticbox = new wxStaticBox (UplinkPanel, -1,
					wxT ("Digital uplink status"));
  if (!maximumSquish)
    PatchBitmap = new wxStaticBitmap (
	this, wxID_ANY, wxBitmap (wxT ("ApolloPatch2.png"), wxBITMAP_TYPE_ANY));
  SimulationLabel = new wxStaticText (
      this, ID_SIMULATIONLABEL,
  ...
  UplinkText = new wxTextCtrl (
      UplinkPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      wxTE_MULTILINE | wxTE_READONLY | wxHSCROLL | wxTE_RICH);
  ScriptText = new wxTextCtrl (
      ScriptPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      wxTE_MULTILINE | wxTE_READONLY | wxHSCROLL | wxTE_RICH);
...
Simulation::UploadEvent (wxCommandEvent &event)
{
  ...
  wxFileDialog *Dialog = new wxFileDialog (
      this, wxT ("Choose script for digital upload to AGC or AEA"),
...
Simulation::set_properties ()
{
  ...
  SetIcon (_icon);
  SetBackgroundColour (wxColour (255, 255, 255));
  SimulationLabel->SetFont (
      wxFont (14, wxDEFAULT, wxNORMAL, wxBOLD, 0, wxT ("")));
	  ...
	  for (j = 0; j < Len; j++)
	      ...
	      if (i == 0 && j == 0)
		{
		  if (toupper (c) == 'C')
			...
			{
			  wxMessageBox (
			      wxT ("There is no CM simulation running"),
			...
			{
			  wxMessageBox (
			      wxT ("There is no LM simulation running"),
			      wxT ("Error"), wxICON_ERROR);
			  goto Done;
			}
		    }
		  ...
		  if (OnShellout < NumShellouts)
		    {
		      ...
		      wxExecute (
			  wxString::FromAscii (UplinkShellouts[OnShellout]));
		      free (UplinkShellouts[OnShellout]);
		      OnShellout++;
		    }
		  Keycode = -1;
