    ...
    wxFrame(parent, id, title, pos, size, wxCAPTION|wxMINIMIZE_BOX|wxCLOSE_BOX|wxCLIP_CHILDREN|wxSYSTEM_MENU)
{
    ...
    Apollo3CmButton = new wxRadioButton(this, ID_APOLLO3CMBUTTON, wxT("AS-202 (\"Apollo 3\") Command Module"));
    Apollo4CmButton = new wxRadioButton(this, ID_APOLLO4CMBUTTON, wxT("Apollo 4 Command Module"));
    Apollo5LmButton = new wxRadioButton(this, ID_APOLLO5LMBUTTON, wxT("Apollo 5 Lunar Module"));
    Apollo6CmButton = new wxRadioButton(this, ID_APOLLO6CMBUTTON, wxT("Apollo 6 Command Module"));
...
void VirtualAGC::RunButtonEvent(wxCommandEvent &event)
{
    ...
    if (Apollo1CmButton->GetValue ())
      ...
      SimulationWindow->WriteSimulationLabel (wxT ("AS-202 (\"Apollo 3\") Command Module"));
...
void VirtualAGC::Apollo3CmEvent(wxCommandEvent &event)
{
    EnforceConsistency ();
}


void VirtualAGC::Apollo4CmEvent(wxCommandEvent &event)
{
    EnforceConsistency ();
}


void VirtualAGC::Apollo5LmEvent(wxCommandEvent &event)
{
    EnforceConsistency ();
}


void VirtualAGC::Apollo6CmEvent(wxCommandEvent &event)
{
    EnforceConsistency ();
}
...
void VirtualAGC::set_properties()
{
    ...
    Apollo5LmButton->Enable(false);
    Apollo6CmButton->Enable(true);
    Apollo8CmButton->SetToolTip(wxT("Click this to select the Apollo 6 CM from the first lunar fly-by.  You will be able to view the source code for the AGC software designated Solarium (build 055).  No simulation is presently available."));
...
VirtualAGC::EnforceConsistency (void)
{
  ...
  block1 = Apollo3CmButton->GetValue() || Apollo4CmButton->GetValue() || Apollo6CmButton->GetValue();
  ...
  AgcSourceButton->Enable (Apollo6CmButton->GetValue() ||
                           Apollo8CmButton->GetValue () ||
                           Apollo9CmButton->GetValue () ||
    ...
    if (Apollo8CmButton->GetValue ())
      {
        ...
        if (DebugMode) DirCmd += wxT ("source/Colossus237");
        CMorLM = wxT ("CM");
        Port = wxT ("19697");
      }
    else if (Apollo9CmButton->GetValue ())
