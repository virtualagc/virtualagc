...
EVT_RADIOBUTTON(ID_DSKYNAVBUTTON, VirtualAGC::DskyNavEvent)
...
void
VirtualAGC::DskyNavEvent(wxCommandEvent &event)
{
  TEMPTRACE ("37a");
  EnforceConsistency();
}
...
VirtualAGC::set_properties()
{
  ...
  Apollo6CmButton->Enable(true);
  Apollo6CmButton->SetToolTip(
      wxT(
          "Click this to select the unmanned Apollo 6 CM mission. You will be able to view the source code or run the AGC software designated Solarium (build 055)."));
...
VirtualAGC::EnforceConsistency(void)
{
  ...
  abnormalCase = ValidationButton->GetValue() || block1
      || Apollo5LmButton->GetValue() || Aurora12Button->GetValue();
...
VirtualAGC::FormCommands(void)
{
  ...
  if (Apollo6CmButton->GetValue())
    {
      basename = wxT("Solarium055");
      Port = wxT("19671");
    }
  else if (Apollo8CmButton->GetValue())
    {
      basename = wxT("Colossus237");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (Apollo9CmButton->GetValue())
    {
      basename = wxT("Colossus249");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (Comanche55Button->GetValue())
    {
      basename = wxT("Comanche055");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (Luminary99Button->GetValue())
    {
      basename = wxT("Luminary099");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Luminary131Button->GetValue())
    {
      basename = wxT("Luminary131");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Artemis72Button->GetValue())
    {
      basename = wxT("Artemis072");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (ValidationButton->GetValue())
    {
      basename = wxT("Validation");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (ZerlinaButton->GetValue())
    {
      basename = wxT("Zerlina");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Apollo5LmButton->GetValue())
    {
      basename = wxT("Sunburst120");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Retread44Button->GetValue())
    {
      basename = wxT("Retread44");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Aurora12Button->GetValue())
    {
      basename = wxT("Aurora12");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Sunburst39Button->GetValue())
    {
      basename = wxT("Sunburst39");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (AgcCustomButton->GetValue())
