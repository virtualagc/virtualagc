...
VirtualAGC::SetSize(void)
{
  ...
  SET_FONT(Apollo3CmButton, 0);
  SET_FONT(Apollo4CmButton, 0);
  SET_FONT(Apollo5LmButton, 0);
  SET_FONT(Apollo6CmButton, 0);
  ...
  SET_FONT(Retread44Button, 0);
  SET_FONT(Aurora12Button, 0);
  SET_FONT(Sunburst39Button, 0);
  SET_FONT(ZerlinaButton, 0);
            ...
            | wxSYSTEM_MENU)
{
  ...
  Apollo1CmButton = new wxRadioButton(this, ID_APOLLO1CMBUTTON,
      wxT("Apollo 1 Command Module"), wxDefaultPosition, wxDefaultSize,
      wxRB_GROUP);
  Apollo3CmButton = new wxRadioButton(this, ID_APOLLO3CMBUTTON,
      wxT("AS-202 (\"Apollo 3\") Command Module"));
  Apollo4CmButton = new wxRadioButton(this, ID_APOLLO4CMBUTTON,
      wxT("Apollo 4 Command Module"));
  Apollo5LmButton = new wxRadioButton(this, ID_APOLLO5LMBUTTON,
      wxT("Apollo 5 Lunar Module"));
  Apollo6CmButton = new wxRadioButton(this, ID_APOLLO6CMBUTTON,
      wxT("Apollo 6 Command Module"));
  Apollo7CmButton = new wxRadioButton(this, ID_APOLLO7CMBUTTON,
      wxT("Apollo 7 Command Module"));
  Apollo8CmButton = new wxRadioButton(this, ID_APOLLO8CMBUTTON,
      wxT("Apollo 8 Command Module"));
  Apollo9CmButton = new wxRadioButton(this, ID_APOLLO9CMBUTTON,
      wxT("Apollo 9 Command Module"));
  Apollo9LmButton = new wxRadioButton(this, ID_APOLLO9LMBUTTON,
      wxT("Apollo 9 Lunar Module"));
  Apollo10CmButton = new wxRadioButton(this, ID_APOLLO10CMBUTTON,
      wxT("Apollo 10 Command Module"));
  Apollo10LmButton = new wxRadioButton(this, ID_APOLLO10LMBUTTON,
      wxT("Apollo 10 Lunar Module"));
  Comanche55Button = new wxRadioButton(this, ID_COMANCHE55BUTTON,
      wxT("Apollo 11 Command Module"));
  Luminary99Button = new wxRadioButton(this, ID_LUMINARY99BUTTON,
      wxT("Apollo 11 Lunar Module"));
  Apollo12CmButton = new wxRadioButton(this, ID_APOLLO12CMBUTTON,
      wxT("Apollo 12 Command Module"));
  Apollo12LmButton = new wxRadioButton(this, ID_APOLLO12LMBUTTON,
      wxT("Apollo 12 Lunar Module"));
  Apollo13CmButton = new wxRadioButton(this, ID_APOLLO13CMBUTTON,
      wxT("Apollo 13 Command Module"));
  Luminary131Button = new wxRadioButton(this, ID_LUMINARY131BUTTON,
      wxT("Apollo 13 Lunar Module"));
  Apollo14CmButton = new wxRadioButton(this, ID_APOLLO14CMBUTTON,
      wxT("Apollo 14 Command Module"));
  Apollo14LmButton = new wxRadioButton(this, ID_APOLLO14LMBUTTON,
      wxT("Apollo 14 Lunar Module"));
  Artemis72Button = new wxRadioButton(this, ID_ARTEMIS72BUTTON,
      wxT("Apollo 15-17 Command Module"));
  Apollo15LmButton = new wxRadioButton(this, ID_APOLLO15LMBUTTON,
      wxT("Apollo 15-17 Lunar Module"));
  SkylabCmButton = new wxRadioButton(this, ID_SKYLABCMBUTTON,
      wxT("Apollo Skylab/Soyuz Command Module"));
  ValidationButton = new wxRadioButton(this, ID_VALIDATIONBUTTON,
      wxT("Validation Suite"));
  Retread44Button = new wxRadioButton(this, ID_RETREAD44BUTTON,
      wxT("RETREAD 44 (LM)"));
  Aurora12Button = new wxRadioButton(this, ID_AURORA12BUTTON,
      wxT("AURORA 12 (LM)"));
  Sunburst39Button = new wxRadioButton(this, ID_SUNBURST39BUTTON,
      wxT("SUNBURST 39 (LM)"));
  ZerlinaButton = new wxRadioButton(this, ID_ZERLINABUTTON,
      wxT("ZERLINA (LM)"));
  ...
  Aurora12Button->Enable(true);
  Apollo5LmButton->Enable(true);
  Apollo6CmButton->Enable(true);
  Apollo8CmButton->Enable(true);
  Apollo9CmButton->Enable(true);
  Comanche55Button->Enable(true);
  Luminary99Button->Enable(true);
  Artemis72Button->Enable(true);
  EnforceConsistency();
...
EVT_RADIOBUTTON(ID_APOLLO3CMBUTTON, VirtualAGC::Apollo3CmEvent)
EVT_RADIOBUTTON(ID_APOLLO4CMBUTTON, VirtualAGC::Apollo4CmEvent)
EVT_RADIOBUTTON(ID_APOLLO5LMBUTTON, VirtualAGC::Apollo5LmEvent)
EVT_RADIOBUTTON(ID_APOLLO6CMBUTTON, VirtualAGC::Apollo6CmEvent)
...
EVT_RADIOBUTTON(ID_RETREAD44BUTTON, VirtualAGC::Retread44Event)
EVT_RADIOBUTTON(ID_AURORA12BUTTON, VirtualAGC::Aurora12Event)
EVT_RADIOBUTTON(ID_SUNBURST39BUTTON, VirtualAGC::Sunburst39Event)
EVT_RADIOBUTTON(ID_ZERLINABUTTON, VirtualAGC::ZerlinaEvent)
...
void
VirtualAGC::DeviceAgcEvent(wxCommandEvent &event)
{
  TEMPTRACE ("5");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceDskyEvent(wxCommandEvent &event)
{
  TEMPTRACE ("6");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceAcaEvent(wxCommandEvent &event)
{
  TEMPTRACE ("7");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceTelemetryEvent(wxCommandEvent &event)
{
  TEMPTRACE ("8");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceAeaEvent(wxCommandEvent &event)
{
  TEMPTRACE ("9");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceDedaEvent(wxCommandEvent &event)
{
  TEMPTRACE ("10");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceCpumonEvent(wxCommandEvent &event)
{
  TEMPTRACE ("11");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceImuEvent(wxCommandEvent &event)
{
  TEMPTRACE ("12");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceDiscoutEvent(wxCommandEvent &event)
{
  TEMPTRACE ("13");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceCrewinEvent(wxCommandEvent &event)
{
  TEMPTRACE ("14");
  EnforceConsistency();
}
...
void
VirtualAGC::DeviceSysinEvent(wxCommandEvent &event)
{
  TEMPTRACE ("15");
  EnforceConsistency();
}
...
void
VirtualAGC::DevicePropulsionEvent(wxCommandEvent &event)
{
  TEMPTRACE ("16");
  EnforceConsistency();
}
...
VirtualAGC::RunButtonEvent(wxCommandEvent &event)
{
  ...
  else if (Apollo3CmButton->GetValue())
    SimulationWindow->WriteSimulationLabel(
        wxT("AS-202 (\"Apollo 3\") Command Module"));
  else if (Apollo4CmButton->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("Apollo 4 Command Module"));
  else if (Apollo5LmButton->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("Apollo 5 Lunar Module"));
  else if (Apollo6CmButton->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("Apollo 6 Command Module"));
  ...
  else if (Retread44Button->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("RETREAD 44 (Lunar Module)"));
  else if (Aurora12Button->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("AURORA 12 (Lunar Module)"));
  else if (Sunburst39Button->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("SUNBURST 39 (Lunar Module)"));
  else if (ZerlinaButton->GetValue())
    SimulationWindow->WriteSimulationLabel(wxT("ZERLINA (Lunar Module)"));
...
VirtualAGC::AgcSourceEvent(wxCommandEvent &event)
{
  ...
  Dummy += wxT("/source/");
  if (Apollo6CmButton->GetValue())
    Dummy += wxT("Solarium055/MAIN.agc.html");
  else if (Apollo5LmButton->GetValue())
    Dummy += wxT("Sunburst120/MAIN.agc.html");
  else if (Apollo8CmButton->GetValue())
    Dummy += wxT("Colossus237/MAIN.agc.html");
  else if (Apollo9CmButton->GetValue())
    ...
    Dummy += wxT("Retread44/MAIN.agc.html");
  else if (Aurora12Button->GetValue())
    Dummy += wxT("Aurora12/MAIN.agc.html");
  else if (Sunburst39Button->GetValue())
    Dummy += wxT("Sunburst39/MAIN.agc.html");
  else if (ZerlinaButton->GetValue())
    Dummy += wxT("Zerlina/MAIN.agc.html");
  else if (AgcCustomButton->GetValue())
...
void
VirtualAGC::StartupWipeEvent(wxCommandEvent &event)
{
  TEMPTRACE ("27");
  EnforceConsistency();
}
...
void
VirtualAGC::StartupPreserveEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::StartupResumeEvent(wxCommandEvent &event)
{
  TEMPTRACE ("28");
  EnforceConsistency();
}
...
void
VirtualAGC::CustomCoreClick(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo1CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo3CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo4CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo5LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo6CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo7CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo8CmEvent(wxCommandEvent &event)
{
  TEMPTRACE ("29");
  EnforceConsistency();
}
...
void
VirtualAGC::Apollo9CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo9LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo10CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo10LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Comanche55Event(wxCommandEvent &event)
{
  TEMPTRACE ("30");
  EnforceConsistency();
}
...
void
VirtualAGC::Luminary99Event(wxCommandEvent &event)
{
  TEMPTRACE ("31");
  EnforceConsistency();
}
...
void
VirtualAGC::Apollo12CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo12LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo13CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Luminary131Event(wxCommandEvent &event)
{
  TEMPTRACE ("32");
  EnforceConsistency();
}
...
void
VirtualAGC::Apollo14CmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo14LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Artemis72Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Apollo15LmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::SkylabCmEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::ValidationEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Retread44Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Aurora12Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::Sunburst39Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::ZerlinaEvent(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::AgcCustomEvent(wxCommandEvent &event)
{
  TEMPTRACE ("34");
  EnforceConsistency();
}
...
void
VirtualAGC::FlightProgram4Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::FlightProgram5Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::FlightProgram6Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::FlightProgram7Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::FlightProgram8Event(wxCommandEvent &event)
{
  EnforceConsistency();
}

void
VirtualAGC::AeaCustomEvent(wxCommandEvent &event)
{
  TEMPTRACE ("34");
  EnforceConsistency();
}
...
void
VirtualAGC::DskyFullEvent(wxCommandEvent &event)
{
  TEMPTRACE ("35");
  EnforceConsistency();
}
...
void
VirtualAGC::DskyHalfEvent(wxCommandEvent &event)
{
  TEMPTRACE ("36");
  EnforceConsistency();
}
...
void
VirtualAGC::DskyLiteEvent(wxCommandEvent &event)
{
  TEMPTRACE ("37");
  EnforceConsistency();
}
...
void
VirtualAGC::AgcDebugNormalEvent(wxCommandEvent &event)
{
  TEMPTRACE ("38");
  EnforceConsistency();
}
...
void
VirtualAGC::AgcDebugMonitorEvent(wxCommandEvent &event)
{
  TEMPTRACE ("39");
  EnforceConsistency();
}
...
void
VirtualAGC::DedaFullEvent(wxCommandEvent &event)
{
  TEMPTRACE ("40");
  EnforceConsistency();
}
...
void
VirtualAGC::DedaHalfEvent(wxCommandEvent &event)
{
  TEMPTRACE ("41");
  EnforceConsistency();
}
...
void
VirtualAGC::AeaDebugNormalEvent(wxCommandEvent &event)
{
  TEMPTRACE ("42");
  EnforceConsistency();
}
...
void
VirtualAGC::AeaDebugMonitorEvent(wxCommandEvent &event)
{
  TEMPTRACE ("43");
  EnforceConsistency();
}
...
VirtualAGC::set_properties()
{
  ...
  Apollo3CmButton->Enable(false);
  Apollo4CmButton->Enable(false);
  Apollo5LmButton->Enable(true);
  Apollo5LmButton->SetToolTip(
      wxT(
          "Click this to select the Apollo 5 unmanned LM mission.  You will be able to view the source code for the AGC software designated Sunburst12, or run the software simulation."));
  Apollo6CmButton->Enable(true);
  Apollo8CmButton->SetToolTip(
      wxT(
          "Click this to select the Apollo 6 CM from the first lunar fly-by.  You will be able to view the source code for the AGC software designated Solarium (build 055).  No simulation is presently available."));
  Apollo7CmButton->Enable(false);
  Apollo8CmButton->SetToolTip(
      wxT(
          "Click this to run a simulation for the Apollo 8 CM from the first lunar fly-by.  This will use AGC software designated Colossus 1 (build 237)."));
  Apollo8CmButton->Enable(false);
  Apollo9CmButton->SetToolTip(
      wxT(
          "Click this to run a simulation for the Apollo 9 CM.  This will use AGC software designated Colossus 1A (build 249, October 28, 1968)."));
  Apollo9CmButton->Enable(false);
  Apollo9LmButton->Enable(false);
  Apollo10CmButton->Enable(false);
  Apollo10LmButton->Enable(false);
  Comanche55Button->SetToolTip(
      wxT(
          "Click this to simulate the Apollo 11 CM from the FIRST moon landing.  This will run AGC software Colossus 2A, otherwise known as Comanche (rev. 55, 1 August 1969)."));
  Comanche55Button->Enable(false);
  Luminary99Button->SetToolTip(
      wxT(
          "Click this to simulate the Apollo 11 LM from the FIRST moon landing.  This will run AGC software Luminary 1A (rev. 55, 14 July 1969)."));
  Luminary99Button->Enable(false);
  Apollo12CmButton->Enable(false);
  Apollo12LmButton->Enable(false);
  Apollo13CmButton->Enable(false);
  Luminary131Button->SetToolTip(
      wxT(
          "Click this to simulate the ill-fated but nevertheless heroic Apollo 13 LM.  This will run AGC software Luminary 1C (rev. 131)."));
  Luminary131Button->SetValue(1);
  Apollo14CmButton->Enable(false);
  Apollo14LmButton->Enable(false);
  Artemis72Button->SetToolTip(
      wxT(
          "Click this to simulate the Apollo 15-17 CM, including the LAST moon-landing.  This will run AGC software Colossus 3, otherwise known as Artemis (rev. 072)."));
  Apollo15LmButton->Enable(false);
  SkylabCmButton->SetToolTip(
      wxT("Software for the Apollo/Skylab or Apollo/Soyuz mission."));
  SkylabCmButton->Enable(false);
  Retread44Button->Enable(false);
  Aurora12Button->SetToolTip(
      wxT(
          "Click this to simulate AURORA 12 software ... very early LM software prior to any actual mission software."));
  Aurora12Button->Enable(false);
  Sunburst39Button->Enable(false);
  ZerlinaButton->Enable(false);
...
VirtualAGC::do_layout()
{
  ...
  sizer_19->Add(Apollo3CmButton, 0, 0, 0);
  sizer_19->Add(Apollo1CmButton, 0, 0, 0);
  sizer_19->Add(Apollo4CmButton, 0, 0, 0);
  sizer_19->Add(Apollo5LmButton, 0, 0, 0);
  sizer_19->Add(Apollo6CmButton, 0, 0, 0);
  ...
  sizer_19->Add(Retread44Button, 0, 0, 0);
  sizer_19->Add(Aurora12Button, 0, 0, 0);
  sizer_19->Add(Sunburst39Button, 0, 0, 0);
  sizer_19->Add(ZerlinaButton, 0, 0, 0);
...
VirtualAGC::EnforceConsistency(void)
{
  ...
  block1 = Apollo3CmButton->GetValue() || Apollo4CmButton->GetValue()
      || Apollo6CmButton->GetValue();
  abnormalCase = ValidationButton->GetValue() || block1;
  ...
  DskyLabel->Enable(!block1);
  DskyFullButton->Enable(!block1);
  ...
  DeviceAgcCheckbox->SetValue(!block1);
  DeviceDskyCheckbox->SetValue(!block1);
  NoviceButton->Enable(!block1);
  ExpertButton->Enable(!block1);
  RunButton->Enable(!block1);

  IsLM = Apollo5LmButton->GetValue() || Apollo9LmButton->GetValue()
      || Apollo10LmButton->GetValue() || Luminary99Button->GetValue()
      || Apollo12LmButton->GetValue() || Luminary131Button->GetValue()
      || Apollo14LmButton->GetValue() || Apollo15LmButton->GetValue()
      || AgcCustomButton->GetValue() || Retread44Button->GetValue()
      || Aurora12Button->GetValue() || Sunburst39Button->GetValue()
      || ZerlinaButton->GetValue();
  ...
  AgcSourceButton->Enable(
      Apollo5LmButton->GetValue() || Apollo6CmButton->GetValue()
          || Apollo8CmButton->GetValue() || Apollo9CmButton->GetValue()
          || Comanche55Button->GetValue() || Artemis72Button->GetValue()
          || Luminary131Button->GetValue() || Luminary99Button->GetValue()
          || ValidationButton->GetValue() || Retread44Button->GetValue()
          || Aurora12Button->GetValue() || Sunburst39Button->GetValue()
          || ZerlinaButton->GetValue()
          ...
          for (i = 0; i < NumLines; i++)
            {
              ...
              CHECK_TRUE_FALSE_SETTING(Apollo3CmButton);
              CHECK_TRUE_FALSE_SETTING(Apollo4CmButton);
              CHECK_TRUE_FALSE_SETTING(Apollo5LmButton);
              CHECK_TRUE_FALSE_SETTING(Apollo6CmButton);
              ...
              CHECK_TRUE_FALSE_SETTING(Retread44Button);
              CHECK_TRUE_FALSE_SETTING(Aurora12Button);
              CHECK_TRUE_FALSE_SETTING(Sunburst39Button);
              CHECK_TRUE_FALSE_SETTING(ZerlinaButton);
  ...
  if (Fout.Create(wxT("VirtualAGC.cfg"), true))
    {
      ...
      WRITE_TRUE_FALSE_SETTING(Apollo3CmButton);
      WRITE_TRUE_FALSE_SETTING(Apollo4CmButton);
      WRITE_TRUE_FALSE_SETTING(Apollo5LmButton);
      WRITE_TRUE_FALSE_SETTING(Apollo6CmButton);
      ...
      WRITE_TRUE_FALSE_SETTING(Retread44Button);
      WRITE_TRUE_FALSE_SETTING(Aurora12Button);
      WRITE_TRUE_FALSE_SETTING(Sunburst39Button);
      WRITE_TRUE_FALSE_SETTING(ZerlinaButton);
...
VirtualAGC::FormCommands(void)
{
  ...
  if (DeviceCpumonCheckbox->GetValue())
    ...
    LM_Simulator = wxT("");
  if (Apollo8CmButton->GetValue())
    {
      CoreBin = wxT("source/Colossus237/Colossus237.bin");
      if (DebugMode)
        DirCmd += wxT("source/Colossus237");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (Apollo9CmButton->GetValue())
  ...
  else if (ValidationButton->GetValue())
    {
      ...
      if (DebugMode)
        DirCmd += wxT("source/Validation");
      CMorLM = wxT("CM");
      Port = wxT("19697");
    }
  else if (ZerlinaButton->GetValue())
    {
      CoreBin = wxT("source/Zerlina/Zerlina.bin");
      if (DebugMode)
        DirCmd += wxT("source/Zerlina");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Apollo5LmButton->GetValue())
    {
      CoreBin = wxT("source/Sunburst120/Sunburst120.bin");
      if (DebugMode)
        DirCmd += wxT("source/Sunburst120");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Retread44Button->GetValue())
    {
      CoreBin = wxT("source/Retread44/Retread44.bin");
      if (DebugMode)
        DirCmd += wxT("source/Retread44");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Aurora12Button->GetValue())
    {
      CoreBin = wxT("source/Aurora12/Aurora12.bin");
      if (DebugMode)
        DirCmd += wxT("source/Aurora12");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (Sunburst39Button->GetValue())
    {
      CoreBin = wxT("source/Sunburst39/Sunburst39.bin");
      if (DebugMode)
        DirCmd += wxT("source/Sunburst39");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else if (AgcCustomButton->GetValue())
    {
      ...
      if (DebugMode)
        DirCmd += wxT("\"") + CoreBin.BeforeLast(PATH_DELIMITER) + wxT("\"");
      CMorLM = wxT("LM");
      Port = wxT("19797");
    }
  else
  ...
  if (!yaAGC.IsSameAs(wxT("")))
    {
      yaAGC += wxT(" ") + CoreCmd + wxT("\"") + CoreBin + wxT("\" --port=")
          + Port + DirCmd + wxT(" --cfg=") + CMorLM + wxT(".ini");
