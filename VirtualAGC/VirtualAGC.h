...
public:
  virtual void
  MoreEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  LessEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  UploadEvent(wxCommandEvent &event); // wxGlade: <event_handler>
};
// wxGlade: end class
...
protected:
  ...
  wxRadioButton* Retread44Button;
  wxRadioButton* Aurora12Button;
  wxRadioButton* Sunburst39Button;
  wxRadioButton* ZerlinaButton;
...
public:
  virtual void
  Comanche55Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Luminary99Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Luminary131Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Artemis72Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AgcCustomEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AgcFilenameBrowseEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  FlightProgram6Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  FlightProgram8Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AeaCustomEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AeaFilenameBrowseEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceAgcEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceDskyEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceAcaEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceTelemetryEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceAeaEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceDedaEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceCpumonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceImuEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceDiscoutEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceCrewinEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DeviceSysinEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DevicePropulsionEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  NoviceButtonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  ExpertButtonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  StartupWipeEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  StartupResumeEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DskyFullEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DskyHalfEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DskyLiteEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DskyNavEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AgcDebugNormalEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AgcDebugMonitorEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DedaFullEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DedaHalfEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AeaDebugNormalEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AeaDebugMonitorEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  RunButtonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  DefaultsButtonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  ExitButtonEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  StartupPreserveEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo3CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo4CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo5LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo6CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo7CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo8CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo9CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo9LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo10CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo10LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo12CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo12LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo13CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo14CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo14LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo15LmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  ValidationEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Retread44Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Aurora12Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Sunburst39Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  ZerlinaEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AgcSourceEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  AeaSourceEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  FlightProgram4Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  FlightProgram5Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  FlightProgram7Event(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  CoreBrowseEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  CoreSaveEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  CustomCoreClick(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  JoystickConfigureClicked(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  Apollo1CmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
  virtual void
  SkylabCmEvent(wxCommandEvent &event); // wxGlade: <event_handler>
};
// wxGlade: end class
