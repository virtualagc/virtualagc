...
# DVE full session
# Saved on Tue Mar 29 17:48:15 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 23} {1535 815}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 445} {child_wave_right 1085} {child_wave_colname 209} {child_wave_colvalue 232} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_8" { TB.core.Decoder.recent_reset TB.core.alu_out_E TB.core.alu_out_E TB.core.rs1_data_E TB.core.rs2_data_E TB.core.k_E TB.core.alu_src1_E TB.core.alu_src2_E TB.core.clock TB.core.reset_n TB.core.pc_F TB.core.pc_1_F TB.core.next_pc_F TB.core.pc_E TB.core.pc_D TB.core.instr_D TB.core.ctrl_D TB.core.ctrl_E TB.core.ctrl_F TB.core.ctrl_W }
...
gui_sg_addsignal -group "$_session_group_10" { TB.core.alu_out_E TB.core.rs1_data_E TB.core.rs2_data_E TB.core.k_E TB.core.alu_src1_E TB.core.alu_src2_E }
...
gui_list_select -id ${Wave.1} {TB.core.Decoder.recent_reset }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group1  -item {TB.core.alu_src2_E[14:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 15
gui_view_scroll -id ${Wave.1} -vertical -set 441
