...
LST2FAN         TC      VBZERO          # VB40 ZERO (USED WITH NOUN 20 OR 40 ONLY)
                ...
                TCF     AGSINIT         # VB63 SEND SPECIAL CDU DOWNLIST
                TCF     ALM/END         # VB64 SET TIMER TO GROUND ELAPSED TIME
                TCF     ALM/END         # VB65 SET GUIDANCE REFERENCE RELEASE DISC
                TCF     ALM/END         # VB66 INITIATE LGC DFI TLM CALIBRATE RTN
                TCF     ALM/END         # VB67 SEND COMMAND TO LMP
                TCF     ALM/END         # VB70 SET MISSION TIMER
                TCF     ALM/END         # VB71 SET MISSION PHASE REGISTER
                TCF     ALM/END         # VB72 SET MISSION PHASE REGISTER + TIMER
                TCF     MINIMP
                TCF     NOMINIMP        # VB73 RESET DPS OR RPS COLD SOAK DISC
...
TORQGYRS        TC      TESTXACT                # GYRO TORQUING WITH NO MOD-SWITCH.
                TC      GRABWAIT
                CAF     VNLODGYR
                TC      NVSBWAIT
                TC      ENDIDLE
...
TSELECT         CAF     LOW5            #   OCTAL 17 OPTIONS WITHOUT OPERATOR ERRO
                MASK    QPLACE
                INDEX   A
                CAF     TESTCADR
                TC      BANKJUMP
...
AURLOKON        TC      MAKECADR
                ...
                TCF     +3                      # LONG DESIGNATION IS WANTED (TO B
...
LONGER          TS      TIMAR           # SNATCH THE MISSION TIME REGS AND STORE
                ...
                EXTEND
                DCA     TIME2           # READ AND STORE THE DP TIME AND TO
...
POSTAND         CAF     EBANK3          # COMES HERE FROM LST2FAN
                XCH     EBANK           # SET UP EBANK FOR BANK 3
                TC      FINETIME
                DXCH    TIMAR           # READ THE SCALAR AND SEE IF IT OVEFLO-
                RELINT                  # ED WHILE THE CGC WAS IN STBY, IF SO
                CAE     TIMAR           # THE OVEFLOW MUST BE ADDED OR IT WILL
                EXTEND                  # SEEM THAT THE REALATIVITY THEOR WORKS
                SU      SCALSAV         # BETTER THAN IT SHOUD...
                EXTEND
