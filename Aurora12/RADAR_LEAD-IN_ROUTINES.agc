...
DORREPOS        TC      SETRRECR        # SET UP RR CDU ERROR COUNTERS.
                ...
                CAF     BIT12           # NOT PUT SHAFT IN RIGHT POSITION
                MASK    RADMODES
                CCS     A
...
# TRUNNION TO -130 (-50) BEFORE INITIATING 2-AXIS CONTROL. ALL RE-MODING IS DONE WITH SINGLE AXIS ROTATIONS (SEE
# RR1AXIS).
...
## Page 237
#          STABLE-MEMBER RR DESIGNATE ROUTINE. DESIGNATE TO A SM LOS VECTOR (HALF-UNIT) IN RRTARGET. REMODS IF
...
TRYSWN          TC      RMODINV         # SEE IF OTHER MODE WILL DO.
                TC      RRLIMCHK        # DO SPECIAL V41 LIMIT CHECK
                ADRES   TANG
...
NOMORE          TC      ALARM           # P20 WANTS THE ALARM.
                OCT     521
BADRAD          CS      ONE
                TS      SAMPLIM
                TC      RDBADEND -2
...
GOODRAD         CS      ONE
                ...
                TS      RADMODES
                TC      SETTRKF         # LAMPS MAY GO OFF IF DATA JUST GOOD.
                TC      RGOODEND -2
...
LVELBIAS        DEC     -12000          # LANDING RADAR BIAS FOR 153.6 KC.
...
LRPOS2          INHINT
                ...
                CS      BIT6            # SHOW DESIRED LR POSITION IS 2
                MASK    RADMODES
                AD      BIT6
                TS      RADMODES
                ...
                CAF     5SECS           # START SCANNING FOR INBIT AFTER 7 SECS.
                TC      WAITLIST
                2CADR   MAKESURE
