...
logAGC(FILE *logFile, uint16_t lastZ)
{
  ...
  else fprintf (logFile, "%02o,%04o", regBank, (lastZ & 07777));
  fprintf (logFile, "\tA=%06o\tQ=%06o\tLP=%06o\tBANK=%03o\tSCL=%lu", regA, regQ, regLP, 037 & regBank, agc.countMCT);
  fprintf (logFile, "\n\tOUT1=%05o\tOUT2=%05o\tOUT3=%05o\tOUT4=%05o", regOUT1, regOUT2, regOUT3, regOUT4);
