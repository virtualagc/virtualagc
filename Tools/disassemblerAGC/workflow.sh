...
disassemblerAGC.py --specs=$baseline-autogenerated.specs <$baseline.binsource >$baseline-autogenerated.patterns $specs
disassemblerAGC.py --find=$baseline-autogenerated.patterns --check=$baseline.lst <$baseline.binsource >$baseline-autogenerated.matches $find
