...
Surprisingly, even in its primitive state as of this writing &mdash; I already have some big improvements in mind &mdash; the disassembler can match about a third of the symbols, even though we are working with only a quarter (9 of 36) of the memory banks. Whether many of those symbols are correct remains to be seen.
