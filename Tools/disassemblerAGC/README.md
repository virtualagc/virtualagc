...
If run as described above, this process finds about a third of the program labels and variables it seeks.  The great majority of those actually remain at the same addresses as in Comanche 55.
