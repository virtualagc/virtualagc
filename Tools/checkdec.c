 ...
 *              by yaYUL.
 * Mods:	11/02/03 RSB	Added the GPL header.
...
main(void)
{
  ...
  printf("\n");
  printf(
      "This program is interactive.  The main purpose is to enter DEC or 2DEC\n");
  printf(
      "constants to see how yaYUL would convert them to octal in the core-rope\n");
  printf(
      "image file, however some other formats are accepted as well.  This is\n");
  ...
  printf("\tdecimal * decimal\n");
  printf(
      "Decimal numbers can include a sign and decimal point, octals cannot.\n");
  printf(
      "The output is two 5-octal-digit numbers, the more-signficant being first.\n");
