...
# Filename:	MAIN.agc
# Purpose:	The main source file for Luminary 99 Rev 2 (LUM99R2).
...
#		2017-03-03 RSB	Adapted from the corresponding 
#				Luminary 99 Rev 1 file.
#
# This is an attempt to recreate Luminary 99 Rev 2 from Luminary 99 Rev 1
# plus a portion of the CONTROLLED CONSTANTS from Luminary 116, affecting
# only memory bank 26.  The page-numbers referenced below thus refer to 
# the Luminary 99 Rev 1 hardcopy, though in so far as the CONTROLLED 
# CONSTANTS are concerned, they match the Luminary 116 hardcopy as well.
