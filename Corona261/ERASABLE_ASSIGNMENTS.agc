...
## 		2025-05-03 MAS  Incorporated original labels found in R-532
...
MIDFLAG		EQUALS	2		# FREE-FALL INTEGRATION.
MOONFLAG	EQUALS	3		# FREE-FALL INTEGRATION.
FIRSTFLG	EQUALS	4		# MIDCOURSE NAVIGATION.
...
COASTFLG	EQUALS	17D		# 17 TO 47 ARE 202 SEQUENCE CONTROL FLAGS.
UPDATFLG	EQUALS	18D
VERTFLAG	EQUALS	19D
SHTDNFLG	EQUALS	20D
ACTIVFLG	EQUALS	21D
...
#
#	IN FLIGHT 202, BITS 2, 5, 11, AND 12 INHIBIT MAINTENANCE OF THE NIGHT WATCHMAN ALARM
...
# B, C MEMORY USED FOR ERASABLE 202 LAUNCH, AIMPOINT, VEHICLE DATA.
