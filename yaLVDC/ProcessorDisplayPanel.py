...
#    Jun 01, 2020 02:40:42 PM CDT  platform: Linux
...
class topProcessorDisplayPanel:
  def __init__(self, top=None):
    ...
    self.dummyScrolledText = ScrolledText(top)
    self.dummyScrolledText.place(relx=0.053, rely=1.008, relheight=0.092
        , relwidth=0.093)
    self.dummyScrolledText.configure(background="white")
    self.dummyScrolledText.configure(font="-family {DejaVu Sans} -size 12")
    self.dummyScrolledText.configure(insertborderwidth="3")
    self.dummyScrolledText.configure(selectbackground="#c4c4c4")
    self.dummyScrolledText.configure(wrap="none")
