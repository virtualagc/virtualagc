...
#    May 17, 2020 04:35:18 PM CDT  platform: Linux
...
class topProcessorDisplayPanel:
  def __init__(self, top=None):
    ...
    font33 = "-family {DejaVu Sans} -size 12"
    font36 = "-family {DejaVu Sans} -size 12"
    self.style = ttk.Style()
    if sys.platform == "win32":
      self.style.theme_use('winnative')
    self.style.configure('.',background=_bgcolor)
    self.style.configure('.',foreground=_fgcolor)
    self.style.configure('.',font=font33)
    self.style.map('.',background=
      [('selected', _compcolor), ('active',_ana2color)])

    top.geometry("1311x729+3200+0")
    top.minsize(1, 1)
    ...
    self.Label14_18.place(relx=0.801, rely=0.768, height=23, width=67
        , bordermode='ignore')
    self.Label14_18.configure(activebackground="#f9f9f9")
    self.Label14_18.configure(anchor='w')
    ...
    self.Label14_15.place(relx=0.938, rely=0.622, height=18, width=12
        , bordermode='ignore')
    ...
    self.pdpLAMP_TEST.place(relx=0.126, rely=0.377, relheight=0.387
        , relwidth=0.092, bordermode='ignore')
    ...
    self.menubar = tk.Menu(top,font=font36,bg=_bgcolor,fg=_fgcolor)
    ...
    self.Label13_12.place(relx=0.664, rely=0.111, height=16, width=70
        , bordermode='ignore')
    ...
    self.Label13_14 = tk.Label(self.paneMemoryLoadAndDataDisplayPanel_p2)
    self.Label13_14.place(relx=0.458, rely=0.556, height=16, width=70
        , bordermode='ignore')
    self.Label13_14.configure(activebackground="#f9f9f9")
    self.Label13_14.configure(anchor='ne')
    self.Label13_14.configure(font="-family {DejaVu Sans} -size 8")
    self.Label13_14.configure(text='''ADDRESS''')
    ...
    self.Label12_12 = tk.Label(self.paneMemoryLoadAndDataDisplayPanel_p3)
    self.Label12_12.place(relx=0.611, rely=0.376, height=23, width=77
        , bordermode='ignore')
    self.Label12_12.configure(activebackground="#f9f9f9")
    self.Label12_12.configure(font="-family {DejaVu Sans} -size 8")
    self.Label12_12.configure(text='''—COMMAND—''')
    ...
    self.Label13_9.place(relx=0.423, rely=0.097, height=9, width=70
        , bordermode='ignore')
