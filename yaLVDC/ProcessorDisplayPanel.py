...
#    May 12, 2020 04:30:40 PM CDT  platform: Linux
...
class topProcessorDisplayPanel:
  def __init__(self, top=None):
    ...
    font27 = "-family {DejaVu Sans} -size 12"
    self.style = ttk.Style()
    if sys.platform == "win32":
      self.style.theme_use('winnative')
    self.style.configure('.',background=_bgcolor)
    self.style.configure('.',foreground=_fgcolor)
    self.style.configure('.',font=font24)
    self.style.map('.',background=
      [('selected', _compcolor), ('active',_ana2color)])

    top.geometry("1311x729")
    top.minsize(1, 1)
    ...
    self.menubar = tk.Menu(top,font=font27,bg=_bgcolor,fg=_fgcolor)
    ...
    self.paneMemoryLoadAndDataDisplayPanel_p3 = ttk.Labelframe(height=82.80000000000001
        , text='DATA ADDRESS')
    ...
    self.paneMemoryLoadAndDataDisplayPanel_p5 = ttk.Labelframe(height=40.5
        , text='')
    self.paneMemoryLoadAndDataDisplayPanel.add(self.paneMemoryLoadAndDataDisplayPanel_p5, weight=1)
    self.paneMemoryLoadAndDataDisplayPanel_p6 = ttk.Labelframe(text='DISPLAY MODE')

    self.paneMemoryLoadAndDataDisplayPanel.add(self.paneMemoryLoadAndDataDisplayPanel_p6, weight=3)
    ...
    self.Label10.place(relx=0.0, rely=0.143, height=25, width=444
        , bordermode='ignore')
    ...
    self.TPanedwindow3 = ttk.Panedwindow(top, orient="vertical")
    self.TPanedwindow3.place(relx=0.0, rely=0.0, relheight=1.0, relwidth=0.328)
    self.TPanedwindow3_p1 = ttk.Labelframe(height=240, text='')
    self.TPanedwindow3.add(self.TPanedwindow3_p1, weight=0)
    self.TPanedwindow3_p2 = ttk.Labelframe(height=194.70000000000005
        , text='ACCUMULATOR')
    self.TPanedwindow3.add(self.TPanedwindow3_p2, weight=3)
    self.TPanedwindow3_p3 = ttk.Labelframe(height=136.20000000000005
        , text='MEMORY BUFFER REGISTER')
    self.TPanedwindow3.add(self.TPanedwindow3_p3, weight=2)
    self.TPanedwindow3_p4 = ttk.Labelframe(height=95.4, text='PROCESSOR TIMING')
    self.TPanedwindow3.add(self.TPanedwindow3_p4, weight=4)
    self.TPanedwindow3_p5 = ttk.Labelframe(text='TAPE READER')
    self.TPanedwindow3.add(self.TPanedwindow3_p5, weight=2)
    self.__funcid4 = self.TPanedwindow3.bind('<Map>', self.__adjust_sash4)

    self.Label11 = tk.Label(self.TPanedwindow3_p1)
