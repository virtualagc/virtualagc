...
## <b>Reconstruction:</b>  V79 is not present in the Comanche 55 baseline, in 
## which this table position was a spare,
## and has been added due to PCR-815 and flowchart FC-2370.
		TC	V79
...
## <b>Reconstruction:</b>  V79 is not present in the Comanche 55 baseline,
## and has been added due to PCR-815 and flowchart FC-2370.
		BANK	43
		SETLOC	EXTVERBS
		BANK
...
RATECOMP	INHINT
		...
		TC	STOPRATE	# ZERO WBODY'S, DELCDU'S, AND BIAS'S
		
		DCA	THETADX
		DXCH	CDUXD		# SET STEERING ANGLES TO CENTER OF DAP DEADBAND
		DCA	THETADY
		DXCH	CDUYD
		DCA	THETADZ
		DXCH	CDUZD
		
		CCS	DBPTC		# TEST DEADBAND PASSIVE THERMAL CONTROL
		AD	ONE
		TC	+1
		ADD	ONE
		TS	ADB
