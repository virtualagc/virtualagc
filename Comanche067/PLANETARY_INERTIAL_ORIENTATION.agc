...
## (PCR) 773.1, "Fix Constants for Planetary Inertial Orientation Subroutine".  Unfortunately,
...
## Luminary 116, CONTROLLED CONSTANTS log section. For simplicity's sake, the constant 
