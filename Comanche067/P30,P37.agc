...
P30		TC	P30/P31
		TC	CNTNUP30
## <b>Reconstruction:</b>  <code>XDELVFLG</code> is set here due to 
## PCR 812.1.
		TC	UPFLAG		# SET XDELVFLG
		ADRES	XDELVFLG
...
## <b>Reconstruction:</b> The addition of the line of code following this annotation is related to the fact that 
