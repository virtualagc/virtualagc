...
##		2021-10-24 RSB	Incorporated PCR-781.1.
...
1/PIPA1		CAF	FOUR		# PIPAZ, PIPAY, PIPAX
		...
		EXTEND
## The following, <code>MP BIT1</code> in the Comanche 55 baseline, has been changed
## due to PCR-781.1, "PIPA Bias Compensation Scale Change".
