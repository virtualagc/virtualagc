...
## of those extra words.  It is also related to the known partial octal listings of Comanche 67,
## in which DODOWNTM seems to match In Artemis, but without a TC C13STALL instruction.
		BLOCK	02
...
#
## <b>Reconstruction:</b> The following comment line was changed from the Comanche 57 baseline
## due to PCR-278.
