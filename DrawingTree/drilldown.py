	...
	for n in findNumbers:
		for c in ["", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N"]:
			...
			if key in findTable:
				...
				ref = False
				if qty != "" and qty.isdigit() and int(qty) > 0 and "SPECIFICATION CONTROL DRAWING" not in thisTitle \
					and "SPECIFICATION CONTROL DWG" not in thisTitle and "SCD" not in thisTitle:
