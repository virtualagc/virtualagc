...
INREL		EQUALS	DOTRET		# INPUT BUFFER SELECTOR ( X,Y,X, REG )
...
# (SERVICER STORAGE AND P11 STORAGE IN UNSWITHCED SHOULD NOT
...
#		(DIFEQCNT THRU XKEP MUST BE IN THE SAME
