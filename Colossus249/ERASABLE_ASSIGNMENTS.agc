...
##				Changed a +8 to +8D to match scans.
##				Various symbol name fixes.
##				FCADRMM1 definition moved to its own EQUALS line.
...
## Page 67
# PAD LOAD FOR DAPS			(1)
EMDOT		EQUALS	FLAGFILL	# I(1)PL (SPS FLOW RATE, SC AT B+3KG/CS)

# EXIT FOR V83				(1D)
STATEXIT	EQUALS	FLAGFILL +2	# I(1) STQ ADDRESS FOR STATEXP
...
HPERMIN		EQUALS	RANGE		# I(2) SET TO 300KFT OR 35KFTFOR SR30.1
...
T3TOT4		EQUALS	RELDELV	+2	# I(2)DSP NOUN 39 FOR P34,35.  TPI TO TIN
					# T(CANNOT SHARE WITH RETURN TO EARTH)
## Page 93
