...
## Assembler:	yaYUL
## Reference:	pp. 693-738.
## Contact:	Ron Burkey <info@sandroid.org>.
## Website:	www.ibiblio.org/apollo.
## Mod history:	08/16/04 RSB.	Began adapting from corresponding Luminary131
##				file.
##		08/22/04 RSB	Removed the "lunar and solar ephemerides subroutines"
##				to their own file.
...
# BY THE ASTRONAUT THIS ROUTINE OPERATES AND CHECKS THE OBSERVED SIGHTINGS AGAINS STORED STAR VECTORS IN THE
...
#
#	1.  SEXTANT ANGLES ARE COMPUTED IN TERMS OF NAVIGTIONAL BASE COORDINATES.  LET SA AND TA BE THE SHAFT AND
...
## Page 736
		...
		TCF	R56A +2		# V33:  DON'T PROCEED -- JUST ENTER TO MARK
		TC	INTPRET
		DLOAD
			MRKBUF1 +3
		STODL	SAC
