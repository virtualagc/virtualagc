...
## Assembler:	yaYUL
## Reference:	Starts on p. 1232
## Contact:	Ron Burkey <info@sandroid.org>.
## Website:	www.ibiblio.org/apollo.
## Mod history:	08/29/04 RSB.	Began converting from corresponding Luminary131 file.
...
#	XPREV		+17 FOR EARTH		PRVIOUS VALUE OF X IN METERS-TO-THE-ONE-HALF FROM KEPPREP
#			+16 FOR MOON		(DP)
#
# SUBROUTINES CALLED --
#	DELTIME
...
#	XPREV		+17 FOR EARTH		DP VALUE OF X IN METERS-TO-THE-ONE-HALF-POWER TO WHICH KEPLER CONVERGED.
#			+16 FOR MOON		(DP)
...
#
# ABORT EXIT MODES --
#	IF SOLNSW WAS SET UPON EXITING, EITHER LAMBERT WAS ASKED TO COMPUTE A TRANSFER TOO NEAR 0 OR 260 DEG, OR T
...
#							CLEAR IF NOT.
#
#	IN ADDITION, IF VTARGTAG IS CLEAR, THE FOLLOWING ARE OUTPUT --
...
#
# PARAMETERS OF NO USE --
#	SP PARAMETERS -- RTNTT, GEOMSGN, RTNPRM, MAGVEC2=R2 (DP), PLUS PUSHLIST LOCATIONS 0-11D, 14D-21D, 24D-39D, R1D
...
#	1. THE ANGLE BETWEEN ANY POSITION VECTOR AND ITS VELOCITY VECTOR MUST BE GREATER THAN 1 DEGREE 47.5 MINUTES
#	   AND LESS THAN 178 DEGREES 12.5 MINUTES.
#	2. THE PARAMETERS IN THE PROBLEM MUST NOT EXCEED THEIR SCALING LIMITS SPECIFIED IN TEH GSOP.  IF THE LIMITS
...
# CALLING SEQUENCE AND NORMAL EXIT MODES --
#	IF ONLY TIME IS DESIRED AS OUTPUT --
#	L	SET	CALL		# USE BE IN INTERPRETIVE MODE BUT OVFIND ARBITRARY.
#	L+1		RVSW
...
## Page 1262
# There is a handwritten note here, in Colossus 249, reading "from Lambert 1267" --- RSB 2004
...
# UN		ERASE	+5	# ONLY USEC IF NORMSE IS 1
# VTARGTAG	ERASE	+0
