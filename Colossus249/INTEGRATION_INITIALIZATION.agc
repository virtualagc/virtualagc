...
# SIDETHE LUNAR SPHERE OF INFLUENCE.
#
...
OTHERS		BON			#		FOR
			SURFFLAG	#		    CSM
			SETCOAST	# DONT DO LM		ONLY
		DLOAD	CALL		# GET SET FOR NON W-MAT PERMANENT INTEG.
...
SETCOAST	AXT,2	CALL		# NOW MOVE PROPERLY SCALE RN,VN AND
