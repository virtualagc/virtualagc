...
RTE380		STORE	NN1A
		...
		DLOAD	DSU
			00D
			DRCON
		NORM	PDDL		# X(T2)ERR-X(T2)ERR,=21			PL06D
			X1
			RPRE'
...
#
# ALARM EXIT MODE
#	AT L+2 OF CALLING SEQUENCE WITH MPAC = OCTAL 612 FOR STATE VECTOR IN MOON'S SPHERE OF INFLUENCE
#
# SUBROUTINES CALLED
#	CSMPREC
#
...
#	RCON		FONAL RADIUS						DP	B29/B27	METERS
...
V2T100		STQ
		...
		SL*	DSU
			0 -7,1
			1RTEB17
		RTB	PDDL		# BETA5*LAMBDA-1 = THETA1	B17
			TPMODE
			1RTEB1
		SR*	DCOMP
			0,1
...
GAMDV45		BOVB	DLOAD
		...
		XSU,1
			X2
		STORE	16D		# PRESERV SIGN IF OVERFLOW
		SR*	BOV
			0 -1,1
			GAMDV47
...
M6RTEB28	2DEC	-6 B-28
2RTEB1		2OCT	3777737777
M9RTEB28	2DEC	-9 B-28
M8RTEB28	2DEC	-8 B-28
30480RTE	2DEC	30480 B-29
VCSPS		2DEC	30.8811 B-5
## Page 885
